var pn=Object.defineProperty;var hn=(r,n,d)=>n in r?pn(r,n,{enumerable:!0,configurable:!0,writable:!0,value:d}):r[n]=d;var T=(r,n,d)=>(hn(r,typeof n!="symbol"?n+"":n,d),d);(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const b of document.querySelectorAll('link[rel="modulepreload"]'))v(b);new MutationObserver(b=>{for(const w of b)if(w.type==="childList")for(const S of w.addedNodes)S.tagName==="LINK"&&S.rel==="modulepreload"&&v(S)}).observe(document,{childList:!0,subtree:!0});function d(b){const w={};return b.integrity&&(w.integrity=b.integrity),b.referrerPolicy&&(w.referrerPolicy=b.referrerPolicy),b.crossOrigin==="use-credentials"?w.credentials="include":b.crossOrigin==="anonymous"?w.credentials="omit":w.credentials="same-origin",w}function v(b){if(b.ep)return;b.ep=!0;const w=d(b);fetch(b.href,w)}})();function _n(r,n){return class extends r{constructor(...d){super(...d),n(this)}}}const gn=_n(Array,r=>r.fill(0));let be=1e-6;function mn(r){function n(g=0,x=0){const y=new r(2);return g!==void 0&&(y[0]=g,x!==void 0&&(y[1]=x)),y}const d=n;function v(g,x,y){const e=y??new r(2);return e[0]=g,e[1]=x,e}function b(g,x){const y=x??new r(2);return y[0]=Math.ceil(g[0]),y[1]=Math.ceil(g[1]),y}function w(g,x){const y=x??new r(2);return y[0]=Math.floor(g[0]),y[1]=Math.floor(g[1]),y}function S(g,x){const y=x??new r(2);return y[0]=Math.round(g[0]),y[1]=Math.round(g[1]),y}function M(g,x=0,y=1,e){const u=e??new r(2);return u[0]=Math.min(y,Math.max(x,g[0])),u[1]=Math.min(y,Math.max(x,g[1])),u}function G(g,x,y){const e=y??new r(2);return e[0]=g[0]+x[0],e[1]=g[1]+x[1],e}function O(g,x,y,e){const u=e??new r(2);return u[0]=g[0]+x[0]*y,u[1]=g[1]+x[1]*y,u}function W(g,x){const y=g[0],e=g[1],u=x[0],i=x[1],o=Math.sqrt(y*y+e*e),s=Math.sqrt(u*u+i*i),l=o*s,m=l&&Z(g,x)/l;return Math.acos(m)}function J(g,x,y){const e=y??new r(2);return e[0]=g[0]-x[0],e[1]=g[1]-x[1],e}const I=J;function Q(g,x){return Math.abs(g[0]-x[0])<be&&Math.abs(g[1]-x[1])<be}function ae(g,x){return g[0]===x[0]&&g[1]===x[1]}function oe(g,x,y,e){const u=e??new r(2);return u[0]=g[0]+y*(x[0]-g[0]),u[1]=g[1]+y*(x[1]-g[1]),u}function L(g,x,y,e){const u=e??new r(2);return u[0]=g[0]+y[0]*(x[0]-g[0]),u[1]=g[1]+y[1]*(x[1]-g[1]),u}function ee(g,x,y){const e=y??new r(2);return e[0]=Math.max(g[0],x[0]),e[1]=Math.max(g[1],x[1]),e}function pe(g,x,y){const e=y??new r(2);return e[0]=Math.min(g[0],x[0]),e[1]=Math.min(g[1],x[1]),e}function R(g,x,y){const e=y??new r(2);return e[0]=g[0]*x,e[1]=g[1]*x,e}const te=R;function ie(g,x,y){const e=y??new r(2);return e[0]=g[0]/x,e[1]=g[1]/x,e}function $(g,x){const y=x??new r(2);return y[0]=1/g[0],y[1]=1/g[1],y}const _e=$;function K(g,x,y){const e=y??new r(3),u=g[0]*x[1]-g[1]*x[0];return e[0]=0,e[1]=0,e[2]=u,e}function Z(g,x){return g[0]*x[0]+g[1]*x[1]}function he(g){const x=g[0],y=g[1];return Math.sqrt(x*x+y*y)}const D=he;function ne(g){const x=g[0],y=g[1];return x*x+y*y}const F=ne;function de(g,x){const y=g[0]-x[0],e=g[1]-x[1];return Math.sqrt(y*y+e*e)}const ge=de;function V(g,x){const y=g[0]-x[0],e=g[1]-x[1];return y*y+e*e}const re=V;function ye(g,x){const y=x??new r(2),e=g[0],u=g[1],i=Math.sqrt(e*e+u*u);return i>1e-5?(y[0]=e/i,y[1]=u/i):(y[0]=0,y[1]=0),y}function Se(g,x){const y=x??new r(2);return y[0]=-g[0],y[1]=-g[1],y}function me(g,x){const y=x??new r(2);return y[0]=g[0],y[1]=g[1],y}const Te=me;function ze(g,x,y){const e=y??new r(2);return e[0]=g[0]*x[0],e[1]=g[1]*x[1],e}const ke=ze;function le(g,x,y){const e=y??new r(2);return e[0]=g[0]/x[0],e[1]=g[1]/x[1],e}const we=le;function Be(g=1,x){const y=x??new r(2),e=Math.random()*2*Math.PI;return y[0]=Math.cos(e)*g,y[1]=Math.sin(e)*g,y}function B(g){const x=g??new r(2);return x[0]=0,x[1]=0,x}function A(g,x,y){const e=y??new r(2),u=g[0],i=g[1];return e[0]=u*x[0]+i*x[4]+x[12],e[1]=u*x[1]+i*x[5]+x[13],e}function h(g,x,y){const e=y??new r(2),u=g[0],i=g[1];return e[0]=x[0]*u+x[4]*i+x[8],e[1]=x[1]*u+x[5]*i+x[9],e}function t(g,x,y,e){const u=e??new r(2),i=g[0]-x[0],o=g[1]-x[1],s=Math.sin(y),l=Math.cos(y);return u[0]=i*l-o*s+x[0],u[1]=i*s+o*l+x[1],u}function c(g,x,y){const e=y??new r(2);return ye(g,e),R(e,x,e)}function a(g,x,y){const e=y??new r(2);return he(g)>x?c(g,x,e):me(g,e)}function f(g,x,y){const e=y??new r(2);return oe(g,x,.5,e)}return{create:n,fromValues:d,set:v,ceil:b,floor:w,round:S,clamp:M,add:G,addScaled:O,angle:W,subtract:J,sub:I,equalsApproximately:Q,equals:ae,lerp:oe,lerpV:L,max:ee,min:pe,mulScalar:R,scale:te,divScalar:ie,inverse:$,invert:_e,cross:K,dot:Z,length:he,len:D,lengthSq:ne,lenSq:F,distance:de,dist:ge,distanceSq:V,distSq:re,normalize:ye,negate:Se,copy:me,clone:Te,multiply:ze,mul:ke,divide:le,div:we,random:Be,zero:B,transformMat4:A,transformMat3:h,rotate:t,setLength:c,truncate:a,midpoint:f}}const Et=new Map;function Qt(r){let n=Et.get(r);return n||(n=mn(r),Et.set(r,n)),n}function xn(r){function n(s,l,m){const _=new r(3);return s!==void 0&&(_[0]=s,l!==void 0&&(_[1]=l,m!==void 0&&(_[2]=m))),_}const d=n;function v(s,l,m,_){const p=_??new r(3);return p[0]=s,p[1]=l,p[2]=m,p}function b(s,l){const m=l??new r(3);return m[0]=Math.ceil(s[0]),m[1]=Math.ceil(s[1]),m[2]=Math.ceil(s[2]),m}function w(s,l){const m=l??new r(3);return m[0]=Math.floor(s[0]),m[1]=Math.floor(s[1]),m[2]=Math.floor(s[2]),m}function S(s,l){const m=l??new r(3);return m[0]=Math.round(s[0]),m[1]=Math.round(s[1]),m[2]=Math.round(s[2]),m}function M(s,l=0,m=1,_){const p=_??new r(3);return p[0]=Math.min(m,Math.max(l,s[0])),p[1]=Math.min(m,Math.max(l,s[1])),p[2]=Math.min(m,Math.max(l,s[2])),p}function G(s,l,m){const _=m??new r(3);return _[0]=s[0]+l[0],_[1]=s[1]+l[1],_[2]=s[2]+l[2],_}function O(s,l,m,_){const p=_??new r(3);return p[0]=s[0]+l[0]*m,p[1]=s[1]+l[1]*m,p[2]=s[2]+l[2]*m,p}function W(s,l){const m=s[0],_=s[1],p=s[2],P=l[0],k=l[1],U=l[2],E=Math.sqrt(m*m+_*_+p*p),z=Math.sqrt(P*P+k*k+U*U),N=E*z,Y=N&&Z(s,l)/N;return Math.acos(Y)}function J(s,l,m){const _=m??new r(3);return _[0]=s[0]-l[0],_[1]=s[1]-l[1],_[2]=s[2]-l[2],_}const I=J;function Q(s,l){return Math.abs(s[0]-l[0])<be&&Math.abs(s[1]-l[1])<be&&Math.abs(s[2]-l[2])<be}function ae(s,l){return s[0]===l[0]&&s[1]===l[1]&&s[2]===l[2]}function oe(s,l,m,_){const p=_??new r(3);return p[0]=s[0]+m*(l[0]-s[0]),p[1]=s[1]+m*(l[1]-s[1]),p[2]=s[2]+m*(l[2]-s[2]),p}function L(s,l,m,_){const p=_??new r(3);return p[0]=s[0]+m[0]*(l[0]-s[0]),p[1]=s[1]+m[1]*(l[1]-s[1]),p[2]=s[2]+m[2]*(l[2]-s[2]),p}function ee(s,l,m){const _=m??new r(3);return _[0]=Math.max(s[0],l[0]),_[1]=Math.max(s[1],l[1]),_[2]=Math.max(s[2],l[2]),_}function pe(s,l,m){const _=m??new r(3);return _[0]=Math.min(s[0],l[0]),_[1]=Math.min(s[1],l[1]),_[2]=Math.min(s[2],l[2]),_}function R(s,l,m){const _=m??new r(3);return _[0]=s[0]*l,_[1]=s[1]*l,_[2]=s[2]*l,_}const te=R;function ie(s,l,m){const _=m??new r(3);return _[0]=s[0]/l,_[1]=s[1]/l,_[2]=s[2]/l,_}function $(s,l){const m=l??new r(3);return m[0]=1/s[0],m[1]=1/s[1],m[2]=1/s[2],m}const _e=$;function K(s,l,m){const _=m??new r(3),p=s[2]*l[0]-s[0]*l[2],P=s[0]*l[1]-s[1]*l[0];return _[0]=s[1]*l[2]-s[2]*l[1],_[1]=p,_[2]=P,_}function Z(s,l){return s[0]*l[0]+s[1]*l[1]+s[2]*l[2]}function he(s){const l=s[0],m=s[1],_=s[2];return Math.sqrt(l*l+m*m+_*_)}const D=he;function ne(s){const l=s[0],m=s[1],_=s[2];return l*l+m*m+_*_}const F=ne;function de(s,l){const m=s[0]-l[0],_=s[1]-l[1],p=s[2]-l[2];return Math.sqrt(m*m+_*_+p*p)}const ge=de;function V(s,l){const m=s[0]-l[0],_=s[1]-l[1],p=s[2]-l[2];return m*m+_*_+p*p}const re=V;function ye(s,l){const m=l??new r(3),_=s[0],p=s[1],P=s[2],k=Math.sqrt(_*_+p*p+P*P);return k>1e-5?(m[0]=_/k,m[1]=p/k,m[2]=P/k):(m[0]=0,m[1]=0,m[2]=0),m}function Se(s,l){const m=l??new r(3);return m[0]=-s[0],m[1]=-s[1],m[2]=-s[2],m}function me(s,l){const m=l??new r(3);return m[0]=s[0],m[1]=s[1],m[2]=s[2],m}const Te=me;function ze(s,l,m){const _=m??new r(3);return _[0]=s[0]*l[0],_[1]=s[1]*l[1],_[2]=s[2]*l[2],_}const ke=ze;function le(s,l,m){const _=m??new r(3);return _[0]=s[0]/l[0],_[1]=s[1]/l[1],_[2]=s[2]/l[2],_}const we=le;function Be(s=1,l){const m=l??new r(3),_=Math.random()*2*Math.PI,p=Math.random()*2-1,P=Math.sqrt(1-p*p)*s;return m[0]=Math.cos(_)*P,m[1]=Math.sin(_)*P,m[2]=p*s,m}function B(s){const l=s??new r(3);return l[0]=0,l[1]=0,l[2]=0,l}function A(s,l,m){const _=m??new r(3),p=s[0],P=s[1],k=s[2],U=l[3]*p+l[7]*P+l[11]*k+l[15]||1;return _[0]=(l[0]*p+l[4]*P+l[8]*k+l[12])/U,_[1]=(l[1]*p+l[5]*P+l[9]*k+l[13])/U,_[2]=(l[2]*p+l[6]*P+l[10]*k+l[14])/U,_}function h(s,l,m){const _=m??new r(3),p=s[0],P=s[1],k=s[2];return _[0]=p*l[0*4+0]+P*l[1*4+0]+k*l[2*4+0],_[1]=p*l[0*4+1]+P*l[1*4+1]+k*l[2*4+1],_[2]=p*l[0*4+2]+P*l[1*4+2]+k*l[2*4+2],_}function t(s,l,m){const _=m??new r(3),p=s[0],P=s[1],k=s[2];return _[0]=p*l[0]+P*l[4]+k*l[8],_[1]=p*l[1]+P*l[5]+k*l[9],_[2]=p*l[2]+P*l[6]+k*l[10],_}function c(s,l,m){const _=m??new r(3),p=l[0],P=l[1],k=l[2],U=l[3]*2,E=s[0],z=s[1],N=s[2],Y=P*N-k*z,C=k*E-p*N,H=p*z-P*E;return _[0]=E+Y*U+(P*H-k*C)*2,_[1]=z+C*U+(k*Y-p*H)*2,_[2]=N+H*U+(p*C-P*Y)*2,_}function a(s,l){const m=l??new r(3);return m[0]=s[12],m[1]=s[13],m[2]=s[14],m}function f(s,l,m){const _=m??new r(3),p=l*4;return _[0]=s[p+0],_[1]=s[p+1],_[2]=s[p+2],_}function g(s,l){const m=l??new r(3),_=s[0],p=s[1],P=s[2],k=s[4],U=s[5],E=s[6],z=s[8],N=s[9],Y=s[10];return m[0]=Math.sqrt(_*_+p*p+P*P),m[1]=Math.sqrt(k*k+U*U+E*E),m[2]=Math.sqrt(z*z+N*N+Y*Y),m}function x(s,l,m,_){const p=_??new r(3),P=[],k=[];return P[0]=s[0]-l[0],P[1]=s[1]-l[1],P[2]=s[2]-l[2],k[0]=P[0],k[1]=P[1]*Math.cos(m)-P[2]*Math.sin(m),k[2]=P[1]*Math.sin(m)+P[2]*Math.cos(m),p[0]=k[0]+l[0],p[1]=k[1]+l[1],p[2]=k[2]+l[2],p}function y(s,l,m,_){const p=_??new r(3),P=[],k=[];return P[0]=s[0]-l[0],P[1]=s[1]-l[1],P[2]=s[2]-l[2],k[0]=P[2]*Math.sin(m)+P[0]*Math.cos(m),k[1]=P[1],k[2]=P[2]*Math.cos(m)-P[0]*Math.sin(m),p[0]=k[0]+l[0],p[1]=k[1]+l[1],p[2]=k[2]+l[2],p}function e(s,l,m,_){const p=_??new r(3),P=[],k=[];return P[0]=s[0]-l[0],P[1]=s[1]-l[1],P[2]=s[2]-l[2],k[0]=P[0]*Math.cos(m)-P[1]*Math.sin(m),k[1]=P[0]*Math.sin(m)+P[1]*Math.cos(m),k[2]=P[2],p[0]=k[0]+l[0],p[1]=k[1]+l[1],p[2]=k[2]+l[2],p}function u(s,l,m){const _=m??new r(3);return ye(s,_),R(_,l,_)}function i(s,l,m){const _=m??new r(3);return he(s)>l?u(s,l,_):me(s,_)}function o(s,l,m){const _=m??new r(3);return oe(s,l,.5,_)}return{create:n,fromValues:d,set:v,ceil:b,floor:w,round:S,clamp:M,add:G,addScaled:O,angle:W,subtract:J,sub:I,equalsApproximately:Q,equals:ae,lerp:oe,lerpV:L,max:ee,min:pe,mulScalar:R,scale:te,divScalar:ie,inverse:$,invert:_e,cross:K,dot:Z,length:he,len:D,lengthSq:ne,lenSq:F,distance:de,dist:ge,distanceSq:V,distSq:re,normalize:ye,negate:Se,copy:me,clone:Te,multiply:ze,mul:ke,divide:le,div:we,random:Be,zero:B,transformMat4:A,transformMat4Upper3x3:h,transformMat3:t,transformQuat:c,getTranslation:a,getAxis:f,getScaling:g,rotateX:x,rotateY:y,rotateZ:e,setLength:u,truncate:i,midpoint:o}}const Dt=new Map;function xt(r){let n=Dt.get(r);return n||(n=xn(r),Dt.set(r,n)),n}function yn(r){const n=Qt(r),d=xt(r);function v(t,c,a,f,g,x,y,e,u){const i=new r(12);return i[3]=0,i[7]=0,i[11]=0,t!==void 0&&(i[0]=t,c!==void 0&&(i[1]=c,a!==void 0&&(i[2]=a,f!==void 0&&(i[4]=f,g!==void 0&&(i[5]=g,x!==void 0&&(i[6]=x,y!==void 0&&(i[8]=y,e!==void 0&&(i[9]=e,u!==void 0&&(i[10]=u))))))))),i}function b(t,c,a,f,g,x,y,e,u,i){const o=i??new r(12);return o[0]=t,o[1]=c,o[2]=a,o[3]=0,o[4]=f,o[5]=g,o[6]=x,o[7]=0,o[8]=y,o[9]=e,o[10]=u,o[11]=0,o}function w(t,c){const a=c??new r(12);return a[0]=t[0],a[1]=t[1],a[2]=t[2],a[3]=0,a[4]=t[4],a[5]=t[5],a[6]=t[6],a[7]=0,a[8]=t[8],a[9]=t[9],a[10]=t[10],a[11]=0,a}function S(t,c){const a=c??new r(12),f=t[0],g=t[1],x=t[2],y=t[3],e=f+f,u=g+g,i=x+x,o=f*e,s=g*e,l=g*u,m=x*e,_=x*u,p=x*i,P=y*e,k=y*u,U=y*i;return a[0]=1-l-p,a[1]=s+U,a[2]=m-k,a[3]=0,a[4]=s-U,a[5]=1-o-p,a[6]=_+P,a[7]=0,a[8]=m+k,a[9]=_-P,a[10]=1-o-l,a[11]=0,a}function M(t,c){const a=c??new r(12);return a[0]=-t[0],a[1]=-t[1],a[2]=-t[2],a[4]=-t[4],a[5]=-t[5],a[6]=-t[6],a[8]=-t[8],a[9]=-t[9],a[10]=-t[10],a}function G(t,c,a){const f=a??new r(12);return f[0]=t[0]*c,f[1]=t[1]*c,f[2]=t[2]*c,f[4]=t[4]*c,f[5]=t[5]*c,f[6]=t[6]*c,f[8]=t[8]*c,f[9]=t[9]*c,f[10]=t[10]*c,f}const O=G;function W(t,c,a){const f=a??new r(12);return f[0]=t[0]+c[0],f[1]=t[1]+c[1],f[2]=t[2]+c[2],f[4]=t[4]+c[4],f[5]=t[5]+c[5],f[6]=t[6]+c[6],f[8]=t[8]+c[8],f[9]=t[9]+c[9],f[10]=t[10]+c[10],f}function J(t,c){const a=c??new r(12);return a[0]=t[0],a[1]=t[1],a[2]=t[2],a[4]=t[4],a[5]=t[5],a[6]=t[6],a[8]=t[8],a[9]=t[9],a[10]=t[10],a}const I=J;function Q(t,c){return Math.abs(t[0]-c[0])<be&&Math.abs(t[1]-c[1])<be&&Math.abs(t[2]-c[2])<be&&Math.abs(t[4]-c[4])<be&&Math.abs(t[5]-c[5])<be&&Math.abs(t[6]-c[6])<be&&Math.abs(t[8]-c[8])<be&&Math.abs(t[9]-c[9])<be&&Math.abs(t[10]-c[10])<be}function ae(t,c){return t[0]===c[0]&&t[1]===c[1]&&t[2]===c[2]&&t[4]===c[4]&&t[5]===c[5]&&t[6]===c[6]&&t[8]===c[8]&&t[9]===c[9]&&t[10]===c[10]}function oe(t){const c=t??new r(12);return c[0]=1,c[1]=0,c[2]=0,c[4]=0,c[5]=1,c[6]=0,c[8]=0,c[9]=0,c[10]=1,c}function L(t,c){const a=c??new r(12);if(a===t){let l;return l=t[1],t[1]=t[4],t[4]=l,l=t[2],t[2]=t[8],t[8]=l,l=t[6],t[6]=t[9],t[9]=l,a}const f=t[0*4+0],g=t[0*4+1],x=t[0*4+2],y=t[1*4+0],e=t[1*4+1],u=t[1*4+2],i=t[2*4+0],o=t[2*4+1],s=t[2*4+2];return a[0]=f,a[1]=y,a[2]=i,a[4]=g,a[5]=e,a[6]=o,a[8]=x,a[9]=u,a[10]=s,a}function ee(t,c){const a=c??new r(12),f=t[0*4+0],g=t[0*4+1],x=t[0*4+2],y=t[1*4+0],e=t[1*4+1],u=t[1*4+2],i=t[2*4+0],o=t[2*4+1],s=t[2*4+2],l=s*e-u*o,m=-s*y+u*i,_=o*y-e*i,p=1/(f*l+g*m+x*_);return a[0]=l*p,a[1]=(-s*g+x*o)*p,a[2]=(u*g-x*e)*p,a[4]=m*p,a[5]=(s*f-x*i)*p,a[6]=(-u*f+x*y)*p,a[8]=_*p,a[9]=(-o*f+g*i)*p,a[10]=(e*f-g*y)*p,a}function pe(t){const c=t[0],a=t[0*4+1],f=t[0*4+2],g=t[1*4+0],x=t[1*4+1],y=t[1*4+2],e=t[2*4+0],u=t[2*4+1],i=t[2*4+2];return c*(x*i-u*y)-g*(a*i-u*f)+e*(a*y-x*f)}const R=ee;function te(t,c,a){const f=a??new r(12),g=t[0],x=t[1],y=t[2],e=t[4+0],u=t[4+1],i=t[4+2],o=t[8+0],s=t[8+1],l=t[8+2],m=c[0],_=c[1],p=c[2],P=c[4+0],k=c[4+1],U=c[4+2],E=c[8+0],z=c[8+1],N=c[8+2];return f[0]=g*m+e*_+o*p,f[1]=x*m+u*_+s*p,f[2]=y*m+i*_+l*p,f[4]=g*P+e*k+o*U,f[5]=x*P+u*k+s*U,f[6]=y*P+i*k+l*U,f[8]=g*E+e*z+o*N,f[9]=x*E+u*z+s*N,f[10]=y*E+i*z+l*N,f}const ie=te;function $(t,c,a){const f=a??oe();return t!==f&&(f[0]=t[0],f[1]=t[1],f[2]=t[2],f[4]=t[4],f[5]=t[5],f[6]=t[6]),f[8]=c[0],f[9]=c[1],f[10]=1,f}function _e(t,c){const a=c??n.create();return a[0]=t[8],a[1]=t[9],a}function K(t,c,a){const f=a??n.create(),g=c*4;return f[0]=t[g+0],f[1]=t[g+1],f}function Z(t,c,a,f){const g=f===t?t:J(t,f),x=a*4;return g[x+0]=c[0],g[x+1]=c[1],g}function he(t,c){const a=c??n.create(),f=t[0],g=t[1],x=t[4],y=t[5];return a[0]=Math.sqrt(f*f+g*g),a[1]=Math.sqrt(x*x+y*y),a}function D(t,c){const a=c??d.create(),f=t[0],g=t[1],x=t[2],y=t[4],e=t[5],u=t[6],i=t[8],o=t[9],s=t[10];return a[0]=Math.sqrt(f*f+g*g+x*x),a[1]=Math.sqrt(y*y+e*e+u*u),a[2]=Math.sqrt(i*i+o*o+s*s),a}function ne(t,c){const a=c??new r(12);return a[0]=1,a[1]=0,a[2]=0,a[4]=0,a[5]=1,a[6]=0,a[8]=t[0],a[9]=t[1],a[10]=1,a}function F(t,c,a){const f=a??new r(12),g=c[0],x=c[1],y=t[0],e=t[1],u=t[2],i=t[1*4+0],o=t[1*4+1],s=t[1*4+2],l=t[2*4+0],m=t[2*4+1],_=t[2*4+2];return t!==f&&(f[0]=y,f[1]=e,f[2]=u,f[4]=i,f[5]=o,f[6]=s),f[8]=y*g+i*x+l,f[9]=e*g+o*x+m,f[10]=u*g+s*x+_,f}function de(t,c){const a=c??new r(12),f=Math.cos(t),g=Math.sin(t);return a[0]=f,a[1]=g,a[2]=0,a[4]=-g,a[5]=f,a[6]=0,a[8]=0,a[9]=0,a[10]=1,a}function ge(t,c,a){const f=a??new r(12),g=t[0*4+0],x=t[0*4+1],y=t[0*4+2],e=t[1*4+0],u=t[1*4+1],i=t[1*4+2],o=Math.cos(c),s=Math.sin(c);return f[0]=o*g+s*e,f[1]=o*x+s*u,f[2]=o*y+s*i,f[4]=o*e-s*g,f[5]=o*u-s*x,f[6]=o*i-s*y,t!==f&&(f[8]=t[8],f[9]=t[9],f[10]=t[10]),f}function V(t,c){const a=c??new r(12),f=Math.cos(t),g=Math.sin(t);return a[0]=1,a[1]=0,a[2]=0,a[4]=0,a[5]=f,a[6]=g,a[8]=0,a[9]=-g,a[10]=f,a}function re(t,c,a){const f=a??new r(12),g=t[4],x=t[5],y=t[6],e=t[8],u=t[9],i=t[10],o=Math.cos(c),s=Math.sin(c);return f[4]=o*g+s*e,f[5]=o*x+s*u,f[6]=o*y+s*i,f[8]=o*e-s*g,f[9]=o*u-s*x,f[10]=o*i-s*y,t!==f&&(f[0]=t[0],f[1]=t[1],f[2]=t[2]),f}function ye(t,c){const a=c??new r(12),f=Math.cos(t),g=Math.sin(t);return a[0]=f,a[1]=0,a[2]=-g,a[4]=0,a[5]=1,a[6]=0,a[8]=g,a[9]=0,a[10]=f,a}function Se(t,c,a){const f=a??new r(12),g=t[0*4+0],x=t[0*4+1],y=t[0*4+2],e=t[2*4+0],u=t[2*4+1],i=t[2*4+2],o=Math.cos(c),s=Math.sin(c);return f[0]=o*g-s*e,f[1]=o*x-s*u,f[2]=o*y-s*i,f[8]=o*e+s*g,f[9]=o*u+s*x,f[10]=o*i+s*y,t!==f&&(f[4]=t[4],f[5]=t[5],f[6]=t[6]),f}const me=de,Te=ge;function ze(t,c){const a=c??new r(12);return a[0]=t[0],a[1]=0,a[2]=0,a[4]=0,a[5]=t[1],a[6]=0,a[8]=0,a[9]=0,a[10]=1,a}function ke(t,c,a){const f=a??new r(12),g=c[0],x=c[1];return f[0]=g*t[0*4+0],f[1]=g*t[0*4+1],f[2]=g*t[0*4+2],f[4]=x*t[1*4+0],f[5]=x*t[1*4+1],f[6]=x*t[1*4+2],t!==f&&(f[8]=t[8],f[9]=t[9],f[10]=t[10]),f}function le(t,c){const a=c??new r(12);return a[0]=t[0],a[1]=0,a[2]=0,a[4]=0,a[5]=t[1],a[6]=0,a[8]=0,a[9]=0,a[10]=t[2],a}function we(t,c,a){const f=a??new r(12),g=c[0],x=c[1],y=c[2];return f[0]=g*t[0*4+0],f[1]=g*t[0*4+1],f[2]=g*t[0*4+2],f[4]=x*t[1*4+0],f[5]=x*t[1*4+1],f[6]=x*t[1*4+2],f[8]=y*t[2*4+0],f[9]=y*t[2*4+1],f[10]=y*t[2*4+2],f}function Be(t,c){const a=c??new r(12);return a[0]=t,a[1]=0,a[2]=0,a[4]=0,a[5]=t,a[6]=0,a[8]=0,a[9]=0,a[10]=1,a}function B(t,c,a){const f=a??new r(12);return f[0]=c*t[0*4+0],f[1]=c*t[0*4+1],f[2]=c*t[0*4+2],f[4]=c*t[1*4+0],f[5]=c*t[1*4+1],f[6]=c*t[1*4+2],t!==f&&(f[8]=t[8],f[9]=t[9],f[10]=t[10]),f}function A(t,c){const a=c??new r(12);return a[0]=t,a[1]=0,a[2]=0,a[4]=0,a[5]=t,a[6]=0,a[8]=0,a[9]=0,a[10]=t,a}function h(t,c,a){const f=a??new r(12);return f[0]=c*t[0*4+0],f[1]=c*t[0*4+1],f[2]=c*t[0*4+2],f[4]=c*t[1*4+0],f[5]=c*t[1*4+1],f[6]=c*t[1*4+2],f[8]=c*t[2*4+0],f[9]=c*t[2*4+1],f[10]=c*t[2*4+2],f}return{add:W,clone:I,copy:J,create:v,determinant:pe,equals:ae,equalsApproximately:Q,fromMat4:w,fromQuat:S,get3DScaling:D,getAxis:K,getScaling:he,getTranslation:_e,identity:oe,inverse:ee,invert:R,mul:ie,mulScalar:O,multiply:te,multiplyScalar:G,negate:M,rotate:ge,rotateX:re,rotateY:Se,rotateZ:Te,rotation:de,rotationX:V,rotationY:ye,rotationZ:me,scale:ke,scale3D:we,scaling:ze,scaling3D:le,set:b,setAxis:Z,setTranslation:$,translate:F,translation:ne,transpose:L,uniformScale:B,uniformScale3D:h,uniformScaling:Be,uniformScaling3D:A}}const It=new Map;function bn(r){let n=It.get(r);return n||(n=yn(r),It.set(r,n)),n}function wn(r){const n=xt(r);function d(e,u,i,o,s,l,m,_,p,P,k,U,E,z,N,Y){const C=new r(16);return e!==void 0&&(C[0]=e,u!==void 0&&(C[1]=u,i!==void 0&&(C[2]=i,o!==void 0&&(C[3]=o,s!==void 0&&(C[4]=s,l!==void 0&&(C[5]=l,m!==void 0&&(C[6]=m,_!==void 0&&(C[7]=_,p!==void 0&&(C[8]=p,P!==void 0&&(C[9]=P,k!==void 0&&(C[10]=k,U!==void 0&&(C[11]=U,E!==void 0&&(C[12]=E,z!==void 0&&(C[13]=z,N!==void 0&&(C[14]=N,Y!==void 0&&(C[15]=Y)))))))))))))))),C}function v(e,u,i,o,s,l,m,_,p,P,k,U,E,z,N,Y,C){const H=C??new r(16);return H[0]=e,H[1]=u,H[2]=i,H[3]=o,H[4]=s,H[5]=l,H[6]=m,H[7]=_,H[8]=p,H[9]=P,H[10]=k,H[11]=U,H[12]=E,H[13]=z,H[14]=N,H[15]=Y,H}function b(e,u){const i=u??new r(16);return i[0]=e[0],i[1]=e[1],i[2]=e[2],i[3]=0,i[4]=e[4],i[5]=e[5],i[6]=e[6],i[7]=0,i[8]=e[8],i[9]=e[9],i[10]=e[10],i[11]=0,i[12]=0,i[13]=0,i[14]=0,i[15]=1,i}function w(e,u){const i=u??new r(16),o=e[0],s=e[1],l=e[2],m=e[3],_=o+o,p=s+s,P=l+l,k=o*_,U=s*_,E=s*p,z=l*_,N=l*p,Y=l*P,C=m*_,H=m*p,q=m*P;return i[0]=1-E-Y,i[1]=U+q,i[2]=z-H,i[3]=0,i[4]=U-q,i[5]=1-k-Y,i[6]=N+C,i[7]=0,i[8]=z+H,i[9]=N-C,i[10]=1-k-E,i[11]=0,i[12]=0,i[13]=0,i[14]=0,i[15]=1,i}function S(e,u){const i=u??new r(16);return i[0]=-e[0],i[1]=-e[1],i[2]=-e[2],i[3]=-e[3],i[4]=-e[4],i[5]=-e[5],i[6]=-e[6],i[7]=-e[7],i[8]=-e[8],i[9]=-e[9],i[10]=-e[10],i[11]=-e[11],i[12]=-e[12],i[13]=-e[13],i[14]=-e[14],i[15]=-e[15],i}function M(e,u,i){const o=i??new r(16);return o[0]=e[0]+u[0],o[1]=e[1]+u[1],o[2]=e[2]+u[2],o[3]=e[3]+u[3],o[4]=e[4]+u[4],o[5]=e[5]+u[5],o[6]=e[6]+u[6],o[7]=e[7]+u[7],o[8]=e[8]+u[8],o[9]=e[9]+u[9],o[10]=e[10]+u[10],o[11]=e[11]+u[11],o[12]=e[12]+u[12],o[13]=e[13]+u[13],o[14]=e[14]+u[14],o[15]=e[15]+u[15],o}function G(e,u,i){const o=i??new r(16);return o[0]=e[0]*u,o[1]=e[1]*u,o[2]=e[2]*u,o[3]=e[3]*u,o[4]=e[4]*u,o[5]=e[5]*u,o[6]=e[6]*u,o[7]=e[7]*u,o[8]=e[8]*u,o[9]=e[9]*u,o[10]=e[10]*u,o[11]=e[11]*u,o[12]=e[12]*u,o[13]=e[13]*u,o[14]=e[14]*u,o[15]=e[15]*u,o}const O=G;function W(e,u){const i=u??new r(16);return i[0]=e[0],i[1]=e[1],i[2]=e[2],i[3]=e[3],i[4]=e[4],i[5]=e[5],i[6]=e[6],i[7]=e[7],i[8]=e[8],i[9]=e[9],i[10]=e[10],i[11]=e[11],i[12]=e[12],i[13]=e[13],i[14]=e[14],i[15]=e[15],i}const J=W;function I(e,u){return Math.abs(e[0]-u[0])<be&&Math.abs(e[1]-u[1])<be&&Math.abs(e[2]-u[2])<be&&Math.abs(e[3]-u[3])<be&&Math.abs(e[4]-u[4])<be&&Math.abs(e[5]-u[5])<be&&Math.abs(e[6]-u[6])<be&&Math.abs(e[7]-u[7])<be&&Math.abs(e[8]-u[8])<be&&Math.abs(e[9]-u[9])<be&&Math.abs(e[10]-u[10])<be&&Math.abs(e[11]-u[11])<be&&Math.abs(e[12]-u[12])<be&&Math.abs(e[13]-u[13])<be&&Math.abs(e[14]-u[14])<be&&Math.abs(e[15]-u[15])<be}function Q(e,u){return e[0]===u[0]&&e[1]===u[1]&&e[2]===u[2]&&e[3]===u[3]&&e[4]===u[4]&&e[5]===u[5]&&e[6]===u[6]&&e[7]===u[7]&&e[8]===u[8]&&e[9]===u[9]&&e[10]===u[10]&&e[11]===u[11]&&e[12]===u[12]&&e[13]===u[13]&&e[14]===u[14]&&e[15]===u[15]}function ae(e){const u=e??new r(16);return u[0]=1,u[1]=0,u[2]=0,u[3]=0,u[4]=0,u[5]=1,u[6]=0,u[7]=0,u[8]=0,u[9]=0,u[10]=1,u[11]=0,u[12]=0,u[13]=0,u[14]=0,u[15]=1,u}function oe(e,u){const i=u??new r(16);if(i===e){let j;return j=e[1],e[1]=e[4],e[4]=j,j=e[2],e[2]=e[8],e[8]=j,j=e[3],e[3]=e[12],e[12]=j,j=e[6],e[6]=e[9],e[9]=j,j=e[7],e[7]=e[13],e[13]=j,j=e[11],e[11]=e[14],e[14]=j,i}const o=e[0*4+0],s=e[0*4+1],l=e[0*4+2],m=e[0*4+3],_=e[1*4+0],p=e[1*4+1],P=e[1*4+2],k=e[1*4+3],U=e[2*4+0],E=e[2*4+1],z=e[2*4+2],N=e[2*4+3],Y=e[3*4+0],C=e[3*4+1],H=e[3*4+2],q=e[3*4+3];return i[0]=o,i[1]=_,i[2]=U,i[3]=Y,i[4]=s,i[5]=p,i[6]=E,i[7]=C,i[8]=l,i[9]=P,i[10]=z,i[11]=H,i[12]=m,i[13]=k,i[14]=N,i[15]=q,i}function L(e,u){const i=u??new r(16),o=e[0*4+0],s=e[0*4+1],l=e[0*4+2],m=e[0*4+3],_=e[1*4+0],p=e[1*4+1],P=e[1*4+2],k=e[1*4+3],U=e[2*4+0],E=e[2*4+1],z=e[2*4+2],N=e[2*4+3],Y=e[3*4+0],C=e[3*4+1],H=e[3*4+2],q=e[3*4+3],j=z*q,ce=H*N,X=P*q,ue=H*k,xe=P*N,ve=z*k,Ee=l*q,De=H*m,Ie=l*N,Me=z*m,Ue=l*k,Re=P*m,Oe=U*C,fe=Y*E,Ge=_*C,Ae=Y*p,Pe=_*E,He=U*p,je=o*C,Ye=Y*s,Le=o*E,Fe=U*s,lt=o*p,ut=_*s,Mt=j*p+ue*E+xe*C-(ce*p+X*E+ve*C),Gt=ce*s+Ee*E+Me*C-(j*s+De*E+Ie*C),At=X*s+De*p+Ue*C-(ue*s+Ee*p+Re*C),zt=ve*s+Ie*p+Re*E-(xe*s+Me*p+Ue*E),Ce=1/(o*Mt+_*Gt+U*At+Y*zt);return i[0]=Ce*Mt,i[1]=Ce*Gt,i[2]=Ce*At,i[3]=Ce*zt,i[4]=Ce*(ce*_+X*U+ve*Y-(j*_+ue*U+xe*Y)),i[5]=Ce*(j*o+De*U+Ie*Y-(ce*o+Ee*U+Me*Y)),i[6]=Ce*(ue*o+Ee*_+Re*Y-(X*o+De*_+Ue*Y)),i[7]=Ce*(xe*o+Me*_+Ue*U-(ve*o+Ie*_+Re*U)),i[8]=Ce*(Oe*k+Ae*N+Pe*q-(fe*k+Ge*N+He*q)),i[9]=Ce*(fe*m+je*N+Fe*q-(Oe*m+Ye*N+Le*q)),i[10]=Ce*(Ge*m+Ye*k+lt*q-(Ae*m+je*k+ut*q)),i[11]=Ce*(He*m+Le*k+ut*N-(Pe*m+Fe*k+lt*N)),i[12]=Ce*(Ge*z+He*H+fe*P-(Pe*H+Oe*P+Ae*z)),i[13]=Ce*(Le*H+Oe*l+Ye*z-(je*z+Fe*H+fe*l)),i[14]=Ce*(je*P+ut*H+Ae*l-(lt*H+Ge*l+Ye*P)),i[15]=Ce*(lt*z+Pe*l+Fe*P-(Le*P+ut*z+He*l)),i}function ee(e){const u=e[0],i=e[0*4+1],o=e[0*4+2],s=e[0*4+3],l=e[1*4+0],m=e[1*4+1],_=e[1*4+2],p=e[1*4+3],P=e[2*4+0],k=e[2*4+1],U=e[2*4+2],E=e[2*4+3],z=e[3*4+0],N=e[3*4+1],Y=e[3*4+2],C=e[3*4+3],H=U*C,q=Y*E,j=_*C,ce=Y*p,X=_*E,ue=U*p,xe=o*C,ve=Y*s,Ee=o*E,De=U*s,Ie=o*p,Me=_*s,Ue=H*m+ce*k+X*N-(q*m+j*k+ue*N),Re=q*i+xe*k+De*N-(H*i+ve*k+Ee*N),Oe=j*i+ve*m+Ie*N-(ce*i+xe*m+Me*N),fe=ue*i+Ee*m+Me*k-(X*i+De*m+Ie*k);return u*Ue+l*Re+P*Oe+z*fe}const pe=L;function R(e,u,i){const o=i??new r(16),s=e[0],l=e[1],m=e[2],_=e[3],p=e[4+0],P=e[4+1],k=e[4+2],U=e[4+3],E=e[8+0],z=e[8+1],N=e[8+2],Y=e[8+3],C=e[12+0],H=e[12+1],q=e[12+2],j=e[12+3],ce=u[0],X=u[1],ue=u[2],xe=u[3],ve=u[4+0],Ee=u[4+1],De=u[4+2],Ie=u[4+3],Me=u[8+0],Ue=u[8+1],Re=u[8+2],Oe=u[8+3],fe=u[12+0],Ge=u[12+1],Ae=u[12+2],Pe=u[12+3];return o[0]=s*ce+p*X+E*ue+C*xe,o[1]=l*ce+P*X+z*ue+H*xe,o[2]=m*ce+k*X+N*ue+q*xe,o[3]=_*ce+U*X+Y*ue+j*xe,o[4]=s*ve+p*Ee+E*De+C*Ie,o[5]=l*ve+P*Ee+z*De+H*Ie,o[6]=m*ve+k*Ee+N*De+q*Ie,o[7]=_*ve+U*Ee+Y*De+j*Ie,o[8]=s*Me+p*Ue+E*Re+C*Oe,o[9]=l*Me+P*Ue+z*Re+H*Oe,o[10]=m*Me+k*Ue+N*Re+q*Oe,o[11]=_*Me+U*Ue+Y*Re+j*Oe,o[12]=s*fe+p*Ge+E*Ae+C*Pe,o[13]=l*fe+P*Ge+z*Ae+H*Pe,o[14]=m*fe+k*Ge+N*Ae+q*Pe,o[15]=_*fe+U*Ge+Y*Ae+j*Pe,o}const te=R;function ie(e,u,i){const o=i??ae();return e!==o&&(o[0]=e[0],o[1]=e[1],o[2]=e[2],o[3]=e[3],o[4]=e[4],o[5]=e[5],o[6]=e[6],o[7]=e[7],o[8]=e[8],o[9]=e[9],o[10]=e[10],o[11]=e[11]),o[12]=u[0],o[13]=u[1],o[14]=u[2],o[15]=1,o}function $(e,u){const i=u??n.create();return i[0]=e[12],i[1]=e[13],i[2]=e[14],i}function _e(e,u,i){const o=i??n.create(),s=u*4;return o[0]=e[s+0],o[1]=e[s+1],o[2]=e[s+2],o}function K(e,u,i,o){const s=o===e?o:W(e,o),l=i*4;return s[l+0]=u[0],s[l+1]=u[1],s[l+2]=u[2],s}function Z(e,u){const i=u??n.create(),o=e[0],s=e[1],l=e[2],m=e[4],_=e[5],p=e[6],P=e[8],k=e[9],U=e[10];return i[0]=Math.sqrt(o*o+s*s+l*l),i[1]=Math.sqrt(m*m+_*_+p*p),i[2]=Math.sqrt(P*P+k*k+U*U),i}function he(e,u,i,o,s){const l=s??new r(16),m=Math.tan(Math.PI*.5-.5*e);if(l[0]=m/u,l[1]=0,l[2]=0,l[3]=0,l[4]=0,l[5]=m,l[6]=0,l[7]=0,l[8]=0,l[9]=0,l[11]=-1,l[12]=0,l[13]=0,l[15]=0,Number.isFinite(o)){const _=1/(i-o);l[10]=o*_,l[14]=o*i*_}else l[10]=-1,l[14]=-i;return l}function D(e,u,i,o=1/0,s){const l=s??new r(16),m=1/Math.tan(e*.5);if(l[0]=m/u,l[1]=0,l[2]=0,l[3]=0,l[4]=0,l[5]=m,l[6]=0,l[7]=0,l[8]=0,l[9]=0,l[11]=-1,l[12]=0,l[13]=0,l[15]=0,o===1/0)l[10]=0,l[14]=i;else{const _=1/(o-i);l[10]=i*_,l[14]=o*i*_}return l}function ne(e,u,i,o,s,l,m){const _=m??new r(16);return _[0]=2/(u-e),_[1]=0,_[2]=0,_[3]=0,_[4]=0,_[5]=2/(o-i),_[6]=0,_[7]=0,_[8]=0,_[9]=0,_[10]=1/(s-l),_[11]=0,_[12]=(u+e)/(e-u),_[13]=(o+i)/(i-o),_[14]=s/(s-l),_[15]=1,_}function F(e,u,i,o,s,l,m){const _=m??new r(16),p=u-e,P=o-i,k=s-l;return _[0]=2*s/p,_[1]=0,_[2]=0,_[3]=0,_[4]=0,_[5]=2*s/P,_[6]=0,_[7]=0,_[8]=(e+u)/p,_[9]=(o+i)/P,_[10]=l/k,_[11]=-1,_[12]=0,_[13]=0,_[14]=s*l/k,_[15]=0,_}function de(e,u,i,o,s,l=1/0,m){const _=m??new r(16),p=u-e,P=o-i;if(_[0]=2*s/p,_[1]=0,_[2]=0,_[3]=0,_[4]=0,_[5]=2*s/P,_[6]=0,_[7]=0,_[8]=(e+u)/p,_[9]=(o+i)/P,_[11]=-1,_[12]=0,_[13]=0,_[15]=0,l===1/0)_[10]=0,_[14]=s;else{const k=1/(l-s);_[10]=s*k,_[14]=l*s*k}return _}const ge=n.create(),V=n.create(),re=n.create();function ye(e,u,i,o){const s=o??new r(16);return n.normalize(n.subtract(u,e,re),re),n.normalize(n.cross(i,re,ge),ge),n.normalize(n.cross(re,ge,V),V),s[0]=ge[0],s[1]=ge[1],s[2]=ge[2],s[3]=0,s[4]=V[0],s[5]=V[1],s[6]=V[2],s[7]=0,s[8]=re[0],s[9]=re[1],s[10]=re[2],s[11]=0,s[12]=e[0],s[13]=e[1],s[14]=e[2],s[15]=1,s}function Se(e,u,i,o){const s=o??new r(16);return n.normalize(n.subtract(e,u,re),re),n.normalize(n.cross(i,re,ge),ge),n.normalize(n.cross(re,ge,V),V),s[0]=ge[0],s[1]=ge[1],s[2]=ge[2],s[3]=0,s[4]=V[0],s[5]=V[1],s[6]=V[2],s[7]=0,s[8]=re[0],s[9]=re[1],s[10]=re[2],s[11]=0,s[12]=e[0],s[13]=e[1],s[14]=e[2],s[15]=1,s}function me(e,u,i,o){const s=o??new r(16);return n.normalize(n.subtract(e,u,re),re),n.normalize(n.cross(i,re,ge),ge),n.normalize(n.cross(re,ge,V),V),s[0]=ge[0],s[1]=V[0],s[2]=re[0],s[3]=0,s[4]=ge[1],s[5]=V[1],s[6]=re[1],s[7]=0,s[8]=ge[2],s[9]=V[2],s[10]=re[2],s[11]=0,s[12]=-(ge[0]*e[0]+ge[1]*e[1]+ge[2]*e[2]),s[13]=-(V[0]*e[0]+V[1]*e[1]+V[2]*e[2]),s[14]=-(re[0]*e[0]+re[1]*e[1]+re[2]*e[2]),s[15]=1,s}function Te(e,u){const i=u??new r(16);return i[0]=1,i[1]=0,i[2]=0,i[3]=0,i[4]=0,i[5]=1,i[6]=0,i[7]=0,i[8]=0,i[9]=0,i[10]=1,i[11]=0,i[12]=e[0],i[13]=e[1],i[14]=e[2],i[15]=1,i}function ze(e,u,i){const o=i??new r(16),s=u[0],l=u[1],m=u[2],_=e[0],p=e[1],P=e[2],k=e[3],U=e[1*4+0],E=e[1*4+1],z=e[1*4+2],N=e[1*4+3],Y=e[2*4+0],C=e[2*4+1],H=e[2*4+2],q=e[2*4+3],j=e[3*4+0],ce=e[3*4+1],X=e[3*4+2],ue=e[3*4+3];return e!==o&&(o[0]=_,o[1]=p,o[2]=P,o[3]=k,o[4]=U,o[5]=E,o[6]=z,o[7]=N,o[8]=Y,o[9]=C,o[10]=H,o[11]=q),o[12]=_*s+U*l+Y*m+j,o[13]=p*s+E*l+C*m+ce,o[14]=P*s+z*l+H*m+X,o[15]=k*s+N*l+q*m+ue,o}function ke(e,u){const i=u??new r(16),o=Math.cos(e),s=Math.sin(e);return i[0]=1,i[1]=0,i[2]=0,i[3]=0,i[4]=0,i[5]=o,i[6]=s,i[7]=0,i[8]=0,i[9]=-s,i[10]=o,i[11]=0,i[12]=0,i[13]=0,i[14]=0,i[15]=1,i}function le(e,u,i){const o=i??new r(16),s=e[4],l=e[5],m=e[6],_=e[7],p=e[8],P=e[9],k=e[10],U=e[11],E=Math.cos(u),z=Math.sin(u);return o[4]=E*s+z*p,o[5]=E*l+z*P,o[6]=E*m+z*k,o[7]=E*_+z*U,o[8]=E*p-z*s,o[9]=E*P-z*l,o[10]=E*k-z*m,o[11]=E*U-z*_,e!==o&&(o[0]=e[0],o[1]=e[1],o[2]=e[2],o[3]=e[3],o[12]=e[12],o[13]=e[13],o[14]=e[14],o[15]=e[15]),o}function we(e,u){const i=u??new r(16),o=Math.cos(e),s=Math.sin(e);return i[0]=o,i[1]=0,i[2]=-s,i[3]=0,i[4]=0,i[5]=1,i[6]=0,i[7]=0,i[8]=s,i[9]=0,i[10]=o,i[11]=0,i[12]=0,i[13]=0,i[14]=0,i[15]=1,i}function Be(e,u,i){const o=i??new r(16),s=e[0*4+0],l=e[0*4+1],m=e[0*4+2],_=e[0*4+3],p=e[2*4+0],P=e[2*4+1],k=e[2*4+2],U=e[2*4+3],E=Math.cos(u),z=Math.sin(u);return o[0]=E*s-z*p,o[1]=E*l-z*P,o[2]=E*m-z*k,o[3]=E*_-z*U,o[8]=E*p+z*s,o[9]=E*P+z*l,o[10]=E*k+z*m,o[11]=E*U+z*_,e!==o&&(o[4]=e[4],o[5]=e[5],o[6]=e[6],o[7]=e[7],o[12]=e[12],o[13]=e[13],o[14]=e[14],o[15]=e[15]),o}function B(e,u){const i=u??new r(16),o=Math.cos(e),s=Math.sin(e);return i[0]=o,i[1]=s,i[2]=0,i[3]=0,i[4]=-s,i[5]=o,i[6]=0,i[7]=0,i[8]=0,i[9]=0,i[10]=1,i[11]=0,i[12]=0,i[13]=0,i[14]=0,i[15]=1,i}function A(e,u,i){const o=i??new r(16),s=e[0*4+0],l=e[0*4+1],m=e[0*4+2],_=e[0*4+3],p=e[1*4+0],P=e[1*4+1],k=e[1*4+2],U=e[1*4+3],E=Math.cos(u),z=Math.sin(u);return o[0]=E*s+z*p,o[1]=E*l+z*P,o[2]=E*m+z*k,o[3]=E*_+z*U,o[4]=E*p-z*s,o[5]=E*P-z*l,o[6]=E*k-z*m,o[7]=E*U-z*_,e!==o&&(o[8]=e[8],o[9]=e[9],o[10]=e[10],o[11]=e[11],o[12]=e[12],o[13]=e[13],o[14]=e[14],o[15]=e[15]),o}function h(e,u,i){const o=i??new r(16);let s=e[0],l=e[1],m=e[2];const _=Math.sqrt(s*s+l*l+m*m);s/=_,l/=_,m/=_;const p=s*s,P=l*l,k=m*m,U=Math.cos(u),E=Math.sin(u),z=1-U;return o[0]=p+(1-p)*U,o[1]=s*l*z+m*E,o[2]=s*m*z-l*E,o[3]=0,o[4]=s*l*z-m*E,o[5]=P+(1-P)*U,o[6]=l*m*z+s*E,o[7]=0,o[8]=s*m*z+l*E,o[9]=l*m*z-s*E,o[10]=k+(1-k)*U,o[11]=0,o[12]=0,o[13]=0,o[14]=0,o[15]=1,o}const t=h;function c(e,u,i,o){const s=o??new r(16);let l=u[0],m=u[1],_=u[2];const p=Math.sqrt(l*l+m*m+_*_);l/=p,m/=p,_/=p;const P=l*l,k=m*m,U=_*_,E=Math.cos(i),z=Math.sin(i),N=1-E,Y=P+(1-P)*E,C=l*m*N+_*z,H=l*_*N-m*z,q=l*m*N-_*z,j=k+(1-k)*E,ce=m*_*N+l*z,X=l*_*N+m*z,ue=m*_*N-l*z,xe=U+(1-U)*E,ve=e[0],Ee=e[1],De=e[2],Ie=e[3],Me=e[4],Ue=e[5],Re=e[6],Oe=e[7],fe=e[8],Ge=e[9],Ae=e[10],Pe=e[11];return s[0]=Y*ve+C*Me+H*fe,s[1]=Y*Ee+C*Ue+H*Ge,s[2]=Y*De+C*Re+H*Ae,s[3]=Y*Ie+C*Oe+H*Pe,s[4]=q*ve+j*Me+ce*fe,s[5]=q*Ee+j*Ue+ce*Ge,s[6]=q*De+j*Re+ce*Ae,s[7]=q*Ie+j*Oe+ce*Pe,s[8]=X*ve+ue*Me+xe*fe,s[9]=X*Ee+ue*Ue+xe*Ge,s[10]=X*De+ue*Re+xe*Ae,s[11]=X*Ie+ue*Oe+xe*Pe,e!==s&&(s[12]=e[12],s[13]=e[13],s[14]=e[14],s[15]=e[15]),s}const a=c;function f(e,u){const i=u??new r(16);return i[0]=e[0],i[1]=0,i[2]=0,i[3]=0,i[4]=0,i[5]=e[1],i[6]=0,i[7]=0,i[8]=0,i[9]=0,i[10]=e[2],i[11]=0,i[12]=0,i[13]=0,i[14]=0,i[15]=1,i}function g(e,u,i){const o=i??new r(16),s=u[0],l=u[1],m=u[2];return o[0]=s*e[0*4+0],o[1]=s*e[0*4+1],o[2]=s*e[0*4+2],o[3]=s*e[0*4+3],o[4]=l*e[1*4+0],o[5]=l*e[1*4+1],o[6]=l*e[1*4+2],o[7]=l*e[1*4+3],o[8]=m*e[2*4+0],o[9]=m*e[2*4+1],o[10]=m*e[2*4+2],o[11]=m*e[2*4+3],e!==o&&(o[12]=e[12],o[13]=e[13],o[14]=e[14],o[15]=e[15]),o}function x(e,u){const i=u??new r(16);return i[0]=e,i[1]=0,i[2]=0,i[3]=0,i[4]=0,i[5]=e,i[6]=0,i[7]=0,i[8]=0,i[9]=0,i[10]=e,i[11]=0,i[12]=0,i[13]=0,i[14]=0,i[15]=1,i}function y(e,u,i){const o=i??new r(16);return o[0]=u*e[0*4+0],o[1]=u*e[0*4+1],o[2]=u*e[0*4+2],o[3]=u*e[0*4+3],o[4]=u*e[1*4+0],o[5]=u*e[1*4+1],o[6]=u*e[1*4+2],o[7]=u*e[1*4+3],o[8]=u*e[2*4+0],o[9]=u*e[2*4+1],o[10]=u*e[2*4+2],o[11]=u*e[2*4+3],e!==o&&(o[12]=e[12],o[13]=e[13],o[14]=e[14],o[15]=e[15]),o}return{add:M,aim:ye,axisRotate:c,axisRotation:h,cameraAim:Se,clone:J,copy:W,create:d,determinant:ee,equals:Q,equalsApproximately:I,fromMat3:b,fromQuat:w,frustum:F,frustumReverseZ:de,getAxis:_e,getScaling:Z,getTranslation:$,identity:ae,inverse:L,invert:pe,lookAt:me,mul:te,mulScalar:O,multiply:R,multiplyScalar:G,negate:S,ortho:ne,perspective:he,perspectiveReverseZ:D,rotate:a,rotateX:le,rotateY:Be,rotateZ:A,rotation:t,rotationX:ke,rotationY:we,rotationZ:B,scale:g,scaling:f,set:v,setAxis:K,setTranslation:ie,translate:ze,translation:Te,transpose:oe,uniformScale:y,uniformScaling:x}}const Ut=new Map;function vn(r){let n=Ut.get(r);return n||(n=wn(r),Ut.set(r,n)),n}function Sn(r){const n=xt(r);function d(B,A,h,t){const c=new r(4);return B!==void 0&&(c[0]=B,A!==void 0&&(c[1]=A,h!==void 0&&(c[2]=h,t!==void 0&&(c[3]=t)))),c}const v=d;function b(B,A,h,t,c){const a=c??new r(4);return a[0]=B,a[1]=A,a[2]=h,a[3]=t,a}function w(B,A,h){const t=h??new r(4),c=A*.5,a=Math.sin(c);return t[0]=a*B[0],t[1]=a*B[1],t[2]=a*B[2],t[3]=Math.cos(c),t}function S(B,A){const h=A??n.create(3),t=Math.acos(B[3])*2,c=Math.sin(t*.5);return c>be?(h[0]=B[0]/c,h[1]=B[1]/c,h[2]=B[2]/c):(h[0]=1,h[1]=0,h[2]=0),{angle:t,axis:h}}function M(B,A){const h=he(B,A);return Math.acos(2*h*h-1)}function G(B,A,h){const t=h??new r(4),c=B[0],a=B[1],f=B[2],g=B[3],x=A[0],y=A[1],e=A[2],u=A[3];return t[0]=c*u+g*x+a*e-f*y,t[1]=a*u+g*y+f*x-c*e,t[2]=f*u+g*e+c*y-a*x,t[3]=g*u-c*x-a*y-f*e,t}const O=G;function W(B,A,h){const t=h??new r(4),c=A*.5,a=B[0],f=B[1],g=B[2],x=B[3],y=Math.sin(c),e=Math.cos(c);return t[0]=a*e+x*y,t[1]=f*e+g*y,t[2]=g*e-f*y,t[3]=x*e-a*y,t}function J(B,A,h){const t=h??new r(4),c=A*.5,a=B[0],f=B[1],g=B[2],x=B[3],y=Math.sin(c),e=Math.cos(c);return t[0]=a*e-g*y,t[1]=f*e+x*y,t[2]=g*e+a*y,t[3]=x*e-f*y,t}function I(B,A,h){const t=h??new r(4),c=A*.5,a=B[0],f=B[1],g=B[2],x=B[3],y=Math.sin(c),e=Math.cos(c);return t[0]=a*e+f*y,t[1]=f*e-a*y,t[2]=g*e+x*y,t[3]=x*e-g*y,t}function Q(B,A,h,t){const c=t??new r(4),a=B[0],f=B[1],g=B[2],x=B[3];let y=A[0],e=A[1],u=A[2],i=A[3],o=a*y+f*e+g*u+x*i;o<0&&(o=-o,y=-y,e=-e,u=-u,i=-i);let s,l;if(1-o>be){const m=Math.acos(o),_=Math.sin(m);s=Math.sin((1-h)*m)/_,l=Math.sin(h*m)/_}else s=1-h,l=h;return c[0]=s*a+l*y,c[1]=s*f+l*e,c[2]=s*g+l*u,c[3]=s*x+l*i,c}function ae(B,A){const h=A??new r(4),t=B[0],c=B[1],a=B[2],f=B[3],g=t*t+c*c+a*a+f*f,x=g?1/g:0;return h[0]=-t*x,h[1]=-c*x,h[2]=-a*x,h[3]=f*x,h}function oe(B,A){const h=A??new r(4);return h[0]=-B[0],h[1]=-B[1],h[2]=-B[2],h[3]=B[3],h}function L(B,A){const h=A??new r(4),t=B[0]+B[5]+B[10];if(t>0){const c=Math.sqrt(t+1);h[3]=.5*c;const a=.5/c;h[0]=(B[6]-B[9])*a,h[1]=(B[8]-B[2])*a,h[2]=(B[1]-B[4])*a}else{let c=0;B[5]>B[0]&&(c=1),B[10]>B[c*4+c]&&(c=2);const a=(c+1)%3,f=(c+2)%3,g=Math.sqrt(B[c*4+c]-B[a*4+a]-B[f*4+f]+1);h[c]=.5*g;const x=.5/g;h[3]=(B[a*4+f]-B[f*4+a])*x,h[a]=(B[a*4+c]+B[c*4+a])*x,h[f]=(B[f*4+c]+B[c*4+f])*x}return h}function ee(B,A,h,t,c){const a=c??new r(4),f=B*.5,g=A*.5,x=h*.5,y=Math.sin(f),e=Math.cos(f),u=Math.sin(g),i=Math.cos(g),o=Math.sin(x),s=Math.cos(x);switch(t){case"xyz":a[0]=y*i*s+e*u*o,a[1]=e*u*s-y*i*o,a[2]=e*i*o+y*u*s,a[3]=e*i*s-y*u*o;break;case"xzy":a[0]=y*i*s-e*u*o,a[1]=e*u*s-y*i*o,a[2]=e*i*o+y*u*s,a[3]=e*i*s+y*u*o;break;case"yxz":a[0]=y*i*s+e*u*o,a[1]=e*u*s-y*i*o,a[2]=e*i*o-y*u*s,a[3]=e*i*s+y*u*o;break;case"yzx":a[0]=y*i*s+e*u*o,a[1]=e*u*s+y*i*o,a[2]=e*i*o-y*u*s,a[3]=e*i*s-y*u*o;break;case"zxy":a[0]=y*i*s-e*u*o,a[1]=e*u*s+y*i*o,a[2]=e*i*o+y*u*s,a[3]=e*i*s-y*u*o;break;case"zyx":a[0]=y*i*s-e*u*o,a[1]=e*u*s+y*i*o,a[2]=e*i*o-y*u*s,a[3]=e*i*s+y*u*o;break;default:throw new Error(`Unknown rotation order: ${t}`)}return a}function pe(B,A){const h=A??new r(4);return h[0]=B[0],h[1]=B[1],h[2]=B[2],h[3]=B[3],h}const R=pe;function te(B,A,h){const t=h??new r(4);return t[0]=B[0]+A[0],t[1]=B[1]+A[1],t[2]=B[2]+A[2],t[3]=B[3]+A[3],t}function ie(B,A,h){const t=h??new r(4);return t[0]=B[0]-A[0],t[1]=B[1]-A[1],t[2]=B[2]-A[2],t[3]=B[3]-A[3],t}const $=ie;function _e(B,A,h){const t=h??new r(4);return t[0]=B[0]*A,t[1]=B[1]*A,t[2]=B[2]*A,t[3]=B[3]*A,t}const K=_e;function Z(B,A,h){const t=h??new r(4);return t[0]=B[0]/A,t[1]=B[1]/A,t[2]=B[2]/A,t[3]=B[3]/A,t}function he(B,A){return B[0]*A[0]+B[1]*A[1]+B[2]*A[2]+B[3]*A[3]}function D(B,A,h,t){const c=t??new r(4);return c[0]=B[0]+h*(A[0]-B[0]),c[1]=B[1]+h*(A[1]-B[1]),c[2]=B[2]+h*(A[2]-B[2]),c[3]=B[3]+h*(A[3]-B[3]),c}function ne(B){const A=B[0],h=B[1],t=B[2],c=B[3];return Math.sqrt(A*A+h*h+t*t+c*c)}const F=ne;function de(B){const A=B[0],h=B[1],t=B[2],c=B[3];return A*A+h*h+t*t+c*c}const ge=de;function V(B,A){const h=A??new r(4),t=B[0],c=B[1],a=B[2],f=B[3],g=Math.sqrt(t*t+c*c+a*a+f*f);return g>1e-5?(h[0]=t/g,h[1]=c/g,h[2]=a/g,h[3]=f/g):(h[0]=0,h[1]=0,h[2]=0,h[3]=1),h}function re(B,A){return Math.abs(B[0]-A[0])<be&&Math.abs(B[1]-A[1])<be&&Math.abs(B[2]-A[2])<be&&Math.abs(B[3]-A[3])<be}function ye(B,A){return B[0]===A[0]&&B[1]===A[1]&&B[2]===A[2]&&B[3]===A[3]}function Se(B){const A=B??new r(4);return A[0]=0,A[1]=0,A[2]=0,A[3]=1,A}const me=n.create(),Te=n.create(),ze=n.create();function ke(B,A,h){const t=h??new r(4),c=n.dot(B,A);return c<-.999999?(n.cross(Te,B,me),n.len(me)<1e-6&&n.cross(ze,B,me),n.normalize(me,me),w(me,Math.PI,t),t):c>.999999?(t[0]=0,t[1]=0,t[2]=0,t[3]=1,t):(n.cross(B,A,me),t[0]=me[0],t[1]=me[1],t[2]=me[2],t[3]=1+c,V(t,t))}const le=new r(4),we=new r(4);function Be(B,A,h,t,c,a){const f=a??new r(4);return Q(B,t,c,le),Q(A,h,c,we),Q(le,we,2*c*(1-c),f),f}return{create:d,fromValues:v,set:b,fromAxisAngle:w,toAxisAngle:S,angle:M,multiply:G,mul:O,rotateX:W,rotateY:J,rotateZ:I,slerp:Q,inverse:ae,conjugate:oe,fromMat:L,fromEuler:ee,copy:pe,clone:R,add:te,subtract:ie,sub:$,mulScalar:_e,scale:K,divScalar:Z,dot:he,lerp:D,length:ne,len:F,lengthSq:de,lenSq:ge,normalize:V,equalsApproximately:re,equals:ye,identity:Se,rotationTo:ke,sqlerp:Be}}const Ot=new Map;function Bn(r){let n=Ot.get(r);return n||(n=Sn(r),Ot.set(r,n)),n}function Pn(r){function n(h,t,c,a){const f=new r(4);return h!==void 0&&(f[0]=h,t!==void 0&&(f[1]=t,c!==void 0&&(f[2]=c,a!==void 0&&(f[3]=a)))),f}const d=n;function v(h,t,c,a,f){const g=f??new r(4);return g[0]=h,g[1]=t,g[2]=c,g[3]=a,g}function b(h,t){const c=t??new r(4);return c[0]=Math.ceil(h[0]),c[1]=Math.ceil(h[1]),c[2]=Math.ceil(h[2]),c[3]=Math.ceil(h[3]),c}function w(h,t){const c=t??new r(4);return c[0]=Math.floor(h[0]),c[1]=Math.floor(h[1]),c[2]=Math.floor(h[2]),c[3]=Math.floor(h[3]),c}function S(h,t){const c=t??new r(4);return c[0]=Math.round(h[0]),c[1]=Math.round(h[1]),c[2]=Math.round(h[2]),c[3]=Math.round(h[3]),c}function M(h,t=0,c=1,a){const f=a??new r(4);return f[0]=Math.min(c,Math.max(t,h[0])),f[1]=Math.min(c,Math.max(t,h[1])),f[2]=Math.min(c,Math.max(t,h[2])),f[3]=Math.min(c,Math.max(t,h[3])),f}function G(h,t,c){const a=c??new r(4);return a[0]=h[0]+t[0],a[1]=h[1]+t[1],a[2]=h[2]+t[2],a[3]=h[3]+t[3],a}function O(h,t,c,a){const f=a??new r(4);return f[0]=h[0]+t[0]*c,f[1]=h[1]+t[1]*c,f[2]=h[2]+t[2]*c,f[3]=h[3]+t[3]*c,f}function W(h,t,c){const a=c??new r(4);return a[0]=h[0]-t[0],a[1]=h[1]-t[1],a[2]=h[2]-t[2],a[3]=h[3]-t[3],a}const J=W;function I(h,t){return Math.abs(h[0]-t[0])<be&&Math.abs(h[1]-t[1])<be&&Math.abs(h[2]-t[2])<be&&Math.abs(h[3]-t[3])<be}function Q(h,t){return h[0]===t[0]&&h[1]===t[1]&&h[2]===t[2]&&h[3]===t[3]}function ae(h,t,c,a){const f=a??new r(4);return f[0]=h[0]+c*(t[0]-h[0]),f[1]=h[1]+c*(t[1]-h[1]),f[2]=h[2]+c*(t[2]-h[2]),f[3]=h[3]+c*(t[3]-h[3]),f}function oe(h,t,c,a){const f=a??new r(4);return f[0]=h[0]+c[0]*(t[0]-h[0]),f[1]=h[1]+c[1]*(t[1]-h[1]),f[2]=h[2]+c[2]*(t[2]-h[2]),f[3]=h[3]+c[3]*(t[3]-h[3]),f}function L(h,t,c){const a=c??new r(4);return a[0]=Math.max(h[0],t[0]),a[1]=Math.max(h[1],t[1]),a[2]=Math.max(h[2],t[2]),a[3]=Math.max(h[3],t[3]),a}function ee(h,t,c){const a=c??new r(4);return a[0]=Math.min(h[0],t[0]),a[1]=Math.min(h[1],t[1]),a[2]=Math.min(h[2],t[2]),a[3]=Math.min(h[3],t[3]),a}function pe(h,t,c){const a=c??new r(4);return a[0]=h[0]*t,a[1]=h[1]*t,a[2]=h[2]*t,a[3]=h[3]*t,a}const R=pe;function te(h,t,c){const a=c??new r(4);return a[0]=h[0]/t,a[1]=h[1]/t,a[2]=h[2]/t,a[3]=h[3]/t,a}function ie(h,t){const c=t??new r(4);return c[0]=1/h[0],c[1]=1/h[1],c[2]=1/h[2],c[3]=1/h[3],c}const $=ie;function _e(h,t){return h[0]*t[0]+h[1]*t[1]+h[2]*t[2]+h[3]*t[3]}function K(h){const t=h[0],c=h[1],a=h[2],f=h[3];return Math.sqrt(t*t+c*c+a*a+f*f)}const Z=K;function he(h){const t=h[0],c=h[1],a=h[2],f=h[3];return t*t+c*c+a*a+f*f}const D=he;function ne(h,t){const c=h[0]-t[0],a=h[1]-t[1],f=h[2]-t[2],g=h[3]-t[3];return Math.sqrt(c*c+a*a+f*f+g*g)}const F=ne;function de(h,t){const c=h[0]-t[0],a=h[1]-t[1],f=h[2]-t[2],g=h[3]-t[3];return c*c+a*a+f*f+g*g}const ge=de;function V(h,t){const c=t??new r(4),a=h[0],f=h[1],g=h[2],x=h[3],y=Math.sqrt(a*a+f*f+g*g+x*x);return y>1e-5?(c[0]=a/y,c[1]=f/y,c[2]=g/y,c[3]=x/y):(c[0]=0,c[1]=0,c[2]=0,c[3]=0),c}function re(h,t){const c=t??new r(4);return c[0]=-h[0],c[1]=-h[1],c[2]=-h[2],c[3]=-h[3],c}function ye(h,t){const c=t??new r(4);return c[0]=h[0],c[1]=h[1],c[2]=h[2],c[3]=h[3],c}const Se=ye;function me(h,t,c){const a=c??new r(4);return a[0]=h[0]*t[0],a[1]=h[1]*t[1],a[2]=h[2]*t[2],a[3]=h[3]*t[3],a}const Te=me;function ze(h,t,c){const a=c??new r(4);return a[0]=h[0]/t[0],a[1]=h[1]/t[1],a[2]=h[2]/t[2],a[3]=h[3]/t[3],a}const ke=ze;function le(h){const t=h??new r(4);return t[0]=0,t[1]=0,t[2]=0,t[3]=0,t}function we(h,t,c){const a=c??new r(4),f=h[0],g=h[1],x=h[2],y=h[3];return a[0]=t[0]*f+t[4]*g+t[8]*x+t[12]*y,a[1]=t[1]*f+t[5]*g+t[9]*x+t[13]*y,a[2]=t[2]*f+t[6]*g+t[10]*x+t[14]*y,a[3]=t[3]*f+t[7]*g+t[11]*x+t[15]*y,a}function Be(h,t,c){const a=c??new r(4);return V(h,a),pe(a,t,a)}function B(h,t,c){const a=c??new r(4);return K(h)>t?Be(h,t,a):ye(h,a)}function A(h,t,c){const a=c??new r(4);return ae(h,t,.5,a)}return{create:n,fromValues:d,set:v,ceil:b,floor:w,round:S,clamp:M,add:G,addScaled:O,subtract:W,sub:J,equalsApproximately:I,equals:Q,lerp:ae,lerpV:oe,max:L,min:ee,mulScalar:pe,scale:R,divScalar:te,inverse:ie,invert:$,dot:_e,length:K,len:Z,lengthSq:he,lenSq:D,distance:ne,dist:F,distanceSq:de,distSq:ge,normalize:V,negate:re,copy:ye,clone:Se,multiply:me,mul:Te,divide:ze,div:ke,zero:le,transformMat4:we,setLength:Be,truncate:B,midpoint:A}}const Rt=new Map;function Tn(r){let n=Rt.get(r);return n||(n=Pn(r),Rt.set(r,n)),n}function Pt(r,n,d,v,b,w){return{mat3:bn(r),mat4:vn(n),quat:Bn(d),vec2:Qt(v),vec3:xt(b),vec4:Tn(w)}}const{mat3:bt,mat4:We,quat:$e,vec2:Lt,vec3:se,vec4:Ps}=Pt(Float32Array,Float32Array,Float32Array,Float32Array,Float32Array,Float32Array);Pt(Float64Array,Float64Array,Float64Array,Float64Array,Float64Array,Float64Array);Pt(gn,Array,Array,Array,Array,Array);const Ct=document.querySelector("#log");let qe=null,rt=null;function en(){if(qe)return qe;qe=document.createElement("div"),qe.className="ply-spinner-overlay";const r=document.createElement("div");return r.className="ply-spinner",qe.appendChild(r),rt=document.createElement("div"),rt.className="ply-spinner-label",qe.appendChild(rt),qe.style.display="none",document.body.appendChild(qe),qe}function kn(r){en(),rt&&r&&(rt.textContent=r),qe&&(qe.style.opacity="1",qe.style.display="flex")}function dt(r){en(),rt&&(rt.textContent=r)}function Mn(){if(!qe)return;const r=qe;r.style.opacity="0",setTimeout(()=>{r.style.opacity==="0"&&(r.style.display="none")},220)}function tn(r,n){if(!Ct)return;const d=document.createElement("p");d.innerText=r,n&&Object.assign(d.style,n),Ct.appendChild(d)}async function Ze(r){console.log(r),tn(r)}async function Gn(r){console.error(r),tn(r,{color:"red",backgroundColor:"rgba(255, 0, 0, 0.1)"})}let nn;function An(){nn=performance.now()}function Ft(r){const n=performance.now()-nn;Ze(`⏱️ ${r} Time: ${n.toFixed(0)} ms`)}function zn(r,n){return 2*Math.atan(n/(2*r))}function En(r,n,d,v){const b=Math.tan(v/2),w=Math.tan(d/2),S=b*r,M=-S,G=w*r,O=-G,W=We.create();return W[0]=2*r/(G-O),W[5]=-2*r/(S-M),W[2]=(G+O)/(G-O),W[6]=(S+M)/(S-M),W[14]=1,W[10]=n/(n-r),W[11]=-(n*r)/(n-r),We.transpose(W,W),W}async function Dn(r){Ze(`loading scene camera file... : ${r}`);const d=await(await fetch(r)).json();return Ze(`loaded cameras count: ${d.length}`),d.map(v=>{const b=se.clone(v.position),w=bt.create(...v.rotation.flat()),S=w[0],M=w[4],G=w[8],O=w[1],W=w[5],J=w[9],I=w[2],Q=w[6],ae=w[10];S*(W*ae-J*Q)-M*(O*ae-J*I)+G*(O*Q-W*I)<0&&(w[1]=-w[1],w[5]=-w[5],w[9]=-w[9]);const L=We.fromMat3(w);return{position:b,rotation:L,img_name:v.img_name,id:v.id}})}const In=4*2,Un=4*16,sn=4*Un+2*In;function On(r){return r.createBuffer({label:"camera uniform",size:sn,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}const Qe=new Float32Array(sn/Float32Array.BYTES_PER_ELEMENT),mt=class mt{constructor(n,d){T(this,"_renderSize",null);T(this,"uniform_buffer");T(this,"position",se.create());T(this,"rotation",We.create());T(this,"fovY",45/180*Math.PI);T(this,"fovX");T(this,"focal",Lt.create());T(this,"viewport",Lt.create());T(this,"view_matrix",We.identity());T(this,"view_inv_matrix",We.identity());T(this,"proj_matrix",We.identity());T(this,"proj_inv_matrix",We.identity());T(this,"_negPos",se.create());T(this,"look",se.create(0,0,1));T(this,"up",se.create(0,1,0));T(this,"right",se.create(1,0,0));this.canvas=n,this.device=d,this.uniform_buffer=On(d),this.on_update_canvas()}setRenderSize(n,d){this._renderSize=[n,d],this.on_update_canvas()}clearRenderSize(){this._renderSize=null,this.on_update_canvas()}on_update_canvas(){const n=this._renderSize?this._renderSize[0]:this.canvas.width,d=this._renderSize?this._renderSize[1]:this.canvas.height,v=.5*d/Math.tan(this.fovY*.5);this.focal[0]=v,this.focal[1]=v,this.fovX=zn(v,n),this.viewport[0]=n,this.viewport[1]=d,this.proj_matrix=En(.01,100,this.fovX,this.fovY),We.inverse(this.proj_matrix,this.proj_inv_matrix),this.update_buffer()}update_buffer(){this._negPos[0]=-this.position[0],this._negPos[1]=-this.position[1],this._negPos[2]=-this.position[2],We.copy(this.rotation,this.view_matrix),We.translate(this.view_matrix,this._negPos,this.view_matrix),We.inverse(this.view_matrix,this.view_inv_matrix),se.transformMat4Upper3x3(mt.Z_AXIS,this.view_inv_matrix,this.look),se.normalize(this.look,this.look),se.cross(this.up,this.look,this.right),se.normalize(this.right,this.right);let n=0;Qe.set(this.view_matrix,n),n+=16,Qe.set(this.view_inv_matrix,n),n+=16,Qe.set(this.proj_matrix,n),n+=16,Qe.set(this.proj_inv_matrix,n),n+=16,Qe.set(this.viewport,n),n+=2,Qe.set(this.focal,n),n+=2,this.device.queue.writeBuffer(this.uniform_buffer,0,Qe)}set_preset(n){se.copy(n.position,this.position),We.copy(n.rotation,this.rotation),this.update_buffer()}setFov(n){this.fovY=n,this.on_update_canvas()}getFov(){return this.fovY}};T(mt,"Z_AXIS",se.create(0,0,1));let wt=mt;const Rn=se.create(1,0,0),Ln=se.create(0,1,0),Cn=se.create(0,0,1);function Fn(r,n){const d=r[0],v=r[4],b=r[8],w=r[1],S=r[5],M=r[9],G=r[2],O=r[6],W=r[10],J=d+S+W;let I,Q,ae,oe;if(J>0){const L=.5/Math.sqrt(J+1);I=.25/L,Q=(O-M)*L,ae=(b-G)*L,oe=(w-v)*L}else if(d>S&&d>W){const L=2*Math.sqrt(1+d-S-W);I=(O-M)/L,Q=.25*L,ae=(v+w)/L,oe=(b+G)/L}else if(S>W){const L=2*Math.sqrt(1+S-d-W);I=(b-G)/L,Q=(v+w)/L,ae=.25*L,oe=(M+O)/L}else{const L=2*Math.sqrt(1+W-d-S);I=(w-v)/L,Q=(b+G)/L,ae=(M+O)/L,oe=.25*L}return n[0]=Q,n[1]=ae,n[2]=oe,n[3]=I,n}class $n{constructor(n){T(this,"element");T(this,"enabled",!0);T(this,"center",se.create(0,0,0));T(this,"up",se.create(0,1,0));T(this,"rotation",[0,0]);T(this,"shift",[0,0]);T(this,"scroll",0);T(this,"speed",.1);T(this,"sensitivity",.08);T(this,"leftPressed",!1);T(this,"rightPressed",!1);T(this,"leftDragPans",!1);T(this,"lastX",0);T(this,"lastY",0);T(this,"touches",new Map);T(this,"lastTouchCenter",null);T(this,"lastPinchDistance",null);T(this,"lastTwoFingerAngle",null);T(this,"lastTouchCount",0);T(this,"roll",0);T(this,"_dir",se.create());T(this,"_right",se.create());T(this,"_upCam",se.create());T(this,"_scratch",se.create());T(this,"_qY",$e.create());T(this,"_qX",$e.create());T(this,"_qRot",$e.create());T(this,"_qZ",$e.create());T(this,"_qLocal",$e.create());T(this,"_qWorldToCam",$e.create());T(this,"_scratchMat3",bt.create());T(this,"bboxMin",null);T(this,"bboxMax",null);T(this,"anchor",se.create(0,0,0));T(this,"downCallback",n=>{var d,v,b,w;if(this.enabled){if(n.pointerType==="touch"){this.touches.set(n.pointerId,{x:n.pageX,y:n.pageY}),this.handleTouchGestures(),(v=(d=n.target)==null?void 0:d.setPointerCapture)==null||v.call(d,n.pointerId),n.preventDefault();return}n.isPrimary&&(n.button===0?(this.leftPressed=!0,this.leftDragPans=n.shiftKey):n.button===2?this.rightPressed=!0:this.rightPressed=!0,this.lastX=n.pageX,this.lastY=n.pageY,(w=(b=n.target)==null?void 0:b.setPointerCapture)==null||w.call(b,n.pointerId),n.preventDefault())}});T(this,"moveCallback",n=>{if(!this.enabled)return;if(n.pointerType==="touch"){if(!this.touches.has(n.pointerId))return;this.touches.set(n.pointerId,{x:n.pageX,y:n.pageY}),this.handleTouchGestures(),n.preventDefault();return}if(!n.isPrimary||!this.leftPressed&&!this.rightPressed)return;n.preventDefault();const d=n.pageX-this.lastX,v=n.pageY-this.lastY;this.lastX=n.pageX,this.lastY=n.pageY,this.leftPressed&&!this.leftDragPans?(this.rotation[0]+=d,this.rotation[1]-=v):(this.rightPressed||this.leftPressed&&this.leftDragPans)&&(this.shift[1]-=d,this.shift[0]+=v)});T(this,"upCallback",n=>{var d,v,b,w;if(n.pointerType==="touch"){this.touches.delete(n.pointerId),this.handleTouchGestures(),(v=(d=n.target)==null?void 0:d.releasePointerCapture)==null||v.call(d,n.pointerId),n.preventDefault();return}n.button===0?this.leftPressed=!1:n.button===2?this.rightPressed=!1:this.rightPressed=!1,(w=(b=n.target)==null?void 0:b.releasePointerCapture)==null||w.call(b,n.pointerId),n.preventDefault()});T(this,"wheelCallback",n=>{if(!this.enabled||(n.preventDefault(),this.rightPressed))return;let d=n.deltaY;n.deltaMode===1?d*=16:n.deltaMode===2&&(d*=100),this.scroll+=d*.01});this.camera=n,this.registerElement(n.canvas)}registerElement(n){this.element&&this.element!==n&&(this.element.removeEventListener("pointerdown",this.downCallback),this.element.removeEventListener("pointermove",this.moveCallback),this.element.removeEventListener("pointerup",this.upCallback),this.element.removeEventListener("wheel",this.wheelCallback)),this.element=n,this.element.addEventListener("pointerdown",this.downCallback),this.element.addEventListener("pointermove",this.moveCallback),this.element.addEventListener("pointerup",this.upCallback),this.element.addEventListener("wheel",this.wheelCallback,{passive:!1}),this.element.addEventListener("contextmenu",d=>d.preventDefault())}setCenter(n){se.copy(n,this.center),se.copy(n,this.anchor)}setOrbitPivot(n){se.set(n[0],n[1],n[2],this.center),this._reorientCameraToCenter()}setOrbitDepth(n){if(!isFinite(n)||n<.001)return;const d=this.camera.rotation;se.set(d[2],d[6],d[10],this._dir),se.normalize(this._dir,this._dir),se.scale(this._dir,n,this._dir),se.add(this.camera.position,this._dir,this.center)}_reorientCameraToCenter(){const n=this.camera;if(se.subtract(this.center,n.position,this._scratch),se.length(this._scratch)<1e-6)return;se.normalize(this._scratch,this._scratch),se.cross(this.up,this._scratch,this._right),se.length(this._right)<1e-6&&se.set(1,0,0,this._right),se.normalize(this._right,this._right),se.cross(this._scratch,this._right,this._upCam),se.normalize(this._upCam,this._upCam);const d=n.rotation;d[0]=this._right[0],d[1]=this._upCam[0],d[2]=this._scratch[0],d[3]=0,d[4]=this._right[1],d[5]=this._upCam[1],d[6]=this._scratch[1],d[7]=0,d[8]=this._right[2],d[9]=this._upCam[2],d[10]=this._scratch[2],d[11]=0,d[12]=0,d[13]=0,d[14]=0,d[15]=1,n.update_buffer()}setBbox(n,d){this.bboxMin=se.create(n[0],n[1],n[2]),this.bboxMax=se.create(d[0],d[1],d[2]);const v=(n[0]+d[0])*.5,b=(n[1]+d[1])*.5,w=(n[2]+d[2])*.5;se.set(v,b,w,this.center),se.set(v,b,w,this.anchor)}resetToCamera(){const n=this.camera.rotation;se.set(n[2],n[6],n[10],this._dir),se.normalize(this._dir,this._dir);let d=null;if(this.bboxMin&&this.bboxMax){let v=-1/0,b=1/0,w=!1;for(let S=0;S<3;S++){const M=this._dir[S],G=this.bboxMin[S]-this.camera.position[S],O=this.bboxMax[S]-this.camera.position[S];if(Math.abs(M)>1e-8){const W=G/M,J=O/M;v=Math.max(v,Math.min(W,J)),b=Math.min(b,Math.max(W,J))}else if(G>0||O<0){w=!0;break}}!w&&v<=b&&b>0&&(d=(Math.max(v,0)+b)*.5)}if(d===null||!isFinite(d)||d<.001){se.subtract(this.anchor,this.camera.position,this._scratch);const v=se.dot(this._scratch,this._dir);d=v>.001?v:se.length(this._scratch)}d=Math.max(.1,d),se.scale(this._dir,d,this._dir),se.add(this.camera.position,this._dir,this.center)}handleTouchGestures(){const n=this.touches.size;if(n!==this.lastTouchCount&&(this.lastTouchCenter=null,this.lastPinchDistance=null,this.lastTwoFingerAngle=null),this.lastTouchCount=n,n===1){const d=this.touches.values().next().value;if(this.lastTouchCenter){const v=d.x-this.lastTouchCenter[0],b=d.y-this.lastTouchCenter[1];this.rotation[0]+=v*.3,this.rotation[1]-=b*.3}this.lastTouchCenter=[d.x,d.y]}else if(n===2){const d=Array.from(this.touches.values()),v=(d[0].x+d[1].x)*.5,b=(d[0].y+d[1].y)*.5,w=d[1].x-d[0].x,S=d[1].y-d[0].y,M=Math.hypot(w,S),G=Math.atan2(S,w);if(this.lastTouchCenter!==null&&this.lastPinchDistance!==null&&this.lastTwoFingerAngle!==null){const O=v-this.lastTouchCenter[0],W=b-this.lastTouchCenter[1],J=Math.hypot(O,W),I=Math.abs(M-this.lastPinchDistance);let Q=G-this.lastTwoFingerAngle;Q>Math.PI&&(Q-=2*Math.PI),Q<-Math.PI&&(Q+=2*Math.PI),J>.5&&(this.shift[1]-=O,this.shift[0]+=W),I>1&&this.lastPinchDistance>.001&&(this.scroll+=-Math.log(M/this.lastPinchDistance)*10),Math.abs(Q)>.0087&&(this.roll+=Q)}this.lastTouchCenter=[v,b],this.lastPinchDistance=M,this.lastTwoFingerAngle=G}}update(n){if(!this.enabled||Math.abs(this.rotation[0])<1e-4&&Math.abs(this.rotation[1])<1e-4&&Math.abs(this.shift[0])<1e-4&&Math.abs(this.shift[1])<1e-4&&Math.abs(this.scroll)<1e-4&&Math.abs(this.roll)<1e-4)return;const d=this.camera;{const L=d.rotation;this.up[0]=L[1],this.up[1]=L[5],this.up[2]=L[9],se.length(this.up)>1e-6?se.normalize(this.up,this.up):se.set(0,1,0,this.up)}let v=0,b=!1;Math.abs(this.roll)>1e-4&&(v=this.roll,this.roll=0,b=!0),se.subtract(d.position,this.center,this._dir);let w=se.length(this._dir);w<1e-6&&(w=1e-6);const S=Math.exp(Math.log(w)+this.scroll*n*10*this.speed);se.scale(this._dir,S/w,this._dir),w=S;const M=d.rotation;this._right[0]=M[0],this._right[1]=M[4],this._right[2]=M[8],se.normalize(this._right,this._right),se.length(this._right)<1e-6&&se.set(1,0,0,this._right);const G=se.create(M[1],M[5],M[9]);se.normalize(G,G),se.length(G)<1e-6&&se.set(0,1,0,G);const O=n*this.speed*.1*w,W=this.shift[1]*O,J=-this.shift[0]*O;se.scale(this._right,W,this._scratch),se.add(this.center,this._scratch,this.center),se.add(d.position,this._scratch,d.position),se.scale(G,J,this._scratch),se.add(this.center,this._scratch,this.center),se.add(d.position,this._scratch,d.position);const I=this.rotation[0]*n*this.sensitivity,Q=this.rotation[1]*n*this.sensitivity;if(Math.abs(I)>1e-5||Math.abs(Q)>1e-5||b){const L=d.rotation;Fn(L,this._qWorldToCam),$e.fromAxisAngle(Rn,-Q,this._qX),$e.fromAxisAngle(Ln,-I,this._qY),$e.multiply(this._qX,this._qY,this._qLocal),b&&($e.fromAxisAngle(Cn,1*v,this._qZ),$e.multiply(this._qZ,this._qLocal,this._qLocal)),$e.normalize(this._qLocal,this._qLocal),$e.multiply(this._qLocal,this._qWorldToCam,this._qWorldToCam),$e.normalize(this._qWorldToCam,this._qWorldToCam),bt.fromQuat(this._qWorldToCam,this._scratchMat3),We.fromMat3(this._scratchMat3,d.rotation);const ee=d.rotation,pe=ee[2],R=ee[6],te=ee[10];d.position[0]=this.center[0]-pe*w,d.position[1]=this.center[1]-R*w,d.position[2]=this.center[2]-te*w,this.up[0]=ee[1],this.up[1]=ee[5],this.up[2]=ee[9],se.normalize(this.up,this.up)}else se.add(this.center,this._dir,d.position);d.update_buffer();const oe=Math.pow(.8,n*60);this.rotation[0]*=oe,Math.abs(this.rotation[0])<1e-4&&(this.rotation[0]=0),this.rotation[1]*=oe,Math.abs(this.rotation[1])<1e-4&&(this.rotation[1]=0),this.shift[0]*=oe,Math.abs(this.shift[0])<1e-4&&(this.shift[0]=0),this.shift[1]*=oe,Math.abs(this.shift[1])<1e-4&&(this.shift[1]=0),this.scroll*=oe,Math.abs(this.scroll)<1e-4&&(this.scroll=0)}}function at(r){return r+3&-4}const Wn=2,qn=3,Nn=5,Zn=6,it=7,_t=8,ot=9,ct=10;function Hn(r){const n=new TextDecoder("ascii"),d=n.decode(new Uint8Array(r,0,4));if(d!=="NAT2")throw new Error(`NAT2 bad magic: '${d}'`);if(r.byteLength<4+64)throw new Error(`NAT2 truncated (${r.byteLength} bytes < 4 + 64)`);const v=new DataView(r),b=4,w=v.getUint32(b+0,!0),S=v.getUint32(b+4,!0),M=v.getUint32(b+8,!0),G=v.getUint32(b+12,!0),O=v.getUint32(b+16,!0),W=v.getFloat32(b+20,!0),J=v.getUint32(b+24,!0),I=v.getUint32(b+28,!0),Q=v.getFloat32(b+32,!0),ae=v.getFloat32(b+36,!0),oe=v.getFloat32(b+40,!0),L=v.getUint32(b+44,!0),ee=v.getFloat32(b+48,!0),pe=v.getFloat32(b+52,!0),R=v.getUint32(b+56,!0),te=v.getUint32(b+60,!0),ie=I===ot||I===ct,$=ie?te:0,_e=ie?0:te&255,K=ie?0:te>>8&255,Z=_e>0?_e:1;if(I===Nn||I===Zn)throw new Error(`NAT2: paired-RVQ format=${I} is retired 2026-07-23; re-bake with typeD (--bc7-codebook)`);const he=I===ot||I===ct;if(I!==Wn&&I!==qn&&I!==it&&I!==_t&&!he)throw new Error(`NAT2: Halloumi-WS supports BC7 (2), ASTC 4x4 (3), BC7-codebook (7), ASTC-codebook (8), probe-BC7 (9) or probe-ASTC (10); got format=${I}`);if(w%4!==0||L%4!==0)throw new Error(`NAT2 block-format dims must be 4-aligned: width=${w} layer_h=${L}`);let D=b+64;const ne=(R+1)*4,F=new Uint32Array(r.slice(D,D+ne));D+=ne;let de;if(Z>1){const le=(Z+1)*4;if(D+le>r.byteLength)throw new Error(`NAT2 truncated at column_cuts (need ${le} from ${D})`);de=new Uint32Array(r.slice(D,D+le)),D+=le}else de=new Uint32Array([0,w]);let ge=0;for(let le=0;le<Z;le++){const we=de[le+1]-de[le];we>ge&&(ge=we)}if(he){const le=$&1?7:6,we=O*le*4;if(D+we>r.byteLength)throw new Error(`NAT2 truncated at probes: need ${we} more bytes from offset ${D}, have ${r.byteLength-D}`);const Be=new Float32Array(r.slice(D,D+we));D+=we;const B=Math.max(1,$>>8&255),A=[];let h=0;for(let g=0,x=w,y=L;g<B;g++,x>>=1,y>>=1){const e=Math.max(1,x>>2)*Math.max(1,y>>2)*16;A.push(e),h+=e}const t=r.byteLength-D;if(t<h)throw new Error(`NAT2 probe atlas truncated: need ${h} bytes for ${w}x${L} x${B} mips, have ${t}`);const c=[];let a=D;for(const g of A)c.push(new Uint8Array(r.slice(a,a+g))),a+=g;const f=c[0];return{width:w,height:S,channels:M,kernel_type:G,num_rects:O,uv_extent:W,sb_number:J,format:I,sh_bias:Q,res_bias:ae,compact_mult:oe,layer_h:L,atlas_scale:ee,atlas_offset:pe,n_layers:R,n_cols:Z,layer_cuts:F,column_cuts:de,slice_width:ge,rects_expanded:Be,atlas_bytes:f,mip_bytes:c,probe_mode:$&1?2:1}}const V=O*4*4;if(D+V>r.byteLength)throw new Error(`NAT2 truncated at rects: need ${V} more bytes from offset ${D}, have ${r.byteLength-D}`);const re=new Float32Array(r.slice(D,D+V));D+=V;const ye=new Float32Array(O*5);for(let le=0;le<O;le++){const we=re[le*4+0],Be=re[le*4+1],B=re[le*4+2],A=re[le*4+3];let h=0;for(let g=1;g<=R&&F[g]<=Be;g++)h=g;let t=0;for(let g=1;g<=Z&&de[g]<=we;g++)t=g;const c=Be-F[h],a=we-de[t],f=t*R+h;ye[le*5+0]=a,ye[le*5+1]=c,ye[le*5+2]=B,ye[le*5+3]=A,ye[le*5+4]=f}let Se,me;const Te=Z,ke=w/4*16;if(I===it||I===_t){if(D+24>r.byteLength)throw new Error("NAT2 truncated at typeD sub-header");const le=I===it?"BCCB":"ACCB",we=n.decode(new Uint8Array(r,D,4));if(we!==le)throw new Error(`NAT2 typeD bad sub-magic: expected '${le}' got '${we}'`);const Be=v.getUint32(D+4,!0),B=v.getUint32(D+8,!0),A=v.getUint32(D+12,!0),h=v.getUint32(D+16,!0),t=v.getUint32(D+20,!0);if(Be!==1)throw new Error(`NAT2 BCCB unsupported version ${Be}`);if(A!==S/4||h!==w/4||t!==A*h)throw new Error(`NAT2 BCCB block grid mismatch: header ${w}×${S}, sub-header ${h}×${A} (${t} blocks)`);D+=24;const c=B*16;if(D+c>r.byteLength)throw new Error(`NAT2 BCCB truncated at codebook (need ${c}, have ${r.byteLength-D})`);const a=new Uint8Array(r,D,c);D+=c;const f=t*2;if(D+f>r.byteLength)throw new Error(`NAT2 BCCB truncated at indices (need ${f}, have ${r.byteLength-D})`);const g=new Uint16Array(r.slice(D,D+f));D+=f;const x=new Uint8Array(t*16);for(let y=0;y<t;y++){const e=g[y]*16;x.set(a.subarray(e,e+16),y*16)}if(Se=x,K>1){me=[x];for(let y=1;y<K;y++){if(D+24>r.byteLength)throw new Error(`NAT2 truncated at mip ${y} sub-header`);const e=n.decode(new Uint8Array(r,D,4));if(e!==le)throw new Error(`NAT2 mip ${y}: bad sub-magic '${e}'`);const u=v.getUint32(D+8,!0),i=v.getUint32(D+16,!0),o=v.getUint32(D+20,!0);if(i!==y)throw new Error(`NAT2 mip section order: expected level ${y}, got ${i}`);D+=24;let s=0;for(let p=0;p<Te;p++)for(let P=0;P<R;P++){const k=rn(y,de[p+1]-de[p],F[P+1]-F[P],ge,L);s+=(k.cw>>2)*(k.ch>>2)}if(s!==o)throw new Error(`NAT2 mip ${y}: ${o} blocks, loader expects ${s}`);if(D+u*16+o*2>r.byteLength)throw new Error(`NAT2 truncated in mip ${y}`);const l=new Uint8Array(r,D,u*16);D+=u*16;const m=new Uint16Array(r.slice(D,D+o*2));D+=o*2;const _=new Uint8Array(o*16);for(let p=0;p<o;p++){const P=m[p]*16;_.set(l.subarray(P,P+16),p*16)}me.push(_)}}}else{let le=0;for(let we=0;we<R;we++){const Be=F[we+1]-F[we];if(Be%4!==0)throw new Error(`NAT2 BC7 layer ${we} rows ${Be} not 4-aligned`);le+=Be/4*ke}if(D+le>r.byteLength)throw new Error(`NAT2 truncated at atlas payload: need ${le} more bytes from offset ${D}, have ${r.byteLength-D}`);Se=new Uint8Array(r.slice(D,D+le))}return{width:w,height:S,channels:M,kernel_type:G,num_rects:O,uv_extent:W,sb_number:J,format:I,sh_bias:Q,res_bias:ae,compact_mult:oe,layer_h:L,atlas_scale:ee,atlas_offset:pe,n_layers:R,n_cols:Z,layer_cuts:F,column_cuts:de,slice_width:ge,rects_expanded:ye,atlas_bytes:Se,...me?{mip_bytes:me}:{}}}function rn(r,n,d,v,b){const w=M=>M+3>>2<<2,S=1<<r;return{cw:Math.min(w(Math.max(1,v>>r)),w(Math.ceil(n/S))),ch:Math.min(w(Math.max(1,b>>r)),w(Math.ceil(d/S)))}}const jn=32;function Yn(r,n,d){if(n.format===5||n.format===6)throw new Error(`paired-RVQ format=${n.format} is retired; re-bake with typeD (--bc7-codebook)`);let v,b,w,S;if(n.format===2||n.format===it||n.format===ot){if(!r.features.has("texture-compression-bc"))return Ze(`⚠️  bundle is BC7 (format=${n.format}) but texture-compression-bc not supported — atlas disabled`),null;S=n.format===ot?"BC7 atlas (proberes: shared probe texture)":n.format===it?"BC7 atlas (typeD: codebook gather)":"BC7 atlas",{texture:v,view:b,sampler:w}=$t(r,n,"bc7-rgba-unorm",S)}else if(n.format===3||n.format===_t||n.format===ct){if(!r.features.has("texture-compression-astc"))return Ze(`⚠️  bundle is ASTC 4x4 (format=${n.format}) but texture-compression-astc not supported — atlas disabled`),null;S=n.format===ct?"ASTC 4x4 atlas (proberes: shared probe texture)":n.format===_t?"ASTC 4x4 atlas (typeD-ASTC: codebook gather)":"ASTC 4x4 atlas",{texture:v,view:b,sampler:w}=$t(r,n,"astc-4x4-unorm",S)}else return Ze(`⚠️  unsupported atlas format ${n.format} — atlas disabled`),null;const{rects_expanded:M}=n,G=r.createBuffer({label:"atlas rects (5-stride)",size:at(M.byteLength),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST});r.queue.writeBuffer(G,0,M);const O=r.createBuffer({label:"tex_params",size:48,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return ht(r,O,n,d),{texture:v,view:b,sampler:w,rectsBuffer:G,texParamsBuffer:O,meta:n}}function $t(r,n,d,v){const{width:b,layer_h:w,n_layers:S,n_cols:M,layer_cuts:G,column_cuts:O,slice_width:W,atlas_bytes:J}=n,Q=b/4*16,ae=r.limits.maxTextureDimension2D;if(w>ae||W>ae)throw new Error(`⚠️  atlas slice dims ${W}x${w} exceed maxTextureDimension2D=${ae}. Re-bake with smaller LAYER_H or pack with column-aware atlas widths.`);const oe=M*S;if(oe>r.limits.maxTextureArrayLayers)throw new Error(`⚠️  ${M} cols × ${S} layers = ${oe} slices > maxTextureArrayLayers=${r.limits.maxTextureArrayLayers}.`);const L=n.mip_bytes??[J],ee=L.length,pe=r.createTexture({label:v,size:{width:W,height:w,depthOrArrayLayers:oe},mipLevelCount:ee,sampleCount:1,dimension:"2d",format:d,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});for(let $=0;$<M;$++){const _e=O[$]/4,K=(O[$+1]-O[$])/4;for(let Z=0;Z<S;Z++){const he=G[Z]/4,D=(G[Z+1]-G[Z])/4,ne=$*S+Z,F=he*Q+_e*16;r.queue.writeTexture({texture:pe,mipLevel:0,origin:{x:0,y:0,z:ne},aspect:"all"},J,{offset:F,bytesPerRow:Q,rowsPerImage:D},{width:K*4,height:D*4,depthOrArrayLayers:1})}}const R=n.format===ot||n.format===ct;for(let $=1;$<ee&&!R;$++){let _e=0;for(let K=0;K<M;K++)for(let Z=0;Z<S;Z++){const{cw:he,ch:D}=rn($,O[K+1]-O[K],G[Z+1]-G[Z],W,w);r.queue.writeTexture({texture:pe,mipLevel:$,origin:{x:0,y:0,z:K*S+Z},aspect:"all"},L[$],{offset:_e,bytesPerRow:(he>>2)*16,rowsPerImage:D>>2},{width:he,height:D,depthOrArrayLayers:1}),_e+=(he>>2)*(D>>2)*16}}for(let $=1;$<ee&&R;$++){const _e=Math.max(1,W>>$),K=Math.max(1,w>>$);r.queue.writeTexture({texture:pe,mipLevel:$,origin:{x:0,y:0,z:0},aspect:"all"},L[$],{offset:0,bytesPerRow:Math.max(1,_e>>2)*16,rowsPerImage:Math.max(1,K>>2)},{width:_e,height:K,depthOrArrayLayers:1})}ee>1&&console.log(`[atlas] ${ee} mip levels uploaded (${R?"trilinear":"per-surfel integer level"})`);const te=pe.createView({label:`${v} view`,dimension:"2d-array"}),ie=r.createSampler({label:`${v} sampler`,addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",addressModeW:"clamp-to-edge",magFilter:"linear",minFilter:"linear",mipmapFilter:ee>1&&R?"linear":"nearest"});return{texture:pe,view:te,sampler:ie}}function ht(r,n,d,v,b=1){var O;const w=new ArrayBuffer(32),S=new Uint32Array(w),M=new Float32Array(w);S[0]=v?1:0,M[1]=d.atlas_scale,M[2]=d.atlas_offset,M[3]=d.res_bias,S[4]=d.probe_mode?d.probe_mode|0:0,S[5]=d.width|0;const G=(((O=d.mip_bytes)==null?void 0:O.length)??1)>1;S[6]=G&&b!==0?1:0,r.queue.writeBuffer(n,0,w)}async function Vn(r,n){Ze(`loading ply file from File... : ${r.name}`),kn("downloading PLY...");const d=await r.arrayBuffer();try{return await Xn(d,n)}finally{Mn()}}async function Xn(r,n){return new Promise((d,v)=>{const b=new Worker(new URL(""+new URL("ply-worker-621cb083.js",import.meta.url).href,self.location),{type:"module"});b.onmessage=w=>{var M,G,O,W,J,I,Q,ae,oe,L,ee,pe;const S=w.data;if((S==null?void 0:S.type)==="error"){Gn(`PLY worker error: ${S.message??"unknown error"}`),b.terminate(),v(new Error(S.message??"Worker error"));return}else if((S==null?void 0:S.type)==="download_progress"){const R=S.totalBytes,te=S.loadedBytes/(1024*1024),ie=R?R/(1024*1024):void 0,$=(S.speedBps??0)/(1024*1024),_e=R?Math.min(99,Math.floor(S.loadedBytes/R*100)):void 0,K=ie?`total ${ie.toFixed(1)} MB`:"total -- MB",Z=ie&&_e!==void 0?`${te.toFixed(1)} MB downloaded (${_e}%)`:`${te.toFixed(1)} MB downloaded`,he=`${$.toFixed(2)} MB/s`;dt(`downloading PLY ...
${K}, ${Z}
${he}`);return}else if((S==null?void 0:S.type)==="fetched"){Ze(`💾 Fetched (${S.byteLength} bytes)`),Ft("Download"),dt("parsing PLY..."),An();return}else if((S==null?void 0:S.type)==="parse_progress"){const R=S.total??0,te=S.read??0,ie=R>0?Math.floor(te/R*100):0;dt(`parsing PLY ...
${te}/${R} surfels (${ie}%)`);return}else if((S==null?void 0:S.type)==="done"){const R=S.num_points,te=S.K,ie=S.feature_mode??0,$=S.sh_bias,_e=S.kernel_type,K=S.surfelBuffer,Z=S.svParamsBuffer;Ze(`🪐 Total surfels: ${R}, mode=${ie===1?"SB":"SV"}, K=${te}, sh_bias=${$}, kernel_type=${_e}`);const D=n.createBuffer({label:"surfel input buffer",size:at(R*jn),usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.STORAGE});n.queue.writeBuffer(D,0,K);const ne=Z.byteLength>0?Z.byteLength:16,F=n.createBuffer({label:ie===1?"color_params buffer (SB)":"color_params buffer (SV)",size:at(ne),usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.STORAGE});Z.byteLength>0&&n.queue.writeBuffer(F,0,Z),b.terminate(),Ft("Parse"),d({num_points:R,K:te,feature_mode:ie,sh_bias:$,kernel_type:_e,surfel_buffer:D,surfel_data:new Float32Array(K),sv_params_buffer:F,bbox:S.bbox??{min:[-1,-1,-1],max:[1,1,1]},centroid:S.centroid??[((((G=(M=S.bbox)==null?void 0:M.min)==null?void 0:G[0])??-1)+(((W=(O=S.bbox)==null?void 0:O.max)==null?void 0:W[0])??1))/2,((((I=(J=S.bbox)==null?void 0:J.min)==null?void 0:I[1])??-1)+(((ae=(Q=S.bbox)==null?void 0:Q.max)==null?void 0:ae[1])??1))/2,((((L=(oe=S.bbox)==null?void 0:oe.min)==null?void 0:L[2])??-1)+(((pe=(ee=S.bbox)==null?void 0:ee.max)==null?void 0:pe[2])??1))/2]})}},b.onerror=w=>{b.terminate(),v(w)},r instanceof ArrayBuffer?(dt("parsing PLY..."),b.postMessage({type:"start",plyBuffer:r},[r])):b.postMessage({type:"start_url",url:r.url})})}const Kn=`// 2DGS preprocess — per-alive-Gauss view-dependent color eval.
//
...
`,kt=8,Ve=1<<kt,et=256,yt=32/kt;class xs{constructor(n,d,v){T(this,"depthsIn");T(this,"indicesIn");T(this,"indicesOut");T(this,"owned",[]);T(this,"passes",[]);T(this,"histBg");T(this,"scatterBg");T(this,"prefixBg");T(this,"prefix",{});this.device=n,this.info=v;const b=(Math.floor((d+et-1)/et)+1)*et,w=Math.ceil(b/et),S=(ne,F)=>{const de=n.createBuffer({label:ne,size:F,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC});return this.owned.push(de),de},M=[0,1].map(ne=>({d:S(`sort keys ${ne}`,b*4),p:S(`sort payload ${ne}`,b*4)})),G=S("wg histograms",w*Ve*4),O=S("wg prefixes",w*Ve*4),W=S("digit base",Ve*4),J=Math.ceil(w/et),I=Math.ceil(J/et),Q=S("l0 sums",J*Ve*4),ae=S("l0 offsets",J*Ve*4),oe=S("l1 sums",I*Ve*4),L=S("l1 offsets",I*Ve*4);this.depthsIn=M[0].d,this.indicesIn=M[0].p,this.indicesOut=M[yt&1].p;const ee=ne=>({visibility:GPUShaderStage.COMPUTE,buffer:{type:ne}}),pe=n.createBindGroupLayout({entries:[{binding:0,...ee("read-only-storage")},{binding:1,...ee("read-only-storage")},{binding:2,...ee("storage")}]}),R=n.createBindGroupLayout({entries:[{binding:0,...ee("read-only-storage")},{binding:1,...ee("read-only-storage")},{binding:2,...ee("read-only-storage")},{binding:3,...ee("storage")},{binding:4,...ee("read-only-storage")},{binding:5,...ee("storage")},{binding:6,...ee("read-only-storage")}]}),te=n.createBindGroupLayout({entries:[{binding:0,...ee("read-only-storage")},{binding:1,...ee("read-only-storage")},...[2,3,4,5,6,7].map(ne=>({binding:ne,...ee("storage")}))]}),ie=n.createShaderModule({label:"bench radix histogram",code:cn}),$=n.createShaderModule({label:"bench radix scatter",code:on}),_e=n.createShaderModule({label:"bench radix prefix",code:ln}),K=n.createPipelineLayout({bindGroupLayouts:[pe]}),Z=n.createPipelineLayout({bindGroupLayouts:[R]});for(let ne=0;ne<yt;ne++){const F={PASS_ID:ne,RS_RADIX_LOG2:kt,RS_RADIX_SIZE:Ve};this.passes.push({hist:n.createComputePipeline({layout:K,compute:{module:ie,entryPoint:"local_histogram_pass",constants:F}}),scatter:n.createComputePipeline({layout:Z,compute:{module:$,entryPoint:"scatter_elements",constants:F}})})}const he=n.createPipelineLayout({bindGroupLayouts:[te]});for(const ne of["prefix_l0_tile_scan","prefix_l1_tile_scan_on_l0_sums","prefix_scan_l1_sums","prefix_add_l1_to_l0_offsets","prefix_add_l0_to_elements","compute_digit_base"])this.prefix[ne]=n.createComputePipeline({layout:he,compute:{module:_e,entryPoint:ne,constants:{WG_SIZE:et}}});const D=(ne,F)=>({binding:ne,resource:{buffer:F}});this.prefixBg=n.createBindGroup({layout:te,entries:[D(0,v),D(1,G),D(2,O),D(3,Q),D(4,ae),D(5,oe),D(6,L),D(7,W)]}),this.histBg=[0,1].map(ne=>n.createBindGroup({layout:pe,entries:[D(0,v),D(1,M[ne].d),D(2,G)]})),this.scatterBg=[0,1].map(ne=>n.createBindGroup({layout:R,entries:[D(0,v),D(1,W),D(2,M[ne].d),D(3,M[1-ne].d),D(4,M[ne].p),D(5,M[1-ne].p),D(6,O)]}))}encode(n){const d=(v,b,w,S)=>{const M=n.beginComputePass();M.setPipeline(v),M.setBindGroup(0,b),w!==null?M.dispatchWorkgroupsIndirect(this.info,w):M.dispatchWorkgroups(S[0],S[1],1),M.end()};for(let v=0;v<yt;v++){const b=v&1;d(this.passes[v].hist,this.histBg[b],4),d(this.prefix.prefix_l0_tile_scan,this.prefixBg,16),d(this.prefix.prefix_l1_tile_scan_on_l0_sums,this.prefixBg,32),d(this.prefix.prefix_scan_l1_sums,this.prefixBg,null,[1,Ve]),d(this.prefix.prefix_add_l1_to_l0_offsets,this.prefixBg,32),d(this.prefix.prefix_add_l0_to_elements,this.prefixBg,16),d(this.prefix.compute_digit_base,this.prefixBg,null,[1,1]),d(this.passes[v].scatter,this.scatterBg[b],4)}}destroy(){for(const n of this.owned)n.destroy()}}const Kt=256,ys=64,tt=GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST;class bs{constructor(n,d,v,b,w){T(this,"n");T(this,"kind");T(this,"freezeMlp",!1);T(this,"owned",[]);T(this,"params",new ArrayBuffer(32));T(this,"paramsBuf");T(this,"info");T(this,"drawArgs");T(this,"vpBuf");T(this,"indirectPipe");T(this,"indirectBg");T(this,"computeBgs");T(this,"cullPipe");T(this,"mlpPipe",null);T(this,"mlpAllPipe",null);T(this,"prepPipe",null);T(this,"rasterPipe");T(this,"rasterBg");T(this,"sorter",null);T(this,"countCopy",null);T(this,"cullInfoBg",null);T(this,"accTex",null);T(this,"trTex",null);T(this,"resolvePipe",null);T(this,"resolveBgl",null);T(this,"resolveBg",null);T(this,"accFormat");T(this,"wScale");T(this,"eps",null);this.device=n,this.targetFormat=b;const S=d.header;this.n=S.n,this.kind=S.render;const M=S.n,G=(V,re,ye=tt|GPUBufferUsage.COPY_SRC)=>{const Se=n.createBuffer({label:V,size:Math.max(16,re+(4-re%4)%4),usage:ye});return this.owned.push(Se),Se},O=(V,re)=>{const ye=re instanceof ArrayBuffer?new Uint8Array(re):new Uint8Array(re.buffer,re.byteOffset,re.byteLength),Se=G(V,ye.byteLength,tt);return n.queue.writeBuffer(Se,0,ye),Se},W=new Float32Array(d.block("pos")),J=new Float32Array(d.block("cov3d")),I=this.kind==="sorted_3dgs"?new Float32Array(d.block("opacity")):null,Q=new Float32Array(M*10);for(let V=0;V<M;V++)Q[V*10]=W[V*3],Q[V*10+1]=W[V*3+1],Q[V*10+2]=W[V*3+2],Q[V*10+3]=I?I[V]:1,Q.set(J.subarray(V*6,V*6+6),V*10+4);const ae=O("bench gauss",Q),oe=O("bench sh",d.block("sh"));this.paramsBuf=G("bench params",32,GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST),this.accFormat=w.float32Blend?"rgba32float":"rgba16float",this.wScale=w.float32Blend?1:1/1024;const L=new Uint32Array(this.params),ee=new Float32Array(this.params);L[0]=M,L[1]=S.sh_degree,ee[2]=w.cutoffMult??S.cutoff_mult??1,ee[3]=this.wScale,n.queue.writeBuffer(this.paramsBuf,0,this.params),this.info=G("bench sort info",64,tt|GPUBufferUsage.COPY_SRC|GPUBufferUsage.INDIRECT),this.drawArgs=G("bench draw args",16,tt|GPUBufferUsage.INDIRECT),n.queue.writeBuffer(this.drawArgs,0,new Uint32Array([4,0,0,0])),this.vpBuf=G("bench viewport",16,GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST);const pe=G("bench splats",M*ys),R=n.createShaderModule({label:"bench indirect",code:an});this.indirectPipe=n.createComputePipeline({layout:"auto",compute:{module:R,entryPoint:"write_dispatch_triples",constants:{RS_RADIX_SIZE:256}}}),this.indirectBg=n.createBindGroup({layout:this.indirectPipe.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.info}},{binding:1,resource:{buffer:this.drawArgs}}]});const te=GPUShaderStage.COMPUTE,ie=(V,re=te)=>n.createBindGroupLayout({entries:V.map((ye,Se)=>({binding:Se,visibility:re,buffer:{type:ye}}))}),$=(V,re)=>({binding:V,resource:{buffer:re}}),_e=ie(["uniform","uniform"]),K=n.createBindGroup({layout:_e,entries:[$(0,v),$(1,this.paramsBuf)]});let Z,he;if(this.kind==="sorted_3dgs"){this.sorter=new xs(n,M,this.info);const V=ie(["read-only-storage","read-only-storage","storage"]),re=ie(["storage","storage","storage"]),ye=n.createShaderModule({label:"gs3d_cull",code:Xt+hs});this.cullPipe=n.createComputePipeline({label:"gs3d_cull",layout:n.createPipelineLayout({bindGroupLayouts:[_e,V,re]}),compute:{module:ye,entryPoint:"cull"}}),this.computeBgs=[K,n.createBindGroup({layout:V,entries:[$(0,ae),$(1,oe),$(2,pe)]}),n.createBindGroup({layout:re,entries:[$(0,this.info),$(1,this.sorter.depthsIn),$(2,this.sorter.indicesIn)]})],he=this.sorter.indicesOut,Z=G("bench weights stub",16,tt)}else{const V=new Float32Array(d.block("scale")),re=new Float32Array(d.block("rot")),ye=new Float32Array(M*7);for(let x=0;x<M;x++)ye.set(V.subarray(x*3,x*3+3),x*7),ye.set(re.subarray(x*4,x*4+4),x*7+3);const Se=O("bench mgs attr",ye),me=(x,y,e)=>{const u=new Float32Array(x.length);for(let i=0;i<y;i++)for(let o=0;o<e;o++)u[o*y+i]=x[i*e+o];return u},Te=S.mlp.flatMap(x=>[me(new Float32Array(d.block(`${x.name}.weight`)),x.out_dim,x.in_dim),new Float32Array(d.block(`${x.name}.bias`))]),ze=S.mlp.map(x=>`${x.in_dim}>${x.out_dim}`).join(",");if(ze!=="22>256,256>128,128>64,64>1,64>1")throw new Error(`unexpected Mobile-GS MLP ${ze}`);const ke=new Float32Array(Te.reduce((x,y)=>x+y.length,0));let le=0;for(const x of Te)ke.set(x,le),le+=x.length;const we=O("bench mgs mlp",ke),Be=G("bench mgs vis",M*4),B=G("bench mgs mlp out",M*8);Z=G("bench mgs weights",M*4),this.countCopy=G("bench mgs count",16,tt);const A=ie(["read-only-storage","read-only-storage","read-only-storage","read-only-storage"]),h=ie(["read-only-storage","storage","storage","storage","storage"]),t=ie(["storage"]),c=n.createShaderModule({label:"mgs_compute",code:Xt+_s}),a=n.createPipelineLayout({bindGroupLayouts:[_e,A,h,t]}),f=n.createPipelineLayout({bindGroupLayouts:[_e,A,h]}),g=(x,y)=>n.createComputePipeline({label:`mgs_${x}`,layout:y,compute:{module:c,entryPoint:x}});this.cullPipe=g("cull",a),this.mlpPipe=g("mlp_coop",f),this.mlpAllPipe=g("mlp_all_coop",f),this.prepPipe=g("prep",f),this.computeBgs=[K,n.createBindGroup({layout:A,entries:[$(0,ae),$(1,oe),$(2,Se),$(3,we)]}),n.createBindGroup({layout:h,entries:[$(0,this.countCopy),$(1,Be),$(2,B),$(3,pe),$(4,Z)]})],this.cullInfoBg=n.createBindGroup({layout:t,entries:[$(0,this.info)]}),he=G("bench order stub",16,tt)}const D=GPUShaderStage.VERTEX,ne=n.createBindGroupLayout({entries:[{binding:0,visibility:D,buffer:{type:"read-only-storage"}},{binding:1,visibility:D,buffer:{type:"read-only-storage"}},{binding:2,visibility:D,buffer:{type:"uniform"}},{binding:3,visibility:D,buffer:{type:"read-only-storage"}}]});this.rasterBg=n.createBindGroup({layout:ne,entries:[$(0,pe),$(1,he),$(2,this.vpBuf),$(3,Z)]});const F=n.createShaderModule({label:"gs_raster",code:gs}),de=V=>({operation:"add",srcFactor:"one",dstFactor:V}),ge=this.kind==="sorted_3dgs";if(this.rasterPipe=n.createRenderPipeline({label:ge?"gs_raster over":"gs_raster wsum",layout:n.createPipelineLayout({bindGroupLayouts:[ne]}),vertex:{module:F,entryPoint:ge?"vs_main":"vs_wsum"},fragment:ge?{module:F,entryPoint:"fs_over",targets:[{format:b,blend:{color:de("one-minus-src-alpha"),alpha:de("one-minus-src-alpha")}}]}:{module:F,entryPoint:"fs_wsum",targets:[{format:this.accFormat,blend:{color:de("one"),alpha:de("one")}},{format:"r16float",blend:{color:{operation:"add",srcFactor:"zero",dstFactor:"one-minus-src"},alpha:{operation:"add",srcFactor:"zero",dstFactor:"one"}}}]},primitive:{topology:"triangle-strip",cullMode:"none"}}),!ge){this.eps=G("bench resolve eps",16,GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST),n.queue.writeBuffer(this.eps,0,new Float32Array([1e-5*this.wScale,0,0,0]));const V=GPUShaderStage.FRAGMENT;this.resolveBgl=n.createBindGroupLayout({entries:[{binding:0,visibility:V,texture:{sampleType:"unfilterable-float"}},{binding:1,visibility:V,texture:{sampleType:"unfilterable-float"}},{binding:2,visibility:V,buffer:{type:"uniform"}}]});const re=n.createShaderModule({label:"mgs_resolve",code:ms});this.resolvePipe=n.createRenderPipeline({layout:n.createPipelineLayout({bindGroupLayouts:[this.resolveBgl]}),vertex:{module:re,entryPoint:"vs_full"},fragment:{module:re,entryPoint:"fs_resolve",targets:[{format:b}]},primitive:{topology:"triangle-list"}})}}get label(){return this.kind==="sorted_3dgs"?"sorted 3DGS":`sort-free (${this.accFormat})`}get accumulationFormat(){return this.accFormat}async computeAllMlp(n=32768){if(!this.mlpAllPipe)return;const d=new Uint32Array(this.params);for(let v=0;v<this.n;v+=n){d[4]=v,this.device.queue.writeBuffer(this.paramsBuf,0,this.params);const b=this.device.createCommandEncoder(),w=b.beginComputePass();w.setPipeline(this.mlpAllPipe),this.computeBgs.forEach((S,M)=>w.setBindGroup(M,S)),w.dispatchWorkgroups(Math.ceil(Math.min(n,this.n-v)/Kt)),w.end(),this.device.queue.submit([b.finish()]),await this.device.queue.onSubmittedWorkDone()}d[4]=0,this.device.queue.writeBuffer(this.paramsBuf,0,this.params)}ensureTargets(n,d){var b,w;if(this.kind!=="sortfree_weighted"||this.accTex&&this.accTex.width===n&&this.accTex.height===d)return;(b=this.accTex)==null||b.destroy(),(w=this.trTex)==null||w.destroy();const v=GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING;this.accTex=this.device.createTexture({label:"mgs acc",size:[n,d],format:this.accFormat,usage:v}),this.trTex=this.device.createTexture({label:"mgs T",size:[n,d],format:"r16float",usage:v}),this.resolveBg=this.device.createBindGroup({layout:this.resolveBgl,entries:[{binding:0,resource:this.accTex.createView()},{binding:1,resource:this.trTex.createView()},{binding:2,resource:{buffer:this.eps}}]})}frame(n,d,v,b){this.device.queue.writeBuffer(this.vpBuf,0,new Float32Array([v,b,0,0])),this.ensureTargets(v,b);const w=(G,O)=>{const W=n.beginComputePass();W.setPipeline(G),this.computeBgs.forEach((J,I)=>W.setBindGroup(I,J)),!O&&this.cullInfoBg&&W.setBindGroup(3,this.cullInfoBg),O?W.dispatchWorkgroupsIndirect(this.info,4):W.dispatchWorkgroups(Math.ceil(this.n/Kt)),W.end()};n.clearBuffer(this.info,0,4),w(this.cullPipe,!1);{const G=n.beginComputePass();G.setPipeline(this.indirectPipe),G.setBindGroup(0,this.indirectBg),G.dispatchWorkgroups(1),G.end()}if(this.kind==="sorted_3dgs"){this.sorter.encode(n);const G=n.beginRenderPass({colorAttachments:[{view:d,loadOp:"clear",storeOp:"store",clearValue:[0,0,0,1]}]});G.setPipeline(this.rasterPipe),G.setBindGroup(0,this.rasterBg),G.drawIndirect(this.drawArgs,0),G.end();return}n.copyBufferToBuffer(this.info,0,this.countCopy,0,4),this.freezeMlp||w(this.mlpPipe,!0),w(this.prepPipe,!0);const S=n.beginRenderPass({colorAttachments:[{view:this.accTex.createView(),loadOp:"clear",storeOp:"store",clearValue:[0,0,0,0]},{view:this.trTex.createView(),loadOp:"clear",storeOp:"store",clearValue:[1,0,0,0]}]});S.setPipeline(this.rasterPipe),S.setBindGroup(0,this.rasterBg),S.drawIndirect(this.drawArgs,0),S.end();const M=n.beginRenderPass({colorAttachments:[{view:d,loadOp:"clear",storeOp:"store",clearValue:[0,0,0,1]}]});M.setPipeline(this.resolvePipe),M.setBindGroup(0,this.resolveBg),M.draw(3),M.end()}destroy(){var n,d,v;for(const b of this.owned)b.destroy();(n=this.sorter)==null||n.destroy(),(d=this.accTex)==null||d.destroy(),(v=this.trTex)==null||v.destroy()}}const nt="rgba8unorm",Jt="https://huggingface.co/datasets/Nilkel/bitymi-demos/resolve/main",Ke=[{id:"bitymi",label:"BITYMI (ours)",asset:"bitymi",note:"baked 2DGS + compressed atlas, stock viewer renderer"},{id:"bitymi_noatlas",label:"BITYMI (atlas off)",asset:"bitymi",note:"diagnostic: same surfels, no atlas texture fetch (SV colour only)"},{id:"bitymi_oct",label:"BITYMI (octagon bound)",asset:"bitymi",note:"diagnostic: 8-vertex ellipse-tangent bound, ~25% fewer fragments (?oct=1)"},{id:"bitymi_mip0",label:"BITYMI (mips, bias 0)",asset:"bitymimip",note:"diagnostic: atlas mip chain, full per-surfel prefiltering"},{id:"bitymi_mip1",label:"BITYMI (mips, bias 1)",asset:"bitymimip",note:"diagnostic: atlas mip chain, one level less prefiltering"},{id:"bitymi_mipft0",label:"BITYMI (mip-aware ft, bias 0)",asset:"bitymimipft",note:"atlas finetuned with the bias-0 per-surfel mip rule"},{id:"fastgs",label:"FastGS",asset:"fastgs",note:"authors checkpoint, sorted 3DGS SH3"},{id:"speedy",label:"Speedy-Splat",asset:"speedy",note:"authors checkpoint, sorted 3DGS SH3"},{id:"mobilegs",label:"Mobile-GS",asset:"mobilegs",note:"authors checkpoint (their decode), sort-free, per-frame MLP"},{id:"mobilegs_frozen",label:"Mobile-GS (MLP frozen)",asset:"mobilegs",note:"ablation: MLP evaluated once, raster cost only"}],ws=r=>new Promise(n=>setTimeout(n,r)),ft=()=>new Promise(r=>setTimeout(r,0));function vs(r){const n=new TextDecoder().decode(new Uint8Array(r,0,8));if(n!=="BITYMI01")throw new Error(`not a BITYMI bundle ('${n}')`);const d=new DataView(r);let v=null,b=null;for(let w=0;w<d.getUint32(8,!0);w++){const S=12+w*20,M=d.getUint32(S,!0),G=Number(d.getBigUint64(S+4,!0)),O=Number(d.getBigUint64(S+12,!0));M===0||M===1||M===5?v=r.slice(G,G+O):(M===3||M===4)&&(b=r.slice(G,G+O))}if(!v)throw new Error("bundle has no point cloud chunk");return{pc:v,atlas:b}}async function pt(r,n){var W;const d=await fetch(r);if(!d.ok)throw new Error(`${r}: HTTP ${d.status}`);const v=Number(d.headers.get("content-length"))||0,b=(W=d.body)==null?void 0:W.getReader();if(!b)return d.arrayBuffer();const w=[];let S=0,M=0;for(;;){const{done:J,value:I}=await b.read();if(J)break;w.push(I),S+=I.byteLength,S-M>2<<20&&(M=S,n(S/2**20,v?v/2**20:null))}const G=new Uint8Array(S);let O=0;for(const J of w)G.set(J,O),O+=J.byteLength;return G.buffer}function Bt(r,n,d=new Set,v=0){if(!(!r||typeof r!="object"||d.has(r)||v>2)){d.add(r);for(const b of Object.values(r))n.has(b)||(b instanceof GPUBuffer||b instanceof GPUTexture?b.destroy():Array.isArray(b)?b.forEach(w=>Bt(w,n,d,v+1)):b&&typeof b=="object"&&Object.getPrototypeOf(b)===Object.prototype&&Bt(b,n,d,v+1))}}async function Ss(r,n,d,v,b){const w=new URLSearchParams(location.search),S=w.get("scene")??"garden",M=(w.get("assets")??`${Jt}/bench/${S}`).replace(/\/$/,""),G=d.features.has("texture-compression-bc"),O=d.features.has("texture-compression-astc"),W=w.get("bitymi")??`${Jt}/mip_360/${S}_e3rdraw${G||!O?"":"_astc"}.bitymi`,J=d.features.has("float32-blendable"),I=/Android|iPhone|iPad|iPod|Mobile/i.test(navigator.userAgent)||navigator.maxTouchPoints>1&&/Mac/i.test(navigator.platform),Q=w.get("byid");let ae=Q!==null?Q==="1":!I,oe=w.get("legacy")==="1";n.configure({device:d,format:nt,alphaMode:"opaque"});const L=new wt(r,d),ee=new $n(L),pe=document.getElementById("bench-panel"),R=p=>document.getElementById(p),te=p=>{R("status").textContent=p},ie=await(await fetch(`${M}/manifest.json`)).json(),$=await Dn(`${M}/${ie.cameras}`),_e=await(await fetch(`${M}/${ie.cameras}`)).json(),[K,Z]=ie.resolution,he=2*Math.atan(Z/(2*_e[0].fy));L.setFov(he),L.set_preset($[0]),ee.resetToCamera();const D=R("method");for(const p of Ke)D.add(new Option(p.label,p.id));const ne=v.info;R("device").textContent=`${ne.vendor||"?"} ${ne.architecture||""} ${ne.device||ne.description||""}`.trim()+` · BC7 ${G?"✓":"✗"} ASTC ${O?"✓":"✗"} · float32-blend ${J?"✓":"✗"}`;let F=null,de=!1,ge=null,V=null,re=null;const ye=w.get("bitymimip")??W.replace(/_e3rdraw(_astc)?\.bitymi$/,"_e3rdmip$1.bitymi"),Se=w.get("bitymimipft")??W.replace(/_e3rdraw(_astc)?\.bitymi$/,"_e3rdmipft$1.bitymi"),me=p=>p==="bitymimip"||p==="bitymimipft",Te=p=>["bitymi_mip0","bitymi_mipft0"].includes(p.base??p.id)?0:1;async function ze(p){var N,Y;const P=performance.now(),k=(C,H)=>te(`${p.label}: downloading ${C.toFixed(0)}${H?` / ${H.toFixed(0)}`:""} MB`);if(p.asset==="bitymi"||me(p.asset)){const C=p.asset==="bitymi"?ge??(ge=await pt(W,k)):p.asset==="bitymimip"?V??(V=await pt(ye,k)):re??(re=await pt(Se,k)),H=(p.base??p.id)==="bitymi_oct";te(`${p.label}: parsing`);const{pc:q,atlas:j}=vs(C),ce=await Vn(new File([q],"bundle.ply"),d);let X=null;j&&(X=Yn(d,Hn(j),!0));const ue=new fs(ce,d,nt,L.uniform_buffer,b,X,{fetchById:p.byid??ae,octBound:H,acc16:!1});(p.legacy??oe)&&ue.setLegacyRenderer(!0),ue.setAtlasEnabled((p.base??p.id)!=="bitymi_noatlas"),me(p.asset)&&ue.setMipLodBias(Te(p));let xe=0,ve=0;const Ee=X?X.meta.format===3||X.meta.format===8||X.meta.format===10?"ASTC":"BC7":"NONE (atlas unsupported: renders SV-only, not comparable)";return{def:p,prims:ce.num_points,downloadBytes:C.byteLength,gs:ue,oct:H,atlasKind:Ee,detail:`atlas ${(p.base??p.id)==="bitymi_noatlas"?"OFF (diagnostic)":Ee} · fragment inputs ${p.byid??ae?"fetch-by-id":"varyings"} · ${p.legacy??oe?"LEGACY renderer":"current renderer"}${H?" · octagon bound":""}${me(p.asset)?` · atlas mips (${((Y=(N=X==null?void 0:X.meta)==null?void 0:N.mip_bytes)==null?void 0:Y.length)??1} levels)`:""} · ${(performance.now()-P).toFixed(0)} ms load`,render(De,Ie,Me,Ue){(Me!==xe||Ue!==ve)&&(ts(Me,Ue,d,ue.render_settings_buffer),xe=Me,ve=Ue),ue.frame(De,Ie,!1)},destroy(){ce.surfel_buffer.destroy(),ce.sv_params_buffer.destroy(),X&&(X.texture.destroy(),X.rectsBuffer.destroy(),X.texParamsBuffer.destroy()),Bt(ue,new Set([L.uniform_buffer]))}}}const U=await pt(`${M}/${ie.methods[p.asset].file}`,k);te(`${p.label}: uploading`);const E=new bs(d,ps(U),L.uniform_buffer,nt,{float32Blend:J});return{def:p,prims:E.n,downloadBytes:U.byteLength,baseline:E,detail:`${E.label}${p.asset==="mobilegs"?` · shipped model ${(ie.methods.mobilegs.shipped_bytes/2**20).toFixed(1)} MB (comp.xz, decoded offline)`:""}`,render:(C,H,q,j)=>E.frame(C,H,q,j),destroy:()=>E.destroy()}}async function ke(p){var k,U;const P=(F==null?void 0:F.gs)&&F.def.asset===p.asset&&F.oct===((p.base??p.id)==="bitymi_oct");if(F&&F.def.asset===p.asset&&(F.baseline||P)?(F={...F,def:p},(k=F.gs)==null||k.setAtlasEnabled((p.base??p.id)!=="bitymi_noatlas"),me(p.asset)&&((U=F.gs)==null||U.setMipLodBias(Te(p))),F.gs&&(F.gs.setFetchById(p.byid??ae),F.gs.setLegacyRenderer(p.legacy??oe),F.detail=F.detail.replace(/^atlas [^·]+·/,`atlas ${(p.base??p.id)==="bitymi_noatlas"?"OFF (diagnostic)":F.atlasKind} ·`).replace(/fragment inputs [a-z-]+/,`fragment inputs ${p.byid??ae?"fetch-by-id":"varyings"}`).replace(/(LEGACY|current) renderer/,p.legacy??oe?"LEGACY renderer":"current renderer"))):(F==null||F.destroy(),F=null,await d.queue.onSubmittedWorkDone(),F=await ze(p)),F.baseline&&F.baseline.kind==="sortfree_weighted"){const E=p.id==="mobilegs_frozen";E&&(L.set_preset($[0]),te("Mobile-GS: evaluating the MLP once for all Gaussians"),await F.baseline.computeAllMlp()),F.baseline.freezeMlp=E}return R("info").textContent=`${F.def.label}: ${F.prims.toLocaleString()} primitives · ${(F.downloadBytes/2**20).toFixed(1)} MB download · ${F.detail}`,te("ready"),F}D.onchange=async()=>{if(!(de||h)){de=!0;try{await ke(Ke.find(p=>p.id===D.value))}catch(p){te(`load failed: ${p}`),console.error(p)}finally{de=!1}}};const le=R("byid"),we=R("legacy");le.checked=ae,we.checked=oe;const Be=async()=>{if(de||h){le.checked=ae,we.checked=oe;return}if(ae=le.checked,oe=we.checked,(F==null?void 0:F.def.id)==="bitymi"){de=!0;try{F.destroy(),F=null,await d.queue.onSubmittedWorkDone(),await ke(Ke[0])}catch(p){te(`load failed: ${p}`),console.error(p)}finally{de=!1}}};le.onchange=Be,we.onchange=Be;let B=0;const A=p=>{B=(p+$.length)%$.length,L.set_preset($[B]),ee.resetToCamera(),R("view").textContent=`${B+1}/${$.length}`};R("prev").onclick=()=>A(B-1),R("next").onclick=()=>A(B+1);let h=!1,t=!1;document.addEventListener("visibilitychange",()=>{document.hidden&&(t=!0)});const c=()=>({warmupS:Number(R("warmup").value),measureS:Number(R("measure").value),minFrames:Number(R("minframes").value),maxS:Number(R("maxs").value),cooldownS:Number(R("cooldown").value),rounds:Number(R("rounds").value),frozen:R("frozen").checked,diag:R("diag").checked});window.__setMipBias=p=>{var P;(P=F==null?void 0:F.gs)==null||P.setMipLodBias(p)},window.__mipHistogram=async p=>{const P=F==null?void 0:F.gs;if(!P)throw new Error("BITYMI not loaded");const k=d.createTexture({size:[K,Z],format:nt,usage:GPUTextureUsage.RENDER_ATTACHMENT});L.setRenderSize(K,Z),L.setFov(he),L.set_preset($[p]);const U=d.createCommandEncoder();F.render(U,k.createView(),K,Z);const E=P.splat_2d_buffer.size,z=d.createBuffer({size:E,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ}),N=d.createBuffer({size:16,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ});U.copyBufferToBuffer(P.splat_2d_buffer,0,z,0,E),U.copyBufferToBuffer(P.sort_info_buffer,0,N,0,16),d.queue.submit([U.finish()]),await Promise.all([z.mapAsync(GPUMapMode.READ),N.mapAsync(GPUMapMode.READ)]);const Y=new Uint32Array(N.getMappedRange())[0],C=new Uint32Array(z.getMappedRange()),H=new Float32Array(C.buffer),q=[0,0,0,0,0],j=[0,0,0,0,0],ce=X=>{const ue=X>>10&31,xe=X&1023;return ue===0?xe/1024*2**-14:2**(ue-15)*(1+xe/1024)};for(let X=0;X<Y;X++){const ue=Math.min(4,Math.round(H[X*24+23])),xe=C[X*24+11],ve=4*ce(xe&65535)*ce(xe>>>16);q[ue]++,j[ue]+=ve}return z.unmap(),N.unmap(),z.destroy(),N.destroy(),k.destroy(),L.clearRenderSize(),L.setFov(he),A(B),{n:Y,cnt:q,area:j}},window.__setMipMode=p=>{var P;(P=F==null?void 0:F.gs)==null||P.setMipMode(p)},window.__benchRender=async p=>{if(!F)throw new Error("nothing loaded");const P=d.createTexture({size:[K,Z],format:nt,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.COPY_SRC}),k=Math.ceil(K*4/256)*256,U=d.createBuffer({size:k*Z,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ});L.setRenderSize(K,Z),L.setFov(he),L.set_preset($[p]);const E=d.createCommandEncoder();F.render(E,P.createView(),K,Z),E.copyTextureToBuffer({texture:P},{buffer:U,bytesPerRow:k,rowsPerImage:Z},[K,Z,1]),d.queue.submit([E.finish()]),await U.mapAsync(GPUMapMode.READ);const z=new Uint8Array(U.getMappedRange()),N=new Uint8Array(K*Z*4);for(let C=0;C<Z;C++)N.set(z.subarray(C*k,C*k+K*4),C*K*4);U.unmap(),U.destroy(),P.destroy(),L.clearRenderSize(),L.setFov(he),A(B);let Y="";for(let C=0;C<N.length;C+=32768)Y+=String.fromCharCode(...N.subarray(C,C+32768));return{w:K,h:Z,b64:btoa(Y)}};async function a(p,P,k){const U=d.createTexture({size:[K,Z],format:nt,usage:GPUTextureUsage.RENDER_ATTACHMENT}),E=U.createView();L.setRenderSize(K,Z),L.setFov(he);let z=0;const N=async q=>{const j=performance.now();for(let ce=0;ce<q;ce++){L.set_preset($[z++%$.length]);const X=d.createCommandEncoder();p.render(X,E,K,Z),d.queue.submit([X.finish()])}return await d.queue.onSubmittedWorkDone(),performance.now()-j};let Y=1;const C=(q,j)=>{Y=Math.max(1,Math.min(60,Math.round(j*250/Math.max(q,1))))},H=`${p.def.label} · round ${P+1}`;t=!1;try{let q=0,j=0;for(;q<k.warmupS*1e3||j<3;){const xe=Y,ve=await N(xe);q+=ve,j+=xe,C(ve,xe),te(`${H}: warmup ${(q/1e3).toFixed(1)}/${k.warmupS} s`),await ft()}let ce=0,X=0;const ue=[];for(;(ce<k.measureS*1e3||X<k.minFrames)&&ce<k.maxS*1e3;){const xe=Y,ve=await N(xe);ce+=ve,X+=xe,ue.push(+(ve/xe).toFixed(3)),C(ve,xe),te(`${H}: ${(1e3*X/ce).toFixed(1)} FPS · ${X} frames · ${(ce/1e3).toFixed(1)} s`),await ft()}return{round:P,frames:X,ms:ce,fps:1e3*X/ce,chunkMsPerFrame:ue,interrupted:t}}finally{U.destroy(),L.clearRenderSize(),L.setFov(he),A(B)}}let f=null,g=Ke;function x(p,P){var N;const k=((N=g.find(Y=>(Y.base??Y.id)==="bitymi"))==null?void 0:N.id)??"bitymi",U=p.get(k),E=U&&U.length?U.reduce((Y,C)=>Y+C.frames,0)/U.reduce((Y,C)=>Y+C.ms,0)*1e3:0,z=g.filter(Y=>p.has(Y.id)).map(Y=>{const C=p.get(Y.id),H=C.length?C.reduce((j,ce)=>j+ce.frames,0)/C.reduce((j,ce)=>j+ce.ms,0)*1e3:0,q=P.get(Y.id);return`<tr><td>${Y.label}</td><td>${q?q.prims.toLocaleString():""}</td><td>${q?(q.bytes/2**20).toFixed(0):""}</td><td>${C.map(j=>j.fps.toFixed(1)+(j.interrupted?"⚠":"")).join(" / ")}</td><td><b>${H?H.toFixed(1):""}</b></td><td>${H?(1e3/H).toFixed(1):""}</td><td>${E&&H&&!Y.id.startsWith("bitymi")?(E/H).toFixed(1)+"×":""}</td></tr>`}).join("");R("results").innerHTML=`<table><tr><th>method</th><th>prims</th><th>MB</th><th>FPS per round</th><th>FPS</th><th>ms</th><th>ours ×</th></tr>${z}</table>`}async function y(){var C,H;if(h||de)return;h=!0;const p=c(),P=R("benchall");P.disabled=!0,D.disabled=!0;let k=null;try{k=await((C=navigator.wakeLock)==null?void 0:C.request("screen"))}catch{}const U=(H=w.get("only"))==null?void 0:H.split(",").map(q=>q.trim()).filter(Boolean);let E=U!=null&&U.length?Ke.filter(q=>U.includes(q.id)):Ke.filter(q=>(p.frozen||q.id!=="mobilegs_frozen")&&(p.diag||!q.id.startsWith("bitymi_")));w.get("combos")==="1"&&(E=E.flatMap(q=>q.asset.startsWith("bitymi")?[[!0,!1],[!1,!1],[!0,!0],[!1,!0]].map(([j,ce])=>({...q,base:q.id,byid:j,legacy:ce,id:`${q.id}@${j?"byid":"vary"}${ce?"+legacy":""}`,label:`${q.label} · ${j?"byid":"varyings"}${ce?" · legacy":""}`})):[q])),g=E;const z=new Map,N=new Map,Y=new Date().toISOString();try{let q=!0;for(let j=0;j<p.rounds;j++){const ce=j%2===0?E:[...E].reverse();for(const X of ce){const ue=await ke(X);if(N.set(X.id,{prims:ue.prims,bytes:ue.downloadBytes,detail:ue.detail}),!q&&p.cooldownS>0)for(let ve=p.cooldownS;ve>0;ve--)te(`cooldown ${ve} s (next: ${X.label})`),await ws(1e3);q=!1;const xe=await a(ue,j,p);z.has(X.id)||z.set(X.id,[]),z.get(X.id).push(xe),x(z,N)}}f={kind:"bitymi-mobile-bench",version:1,scene:S,started:Y,finished:new Date().toISOString(),userAgent:navigator.userAgent,devicePixelRatio,adapter:{vendor:ne.vendor,architecture:ne.architecture,device:ne.device,description:ne.description},features:{bc:G,astc:O,float32Blendable:J,timestampQuery:d.features.has("timestamp-query")},resolution:[K,Z],fovY:he,cameras:$.length,assets:M,bitymiUrl:W,bitymiVariant:{fetchById:ae,legacy:oe},protocol:{...p,order:E.map(j=>j.id),mirrored:!0,timing:"performance.now around chunked submits fenced by onSubmittedWorkDone, offscreen rgba8unorm"},methods:E.map(j=>({id:j.id,base:j.base,byid:j.byid,legacy:j.legacy,label:j.label,note:j.note,...N.get(j.id),fps:(()=>{const ce=z.get(j.id)??[],X=ce.reduce((ue,xe)=>ue+xe.ms,0);return X?1e3*ce.reduce((ue,xe)=>ue+xe.frames,0)/X:null})(),rounds:z.get(j.id)??[]}))},te(`done · ${E.length} methods × ${p.rounds} rounds`),R("summary").value=e(f),R("export").style.display=""}catch(q){te(`bench failed: ${q}`),console.error(q)}finally{try{await(k==null?void 0:k.release())}catch{}P.disabled=!1,D.disabled=!1,h=!1,D.value=(F==null?void 0:F.def.id)??"bitymi"}}function e(p){var Y,C,H;const P=p.methods.find(q=>(q.base??q.id)==="bitymi"),k=P==null?void 0:P.fps,U=[p.adapter.vendor,p.adapter.architecture,p.adapter.device||p.adapter.description].filter(Boolean).join(" ")||"unknown GPU",E=(((Y=p.userAgent.match(/\(([^)]*)\)/))==null?void 0:Y[1])??"")+" "+(((C=p.userAgent.match(/(Chrome|Firefox|Safari)\/[\d.]+/))==null?void 0:C[0])??""),z=p.protocol;return[`**${p.scene} render benchmark** · ${U} · ${E.trim()}`,`${p.resolution[0]}×${p.resolution[1]}, ${p.cameras} test views · ${z.rounds} rounds mirrored · warmup ${z.warmupS} s · measure ≥${z.measureS} s / ${z.minFrames} frames · cooldown ${z.cooldownS} s`,"","| method | primitives | download (MB) | FPS per round | FPS | ms/frame | BITYMI speed-up |","|---|---:|---:|---|---:|---:|---:|",...p.methods.map(q=>{var j;return`| ${q.label} | ${((j=q.prims)==null?void 0:j.toLocaleString())??""} | ${q.bytes?(q.bytes/2**20).toFixed(0):""} | ${q.rounds.map(ce=>ce.fps.toFixed(1)+(ce.interrupted?" (tab hidden)":"")).join(" / ")} | ${q.fps?q.fps.toFixed(1):""} | ${q.fps?(1e3/q.fps).toFixed(1):""} | ${!q.id.startsWith("bitymi")&&k&&q.fps?(k/q.fps).toFixed(2)+"×":""} |`}),"",`BITYMI: ${(P==null?void 0:P.detail)??((H=p.methods.find(q=>q.id.startsWith("bitymi")))==null?void 0:H.detail)??""}. Mobile-GS blend target: ${p.features.float32Blendable?"rgba32float":"rgba16float (float32-blendable unavailable)"}; frozen-MLP row = MLP evaluated once, i.e. raster cost only.`].join(`
`)}async function u(){var q,j,ce;if(h||de)return;h=!0;const p=R("abrun");p.disabled=!0,R("benchall").disabled=!0,D.disabled=!0;const P=Number(w.get("slice")??3),k=Number(w.get("cycles")??10),U=w.get("combos")==="1",E=[{id:"stock",label:"BITYMI (no mips)",atlas:!0,mips:!1,bias:1},{id:"noatlas",label:"BITYMI (atlas off)",atlas:!1,mips:!1,bias:1},{id:"mip0",label:"BITYMI (mips, bias 0)",atlas:!0,mips:!0,bias:0},{id:"mip1",label:"BITYMI (mips, bias 1)",atlas:!0,mips:!0,bias:1}],z=U?E.flatMap(X=>[[!0,!1],[!1,!1],[!0,!0],[!1,!0]].map(([ue,xe])=>({...X,byid:ue,legacy:xe,id:`${X.id}@${ue?"byid":"vary"}${xe?"+legacy":""}`,label:`${X.label} · ${ue?"byid":"varyings"}${xe?" · legacy":""}`}))):E.map(X=>({...X,byid:ae,legacy:oe}));let N=null;try{N=await((q=navigator.wakeLock)==null?void 0:q.request("screen"))}catch{}const Y=new Date().toISOString(),C=d.createTexture({size:[K,Z],format:nt,usage:GPUTextureUsage.RENDER_ATTACHMENT}),H=C.createView();try{const X=await ke(Ke.find(fe=>fe.id==="bitymi_mip1")),ue=X.gs,xe=fe=>{ue.setFetchById(fe.byid),ue.setLegacyRenderer(fe.legacy),ue.setMipLodBias(fe.bias),ue.setMipMode(fe.mips),ue.setAtlasEnabled(fe.atlas)};L.setRenderSize(K,Z),L.setFov(he);let ve=0;const Ee=async fe=>{const Ge=performance.now();for(let Ae=0;Ae<fe;Ae++){L.set_preset($[ve++%$.length]);const Pe=d.createCommandEncoder();X.render(Pe,H,K,Z),d.queue.submit([Pe.finish()])}return await d.queue.onSubmittedWorkDone(),performance.now()-Ge};for(const fe of z)xe(fe),te(`A/B warmup: ${fe.label}`),await ft(),await Ee(10);const De={};for(const fe of z)De[fe.id]=[];for(let fe=0;fe<k;fe++){const Ge=z.map((Ae,Pe)=>z[(Pe+fe)%z.length]);for(const Ae of Ge){xe(Ae),await Ee(3);let Pe=0,He=0,je=4;for(;Pe<P*1e3;){const Ye=await Ee(je);Pe+=Ye,He+=je,je=Math.max(1,Math.min(60,Math.round(je*250/Math.max(Ye,1))))}De[Ae.id].push(1e3*He/Pe),te(`A/B cycle ${fe+1}/${k} · ${Ae.label}: ${(1e3*He/Pe).toFixed(1)} FPS`),await ft()}}const Ie=z[0].id,Me=z.map(fe=>{const Ge=De[fe.id],Ae=Ge.reduce((Le,Fe)=>Le+Fe,0)/Ge.length,Pe=Ge.map((Le,Fe)=>Le/De[Ie][Fe]),He=Pe.reduce((Le,Fe)=>Le+Fe,0)/Pe.length,je=Math.sqrt(Pe.reduce((Le,Fe)=>Le+(Fe-He)**2,0)/Math.max(1,Pe.length-1)/Pe.length),Ye=Math.sqrt(Ge.reduce((Le,Fe)=>Le+(Fe-Ae)**2,0)/Math.max(1,Ge.length-1));return{...fe,fps:Ae,fpsSd:Ye,ratio:He,ratioSe:je,perCycle:Ge.map(Le=>+Le.toFixed(2))}}),Ue=[ne.vendor,ne.architecture,ne.device||ne.description].filter(Boolean).join(" ")||"unknown GPU",Re=(((j=navigator.userAgent.match(/\(([^)]*)\)/))==null?void 0:j[1])??"")+" "+(((ce=navigator.userAgent.match(/(Chrome|Firefox|Safari)\/[\d.]+/))==null?void 0:ce[0])??""),Oe=[`**${S} interleaved A/B (BITYMI variants)** · ${Ue} · ${Re.trim()}`,`${K}×${Z}, ${$.length} test views · ${k} cycles × ${z.length} variants × ${P} s slices, rotating order · ratio = paired per-cycle FPS / stock ± s.e.`,"","| variant | FPS (mean ± sd over cycles) | ms/frame | vs stock (paired) |","|---|---:|---:|---:|",...Me.map(fe=>`| ${fe.label} | ${fe.fps.toFixed(1)} ± ${fe.fpsSd.toFixed(1)} | ${(1e3/fe.fps).toFixed(2)} | ${fe.id===Ie?"1.00":`${fe.ratio.toFixed(3)} ± ${fe.ratioSe.toFixed(3)}`} |`),"",`bundle: ${ye.split("/").pop()} (mips off = the stock atlas: level 0 is identical) · ${X.detail}`].join(`
`);f={kind:"bitymi-interleaved-ab",version:1,scene:S,started:Y,finished:new Date().toISOString(),userAgent:navigator.userAgent,adapter:{vendor:ne.vendor,architecture:ne.architecture,device:ne.device,description:ne.description},resolution:[K,Z],slice_s:P,cycles:k,variants:Me},R("summary").value=Oe,R("results").innerHTML="<table><tr><th>variant</th><th>FPS</th><th>vs stock</th></tr>"+Me.map(fe=>`<tr><td>${fe.label}</td><td>${fe.fps.toFixed(1)} ± ${fe.fpsSd.toFixed(1)}</td><td>${fe.id===Ie?"1.00":`${fe.ratio.toFixed(3)} ± ${fe.ratioSe.toFixed(3)}`}</td></tr>`).join("")+"</table>",R("export").style.display="",te(`A/B done · ${k} cycles × ${z.length} variants`),window.__abText=Oe}catch(X){te(`A/B failed: ${X}`),console.error(X)}finally{C.destroy(),L.clearRenderSize(),L.setFov(he),A(B);try{await(N==null?void 0:N.release())}catch{}p.disabled=!1,R("benchall").disabled=!1,D.disabled=!1,h=!1}}R("abrun").onclick=()=>u();const i=async(p,P)=>{try{await navigator.clipboard.writeText(p)}catch{const k=R("summary");k.value=p,k.select(),document.execCommand("copy")}te(`${P} copied`)};R("benchall").onclick=()=>y(),R("copytable").onclick=()=>{f&&i(f.kind==="bitymi-interleaved-ab"?window.__abText:e(f),"table")},R("copy").onclick=()=>{f&&i(JSON.stringify(f,null,1),"JSON")},R("download").onclick=()=>{if(!f)return;const p=document.createElement("a");p.href=URL.createObjectURL(new Blob([JSON.stringify(f,null,1)],{type:"application/json"})),p.download=`bench_${S}_${(ne.vendor||"gpu").replace(/\W+/g,"_")}_${Date.now()}.json`,p.click()};const o=()=>{r.width=Math.max(1,Math.round(r.clientWidth)),r.height=Math.max(1,Math.round(r.clientHeight)),L.on_update_canvas()};new ResizeObserver(o).observe(r),o();let s=performance.now(),l=0,m=Promise.resolve();async function _(){const p=performance.now(),P=Math.min(.1,(p-s)/1e3);if(s=p,!h&&F&&!de){ee.update(P),await m;const k=F;if(!k||h||de){requestAnimationFrame(_);return}const U=performance.now(),E=d.createCommandEncoder();k.render(E,n.getCurrentTexture().createView(),r.width,r.height),d.queue.submit([E.finish()]),m=d.queue.onSubmittedWorkDone().then(()=>{const z=performance.now()-U;l=l?.9*l+.1*z:z,R("live").textContent=`${(1e3/l).toFixed(0)} FPS live (${r.width}×${r.height}, vsync-capped)`})}requestAnimationFrame(_)}requestAnimationFrame(_),pe.style.display="",D.value="bitymi",de=!0;try{await ke(Ke[0])}catch(p){te(`load failed: ${p}`),console.error(p)}finally{de=!1}}(async()=>{const r=w=>{document.body.insertAdjacentHTML("afterbegin",`<p style="color:#fff;padding:16px;font:15px sans-serif">${w}</p>`)};if(navigator.gpu===void 0)return r("WebGPU is not supported in this browser.");const n=await navigator.gpu.requestAdapter({powerPreference:"high-performance"});if(n===null)return r("No WebGPU adapter available.");const d=[];for(const w of["timestamp-query","texture-compression-bc","texture-compression-astc","float32-blendable"])n.features.has(w)&&d.push(w);if(n.limits.maxStorageBuffersPerShaderStage<10)return r(`This GPU exposes ${n.limits.maxStorageBuffersPerShaderStage} storage buffers per stage; the renderers need 10.`);const v=await n.requestDevice({requiredFeatures:d,requiredLimits:{maxStorageBuffersPerShaderStage:10,maxComputeWorkgroupStorageSize:n.limits.maxComputeWorkgroupStorageSize,maxBufferSize:n.limits.maxBufferSize,maxStorageBufferBindingSize:n.limits.maxStorageBufferBindingSize}});v.lost.then(w=>r(`GPU device lost: ${w.message}`)),v.addEventListener("uncapturederror",w=>{var S;return console.error("[bench] WebGPU error:",((S=w.error)==null?void 0:S.message)??w.error)});const b=document.querySelector("#webgpu-canvas");await Ss(b,b.getContext("webgpu"),v,n,d)})();
