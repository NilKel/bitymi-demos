...
`,Fl=`// 2DGS render — vertex+fragment.
...
`),q="data:text/csv;charset=utf-8,"+encodeURIComponent(ut+G),U=document.createElement("a");U.href=q,U.download=`${this.downloadOnceFileName}.csv`,document.body.appendChild(U),U.click(),U.remove()}if(this.showPerfDialogNext){this.showPerfDialogNext=!1;try{alert(j)}catch{console.warn("Unable to show dialog; metrics printed to console.")}}this.resultBuffer.unmap()}_setupTimestampQueries(){this.querySet=this.device.createQuerySet({type:"timestamp",count:this.totalQueryCount});const c=this.totalQueryCount*8;this.resolveBuffer=this.device.createBuffer({size:c,usage:GPUBufferUsage.QUERY_RESOLVE|GPUBufferUsage.COPY_SRC}),this.resultBuffer=this.device.createBuffer({size:c,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ})}_setupBuffers(){this.render_settings_buffer=this.device.createBuffer({label:"render settings",size:Xl,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});const c=document.querySelector("canvas"),_=c?c.width:1,C=c?c.height:1;Hl({width:_,height:C,sh_bias:this.pc.sh_bias,color_K:this.pc.K,feature_mode:this.pc.feature_mode}),Qi(this.device,this.render_settings_buffer),this.splat_2d_buffer=this.device.createBuffer({label:"splats_2d (Splat2DGS)",size:Qe(this.pc.num_points*Jl),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST}),this.draw_indirect_buffer=this.device.createBuffer({label:"draw indirect",size:4*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC|GPUBufferUsage.INDIRECT}),this.device.queue.writeBuffer(this.draw_indirect_buffer,0,new Uint32Array([4,0,0,0])),this.sh_solvers_buffer=this.device.createBuffer({label:"sh_solvers",size:Qe(this.pc.num_points*tc),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST})}requestPerfDialog(){this.showPerfDialogNext=!0}requestDownloadMetrics(c){if(c&&c.trim().length>0){const _=c.trim().replace(/[^a-zA-Z0-9_\-]/g,"_");this.downloadOnceFileName=_.length>0?_:this.downloadOnceFileName}else{const _=new Date,C=`${_.getFullYear()}${String(_.getMonth()+1).padStart(2,"0")}${String(_.getDate()).padStart(2,"0")}_${String(_.getHours()).padStart(2,"0")}${String(_.getMinutes()).padStart(2,"0")}${String(_.getSeconds()).padStart(2,"0")}`;this.downloadOnceFileName=`fps_metrics_${C}`}this.downloadOnceNextRead=!0}requestReorder(){}async maybeReorderAfterSubmit(){}}function ac(o,c){return 2*Math.atan(c/(2*o))}function lc(o,c,_,C){const y=Math.tan(C/2),E=Math.tan(_/2),M=y*o,R=-M,A=E*o,z=-A,W=ee.create();return W[0]=2*o/(A-z),W[5]=-2*o/(M-R),W[2]=(A+z)/(A-z),W[6]=(M+R)/(M-R),W[14]=1,W[10]=c/(c-o),W[11]=-(c*o)/(c-o),ee.transpose(W,W),W}async function cc(o){ie(`loading scene camera file... : ${o}`);const _=await(await fetch(o)).json();return ie(`loaded cameras count: ${_.length}`),_.map(C=>{const y=I.clone(C.position),E=he.create(...C.rotation.flat()),M=E[0],R=E[4],A=E[8],z=E[1],W=E[5],N=E[9],L=E[2],Q=E[6],et=E[10];M*(W*et-N*Q)-R*(z*et-N*L)+A*(z*Q-W*L)<0&&(E[1]=-E[1],E[5]=-E[5],E[9]=-E[9]);const j=ee.fromMat3(E);return{position:y,rotation:j,img_name:C.img_name,id:C.id}})}const uc=4*2,dc=4*16,tr=4*dc+2*uc;function pc(o){return o.createBuffer({label:"camera uniform",size:tr,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}const Ge=new Float32Array(tr/Float32Array.BYTES_PER_ELEMENT),Dn=class Dn{constructor(c,_){J(this,"uniform_buffer");J(this,"position",I.create());J(this,"rotation",ee.create());J(this,"fovY",45/180*Math.PI);J(this,"fovX");J(this,"focal",Ri.create());J(this,"viewport",Ri.create());J(this,"view_matrix",ee.identity());J(this,"view_inv_matrix",ee.identity());J(this,"proj_matrix",ee.identity());J(this,"proj_inv_matrix",ee.identity());J(this,"_negPos",I.create());J(this,"look",I.create(0,0,1));J(this,"up",I.create(0,1,0));J(this,"right",I.create(1,0,0));this.canvas=c,this.device=_,this.uniform_buffer=pc(_),this.on_update_canvas()}on_update_canvas(){const c=.5*this.canvas.height/Math.tan(this.fovY*.5);this.focal[0]=c,this.focal[1]=c,this.fovX=ac(c,this.canvas.width),this.viewport[0]=this.canvas.width,this.viewport[1]=this.canvas.height,this.proj_matrix=lc(.01,100,this.fovX,this.fovY),ee.inverse(this.proj_matrix,this.proj_inv_matrix),this.update_buffer()}update_buffer(){this._negPos[0]=-this.position[0],this._negPos[1]=-this.position[1],this._negPos[2]=-this.position[2],ee.copy(this.rotation,this.view_matrix),ee.translate(this.view_matrix,this._negPos,this.view_matrix),ee.inverse(this.view_matrix,this.view_inv_matrix),I.transformMat4Upper3x3(Dn.Z_AXIS,this.view_inv_matrix,this.look),I.normalize(this.look,this.look),I.cross(this.up,this.look,this.right),I.normalize(this.right,this.right);let c=0;Ge.set(this.view_matrix,c),c+=16,Ge.set(this.view_inv_matrix,c),c+=16,Ge.set(this.proj_matrix,c),c+=16,Ge.set(this.proj_inv_matrix,c),c+=16,Ge.set(this.viewport,c),c+=2,Ge.set(this.focal,c),c+=2,this.device.queue.writeBuffer(this.uniform_buffer,0,Ge)}set_preset(c){I.copy(c.position,this.position),ee.copy(c.rotation,this.rotation),this.update_buffer()}setFov(c){this.fovY=c,this.on_update_canvas()}getFov(){return this.fovY}};J(Dn,"Z_AXIS",I.create(0,0,1));let ds=Dn;const hc=I.create(1,0,0),fc=I.create(0,1,0);function _c(o,c){const _=o[0],C=o[4],y=o[8],E=o[1],M=o[5],R=o[9],A=o[2],z=o[6],W=o[10],N=_+M+W;let L,Q,et,H;if(N>0){const j=.5/Math.sqrt(N+1);L=.25/j,Q=(z-R)*j,et=(y-A)*j,H=(E-C)*j}else if(_>M&&_>W){const j=2*Math.sqrt(1+_-M-W);L=(z-R)/j,Q=.25*j,et=(C+E)/j,H=(y+A)/j}else if(M>W){const j=2*Math.sqrt(1+M-_-W);L=(y-A)/j,Q=(C+E)/j,et=.25*j,H=(R+z)/j}else{const j=2*Math.sqrt(1+W-_-M);L=(E-C)/j,Q=(y+A)/j,et=(R+z)/j,H=.25*j}return c[0]=Q,c[1]=et,c[2]=H,c[3]=L,c}class mc{constructor(c){J(this,"element");J(this,"enabled",!0);J(this,"center",I.create(0,0,0));J(this,"up",I.create(0,1,0));J(this,"rotation",[0,0]);J(this,"shift",[0,0]);J(this,"scroll",0);J(this,"speed",.1);J(this,"sensitivity",.08);J(this,"leftPressed",!1);J(this,"rightPressed",!1);J(this,"leftDragPans",!1);J(this,"lastX",0);J(this,"lastY",0);J(this,"touches",new Map);J(this,"lastTouchCenter",null);J(this,"lastPinchDistance",null);J(this,"lastTwoFingerAngle",null);J(this,"lastTouchCount",0);J(this,"roll",0);J(this,"_dir",I.create());J(this,"_right",I.create());J(this,"_upCam",I.create());J(this,"_scratch",I.create());J(this,"_qY",se.create());J(this,"_qX",se.create());J(this,"_qRot",se.create());J(this,"_qLocal",se.create());J(this,"_qWorldToCam",se.create());J(this,"_scratchMat3",he.create());J(this,"bboxMin",null);J(this,"bboxMax",null);J(this,"anchor",I.create(0,0,0));J(this,"downCallback",c=>{var _,C,y,E;if(this.enabled){if(c.pointerType==="touch"){this.touches.set(c.pointerId,{x:c.pageX,y:c.pageY}),this.handleTouchGestures(),(C=(_=c.target)==null?void 0:_.setPointerCapture)==null||C.call(_,c.pointerId),c.preventDefault();return}c.isPrimary&&(c.button===0?(this.leftPressed=!0,this.leftDragPans=c.shiftKey):c.button===2?this.rightPressed=!0:this.rightPressed=!0,this.lastX=c.pageX,this.lastY=c.pageY,(E=(y=c.target)==null?void 0:y.setPointerCapture)==null||E.call(y,c.pointerId),c.preventDefault())}});J(this,"moveCallback",c=>{if(!this.enabled)return;if(c.pointerType==="touch"){if(!this.touches.has(c.pointerId))return;this.touches.set(c.pointerId,{x:c.pageX,y:c.pageY}),this.handleTouchGestures(),c.preventDefault();return}if(!c.isPrimary||!this.leftPressed&&!this.rightPressed)return;c.preventDefault();const _=c.pageX-this.lastX,C=c.pageY-this.lastY;this.lastX=c.pageX,this.lastY=c.pageY,this.leftPressed&&!this.leftDragPans?(this.rotation[0]+=_,this.rotation[1]-=C):(this.rightPressed||this.leftPressed&&this.leftDragPans)&&(this.shift[1]-=_,this.shift[0]+=C)});J(this,"upCallback",c=>{var _,C,y,E;if(c.pointerType==="touch"){this.touches.delete(c.pointerId),this.handleTouchGestures(),(C=(_=c.target)==null?void 0:_.releasePointerCapture)==null||C.call(_,c.pointerId),c.preventDefault();return}c.button===0?this.leftPressed=!1:c.button===2?this.rightPressed=!1:this.rightPressed=!1,(E=(y=c.target)==null?void 0:y.releasePointerCapture)==null||E.call(y,c.pointerId),c.preventDefault()});J(this,"wheelCallback",c=>{if(!this.enabled||(c.preventDefault(),this.rightPressed))return;let _=c.deltaY;c.deltaMode===1?_*=16:c.deltaMode===2&&(_*=100),this.scroll+=_*.01});this.camera=c,this.registerElement(c.canvas)}registerElement(c){this.element&&this.element!==c&&(this.element.removeEventListener("pointerdown",this.downCallback),this.element.removeEventListener("pointermove",this.moveCallback),this.element.removeEventListener("pointerup",this.upCallback),this.element.removeEventListener("wheel",this.wheelCallback)),this.element=c,this.element.addEventListener("pointerdown",this.downCallback),this.element.addEventListener("pointermove",this.moveCallback),this.element.addEventListener("pointerup",this.upCallback),this.element.addEventListener("wheel",this.wheelCallback,{passive:!1}),this.element.addEventListener("contextmenu",_=>_.preventDefault())}setCenter(c){I.copy(c,this.center),I.copy(c,this.anchor)}setOrbitPivot(c){I.set(c[0],c[1],c[2],this.center),this._reorientCameraToCenter()}setOrbitDepth(c){if(!isFinite(c)||c<.001)return;const _=this.camera.rotation;I.set(_[2],_[6],_[10],this._dir),I.normalize(this._dir,this._dir),I.scale(this._dir,c,this._dir),I.add(this.camera.position,this._dir,this.center)}_reorientCameraToCenter(){const c=this.camera;if(I.subtract(this.center,c.position,this._scratch),I.length(this._scratch)<1e-6)return;I.normalize(this._scratch,this._scratch),I.cross(this.up,this._scratch,this._right),I.length(this._right)<1e-6&&I.set(1,0,0,this._right),I.normalize(this._right,this._right),I.cross(this._scratch,this._right,this._upCam),I.normalize(this._upCam,this._upCam);const _=c.rotation;_[0]=this._right[0],_[1]=this._upCam[0],_[2]=this._scratch[0],_[3]=0,_[4]=this._right[1],_[5]=this._upCam[1],_[6]=this._scratch[1],_[7]=0,_[8]=this._right[2],_[9]=this._upCam[2],_[10]=this._scratch[2],_[11]=0,_[12]=0,_[13]=0,_[14]=0,_[15]=1,c.update_buffer()}setBbox(c,_){this.bboxMin=I.create(c[0],c[1],c[2]),this.bboxMax=I.create(_[0],_[1],_[2]);const C=(c[0]+_[0])*.5,y=(c[1]+_[1])*.5,E=(c[2]+_[2])*.5;I.set(C,y,E,this.center),I.set(C,y,E,this.anchor)}resetToCamera(){const c=this.camera.rotation;I.set(c[2],c[6],c[10],this._dir),I.normalize(this._dir,this._dir);let _=null;if(this.bboxMin&&this.bboxMax){let C=-1/0,y=1/0,E=!1;for(let M=0;M<3;M++){const R=this._dir[M],A=this.bboxMin[M]-this.camera.position[M],z=this.bboxMax[M]-this.camera.position[M];if(Math.abs(R)>1e-8){const W=A/R,N=z/R;C=Math.max(C,Math.min(W,N)),y=Math.min(y,Math.max(W,N))}else if(A>0||z<0){E=!0;break}}!E&&C<=y&&y>0&&(_=(Math.max(C,0)+y)*.5)}if(_===null||!isFinite(_)||_<.001){I.subtract(this.anchor,this.camera.position,this._scratch);const C=I.dot(this._scratch,this._dir);_=C>.001?C:I.length(this._scratch)}_=Math.max(.1,_),I.scale(this._dir,_,this._dir),I.add(this.camera.position,this._dir,this.center)}handleTouchGestures(){const c=this.touches.size;if(c!==this.lastTouchCount&&(this.lastTouchCenter=null,this.lastPinchDistance=null,this.lastTwoFingerAngle=null),this.lastTouchCount=c,c===1){const _=this.touches.values().next().value;if(this.lastTouchCenter){const C=_.x-this.lastTouchCenter[0],y=_.y-this.lastTouchCenter[1];this.rotation[0]+=C*.3,this.rotation[1]-=y*.3}this.lastTouchCenter=[_.x,_.y]}else if(c===2){const _=Array.from(this.touches.values()),C=(_[0].x+_[1].x)*.5,y=(_[0].y+_[1].y)*.5,E=_[1].x-_[0].x,M=_[1].y-_[0].y,R=Math.hypot(E,M),A=Math.atan2(M,E);if(this.lastTouchCenter!==null&&this.lastPinchDistance!==null&&this.lastTwoFingerAngle!==null){const z=C-this.lastTouchCenter[0],W=y-this.lastTouchCenter[1],N=Math.hypot(z,W),L=Math.abs(R-this.lastPinchDistance);let Q=A-this.lastTwoFingerAngle;Q>Math.PI&&(Q-=2*Math.PI),Q<-Math.PI&&(Q+=2*Math.PI),N>.5&&(this.shift[1]-=z,this.shift[0]+=W),L>1&&this.lastPinchDistance>.001&&(this.scroll+=-Math.log(R/this.lastPinchDistance)*10),Math.abs(Q)>.0087&&(this.roll+=-Q)}this.lastTouchCenter=[C,y],this.lastPinchDistance=R,this.lastTwoFingerAngle=A}}update(c){if(!this.enabled||Math.abs(this.rotation[0])<1e-4&&Math.abs(this.rotation[1])<1e-4&&Math.abs(this.shift[0])<1e-4&&Math.abs(this.shift[1])<1e-4&&Math.abs(this.scroll)<1e-4&&Math.abs(this.roll)<1e-4)return;const _=this.camera;{const H=_.rotation;this.up[0]=H[1],this.up[1]=H[5],this.up[2]=H[9],I.length(this.up)>1e-6?I.normalize(this.up,this.up):I.set(0,1,0,this.up)}let C=!1;if(Math.abs(this.roll)>1e-4){const H=_.rotation;I.set(H[2],H[6],H[10],this._scratch),I.normalize(this._scratch,this._scratch),se.fromAxisAngle(this._scratch,this.roll,this._qRot),I.transformQuat(this.up,this._qRot,this.up),I.normalize(this.up,this.up),this.roll=0,C=!0}I.subtract(_.position,this.center,this._dir);let y=I.length(this._dir);y<1e-6&&(y=1e-6);const E=Math.exp(Math.log(y)+this.scroll*c*10*this.speed);I.scale(this._dir,E/y,this._dir),y=E;const M=_.rotation;this._right[0]=M[0],this._right[1]=M[4],this._right[2]=M[8],I.normalize(this._right,this._right),I.length(this._right)<1e-6&&I.set(1,0,0,this._right);const R=I.create(M[1],M[5],M[9]);I.normalize(R,R),I.length(R)<1e-6&&I.set(0,1,0,R);const A=c*this.speed*.1*y,z=this.shift[1]*A,W=-this.shift[0]*A;I.scale(this._right,z,this._scratch),I.add(this.center,this._scratch,this.center),I.add(_.position,this._scratch,_.position),I.scale(R,W,this._scratch),I.add(this.center,this._scratch,this.center),I.add(_.position,this._scratch,_.position);const N=this.rotation[0]*c*this.sensitivity,L=this.rotation[1]*c*this.sensitivity;if(Math.abs(N)>1e-5||Math.abs(L)>1e-5||C){const H=_.rotation;_c(H,this._qWorldToCam),se.fromAxisAngle(hc,-L,this._qX),se.fromAxisAngle(fc,-N,this._qY),se.multiply(this._qX,this._qY,this._qLocal),se.normalize(this._qLocal,this._qLocal),se.multiply(this._qLocal,this._qWorldToCam,this._qWorldToCam),se.normalize(this._qWorldToCam,this._qWorldToCam),he.fromQuat(this._qWorldToCam,this._scratchMat3),ee.fromMat3(this._scratchMat3,_.rotation);const j=_.rotation,ut=j[2],G=j[6],q=j[10];_.position[0]=this.center[0]-ut*y,_.position[1]=this.center[1]-G*y,_.position[2]=this.center[2]-q*y,this.up[0]=j[1],this.up[1]=j[5],this.up[2]=j[9],I.normalize(this.up,this.up)}else I.add(this.center,this._dir,_.position);_.update_buffer();const et=Math.pow(.8,c*60);this.rotation[0]*=et,Math.abs(this.rotation[0])<1e-4&&(this.rotation[0]=0),this.rotation[1]*=et,Math.abs(this.rotation[1])<1e-4&&(this.rotation[1]=0),this.shift[0]*=et,Math.abs(this.shift[0])<1e-4&&(this.shift[0]=0),this.shift[1]*=et,Math.abs(this.shift[1])<1e-4&&(this.shift[1]=0),this.scroll*=et,Math.abs(this.scroll)<1e-4&&(this.scroll=0)}}function er(o){const c=I.create();for(const _ of o)I.add(c,_,c);return I.scale(c,1/Math.max(o.length,1),c)}function nr(o,c){const _=he.create();he.inverse(o,_);const C=I.create();return C[0]=_[0]*c[0]+_[4]*c[1]+_[8]*c[2],C[1]=_[1]*c[0]+_[5]*c[1]+_[9]*c[2],C[2]=_[2]*c[0]+_[6]*c[1]+_[10]*c[2],C}function bc(o){const c=o.slice(),_=[1,0,0,0,1,0,0,0,1],C=(A,z)=>c[A*3+z],y=(A,z,W)=>{c[A*3+z]=W},E=(A,z)=>_[A*3+z],M=(A,z,W)=>{_[A*3+z]=W};for(let A=0;A<30;A++){let z=0,W=1,N=Math.abs(C(0,1));if(Math.abs(C(0,2))>N&&(z=0,W=2,N=Math.abs(C(0,2))),Math.abs(C(1,2))>N&&(z=1,W=2,N=Math.abs(C(1,2))),N<1e-12)break;const L=C(z,z),Q=C(W,W),et=C(z,W);let H;Math.abs(L-Q)<1e-30?H=Math.PI/4*Math.sign(et):H=.5*Math.atan2(2*et,L-Q);const j=Math.cos(H),ut=Math.sin(H);for(let G=0;G<3;G++){const q=C(G,z),U=C(G,W);y(G,z,j*q+ut*U),y(G,W,-ut*q+j*U)}for(let G=0;G<3;G++){const q=C(z,G),U=C(W,G);y(z,G,j*q+ut*U),y(W,G,-ut*q+j*U)}for(let G=0;G<3;G++){const q=E(G,z),U=E(G,W);M(G,z,j*q+ut*U),M(G,W,-ut*q+j*U)}}const R=[];for(let A=0;A<3;A++)R.push({val:C(A,A),vec:I.create(E(0,A),E(1,A),E(2,A))});return R.sort((A,z)=>z.val-A.val),{vals:[R[0].val,R[1].val,R[2].val],vecs:[R[0].vec,R[1].vec,R[2].vec]}}function vc(o,c){const _=er(o);let C=0,y=0,E=0,M=0,R=0,A=0;for(const et of o){const H=et[0]-_[0],j=et[1]-_[1],ut=et[2]-_[2];C+=H*H,y+=H*j,E+=H*ut,M+=j*j,R+=j*ut,A+=ut*ut}const z=[C,y,E,y,M,R,E,R,A],{vecs:W}=bc(z);let N=W[0],L=W[1],Q=W[2];return I.dot(Q,c)<0&&(I.scale(Q,-1,Q),I.scale(L,-1,L)),{centroid:_,normal:Q,u:N,v:L}}function gc(o){let c=0,_=0,C=0,y=0,E=0,M=0,R=0,A=0,z=0;for(const[j,ut]of o){const G=-2*j,q=-2*ut,U=1,ct=-(j*j+ut*ut);c+=G*G,_+=G*q,C+=G*U,y+=q*q,E+=q*U,M+=U*U,R+=G*ct,A+=q*ct,z+=U*ct}const W=he.create(c,_,C,_,y,E,C,E,M),N=nr(W,I.create(R,A,z)),L=N[0],Q=N[1],et=N[2],H=L*L+Q*Q-et;return{center:[L,Q],radius:Math.sqrt(Math.max(H,1e-12))}}function wc(o,c){let _=0,C=0,y=0,E=0,M=0,R=0,A=0,z=0,W=0;for(let L=0;L<o.length;L++){const Q=o[L],et=I.normalize(c[L],I.create()),H=1-et[0]*et[0],j=-et[0]*et[1],ut=-et[0]*et[2],G=1-et[1]*et[1],q=-et[1]*et[2],U=1-et[2]*et[2];_+=H,C+=j,y+=ut,E+=G,M+=q,R+=U,A+=H*Q[0]+j*Q[1]+ut*Q[2],z+=j*Q[0]+G*Q[1]+q*Q[2],W+=ut*Q[0]+q*Q[1]+U*Q[2]}const N=he.create(_,C,y,C,E,M,y,M,R);return nr(N,I.create(A,z,W))}function sr(o,c={}){if(o.length===0)return null;const _=c.tiltDownDeg??8,C=c.radiusScale??1,y=c.alignFirst??!0,E=(c.direction??"ccw")==="ccw"?1:-1,M=o.map(K=>I.clone(K.position)),R=o.map(K=>{const ot=K.rotation;return I.create(ot[8],ot[9],ot[10])}),A=o.map(K=>{const ot=K.rotation;return I.create(ot[4],ot[5],ot[6])}),z=er(A),W=I.normalize(I.scale(z,-1,I.create())),{centroid:N,normal:L,u:Q,v:et}=vc(M,W),H=M.map(K=>{const ot=I.sub(K,N,I.create());return[I.dot(ot,Q),I.dot(ot,et)]}),{center:j,radius:ut}=gc(H),G=ut*C,q=I.add(N,I.add(I.scale(Q,j[0],I.create()),I.scale(et,j[1],I.create()),I.create()),I.create()),U=wc(M,R),ct=G*Math.tan(_*Math.PI/180),$=I.sub(U,I.scale(L,ct,I.create()),I.create());let X=0;if(y){const K=I.sub(M[0],q,I.create());X=Math.atan2(I.dot(K,et),I.dot(K,Q))/(2*Math.PI)%1,X<0&&(X+=1)}return console.log(`[orbit] fit ${o.length} train cams: radius=${G.toFixed(2)}, tilt=${_}°, normal=[${L[0].toFixed(2)}, ${L[1].toFixed(2)}, ${L[2].toFixed(2)}], startPhase=${X.toFixed(3)}`),{center:q,radius:G,normal:L,u:Q,v:et,lookAt:$,startPhase:X,direction:E}}function ir(o,c){const _=(o.startPhase+c*o.direction)*2*Math.PI,C=Math.cos(_),y=Math.sin(_),E=I.add(o.center,I.add(I.scale(o.u,o.radius*C,I.create()),I.scale(o.v,o.radius*y,I.create()),I.create()),I.create()),M=I.normalize(I.sub(o.lookAt,E,I.create())),R=I.cross(M,o.normal,I.create());I.length(R)<1e-6&&I.copy(o.u,R),I.normalize(R,R);const A=I.cross(M,R,I.create());I.normalize(A,A);const z=ee.create();return z[0]=R[0],z[1]=A[0],z[2]=M[0],z[3]=0,z[4]=R[1],z[5]=A[1],z[6]=M[1],z[7]=0,z[8]=R[2],z[9]=A[2],z[10]=M[2],z[11]=0,z[12]=0,z[13]=0,z[14]=0,z[15]=1,{position:E,rotation:z,img_name:`orbit_${(c*1e3).toFixed(0)}`,id:0}}function xc(o,c={}){const _=sr(o,c);if(!_)return[];const C=c.numViews??120;return Array.from({length:C},(y,E)=>({...ir(_,E/C),img_name:`circle_${E.toString().padStart(4,"0")}`,id:E}))}const rr="BITYMI01",yc=0,Pc=1,Sc=2,kc=3,Cc=4,Ec=5;function Bn(o){const c=(o&32768)>>15,_=(o&31744)>>10,C=o&1023;return _===0?(c?-1:1)*Math.pow(2,-14)*(C/1024):_===31?C?NaN:c?-1/0:1/0:(c?-1:1)*Math.pow(2,_-15)*(1+C/1024)}function qi(o,c,_,C,y,E){const M=(o-_.width*.5)/C.focal[0],R=-((c-_.height*.5)/C.focal[1]),A=C.rotation,z=A[0],W=A[4],N=A[8],L=A[1],Q=A[5],et=A[9],H=A[2],j=A[6],ut=A[10];let G=M*z+R*L+H,q=M*W+R*Q+j,U=M*N+R*et+ut;const ct=Math.hypot(G,q,U)||1;G/=ct,q/=ct,U/=ct;const $=C.position[0],X=C.position[1],K=C.position[2],ot=E*.005,_t=ot*ot,Lt=new Uint32Array(y.buffer,y.byteOffset,y.length),Dt=y.length/8;let Tt=1/0,mt=0,St=0,kt=0,Z=-1;for(let nt=0;nt<Dt;nt++){const Rt=nt*8,gt=y[Rt+0]-$,qt=y[Rt+1]-X,Mt=y[Rt+2]-K,Gt=gt*G+qt*q+Mt*U;if(Gt<=0)continue;const dt=gt-Gt*G,Ct=qt-Gt*q,$t=Mt-Gt*U;if(dt*dt+Ct*Ct+$t*$t>=_t||!(Lt[Rt+7]>>>16&1))continue;const b=Lt[Rt+5],r=Lt[Rt+6],h=Bn(b&65535),d=Bn(b>>>16&65535),v=Bn(r&65535),x=Bn(r>>>16&65535),k=Math.hypot(h,d,v,x)||1,S=h/k,i=d/k,m=v/k,u=x/k,p=2*(i*u+S*m),a=2*(m*u-S*i),f=1-2*(i*i+m*m),w=G*p+q*a+U*f;let g;Math.abs(w)>1e-6?(g=(gt*p+qt*a+Mt*f)/w,(!isFinite(g)||g<=0)&&(g=Gt)):g=Gt,g<Tt&&(Tt=g,mt=$+g*G,St=X+g*q,kt=K+g*U,Z=nt)}return Z<0?null:[mt,St,kt]}function or(o){const c=new Uint8Array(o),_=new TextDecoder().decode(c.subarray(0,8));if(_!==rr)throw new Error(`Not a BITYMI bundle (bad magic '${_}')`);const C=new DataView(o),y=C.getUint32(8,!0),E=12,M=20;let R=null,A=null,z=null;for(let W=0;W<y;W++){const N=E+W*M,L=C.getUint32(N+0,!0),Q=Number(C.getBigUint64(N+4,!0)),et=Number(C.getBigUint64(N+12,!0)),H=c.slice(Q,Q+et).buffer;L===yc||L===Pc||L===Ec?R=H:L===Sc?A=H:(L===kc||L===Cc)&&(z=H)}if(R===null)throw new Error("BITYMI bundle has no point cloud chunk");return{pcBuffer:R,camerasBuffer:A,atlasBuffer:z}}async function Mc(o,c){var M;const _=await fetch(o);if(!_.ok)throw new Error(`fetch failed: ${_.status} ${_.statusText}`);const C=(()=>{const R=_.headers.get("content-length");return R&&parseInt(R,10)||void 0})(),y=(M=_.body)==null?void 0:M.getReader();let E;if(!y)E=await _.arrayBuffer(),c&&c(E.byteLength,C,0);else{const R=[];let A=0,z=performance.now(),W=0;for(;;){const{done:Q,value:et}=await y.read();if(Q)break;R.push(et),A+=et.byteLength;const H=performance.now();if(H-z>=150&&c){const j=(A-W)/((H-z)/1e3);c(A,C,j),z=H,W=A}}const N=new Uint8Array(A);let L=0;for(const Q of R)N.set(Q,L),L+=Q.byteLength;E=N.buffer,c&&c(A,C,0)}return E.byteLength>=8&&new TextDecoder().decode(new Uint8Array(E,0,8))===rr?{bundle:or(E),rawPly:null}:{bundle:null,rawPly:E}}function Bc(o){return new Promise(c=>{const _=document.createElement("input");_.type="file",_.accept=o,_.style.display="none",_.onchange=()=>{var C;return c(((C=_.files)==null?void 0:C[0])??null)},document.body.appendChild(_),_.click(),setTimeout(()=>document.body.removeChild(_),1e3)})}function Tc(o,c,_){const C=document.getElementById("ui-panel-container"),y=document.getElementById("load-button"),E=document.getElementById("quick-links");y&&(y.onclick=async()=>{const z=await Bc(".ply,.bitymi");if(z)if(C&&(C.style.display="none"),z.name.toLowerCase().endsWith(".bitymi")){const W=await z.arrayBuffer(),{pcBuffer:N}=or(W),L=new File([N],z.name.replace(/\.bitymi$/i,".ply"),{type:"application/octet-stream"}),Q=await as(L,o);c(Q)}else{const W=await as(z,o);c(W)}}),E&&(E.innerHTML="");const M=new URLSearchParams(window.location.search),R=M.get("bundle")??M.get("model_url"),A=M.get("camera_url");R&&(C&&(C.style.display="none"),_(R,A))}async function Dc(o,c,_,C){const y=new ds(o,_),E=new mc(y);let M=!1;o.addEventListener("pointerdown",()=>{M=!0}),window.addEventListener("pointerup",()=>{M=!1});const R="rgba8unorm";c.configure({device:_,format:R,alphaMode:"opaque",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.STORAGE_BINDING});let A=null;const z=()=>{y.on_update_canvas(),A!==null&&Mn(o.width,o.height,_,A.render_settings_buffer)};new ResizeObserver(()=>{const X=Math.max(.25,q.render_scale),K=Math.max(1,Math.ceil(X*o.clientWidth)),ot=Math.max(1,Math.ceil(X*o.clientHeight));o.width===K&&o.height===ot||(o.width=K,o.height=ot,z())}).observe(o);let N=0,L=0;const Q=()=>{(o.width!==N||o.height!==L)&&(N=o.width,L=o.height,z())},et=new URLSearchParams(window.location.search);let j=et.get("animation")==="1";E.enabled=!j;const ut=et.get("camera_url"),G=Math.max(1,window.devicePixelRatio||1),q={gaussian_scaling:1,sh_bias:.5,animate:j,animateMode:"presets",bg:{r:0,g:0,b:0,a:0},atlas_enabled:!1,bfc:!1,render_scale:1},U=new Vl.Pane({title:"Config",expanded:!0});U.addInput(q,"animate",{label:"Animate"}).on("change",X=>{const K=j;j=X.value,E.enabled=!X.value,!K&&j&&ct.value&&ct.value.onAnimateStart(),K&&!j&&ct.value&&ct.value.onAnimateStop()}),U.addInput(q,"animateMode",{label:"Anim path",options:{"Training views":"presets","Circle orbit":"circle"}});const ct={value:null};Tc(_,X=>$(X,[],null),async(X,K)=>{let ot=K??ut,_t,Lt=null;const Dt=X.toLowerCase();if(Dt.endsWith(".bitymi")||Dt.includes(".bitymi?")){hs("downloading bundle ...");try{const{bundle:mt}=await Mc(X,(kt,Z,nt)=>{const Rt=kt/1048576,gt=Z?Z/(1024*1024):void 0,qt=nt/(1024*1024),Mt=Z?Math.min(99,Math.floor(kt/Z*100)):void 0,Gt=gt?`total ${gt.toFixed(1)} MB`:"total -- MB",dt=gt&&Mt!==void 0?`${Rt.toFixed(1)} MB downloaded (${Mt}%)`:`${Rt.toFixed(1)} MB downloaded`,Ct=`${qt.toFixed(2)} MB/s`;Oe(`downloading bundle ...
${Gt}, ${dt}
${Ct}`)});if(!mt)throw new Error("Expected a .bitymi bundle");Oe("parsing PLY ...");const St=new File([mt.pcBuffer],"bundle.ply",{type:"application/octet-stream"});if(_t=await as(St,_),!ot&&mt.camerasBuffer&&(ot=URL.createObjectURL(new Blob([mt.camerasBuffer],{type:"application/json"}))),mt.atlasBuffer){const kt=mt.atlasBuffer.byteLength/1048576;Oe(`uploading atlas ...
${kt.toFixed(1)} MB BC7`);try{const Z=Al(mt.atlasBuffer);Lt=Ll(_,Z,!0)}catch(Z){console.warn("[atlas] failed to parse/upload atlas:",Z)}}}catch(mt){throw _n(),mt}}else _t=await Ul(X,_);const Tt=ot?await cc(ot):[];Tt.length>0&&y.set_preset(Tt[0]),$(_t,Tt,Lt)});function $(X,K=[],ot=null){const _t=[(X.bbox.min[0]+X.bbox.max[0])/2,(X.bbox.min[1]+X.bbox.max[1])/2,(X.bbox.min[2]+X.bbox.max[2])/2];E.setBbox(X.bbox.min,X.bbox.max);const Lt=.5*Math.sqrt((X.bbox.max[0]-X.bbox.min[0])**2+(X.bbox.max[1]-X.bbox.min[1])**2+(X.bbox.max[2]-X.bbox.min[2])**2);function Dt(Y,at){const rt=qi(Y,at,o,y,X.surfel_data,Lt);rt&&(E.setOrbitPivot(rt),console.log(`[pick] orbit pivot → (${rt[0].toFixed(3)}, ${rt[1].toFixed(3)}, ${rt[2].toFixed(3)})`))}function Tt(){const Y=o.width*.5,at=o.height*.5,rt=qi(Y,at,o,y,X.surfel_data,Lt);if(!rt)return;const vt=y.rotation,yt=vt[2],pt=vt[6],wt=vt[10],Bt=rt[0]-y.position[0],It=rt[1]-y.position[1],Vt=rt[2]-y.position[2],Ft=Bt*yt+It*pt+Vt*wt;Ft>0&&E.setOrbitDepth(Ft)}if(K.length===0){const Y=X.bbox.max[0]-X.bbox.min[0],at=X.bbox.max[1]-X.bbox.min[1],rt=X.bbox.max[2]-X.bbox.min[2],yt=.5*Math.sqrt(Y*Y+at*at+rt*rt)*.5;I.set(_t[0]-yt,_t[1]-yt,_t[2]-yt,y.position);const pt=I.create(yt,yt,yt);I.normalize(pt,pt);const wt=I.create(0,1,0),Bt=I.create();I.cross(wt,pt,Bt),I.normalize(Bt,Bt);const It=I.create();I.cross(pt,Bt,It);const Vt=he.create(Bt[0],It[0],pt[0],Bt[1],It[1],pt[1],Bt[2],It[2],pt[2]);ee.fromMat3(Vt,y.rotation),y.update_buffer()}E.setCenter(I.create(X.centroid[0],X.centroid[1],X.centroid[2]));const mt=new oc(X,_,R,y.uniform_buffer,C,ot);A=mt,Mn(o.width,o.height,_,mt.render_settings_buffer),q.atlas_enabled=ot!==null;let St=!1;const kt=(()=>{if(ot!==null)return`${ot.meta.format===2?"BC7":ot.meta.format===3?"ASTC 4×4":ot.meta.format===5?"RVQ-paired (typeA)":ot.meta.format===6?"RVQ-paired + BC7 codebook (typeB)":ot.meta.format===7?"BC7 codebook gather (typeD)":`format=${ot.meta.format}`} ${ot.meta.width}×${ot.meta.height}, ${ot.meta.n_layers} layers`;const Y=_.features.has("texture-compression-bc"),at=_.features.has("texture-compression-astc");return`no atlas in bundle (GPU supports: ${(Y?["BC7"]:[]).concat(at?["ASTC"]:[]).join("+")||"none"})`})();console.log("[atlas]",kt),Oi(X.sh_bias,_,mt.render_settings_buffer),Vi(q.gaussian_scaling,_,mt.render_settings_buffer),q.sh_bias=X.sh_bias;const Z=X.num_points.toLocaleString(),nt={stats:`${Z} surfels · -- fps`};U.addMonitor(nt,"stats",{label:"Stats",interval:200}),U.addMonitor({atlas:kt},"atlas",{label:"Atlas"});const Rt={stages:"— ms · awaiting timestamp data"};U.addMonitor(Rt,"stages",{label:"Stages",interval:500});let gt=null;if(mt.timeQueryEnabled){gt=document.createElement("canvas"),gt.width=280,gt.height=24,gt.style.cssText="position:fixed;right:8px;bottom:8px;width:280px;height:24px;background:#0008;border:1px solid #2a2a2a;border-radius:4px;font-family:ui-monospace,Menlo,monospace;pointer-events:none;z-index:1000;",document.body.appendChild(gt);const Y=rt=>{const vt=gt.getContext("2d");if(!vt)return;const yt=gt.width,pt=gt.height;if(vt.clearRect(0,0,yt,pt),!rt||rt.total<=0){vt.fillStyle="#888",vt.font="11px ui-monospace,Menlo,monospace",vt.fillText("awaiting GPU timestamps…",8,16);return}const wt=[{label:"cull",ms:rt.cull,color:"#3aa3ff"},{label:"pre",ms:rt.preprocess,color:"#3ad27a"},{label:"sort",ms:rt.sort,color:"#ffa53a"},{label:"render",ms:rt.render,color:"#ff5566"}],Bt=Math.max(.001,wt.reduce((Vt,Ft)=>Vt+Ft.ms,0));let It=0;vt.font="10px ui-monospace,Menlo,monospace",vt.textBaseline="middle";for(const Vt of wt){const Ft=Vt.ms/Bt*yt;vt.fillStyle=Vt.color,vt.fillRect(It,0,Ft,pt),Ft>=38&&(vt.fillStyle="#000c",vt.fillText(`${Vt.label} ${Vt.ms.toFixed(1)}`,It+4,pt/2)),It+=Ft}};setInterval(()=>{St||mt.readPerfMetrics({silent:!0}).then(()=>{const rt=mt.lastStageBreakdownMs;Y(rt),rt&&(Rt.stages=`${rt.total.toFixed(1)} ms · cull ${rt.cull.toFixed(1)} / pre ${rt.preprocess.toFixed(1)} / sort ${rt.sort.toFixed(1)} / render ${rt.render.toFixed(1)}`)}).catch(rt=>console.warn("[perf] readPerfMetrics failed:",rt))},500)}const qt=.4,Mt=3,Gt=.3;let dt=null,Ct=0,$t=0;const B=se.create(),F=he.create();let b=K.length>0?0:-1;const r={view:K.length>0?`${b+1} / ${K.length}: ${K[b].img_name??b}`:"— no presets —"};U.addMonitor(r,"view",{label:"View",interval:100});function h(Y){const at=he.create(Y[0],Y[1],Y[2],Y[4],Y[5],Y[6],Y[8],Y[9],Y[10]);return se.fromMat(at)}function d(Y,at){dt={fromPos:I.clone(y.position),toPos:I.clone(Y.position),fromQuat:se.normalize(h(y.rotation)),toQuat:se.normalize(h(Y.rotation)),target:Y,t:0,duration:Math.max(.01,at)}}const v=(Y,at=!0)=>{if(K.length===0)return;b=(Y%K.length+K.length)%K.length;const rt=K[b];at?d(rt,qt):(y.set_preset(rt),E.resetToCamera(),Tt()),r.view=`${b+1} / ${K.length}: ${K[b].img_name??b}`};K.length>0&&(U.addButton({title:"◀ Prev view"}).on("click",()=>v(b-1)),U.addButton({title:"Next view ▶"}).on("click",()=>v(b+1)));const x=K.length>0?sr(K,{tiltDownDeg:15,alignFirst:!0}):null,k=x?xc(K,{numViews:120,tiltDownDeg:15,alignFirst:!0}):[];let S=0;const i=12;ct.value={onAnimateStart:()=>{S=0},onAnimateStop:()=>{E.resetToCamera(),Tt()}},U.addInput(q,"render_scale",{label:"Render scale",min:.25,max:G,step:.25}).on("change",Y=>{const at=Math.max(.25,Y.value),rt=Math.max(1,Math.ceil(at*o.clientWidth)),vt=Math.max(1,Math.ceil(at*o.clientHeight));(o.width!==rt||o.height!==vt)&&(o.width=rt,o.height=vt,z())}),U.addInput(q,"gaussian_scaling",{label:"Surfel scale",min:0,max:1}).on("change",Y=>Vi(Y.value,_,mt.render_settings_buffer)),U.addInput(q,"sh_bias",{label:"SH bias",min:0,max:2,step:.01}).on("change",Y=>Oi(Y.value,_,mt.render_settings_buffer)),U.addInput(q,"bg",{label:"Background",color:{type:"float",alpha:!0}}).on("change",Y=>{mt.bgColor=[Y.value.r,Y.value.g,Y.value.b,Y.value.a]});const m=ot?ot.meta.format===3?"Atlas (ASTC)":ot.meta.format===5?"Atlas (RVQ)":"Atlas (BC7)":"Atlas";U.addInput(q,"atlas_enabled",{label:m}).on("change",Y=>mt.setAtlasEnabled(Y.value)),U.addInput(q,"bfc",{label:"Backface"}).on("change",Y=>Yl({bfc:Y.value},_,mt.render_settings_buffer)),U.addButton({title:"🎯 Reset camera"}).on("click",()=>{if(K.length>0)y.set_preset(K[0]);else{const Y=X.bbox.max[0]-X.bbox.min[0],at=X.bbox.max[1]-X.bbox.min[1],rt=X.bbox.max[2]-X.bbox.min[2],yt=.5*Math.sqrt(Y*Y+at*at+rt*rt)*.5;I.set(_t[0]-yt,_t[1]-yt,_t[2]-yt,y.position);const pt=I.create(yt,yt,yt);I.normalize(pt,pt);const wt=I.create();I.cross(I.create(0,1,0),pt,wt),I.normalize(wt,wt);const Bt=I.create();I.cross(pt,wt,Bt);const It=he.create(wt[0],Bt[0],pt[0],wt[1],Bt[1],pt[1],wt[2],Bt[2],pt[2]);ee.fromMat3(It,y.rotation),y.update_buffer()}E.resetToCamera(),Tt()});const u={result:"— click Benchmark —"};U.addMonitor(u,"result",{label:"Bench",interval:500,multiline:!0,lineCount:4});const p={bicycle:{w:1237,h:822,fovY:2*Math.atan(3286/(2*4627.3))},flowers:{w:1256,h:828,fovY:2*Math.atan(3312/(2*4285.5))},garden:{w:1297,h:840,fovY:2*Math.atan(3361/(2*3852.4))},stump:{w:1245,h:825,fovY:2*Math.atan(3300/(2*4528.1))},treehill:{w:1267,h:832,fovY:2*Math.atan(3326/(2*4205.6))},bonsai:{w:1559,h:1039,fovY:2*Math.atan(2078/(2*3222.7))},counter:{w:1558,h:1038,fovY:2*Math.atan(2076/(2*3192.7))},kitchen:{w:1558,h:1039,fovY:2*Math.atan(2078/(2*3240.8))},room:{w:1557,h:1038,fovY:2*Math.atan(2075/(2*3174))}};function a(){const at=((new URLSearchParams(window.location.search).get("bundle")??"").split("/").pop()??"").toLowerCase();for(const rt of Object.keys(p))if(at.startsWith(rt))return rt;return null}const f=document.createElement("div");f.id="bench-overlay",f.style.cssText=["position:fixed","top:50%","left:50%","transform:translate(-50%,-50%)","background:rgba(0,0,0,0.9)","color:#fff","padding:24px 32px","border-radius:8px","font-family:monospace","font-size:14px","min-width:340px","text-align:left","box-shadow:0 4px 24px rgba(0,0,0,0.6)","display:none","z-index:9999","pointer-events:none"].join(";"),document.body.appendChild(f);function w(Y,at,rt){const vt=Math.floor(at/Math.max(1,rt)*100),yt=32,pt=Math.floor(at/Math.max(1,rt)*yt),wt="█".repeat(pt)+"░".repeat(yt-pt);f.innerHTML=`<div style="margin-bottom:10px;font-weight:bold">📊 ${Y}</div><div>[${wt}] ${vt}%</div><div style="margin-top:6px;font-size:11px;opacity:0.7">${at} / ${rt} frames · offscreen · pipelined · no vsync</div>`,f.style.display="block"}function g(){f.style.display="none"}async function D(Y=10,at=200){if(St)return;if(K.length===0){u.result="no cameras to benchmark";return}St=!0;const rt=j,vt=q.animate,yt=new Float32Array(y.position),pt=new Float32Array(y.rotation);j=!1,q.animate=!1,U.refresh(),dt=null,E.enabled=!1;const wt=a(),Bt=wt?p[wt]:null,It=(Bt==null?void 0:Bt.w)??o.width,Vt=(Bt==null?void 0:Bt.h)??o.height,Ft=(Bt==null?void 0:Bt.fovY)??y.getFov(),Zt=wt?`${wt} · ${It>=4e3/4+500?"images_4":"images_2"}`:"custom",Wt=o.width,Yt=o.height,Kt=y.getFov();o.width=It,o.height=Vt,y.setFov(Ft),Mn(It,Vt,_,mt.render_settings_buffer);const te=_.createTexture({size:[It,Vt,1],format:R,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.STORAGE_BINDING}),Xt=te.createView(),ve=()=>{const Qt=_.createCommandEncoder();mt.frame(Qt,Xt,!1),_.queue.submit([Qt.finish()])},le=()=>new Promise(Qt=>setTimeout(Qt,0)),be=20,fe=async(Qt,ce)=>{let _e=0,ue=0;for(w(ce,0,Qt),await le();ue<Qt;){const me=Math.min(be,Qt-ue),ge=performance.now();for(let jt=0;jt<me;jt++)y.set_preset(K[(ue+jt)%K.length]),ve();await _.queue.onSubmittedWorkDone();const qe=performance.now();_e+=qe-ge,ue+=me,w(ce,ue,Qt),await le()}return _e};try{await fe(Y,"Warming up");const ce=await fe(at,"Benchmarking")/at,_e=1e3/ce,ue=X.num_points??X.surfel_data.length/8,me=(Ft*180/Math.PI).toFixed(1),ge=`${_e.toFixed(1)} FPS  (${ce.toFixed(2)} ms/frame)
${It}×${Vt} · fovY ${me}° · ${Zt}
${ue.toLocaleString()} surfels · ${Y}w+${at}b · pipelined`;u.result=ge,console.log("[bench]",ge.replace(/\n/g,"  |  "))}catch(Qt){console.error("[bench] failed:",Qt),u.result=`bench failed: ${Qt}`}finally{g(),te.destroy(),o.width=Wt,o.height=Yt,y.setFov(Kt),Mn(Wt,Yt,_,mt.render_settings_buffer),y.position.set(yt),y.rotation.set(pt),y.update_buffer(),E.enabled=!rt,j=rt,q.animate=vt,U.refresh(),St=!1}}U.addButton({title:"📊 Benchmark"}).on("click",()=>D()),document.addEventListener("keydown",Y=>{const at=Y.key;if(at>="0"&&at<="9"&&K.length>0){const rt=parseInt(at);rt<K.length&&v(rt)}else at==="ArrowLeft"||at==="PageUp"?(v(b-1),Y.preventDefault()):at==="ArrowRight"||at==="PageDown"?(v(b+1),Y.preventDefault()):(at==="d"||at==="D")&&mt.debugReadSortedIndices(30).catch(rt=>console.error("[DEBUG] readback failed:",rt))});function V(Y,at){const rt=o.getBoundingClientRect(),vt=window.devicePixelRatio||1;return[(Y-rt.left)*vt,(at-rt.top)*vt]}o.addEventListener("dblclick",Y=>{const[at,rt]=V(Y.clientX,Y.clientY);Dt(at,rt)});let O=0,lt=0,it=0;o.addEventListener("pointerdown",Y=>{if(Y.pointerType!=="touch")return;const at=performance.now(),rt=at-O,vt=Y.clientX-lt,yt=Y.clientY-it;if(rt>0&&rt<300&&vt*vt+yt*yt<40*40){const[pt,wt]=V(Y.clientX,Y.clientY);Dt(pt,wt),O=0}else O=at,lt=Y.clientX,it=Y.clientY});function st(){return M}let ft=performance.now(),xt=60,ht=Promise.resolve(),bt=0;async function At(){var yt;const Y=performance.now(),at=Math.min((Y-ft)/1e3,.1);if(ft=Y,at>0){const pt=((yt=mt.lastStageBreakdownMs)==null?void 0:yt.total)??0,wt=pt>.5?1e3/pt:1/at;xt=xt*.9+wt*.1,nt.stats=`${Z} surfels · ${Math.round(xt)} fps`}if(St){requestAnimationFrame(At);return}if(st()&&(dt||j)&&(dt=null,E.resetToCamera(),Tt(),j&&(j=!1,q.animate=!1,U.refresh())),j&&q.animateMode==="circle"&&x){S+=at/i,S>=1&&(S-=1);const pt=ir(x,S);y.set_preset(pt),E.update(at);const wt=_.createCommandEncoder();mt.frame(wt,c.getCurrentTexture().createView()),_.queue.submit([wt.finish()]),bt++,bt===2&&_n(),requestAnimationFrame(At);return}if(dt){dt.t+=at/dt.duration;const pt=Math.min(1,dt.t),wt=pt*pt*(3-2*pt);I.lerp(dt.fromPos,dt.toPos,wt,y.position),se.slerp(dt.fromQuat,dt.toQuat,wt,B),he.fromQuat(B,F),ee.fromMat3(F,y.rotation),y.update_buffer(),dt.t>=1&&(y.set_preset(dt.target),dt=null,j?K.length>0&&(Ct=Gt):(E.resetToCamera(),Tt()))}else if(j&&!st()){const pt=q.animateMode==="circle"&&k.length>0,wt=pt?k:K;if(wt.length!==0){if(Ct-=at,Ct<=0){const It=((pt?$t:b)+1)%wt.length;pt?$t=It:b=It;const Vt=pt?Mt/8:Mt;d(wt[It],Vt),pt||(r.view=`${b+1} / ${K.length}: ${K[b].img_name??b}`)}}}E.update(at),Q(),await ht;const rt=_.createCommandEncoder(),vt=c.getCurrentTexture().createView();mt.frame(rt,vt),_.queue.submit([rt.finish()]),ht=_.queue.onSubmittedWorkDone(),bt++,bt===2&&_n(),requestAnimationFrame(At)}requestAnimationFrame(At)}}(function(){let c="dev";for(const C of Array.from(document.querySelectorAll('script[type="module"]'))){const E=C.src.match(/\/assets\/index-([0-9a-z]+)\.js$/i);if(E){c=E[1];break}}const _=document.createElement("div");_.textContent="v "+c,_.title="viewer build hash (Vite content hash of index-*.js)",Object.assign(_.style,{position:"fixed",right:"6px",bottom:"6px",font:"10px ui-monospace, SFMono-Regular, Menlo, monospace",color:"rgba(255,255,255,0.55)",background:"rgba(0,0,0,0.35)",padding:"2px 6px",borderRadius:"4px",pointerEvents:"none",zIndex:"9999",userSelect:"all"}),document.body.appendChild(_)})();(async()=>{if(navigator.gpu===void 0){const E=document.querySelector("#title");E.innerText="WebGPU is not supported in this browser.";return}const o=await navigator.gpu.requestAdapter({powerPreference:"high-performance"});if(o===null){const E=document.querySelector("#title");E.innerText="No adapter is available for WebGPU.";return}const c=[];o.features.has("timestamp-query")&&c.push("timestamp-query"),o.features.has("texture-compression-bc")&&c.push("texture-compression-bc"),o.features.has("texture-compression-astc")&&c.push("texture-compression-astc"),console.log("[adapter]",o.info??"(unknown)"),console.log("[adapter] features:",Array.from(o.features)),console.log("[adapter] BC7:",o.features.has("texture-compression-bc")),console.log("[adapter] ASTC:",o.features.has("texture-compression-astc")),console.log("[adapter] limits:",{maxStorageBuffersPerShaderStage:o.limits.maxStorageBuffersPerShaderStage,maxComputeWorkgroupStorageSize:o.limits.maxComputeWorkgroupStorageSize,maxBufferSize:o.limits.maxBufferSize,maxStorageBufferBindingSize:o.limits.maxStorageBufferBindingSize,maxTextureDimension2D:o.limits.maxTextureDimension2D});const _=await o.requestDevice({requiredFeatures:c,requiredLimits:{maxStorageBuffersPerShaderStage:10,maxComputeWorkgroupStorageSize:o.limits.maxComputeWorkgroupStorageSize,maxBufferSize:o.limits.maxBufferSize,maxStorageBufferBindingSize:o.limits.maxStorageBufferBindingSize}}),C=document.querySelector("#webgpu-canvas");Bl(C!==null);const y=C.getContext("webgpu");Dc(C,y,_,c)})();
