...
}`,Ei=32,Us=1,Vs=2,li=4,ci=512,ui=1024,di=2048,nc=0,Qt=new ArrayBuffer(Ei),mt={canvas_size:new Uint32Array(Qt,0,2),accel_flags:new Uint32Array(Qt,8,1),feature_mode:new Uint32Array(Qt,12,1),gaussian_scaling:new Float32Array(Qt,16,1),sh_bias:new Float32Array(Qt,20,1),color_K:new Uint32Array(Qt,24,1),walltime:new Float32Array(Qt,28,1)};function sc(o){mt.canvas_size[0]=o.width>>>0,mt.canvas_size[1]=o.height>>>0,mt.accel_flags[0]=(o.accel_flags??Us|Vs)>>>0,mt.feature_mode[0]=(o.feature_mode??nc)>>>0,mt.gaussian_scaling[0]=o.gaussian_scaling??1,mt.sh_bias[0]=o.sh_bias??.5,mt.color_K[0]=(o.color_K??0)>>>0,mt.walltime[0]=o.walltime??0}function ki(o,a){o.queue.writeBuffer(a,0,Qt)}function us(o,a,h){h&&o&&a&&ki(o,a)}function Bn(o,a,h,E,g=!0){mt.canvas_size[0]=o>>>0,mt.canvas_size[1]=a>>>0,us(h??null,E??null,g)}function pi(o,a,h,E=!0){mt.gaussian_scaling[0]=o,us(a??null,h??null,E)}function hi(o,a,h,E=!0){mt.sh_bias[0]=o,us(a??null,h??null,E)}function Os(o,a,h,E=!0){let g=mt.accel_flags[0];o.oac!==void 0&&(g=o.oac?g|Us:g&~Us),o.spr!==void 0&&(g=o.spr?g|Vs:g&~Vs),o.bfc!==void 0&&(g=o.bfc?g|li:g&~li),o.hypLegacy!==void 0&&(g=o.hypLegacy?g|ci:g&~ci),o.raysplat!==void 0&&(g=o.raysplat?g|di:g&~di),o.legacyPos!==void 0&&(g=o.legacyPos?g|ui:g&~ui),mt.accel_flags[0]=g>>>0,us(a??null,h??null,E)}const rc=256;function fi(o,a){const h=[],E=[];let g=!0;for(const S of o.split(`
...
`),J="data:text/csv;charset=utf-8,"+encodeURIComponent(se+W),N=document.createElement("a");N.href=J,N.download=`${this.downloadOnceFileName}.csv`,document.body.appendChild(N),N.click(),N.remove()}if(this.showPerfDialogNext){this.showPerfDialogNext=!1;try{alert(Q)}catch{console.warn("Unable to show dialog; metrics printed to console.")}}this.resultBuffer.unmap()}_setupTimestampQueries(){this.querySet=this.device.createQuerySet({type:"timestamp",count:this.totalQueryCount});const a=this.totalQueryCount*8;this.resolveBuffer=this.device.createBuffer({size:a,usage:GPUBufferUsage.QUERY_RESOLVE|GPUBufferUsage.COPY_SRC}),this.resultBuffer=this.device.createBuffer({size:a,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ})}_setupBuffers(){this.render_settings_buffer=this.device.createBuffer({label:"render settings",size:ic,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});const a=document.querySelector("canvas"),h=a?a.width:1,E=a?a.height:1;sc({width:h,height:E,sh_bias:this.pc.sh_bias,color_K:this.pc.K,feature_mode:this.pc.feature_mode}),ki(this.device,this.render_settings_buffer),this.splat_2d_buffer=this.device.createBuffer({label:"splats_2d (Splat2DGS)",size:qn(this.pc.num_points*ac),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST}),this.draw_indirect_buffer=this.device.createBuffer({label:"draw indirect",size:4*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC|GPUBufferUsage.INDIRECT}),this.device.queue.writeBuffer(this.draw_indirect_buffer,0,new Uint32Array([this.octBound?8:4,0,0,0])),this.sh_solvers_buffer=this.device.createBuffer({label:"sh_solvers",size:qn(this.pc.num_points*lc),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST})}requestPerfDialog(){this.showPerfDialogNext=!0}requestDownloadMetrics(a){if(a&&a.trim().length>0){const h=a.trim().replace(/[^a-zA-Z0-9_\-]/g,"_");this.downloadOnceFileName=h.length>0?h:this.downloadOnceFileName}else{const h=new Date,E=`${h.getFullYear()}${String(h.getMonth()+1).padStart(2,"0")}${String(h.getDate()).padStart(2,"0")}_${String(h.getHours()).padStart(2,"0")}${String(h.getMinutes()).padStart(2,"0")}${String(h.getSeconds()).padStart(2,"0")}`;this.downloadOnceFileName=`fps_metrics_${E}`}this.downloadOnceNextRead=!0}requestReorder(){}async maybeReorderAfterSubmit(){}}function fc(o,a){return 2*Math.atan(a/(2*o))}function _c(o,a,h,E){const g=Math.tan(E/2),S=Math.tan(h/2),M=g*o,L=-M,A=S*o,I=-A,K=ht.create();return K[0]=2*o/(A-I),K[5]=-2*o/(M-L),K[2]=(A+I)/(A-I),K[6]=(M+L)/(M-L),K[14]=1,K[10]=a/(a-o),K[11]=-(a*o)/(a-o),ht.transpose(K,K),K}async function mc(o){Ct(`loading scene camera file... : ${o}`);const h=await(await fetch(o)).json();return Ct(`loaded cameras count: ${h.length}`),h.map(E=>{const g=R.clone(E.position),S=Bt.create(...E.rotation.flat()),M=S[0],L=S[4],A=S[8],I=S[1],K=S[5],q=S[9],z=S[2],X=S[6],oe=S[10];M*(K*oe-q*X)-L*(I*oe-q*z)+A*(I*X-K*z)<0&&(S[1]=-S[1],S[5]=-S[5],S[9]=-S[9]);const Q=ht.fromMat3(S);return{position:g,rotation:Q,img_name:E.img_name,id:E.id}})}const vc=4*2,bc=4*16,Mi=4*bc+2*vc;function gc(o){return o.createBuffer({label:"camera uniform",size:Mi,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}const dn=new Float32Array(Mi/Float32Array.BYTES_PER_ELEMENT),ls=class ls{constructor(a,h){$(this,"_renderSize",null);$(this,"uniform_buffer");$(this,"position",R.create());$(this,"rotation",ht.create());$(this,"fovY",45/180*Math.PI);$(this,"fovX");$(this,"focalRatioX",1);$(this,"focal",ti.create());$(this,"viewport",ti.create());$(this,"view_matrix",ht.identity());$(this,"view_inv_matrix",ht.identity());$(this,"proj_matrix",ht.identity());$(this,"proj_inv_matrix",ht.identity());$(this,"_negPos",R.create());$(this,"look",R.create(0,0,1));$(this,"up",R.create(0,1,0));$(this,"right",R.create(1,0,0));this.canvas=a,this.device=h,this.uniform_buffer=gc(h),this.on_update_canvas()}setRenderSize(a,h){this._renderSize=[a,h],this.on_update_canvas()}clearRenderSize(){this._renderSize=null,this.on_update_canvas()}on_update_canvas(){const a=this._renderSize?this._renderSize[0]:this.canvas.width,h=this._renderSize?this._renderSize[1]:this.canvas.height,E=.5*h/Math.tan(this.fovY*.5);this.focal[0]=E*this.focalRatioX,this.focal[1]=E,this.fovX=fc(this.focal[0],a),this.viewport[0]=a,this.viewport[1]=h,this.proj_matrix=_c(.01,100,this.fovX,this.fovY),ht.inverse(this.proj_matrix,this.proj_inv_matrix),this.update_buffer()}update_buffer(){this._negPos[0]=-this.position[0],this._negPos[1]=-this.position[1],this._negPos[2]=-this.position[2],ht.copy(this.rotation,this.view_matrix),ht.translate(this.view_matrix,this._negPos,this.view_matrix),ht.inverse(this.view_matrix,this.view_inv_matrix),R.transformMat4Upper3x3(ls.Z_AXIS,this.view_inv_matrix,this.look),R.normalize(this.look,this.look),R.cross(this.up,this.look,this.right),R.normalize(this.right,this.right);let a=0;dn.set(this.view_matrix,a),a+=16,dn.set(this.view_inv_matrix,a),a+=16,dn.set(this.proj_matrix,a),a+=16,dn.set(this.proj_inv_matrix,a),a+=16,dn.set(this.viewport,a),a+=2,dn.set(this.focal,a),a+=2,this.device.queue.writeBuffer(this.uniform_buffer,0,dn)}set_preset(a){R.copy(a.position,this.position),ht.copy(a.rotation,this.rotation),this.update_buffer()}setFov(a){this.fovY=a,this.on_update_canvas()}setFocalRatio(a){this.focalRatioX=a,this.on_update_canvas()}getFov(){return this.fovY}};$(ls,"Z_AXIS",R.create(0,0,1));let Fs=ls;const wc=R.create(1,0,0),xc=R.create(0,1,0),yc=R.create(0,0,1);function Pc(o,a){const h=o[0],E=o[4],g=o[8],S=o[1],M=o[5],L=o[9],A=o[2],I=o[6],K=o[10],q=h+M+K;let z,X,oe,Y;if(q>0){const Q=.5/Math.sqrt(q+1);z=.25/Q,X=(I-L)*Q,oe=(g-A)*Q,Y=(S-E)*Q}else if(h>M&&h>K){const Q=2*Math.sqrt(1+h-M-K);z=(I-L)/Q,X=.25*Q,oe=(E+S)/Q,Y=(g+A)/Q}else if(M>K){const Q=2*Math.sqrt(1+M-h-K);z=(g-A)/Q,X=(E+S)/Q,oe=.25*Q,Y=(L+I)/Q}else{const Q=2*Math.sqrt(1+K-h-M);z=(S-E)/Q,X=(g+A)/Q,oe=(L+I)/Q,Y=.25*Q}return a[0]=X,a[1]=oe,a[2]=Y,a[3]=z,a}class Sc{constructor(a){$(this,"element");$(this,"enabled",!0);$(this,"center",R.create(0,0,0));$(this,"up",R.create(0,1,0));$(this,"rotation",[0,0]);$(this,"shift",[0,0]);$(this,"scroll",0);$(this,"speed",.1);$(this,"sensitivity",.08);$(this,"leftPressed",!1);$(this,"rightPressed",!1);$(this,"leftDragPans",!1);$(this,"lastX",0);$(this,"lastY",0);$(this,"touches",new Map);$(this,"lastTouchCenter",null);$(this,"lastPinchDistance",null);$(this,"lastTwoFingerAngle",null);$(this,"lastTouchCount",0);$(this,"roll",0);$(this,"_dir",R.create());$(this,"_right",R.create());$(this,"_upCam",R.create());$(this,"_scratch",R.create());$(this,"_qY",pt.create());$(this,"_qX",pt.create());$(this,"_qRot",pt.create());$(this,"_qZ",pt.create());$(this,"_qLocal",pt.create());$(this,"_qWorldToCam",pt.create());$(this,"_scratchMat3",Bt.create());$(this,"bboxMin",null);$(this,"bboxMax",null);$(this,"anchor",R.create(0,0,0));$(this,"downCallback",a=>{var h,E,g,S;if(this.enabled){if(a.pointerType==="touch"){this.touches.set(a.pointerId,{x:a.pageX,y:a.pageY}),this.handleTouchGestures(),(E=(h=a.target)==null?void 0:h.setPointerCapture)==null||E.call(h,a.pointerId),a.preventDefault();return}a.isPrimary&&(a.button===0?(this.leftPressed=!0,this.leftDragPans=a.shiftKey):a.button===2?this.rightPressed=!0:this.rightPressed=!0,this.lastX=a.pageX,this.lastY=a.pageY,(S=(g=a.target)==null?void 0:g.setPointerCapture)==null||S.call(g,a.pointerId),a.preventDefault())}});$(this,"moveCallback",a=>{if(!this.enabled)return;if(a.pointerType==="touch"){if(!this.touches.has(a.pointerId))return;this.touches.set(a.pointerId,{x:a.pageX,y:a.pageY}),this.handleTouchGestures(),a.preventDefault();return}if(!a.isPrimary||!this.leftPressed&&!this.rightPressed)return;a.preventDefault();const h=a.pageX-this.lastX,E=a.pageY-this.lastY;this.lastX=a.pageX,this.lastY=a.pageY,this.leftPressed&&!this.leftDragPans?(this.rotation[0]+=h,this.rotation[1]-=E):(this.rightPressed||this.leftPressed&&this.leftDragPans)&&(this.shift[1]-=h,this.shift[0]+=E)});$(this,"upCallback",a=>{var h,E,g,S;if(a.pointerType==="touch"){this.touches.delete(a.pointerId),this.handleTouchGestures(),(E=(h=a.target)==null?void 0:h.releasePointerCapture)==null||E.call(h,a.pointerId),a.preventDefault();return}a.button===0?this.leftPressed=!1:a.button===2?this.rightPressed=!1:this.rightPressed=!1,(S=(g=a.target)==null?void 0:g.releasePointerCapture)==null||S.call(g,a.pointerId),a.preventDefault()});$(this,"wheelCallback",a=>{if(!this.enabled||(a.preventDefault(),this.rightPressed))return;let h=a.deltaY;a.deltaMode===1?h*=16:a.deltaMode===2&&(h*=100),this.scroll+=h*.01});this.camera=a,this.registerElement(a.canvas)}get sceneRadius(){if(!this.bboxMin||!this.bboxMax)return null;const a=this.bboxMax[0]-this.bboxMin[0],h=this.bboxMax[1]-this.bboxMin[1],E=this.bboxMax[2]-this.bboxMin[2],g=.5*Math.sqrt(a*a+h*h+E*E);return g>1e-6?g:null}addRoll(a){this.roll+=a}registerElement(a){this.element&&this.element!==a&&(this.element.removeEventListener("pointerdown",this.downCallback),this.element.removeEventListener("pointermove",this.moveCallback),this.element.removeEventListener("pointerup",this.upCallback),this.element.removeEventListener("wheel",this.wheelCallback)),this.element=a,this.element.addEventListener("pointerdown",this.downCallback),this.element.addEventListener("pointermove",this.moveCallback),this.element.addEventListener("pointerup",this.upCallback),this.element.addEventListener("wheel",this.wheelCallback,{passive:!1}),this.element.addEventListener("contextmenu",h=>h.preventDefault())}setCenter(a){R.copy(a,this.center),R.copy(a,this.anchor)}setOrbitPivot(a){R.set(a[0],a[1],a[2],this.center),this._reorientCameraToCenter()}setOrbitDepth(a){if(!isFinite(a)||a<.001)return;const h=this.camera.rotation;R.set(h[2],h[6],h[10],this._dir),R.normalize(this._dir,this._dir),R.scale(this._dir,a,this._dir),R.add(this.camera.position,this._dir,this.center)}_reorientCameraToCenter(){const a=this.camera;if(R.subtract(this.center,a.position,this._scratch),R.length(this._scratch)<1e-6)return;R.normalize(this._scratch,this._scratch),R.cross(this.up,this._scratch,this._right),R.length(this._right)<1e-6&&R.set(1,0,0,this._right),R.normalize(this._right,this._right),R.cross(this._scratch,this._right,this._upCam),R.normalize(this._upCam,this._upCam);const h=a.rotation;h[0]=this._right[0],h[1]=this._upCam[0],h[2]=this._scratch[0],h[3]=0,h[4]=this._right[1],h[5]=this._upCam[1],h[6]=this._scratch[1],h[7]=0,h[8]=this._right[2],h[9]=this._upCam[2],h[10]=this._scratch[2],h[11]=0,h[12]=0,h[13]=0,h[14]=0,h[15]=1,a.update_buffer()}setBbox(a,h){this.bboxMin=R.create(a[0],a[1],a[2]),this.bboxMax=R.create(h[0],h[1],h[2]);const E=(a[0]+h[0])*.5,g=(a[1]+h[1])*.5,S=(a[2]+h[2])*.5;R.set(E,g,S,this.center),R.set(E,g,S,this.anchor)}resetToCamera(){const a=this.camera.rotation;R.set(a[2],a[6],a[10],this._dir),R.normalize(this._dir,this._dir);let h=null;if(this.bboxMin&&this.bboxMax){let E=-1/0,g=1/0,S=!1;for(let M=0;M<3;M++){const L=this._dir[M],A=this.bboxMin[M]-this.camera.position[M],I=this.bboxMax[M]-this.camera.position[M];if(Math.abs(L)>1e-8){const K=A/L,q=I/L;E=Math.max(E,Math.min(K,q)),g=Math.min(g,Math.max(K,q))}else if(A>0||I<0){S=!0;break}}!S&&E<=g&&g>0&&(h=(Math.max(E,0)+g)*.5)}if(h===null||!isFinite(h)||h<.001){R.subtract(this.anchor,this.camera.position,this._scratch);const E=R.dot(this._scratch,this._dir);h=E>.001?E:R.length(this._scratch)}h=Math.max(.1,h),R.scale(this._dir,h,this._dir),R.add(this.camera.position,this._dir,this.center)}handleTouchGestures(){const a=this.touches.size;if(a!==this.lastTouchCount&&(this.lastTouchCenter=null,this.lastPinchDistance=null,this.lastTwoFingerAngle=null),this.lastTouchCount=a,a===1){const h=this.touches.values().next().value;if(this.lastTouchCenter){const E=h.x-this.lastTouchCenter[0],g=h.y-this.lastTouchCenter[1];this.rotation[0]+=E*.3,this.rotation[1]-=g*.3}this.lastTouchCenter=[h.x,h.y]}else if(a===2){const h=Array.from(this.touches.values()),E=(h[0].x+h[1].x)*.5,g=(h[0].y+h[1].y)*.5,S=h[1].x-h[0].x,M=h[1].y-h[0].y,L=Math.hypot(S,M),A=Math.atan2(M,S);if(this.lastTouchCenter!==null&&this.lastPinchDistance!==null&&this.lastTwoFingerAngle!==null){const I=E-this.lastTouchCenter[0],K=g-this.lastTouchCenter[1],q=Math.hypot(I,K),z=Math.abs(L-this.lastPinchDistance);let X=A-this.lastTwoFingerAngle;X>Math.PI&&(X-=2*Math.PI),X<-Math.PI&&(X+=2*Math.PI),q>.5&&(this.shift[1]-=I,this.shift[0]+=K),z>1&&this.lastPinchDistance>.001&&(this.scroll+=-Math.log(L/this.lastPinchDistance)*10),Math.abs(X)>.0087&&(this.roll+=X)}this.lastTouchCenter=[E,g],this.lastPinchDistance=L,this.lastTwoFingerAngle=A}}update(a){if(!this.enabled||Math.abs(this.rotation[0])<1e-4&&Math.abs(this.rotation[1])<1e-4&&Math.abs(this.shift[0])<1e-4&&Math.abs(this.shift[1])<1e-4&&Math.abs(this.scroll)<1e-4&&Math.abs(this.roll)<1e-4)return;const h=this.camera;{const Q=h.rotation;this.up[0]=Q[1],this.up[1]=Q[5],this.up[2]=Q[9],R.length(this.up)>1e-6?R.normalize(this.up,this.up):R.set(0,1,0,this.up)}let E=0,g=!1;Math.abs(this.roll)>1e-4&&(E=this.roll,this.roll=0,g=!0),R.subtract(h.position,this.center,this._dir);let S=R.length(this._dir);S<1e-6&&(S=1e-6);const M=Math.exp(Math.log(S)+this.scroll*a*10*this.speed);R.scale(this._dir,M/S,this._dir),S=M;const L=h.rotation;this._right[0]=L[0],this._right[1]=L[4],this._right[2]=L[8],R.normalize(this._right,this._right),R.length(this._right)<1e-6&&R.set(1,0,0,this._right);const A=R.create(L[1],L[5],L[9]);R.normalize(A,A),R.length(A)<1e-6&&R.set(0,1,0,A);const I=a*this.speed*.1*S,K=this.shift[1]*I,q=-this.shift[0]*I;R.scale(this._right,K,this._scratch),R.add(this.center,this._scratch,this.center),R.add(h.position,this._scratch,h.position),R.scale(A,q,this._scratch),R.add(this.center,this._scratch,this.center),R.add(h.position,this._scratch,h.position);const z=this.rotation[0]*a*this.sensitivity,X=this.rotation[1]*a*this.sensitivity;if(Math.abs(z)>1e-5||Math.abs(X)>1e-5||g){const Q=h.rotation;Pc(Q,this._qWorldToCam),pt.fromAxisAngle(wc,-X,this._qX),pt.fromAxisAngle(xc,-z,this._qY),pt.multiply(this._qX,this._qY,this._qLocal),g&&(pt.fromAxisAngle(yc,1*E,this._qZ),pt.multiply(this._qZ,this._qLocal,this._qLocal)),pt.normalize(this._qLocal,this._qLocal),pt.multiply(this._qLocal,this._qWorldToCam,this._qWorldToCam),pt.normalize(this._qWorldToCam,this._qWorldToCam),Bt.fromQuat(this._qWorldToCam,this._scratchMat3),ht.fromMat3(this._scratchMat3,h.rotation);const se=h.rotation,W=se[2],J=se[6],N=se[10];h.position[0]=this.center[0]-W*S,h.position[1]=this.center[1]-J*S,h.position[2]=this.center[2]-N*S,this.up[0]=se[1],this.up[1]=se[5],this.up[2]=se[9],R.normalize(this.up,this.up)}else R.add(this.center,this._dir,h.position);h.update_buffer();const Y=Math.pow(.8,a*60);this.rotation[0]*=Y,Math.abs(this.rotation[0])<1e-4&&(this.rotation[0]=0),this.rotation[1]*=Y,Math.abs(this.rotation[1])<1e-4&&(this.rotation[1]=0),this.shift[0]*=Y,Math.abs(this.shift[0])<1e-4&&(this.shift[0]=0),this.shift[1]*=Y,Math.abs(this.shift[1])<1e-4&&(this.shift[1]=0),this.scroll*=Y,Math.abs(this.scroll)<1e-4&&(this.scroll=0)}}function Bi(o){const a=R.create();for(const h of o)R.add(a,h,a);return R.scale(a,1/Math.max(o.length,1),a)}function Ti(o,a){const h=Bt.create();Bt.inverse(o,h);const E=R.create();return E[0]=h[0]*a[0]+h[4]*a[1]+h[8]*a[2],E[1]=h[1]*a[0]+h[5]*a[1]+h[9]*a[2],E[2]=h[2]*a[0]+h[6]*a[1]+h[10]*a[2],E}function Cc(o){const a=o.slice(),h=[1,0,0,0,1,0,0,0,1],E=(A,I)=>a[A*3+I],g=(A,I,K)=>{a[A*3+I]=K},S=(A,I)=>h[A*3+I],M=(A,I,K)=>{h[A*3+I]=K};for(let A=0;A<30;A++){let I=0,K=1,q=Math.abs(E(0,1));if(Math.abs(E(0,2))>q&&(I=0,K=2,q=Math.abs(E(0,2))),Math.abs(E(1,2))>q&&(I=1,K=2,q=Math.abs(E(1,2))),q<1e-12)break;const z=E(I,I),X=E(K,K),oe=E(I,K);let Y;Math.abs(z-X)<1e-30?Y=Math.PI/4*Math.sign(oe):Y=.5*Math.atan2(2*oe,z-X);const Q=Math.cos(Y),se=Math.sin(Y);for(let W=0;W<3;W++){const J=E(W,I),N=E(W,K);g(W,I,Q*J+se*N),g(W,K,-se*J+Q*N)}for(let W=0;W<3;W++){const J=E(I,W),N=E(K,W);g(I,W,Q*J+se*N),g(K,W,-se*J+Q*N)}for(let W=0;W<3;W++){const J=S(W,I),N=S(W,K);M(W,I,Q*J+se*N),M(W,K,-se*J+Q*N)}}const L=[];for(let A=0;A<3;A++)L.push({val:E(A,A),vec:R.create(S(0,A),S(1,A),S(2,A))});return L.sort((A,I)=>I.val-A.val),{vals:[L[0].val,L[1].val,L[2].val],vecs:[L[0].vec,L[1].vec,L[2].vec]}}function Ec(o,a){const h=Bi(o);let E=0,g=0,S=0,M=0,L=0,A=0;for(const oe of o){const Y=oe[0]-h[0],Q=oe[1]-h[1],se=oe[2]-h[2];E+=Y*Y,g+=Y*Q,S+=Y*se,M+=Q*Q,L+=Q*se,A+=se*se}const I=[E,g,S,g,M,L,S,L,A],{vecs:K}=Cc(I);let q=K[0],z=K[1],X=K[2];return R.dot(X,a)<0&&(R.scale(X,-1,X),R.scale(z,-1,z)),{centroid:h,normal:X,u:q,v:z}}function kc(o){let a=0,h=0,E=0,g=0,S=0,M=0,L=0,A=0,I=0;for(const[Q,se]of o){const W=-2*Q,J=-2*se,N=1,pe=-(Q*Q+se*se);a+=W*W,h+=W*J,E+=W*N,g+=J*J,S+=J*N,M+=N*N,L+=W*pe,A+=J*pe,I+=N*pe}const K=Bt.create(a,h,E,h,g,S,E,S,M),q=Ti(K,R.create(L,A,I)),z=q[0],X=q[1],oe=q[2],Y=z*z+X*X-oe;return{center:[z,X],radius:Math.sqrt(Math.max(Y,1e-12))}}function Mc(o,a){let h=0,E=0,g=0,S=0,M=0,L=0,A=0,I=0,K=0;for(let z=0;z<o.length;z++){const X=o[z],oe=R.normalize(a[z],R.create()),Y=1-oe[0]*oe[0],Q=-oe[0]*oe[1],se=-oe[0]*oe[2],W=1-oe[1]*oe[1],J=-oe[1]*oe[2],N=1-oe[2]*oe[2];h+=Y,E+=Q,g+=se,S+=W,M+=J,L+=N,A+=Y*X[0]+Q*X[1]+se*X[2],I+=Q*X[0]+W*X[1]+J*X[2],K+=se*X[0]+J*X[1]+N*X[2]}const q=Bt.create(h,E,g,E,S,M,g,M,L);return Ti(q,R.create(A,I,K))}function Ai(o,a={}){if(o.length===0)return null;const h=a.tiltDownDeg??8,E=a.radiusScale??1,g=a.alignFirst??!0,S=(a.direction??"ccw")==="ccw"?1:-1,M=o.map(ae=>R.clone(ae.position)),L=o.map(ae=>{const ue=ae.rotation;return R.create(ue[8],ue[9],ue[10])}),A=o.map(ae=>{const ue=ae.rotation;return R.create(ue[4],ue[5],ue[6])}),I=Bi(A),K=R.normalize(R.scale(I,-1,R.create())),{centroid:q,normal:z,u:X,v:oe}=Ec(M,K),Y=M.map(ae=>{const ue=R.sub(ae,q,R.create());return[R.dot(ue,X),R.dot(ue,oe)]}),{center:Q,radius:se}=kc(Y),W=se*E,J=R.add(q,R.add(R.scale(X,Q[0],R.create()),R.scale(oe,Q[1],R.create()),R.create()),R.create()),N=Mc(M,L),pe=W*Math.tan(h*Math.PI/180),he=R.sub(N,R.scale(z,pe,R.create()),R.create());let _e=0;if(g){const ae=R.sub(M[0],J,R.create());_e=Math.atan2(R.dot(ae,oe),R.dot(ae,X))/(2*Math.PI)%1,_e<0&&(_e+=1)}return console.log(`[orbit] fit ${o.length} train cams: radius=${W.toFixed(2)}, tilt=${h}°, normal=[${z[0].toFixed(2)}, ${z[1].toFixed(2)}, ${z[2].toFixed(2)}], startPhase=${_e.toFixed(3)}`),{center:J,radius:W,normal:z,u:X,v:oe,lookAt:he,startPhase:_e,direction:S}}function Di(o,a){const h=(o.startPhase+a*o.direction)*2*Math.PI,E=Math.cos(h),g=Math.sin(h),S=R.add(o.center,R.add(R.scale(o.u,o.radius*E,R.create()),R.scale(o.v,o.radius*g,R.create()),R.create()),R.create()),M=R.normalize(R.sub(o.lookAt,S,R.create())),L=R.cross(M,o.normal,R.create());R.length(L)<1e-6&&R.copy(o.u,L),R.normalize(L,L);const A=R.cross(M,L,R.create());R.normalize(A,A);const I=ht.create();return I[0]=L[0],I[1]=A[0],I[2]=M[0],I[3]=0,I[4]=L[1],I[5]=A[1],I[6]=M[1],I[7]=0,I[8]=L[2],I[9]=A[2],I[10]=M[2],I[11]=0,I[12]=0,I[13]=0,I[14]=0,I[15]=1,{position:S,rotation:I,img_name:`orbit_${(a*1e3).toFixed(0)}`,id:0}}function Bc(o,a={}){const h=Ai(o,a);if(!h)return[];const E=a.numViews??120;return Array.from({length:E},(g,S)=>({...Di(h,S/E),img_name:`circle_${S.toString().padStart(4,"0")}`,id:S}))}const Li="BITYMI01",Tc=0,Ac=1,Dc=2,Lc=3,Ic=4,Rc=5;function Ft(o){const a=(o&32768)>>15,h=(o&31744)>>10,E=o&1023;return h===0?(a?-1:1)*Math.pow(2,-14)*(E/1024):h===31?E?NaN:a?-1/0:1/0:(a?-1:1)*Math.pow(2,h-15)*(1+E/1024)}function Ns(o,a,h,E,g,S,M,L,A,I=.5){const K=A?A.length:M.length/8,q=[],z=[];for(let Y=0;Y<K;Y++){const se=(A?A[Y]:Y)*8,W=M[se]-o,J=M[se+1]-a,N=M[se+2]-h,pe=W*E+J*g+N*S;if(pe<=0||!(L[se+7]>>>16&1))continue;const he=L[se+4],_e=Ft(he&65535),ae=Ft(he>>>16&65535),ue=3*Math.max(_e,ae),Te=W-pe*E,ee=J-pe*g,fe=N-pe*S;if(Te*Te+ee*ee+fe*fe>ue*ue)continue;const be=Ft(L[se+3]&65535);if(be<1/255)continue;const Le=L[se+5],Ae=L[se+6];let Z=Ft(Le&65535),j=Ft(Le>>>16&65535),O=Ft(Ae&65535),we=Ft(Ae>>>16&65535);const Ce=Math.hypot(Z,j,O,we)||1;Z/=Ce,j/=Ce,O/=Ce,we/=Ce;const Ve=1-2*(O*O+we*we),Ge=2*(j*O+Z*we),Ne=2*(j*we-Z*O),le=2*(j*O-Z*we),Pe=1-2*(j*j+we*we),ke=2*(O*we+Z*j),B=2*(j*we+Z*O),V=2*(O*we-Z*j),v=1-2*(j*j+O*O),i=E*B+g*V+S*v;if(Math.abs(i)<1e-6)continue;const f=(W*B+J*V+N*v)/i;if(!(f>0))continue;const u=f*E-W,b=f*g-J,x=f*S-N,k=(u*Ve+b*Ge+x*Ne)/(_e||1e-6),P=(u*le+b*Pe+x*ke)/(ae||1e-6),r=k*k+P*P;if(r>9)continue;const m=Math.min(.99,be*Math.exp(-.5*r));m<1/255||(q.push(f),z.push(m))}if(q.length===0)return null;const X=q.map((Y,Q)=>Q).sort((Y,Q)=>q[Y]-q[Q]);let oe=1;for(const Y of X)if(oe*=1-z[Y],oe<I)return q[Y];return null}function $s(o,a,h){const E=(o-h.viewport[0]*.5)/h.focal[0],g=-((a-h.viewport[1]*.5)/h.focal[1]),S=h.rotation;let M=E*S[0]+g*S[1]+S[2],L=E*S[4]+g*S[5]+S[6],A=E*S[8]+g*S[9]+S[10];const I=Math.hypot(M,L,A)||1;return[M/I,L/I,A/I]}function zc(o,a,h,E,g,S){const[M,L,A]=$s(o,a,E),I=E.position[0],K=E.position[1],q=E.position[2],z=new Uint32Array(g.buffer,g.byteOffset,g.length);let X=Ns(I,K,q,M,L,A,g,z,null,.5);return X===null&&(X=Ns(I,K,q,M,L,A,g,z,null,.8)),X===null?null:[I+X*M,K+X*L,q+X*A]}function Gc(o,a){const h=o.viewport[0],E=o.viewport[1],g=new Uint32Array(a.buffer,a.byteOffset,a.length),S=o.position[0],M=o.position[1],L=o.position[2],[A,I,K]=$s(h*.5,E*.5,o),q=.06*Math.max(h,E),z=(q+2)/o.focal[0],X=a.length/8,oe=[];for(let W=0;W<X;W++){const J=W*8,N=a[J]-S,pe=a[J+1]-M,he=a[J+2]-L,_e=N*A+pe*I+he*K;if(_e<=0)continue;const ae=g[J+4],ue=3*Math.max(Ft(ae&65535),Ft(ae>>>16&65535)),Te=N-_e*A,ee=pe-_e*I,fe=he-_e*K,be=_e*z+ue;Te*Te+ee*ee+fe*fe<=be*be&&oe.push(W)}if(oe.length===0)return null;const Y=Int32Array.from(oe),Q=[],se=5;for(let W=0;W<se;W++)for(let J=0;J<se;J++){const N=h*.5+(J-(se-1)/2)/((se-1)/2)*q,pe=E*.5+(W-(se-1)/2)/((se-1)/2)*q,[he,_e,ae]=$s(N,pe,o),ue=Ns(S,M,L,he,_e,ae,a,g,Y,.5);ue!==null&&Q.push(ue*(he*A+_e*I+ae*K))}return Q.length<3?null:(Q.sort((W,J)=>W-J),Q[Q.length>>1])}function Ii(o){const a=new Uint8Array(o),h=new TextDecoder().decode(a.subarray(0,8));if(h!==Li)throw new Error(`Not a BITYMI bundle (bad magic '${h}')`);const E=new DataView(o),g=E.getUint32(8,!0),S=12,M=20;let L=null,A=null,I=null;for(let K=0;K<g;K++){const q=S+K*M,z=E.getUint32(q+0,!0),X=Number(E.getBigUint64(q+4,!0)),oe=Number(E.getBigUint64(q+12,!0)),Y=a.slice(X,X+oe).buffer;z===Tc||z===Ac||z===Rc?L=Y:z===Dc?A=Y:(z===Lc||z===Ic)&&(I=Y)}if(L===null)throw new Error("BITYMI bundle has no point cloud chunk");return{pcBuffer:L,camerasBuffer:A,atlasBuffer:I}}async function bi(o,a){var M;const h=await fetch(o);if(!h.ok)throw new Error(`fetch failed: ${h.status} ${h.statusText}`);const E=(()=>{const L=h.headers.get("content-length");return L&&parseInt(L,10)||void 0})(),g=(M=h.body)==null?void 0:M.getReader();let S;if(!g)S=await h.arrayBuffer(),a&&a(S.byteLength,E,0);else{const L=[];let A=0,I=performance.now(),K=0;for(;;){const{done:X,value:oe}=await g.read();if(X)break;L.push(oe),A+=oe.byteLength;const Y=performance.now();if(Y-I>=150&&a){const Q=(A-K)/((Y-I)/1e3);a(A,E,Q),I=Y,K=A}}const q=new Uint8Array(A);let z=0;for(const X of L)q.set(X,z),z+=X.byteLength;S=q.buffer,a&&a(A,E,0)}return S.byteLength>=8&&new TextDecoder().decode(new Uint8Array(S,0,8))===Li?{bundle:Ii(S),rawPly:null}:{bundle:null,rawPly:S}}function Uc(o){return new Promise(a=>{const h=document.createElement("input");h.type="file",h.accept=o,h.style.display="none",h.onchange=()=>{var E;return a(((E=h.files)==null?void 0:E[0])??null)},document.body.appendChild(h),h.click(),setTimeout(()=>document.body.removeChild(h),1e3)})}function Vc(o,a,h){const E=document.getElementById("ui-panel-container"),g=document.getElementById("load-button"),S=document.getElementById("quick-links");g&&(g.onclick=async()=>{const I=await Uc(".ply,.bitymi");if(I)if(E&&(E.style.display="none"),I.name.toLowerCase().endsWith(".bitymi")){const K=await I.arrayBuffer(),{pcBuffer:q}=Ii(K),z=new File([q],I.name.replace(/\.bitymi$/i,".ply"),{type:"application/octet-stream"}),X=await zs(z,o);a(X)}else{const K=await zs(I,o);a(K)}}),S&&(S.innerHTML="");const M=new URLSearchParams(window.location.search),L=M.get("bundle")??M.get("model_url"),A=M.get("camera_url");L&&(E&&(E.style.display="none"),h(L,A))}async function Oc(o,a,h,E){const g=new Fs(o,h),S=new Sc(g);let M=!1;o.addEventListener("pointerdown",()=>{M=!0}),window.addEventListener("pointerup",()=>{M=!1});const L=typeof window<"u"&&window.parent!==window,A={pos:new Float32Array(3),rot:new Float32Array(16)};if(L){window.addEventListener("message",Z=>{const j=Z.data;if(!(!j||j.type!=="halloumi_sync_pose")&&!(!Array.isArray(j.position)||j.position.length!==3)&&!(!Array.isArray(j.rotation)||j.rotation.length!==16)){for(let O=0;O<3;O++)g.position[O]=j.position[O];for(let O=0;O<16;O++)g.rotation[O]=j.rotation[O];g.update_buffer(),S.resetToCamera();for(let O=0;O<3;O++)A.pos[O]=g.position[O];for(let O=0;O<16;O++)A.rot[O]=g.rotation[O]}});try{window.parent.postMessage({type:"halloumi_sync_ready"},"*")}catch{}}const I=()=>{if(!L)return;const Z=g.position,j=g.rotation;let O=!1;for(let we=0;we<3;we++)if(Math.abs(Z[we]-A.pos[we])>1e-6){O=!0;break}if(!O){for(let we=0;we<16;we++)if(Math.abs(j[we]-A.rot[we])>1e-6){O=!0;break}}if(O){for(let we=0;we<3;we++)A.pos[we]=Z[we];for(let we=0;we<16;we++)A.rot[we]=j[we];try{window.parent.postMessage({type:"halloumi_camera_state",position:[Z[0],Z[1],Z[2]],rotation:Array.from(j)},"*")}catch{}}},K="rgba8unorm";a.configure({device:h,format:K,alphaMode:"opaque",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.STORAGE_BINDING});let q=null,z=null;const X=()=>{g.on_update_canvas(),q!==null&&Bn(o.width,o.height,h,q.render_settings_buffer),z!==null&&z()};new ResizeObserver(()=>{const Z=Math.max(.25,fe.render_scale),j=Math.max(1,Math.ceil(Z*o.clientWidth)),O=Math.max(1,Math.ceil(Z*o.clientHeight));o.width===j&&o.height===O||(o.width=j,o.height=O,X())}).observe(o);let Y=0,Q=0;const se=()=>{(o.width!==Y||o.height!==Q)&&(Y=o.width,Q=o.height,X())},W=new URLSearchParams(window.location.search);let N=W.get("animation")==="1";S.enabled=!N;const pe=W.get("camera_url"),he=W.get("bfc"),_e=he==="1"||he==="true",ae=W.get("bfc_cos"),ue=ae!==null?Number(ae):NaN,Te=Number.isFinite(ue)?ue:2,ee=Math.max(1,window.devicePixelRatio||1),fe={gaussian_scaling:1,sh_bias:.5,animate:N,animateMode:"presets",bg:{r:0,g:0,b:0,a:0},atlas_enabled:!1,mips:(new URLSearchParams(window.location.search).get("mip")??"1")!=="0",bfc:_e,bfc_cos:Te,legacy_renderer:!1,fetch_by_id:!0,render_scale:1},be=new Yl.Pane({title:"Config",expanded:!0});be.addInput(fe,"animate",{label:"Animate"}).on("change",Z=>{const j=N;N=Z.value,S.enabled=!Z.value,!j&&N&&Le.value&&Le.value.onAnimateStart(),j&&!N&&Le.value&&Le.value.onAnimateStop()}),be.addInput(fe,"animateMode",{label:"Anim path",options:{"Training views":"presets","Circle orbit":"circle"}});const Le={value:null};Vc(h,Z=>Ae(Z,[],null),async(Z,j)=>{let O=j??pe,we,Ce=null;const Ve=Z.toLowerCase();if(Ve.endsWith(".bitymi")||Ve.includes(".bitymi?")){Ws("downloading bundle ...");try{const{bundle:ke}=await bi(Z,(V,v,i)=>{const f=V/1048576,u=v?v/(1024*1024):void 0,b=i/(1024*1024),x=v?Math.min(99,Math.floor(V/v*100)):void 0,k=u?`total ${u.toFixed(1)} MB`:"total -- MB",P=u&&x!==void 0?`${f.toFixed(1)} MB downloaded (${x}%)`:`${f.toFixed(1)} MB downloaded`,r=`${b.toFixed(2)} MB/s`;Nt(`downloading bundle ...
${k}, ${P}
