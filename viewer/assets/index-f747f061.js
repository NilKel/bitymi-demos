var xl=Object.defineProperty;var yl=(o,l,f)=>l in o?xl(o,l,{enumerable:!0,configurable:!0,writable:!0,value:f}):o[l]=f;var L=(o,l,f)=>(yl(o,typeof l!="symbol"?l+"":l,f),f);(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const g of document.querySelectorAll('link[rel="modulepreload"]'))S(g);new MutationObserver(g=>{for(const C of g)if(C.type==="childList")for(const B of C.addedNodes)B.tagName==="LINK"&&B.rel==="modulepreload"&&S(B)}).observe(document,{childList:!0,subtree:!0});function f(g){const C={};return g.integrity&&(C.integrity=g.integrity),g.referrerPolicy&&(C.referrerPolicy=g.referrerPolicy),g.crossOrigin==="use-credentials"?C.credentials="include":g.crossOrigin==="anonymous"?C.credentials="omit":C.credentials="same-origin",C}function S(g){if(g.ep)return;g.ep=!0;const C=f(g);fetch(g.href,C)}})();function Pl(o,l){return class extends o{constructor(...f){super(...f),l(this)}}}const Sl=Pl(Array,o=>o.fill(0));let De=1e-6;function El(o){function l(b=0,P=0){const k=new o(2);return b!==void 0&&(k[0]=b,P!==void 0&&(k[1]=P)),k}const f=l;function S(b,P,k){const r=k??new o(2);return r[0]=b,r[1]=P,r}function g(b,P){const k=P??new o(2);return k[0]=Math.ceil(b[0]),k[1]=Math.ceil(b[1]),k}function C(b,P){const k=P??new o(2);return k[0]=Math.floor(b[0]),k[1]=Math.floor(b[1]),k}function B(b,P){const k=P??new o(2);return k[0]=Math.round(b[0]),k[1]=Math.round(b[1]),k}function $(b,P=0,k=1,r){const h=r??new o(2);return h[0]=Math.min(k,Math.max(P,b[0])),h[1]=Math.min(k,Math.max(P,b[1])),h}function I(b,P,k){const r=k??new o(2);return r[0]=b[0]+P[0],r[1]=b[1]+P[1],r}function V(b,P,k,r){const h=r??new o(2);return h[0]=b[0]+P[0]*k,h[1]=b[1]+P[1]*k,h}function q(b,P){const k=b[0],r=b[1],h=P[0],c=P[1],d=Math.sqrt(k*k+r*r),a=Math.sqrt(h*h+c*c),m=d*a,y=m&&he(b,P)/m;return Math.acos(y)}function U(b,P,k){const r=k??new o(2);return r[0]=b[0]-P[0],r[1]=b[1]-P[1],r}const Y=U;function Z(b,P){return Math.abs(b[0]-P[0])<De&&Math.abs(b[1]-P[1])<De}function O(b,P){return b[0]===P[0]&&b[1]===P[1]}function z(b,P,k,r){const h=r??new o(2);return h[0]=b[0]+k*(P[0]-b[0]),h[1]=b[1]+k*(P[1]-b[1]),h}function F(b,P,k,r){const h=r??new o(2);return h[0]=b[0]+k[0]*(P[0]-b[0]),h[1]=b[1]+k[1]*(P[1]-b[1]),h}function W(b,P,k){const r=k??new o(2);return r[0]=Math.max(b[0],P[0]),r[1]=Math.max(b[1],P[1]),r}function j(b,P,k){const r=k??new o(2);return r[0]=Math.min(b[0],P[0]),r[1]=Math.min(b[1],P[1]),r}function M(b,P,k){const r=k??new o(2);return r[0]=b[0]*P,r[1]=b[1]*P,r}const K=M;function oe(b,P,k){const r=k??new o(2);return r[0]=b[0]/P,r[1]=b[1]/P,r}function we(b,P){const k=P??new o(2);return k[0]=1/b[0],k[1]=1/b[1],k}const ue=we;function ne(b,P,k){const r=k??new o(3),h=b[0]*P[1]-b[1]*P[0];return r[0]=0,r[1]=0,r[2]=h,r}function he(b,P){return b[0]*P[0]+b[1]*P[1]}function te(b){const P=b[0],k=b[1];return Math.sqrt(P*P+k*k)}const Oe=te;function Ge(b){const P=b[0],k=b[1];return P*P+k*k}const Le=Ge;function Te(b,P){const k=b[0]-P[0],r=b[1]-P[1];return Math.sqrt(k*k+r*r)}const ge=Te;function Pe(b,P){const k=b[0]-P[0],r=b[1]-P[1];return k*k+r*r}const ae=Pe;function se(b,P){const k=P??new o(2),r=b[0],h=b[1],c=Math.sqrt(r*r+h*h);return c>1e-5?(k[0]=r/c,k[1]=h/c):(k[0]=0,k[1]=0),k}function ie(b,P){const k=P??new o(2);return k[0]=-b[0],k[1]=-b[1],k}function _e(b,P){const k=P??new o(2);return k[0]=b[0],k[1]=b[1],k}const pe=_e;function be(b,P,k){const r=k??new o(2);return r[0]=b[0]*P[0],r[1]=b[1]*P[1],r}const Me=be;function ye(b,P,k){const r=k??new o(2);return r[0]=b[0]/P[0],r[1]=b[1]/P[1],r}const Be=ye;function Ve(b=1,P){const k=P??new o(2),r=Math.random()*2*Math.PI;return k[0]=Math.cos(r)*b,k[1]=Math.sin(r)*b,k}function A(b){const P=b??new o(2);return P[0]=0,P[1]=0,P}function H(b,P,k){const r=k??new o(2),h=b[0],c=b[1];return r[0]=h*P[0]+c*P[4]+P[12],r[1]=h*P[1]+c*P[5]+P[13],r}function x(b,P,k){const r=k??new o(2),h=b[0],c=b[1];return r[0]=P[0]*h+P[4]*c+P[8],r[1]=P[1]*h+P[5]*c+P[9],r}function i(b,P,k,r){const h=r??new o(2),c=b[0]-P[0],d=b[1]-P[1],a=Math.sin(k),m=Math.cos(k);return h[0]=c*m-d*a+P[0],h[1]=c*a+d*m+P[1],h}function _(b,P,k){const r=k??new o(2);return se(b,r),M(r,P,r)}function p(b,P,k){const r=k??new o(2);return te(b)>P?_(b,P,r):_e(b,r)}function v(b,P,k){const r=k??new o(2);return z(b,P,.5,r)}return{create:l,fromValues:f,set:S,ceil:g,floor:C,round:B,clamp:$,add:I,addScaled:V,angle:q,subtract:U,sub:Y,equalsApproximately:Z,equals:O,lerp:z,lerpV:F,max:W,min:j,mulScalar:M,scale:K,divScalar:oe,inverse:we,invert:ue,cross:ne,dot:he,length:te,len:Oe,lengthSq:Ge,lenSq:Le,distance:Te,dist:ge,distanceSq:Pe,distSq:ae,normalize:se,negate:ie,copy:_e,clone:pe,multiply:be,mul:Me,divide:ye,div:Be,random:Ve,zero:A,transformMat4:H,transformMat3:x,rotate:i,setLength:_,truncate:p,midpoint:v}}const Kr=new Map;function di(o){let l=Kr.get(o);return l||(l=El(o),Kr.set(o,l)),l}function Cl(o){function l(a,m,y){const w=new o(3);return a!==void 0&&(w[0]=a,m!==void 0&&(w[1]=m,y!==void 0&&(w[2]=y))),w}const f=l;function S(a,m,y,w){const D=w??new o(3);return D[0]=a,D[1]=m,D[2]=y,D}function g(a,m){const y=m??new o(3);return y[0]=Math.ceil(a[0]),y[1]=Math.ceil(a[1]),y[2]=Math.ceil(a[2]),y}function C(a,m){const y=m??new o(3);return y[0]=Math.floor(a[0]),y[1]=Math.floor(a[1]),y[2]=Math.floor(a[2]),y}function B(a,m){const y=m??new o(3);return y[0]=Math.round(a[0]),y[1]=Math.round(a[1]),y[2]=Math.round(a[2]),y}function $(a,m=0,y=1,w){const D=w??new o(3);return D[0]=Math.min(y,Math.max(m,a[0])),D[1]=Math.min(y,Math.max(m,a[1])),D[2]=Math.min(y,Math.max(m,a[2])),D}function I(a,m,y){const w=y??new o(3);return w[0]=a[0]+m[0],w[1]=a[1]+m[1],w[2]=a[2]+m[2],w}function V(a,m,y,w){const D=w??new o(3);return D[0]=a[0]+m[0]*y,D[1]=a[1]+m[1]*y,D[2]=a[2]+m[2]*y,D}function q(a,m){const y=a[0],w=a[1],D=a[2],T=m[0],N=m[1],re=m[2],J=Math.sqrt(y*y+w*w+D*D),X=Math.sqrt(T*T+N*N+re*re),fe=J*X,me=fe&&he(a,m)/fe;return Math.acos(me)}function U(a,m,y){const w=y??new o(3);return w[0]=a[0]-m[0],w[1]=a[1]-m[1],w[2]=a[2]-m[2],w}const Y=U;function Z(a,m){return Math.abs(a[0]-m[0])<De&&Math.abs(a[1]-m[1])<De&&Math.abs(a[2]-m[2])<De}function O(a,m){return a[0]===m[0]&&a[1]===m[1]&&a[2]===m[2]}function z(a,m,y,w){const D=w??new o(3);return D[0]=a[0]+y*(m[0]-a[0]),D[1]=a[1]+y*(m[1]-a[1]),D[2]=a[2]+y*(m[2]-a[2]),D}function F(a,m,y,w){const D=w??new o(3);return D[0]=a[0]+y[0]*(m[0]-a[0]),D[1]=a[1]+y[1]*(m[1]-a[1]),D[2]=a[2]+y[2]*(m[2]-a[2]),D}function W(a,m,y){const w=y??new o(3);return w[0]=Math.max(a[0],m[0]),w[1]=Math.max(a[1],m[1]),w[2]=Math.max(a[2],m[2]),w}function j(a,m,y){const w=y??new o(3);return w[0]=Math.min(a[0],m[0]),w[1]=Math.min(a[1],m[1]),w[2]=Math.min(a[2],m[2]),w}function M(a,m,y){const w=y??new o(3);return w[0]=a[0]*m,w[1]=a[1]*m,w[2]=a[2]*m,w}const K=M;function oe(a,m,y){const w=y??new o(3);return w[0]=a[0]/m,w[1]=a[1]/m,w[2]=a[2]/m,w}function we(a,m){const y=m??new o(3);return y[0]=1/a[0],y[1]=1/a[1],y[2]=1/a[2],y}const ue=we;function ne(a,m,y){const w=y??new o(3),D=a[2]*m[0]-a[0]*m[2],T=a[0]*m[1]-a[1]*m[0];return w[0]=a[1]*m[2]-a[2]*m[1],w[1]=D,w[2]=T,w}function he(a,m){return a[0]*m[0]+a[1]*m[1]+a[2]*m[2]}function te(a){const m=a[0],y=a[1],w=a[2];return Math.sqrt(m*m+y*y+w*w)}const Oe=te;function Ge(a){const m=a[0],y=a[1],w=a[2];return m*m+y*y+w*w}const Le=Ge;function Te(a,m){const y=a[0]-m[0],w=a[1]-m[1],D=a[2]-m[2];return Math.sqrt(y*y+w*w+D*D)}const ge=Te;function Pe(a,m){const y=a[0]-m[0],w=a[1]-m[1],D=a[2]-m[2];return y*y+w*w+D*D}const ae=Pe;function se(a,m){const y=m??new o(3),w=a[0],D=a[1],T=a[2],N=Math.sqrt(w*w+D*D+T*T);return N>1e-5?(y[0]=w/N,y[1]=D/N,y[2]=T/N):(y[0]=0,y[1]=0,y[2]=0),y}function ie(a,m){const y=m??new o(3);return y[0]=-a[0],y[1]=-a[1],y[2]=-a[2],y}function _e(a,m){const y=m??new o(3);return y[0]=a[0],y[1]=a[1],y[2]=a[2],y}const pe=_e;function be(a,m,y){const w=y??new o(3);return w[0]=a[0]*m[0],w[1]=a[1]*m[1],w[2]=a[2]*m[2],w}const Me=be;function ye(a,m,y){const w=y??new o(3);return w[0]=a[0]/m[0],w[1]=a[1]/m[1],w[2]=a[2]/m[2],w}const Be=ye;function Ve(a=1,m){const y=m??new o(3),w=Math.random()*2*Math.PI,D=Math.random()*2-1,T=Math.sqrt(1-D*D)*a;return y[0]=Math.cos(w)*T,y[1]=Math.sin(w)*T,y[2]=D*a,y}function A(a){const m=a??new o(3);return m[0]=0,m[1]=0,m[2]=0,m}function H(a,m,y){const w=y??new o(3),D=a[0],T=a[1],N=a[2],re=m[3]*D+m[7]*T+m[11]*N+m[15]||1;return w[0]=(m[0]*D+m[4]*T+m[8]*N+m[12])/re,w[1]=(m[1]*D+m[5]*T+m[9]*N+m[13])/re,w[2]=(m[2]*D+m[6]*T+m[10]*N+m[14])/re,w}function x(a,m,y){const w=y??new o(3),D=a[0],T=a[1],N=a[2];return w[0]=D*m[0*4+0]+T*m[1*4+0]+N*m[2*4+0],w[1]=D*m[0*4+1]+T*m[1*4+1]+N*m[2*4+1],w[2]=D*m[0*4+2]+T*m[1*4+2]+N*m[2*4+2],w}function i(a,m,y){const w=y??new o(3),D=a[0],T=a[1],N=a[2];return w[0]=D*m[0]+T*m[4]+N*m[8],w[1]=D*m[1]+T*m[5]+N*m[9],w[2]=D*m[2]+T*m[6]+N*m[10],w}function _(a,m,y){const w=y??new o(3),D=m[0],T=m[1],N=m[2],re=m[3]*2,J=a[0],X=a[1],fe=a[2],me=T*fe-N*X,de=N*J-D*fe,ve=D*X-T*J;return w[0]=J+me*re+(T*ve-N*de)*2,w[1]=X+de*re+(N*me-D*ve)*2,w[2]=fe+ve*re+(D*de-T*me)*2,w}function p(a,m){const y=m??new o(3);return y[0]=a[12],y[1]=a[13],y[2]=a[14],y}function v(a,m,y){const w=y??new o(3),D=m*4;return w[0]=a[D+0],w[1]=a[D+1],w[2]=a[D+2],w}function b(a,m){const y=m??new o(3),w=a[0],D=a[1],T=a[2],N=a[4],re=a[5],J=a[6],X=a[8],fe=a[9],me=a[10];return y[0]=Math.sqrt(w*w+D*D+T*T),y[1]=Math.sqrt(N*N+re*re+J*J),y[2]=Math.sqrt(X*X+fe*fe+me*me),y}function P(a,m,y,w){const D=w??new o(3),T=[],N=[];return T[0]=a[0]-m[0],T[1]=a[1]-m[1],T[2]=a[2]-m[2],N[0]=T[0],N[1]=T[1]*Math.cos(y)-T[2]*Math.sin(y),N[2]=T[1]*Math.sin(y)+T[2]*Math.cos(y),D[0]=N[0]+m[0],D[1]=N[1]+m[1],D[2]=N[2]+m[2],D}function k(a,m,y,w){const D=w??new o(3),T=[],N=[];return T[0]=a[0]-m[0],T[1]=a[1]-m[1],T[2]=a[2]-m[2],N[0]=T[2]*Math.sin(y)+T[0]*Math.cos(y),N[1]=T[1],N[2]=T[2]*Math.cos(y)-T[0]*Math.sin(y),D[0]=N[0]+m[0],D[1]=N[1]+m[1],D[2]=N[2]+m[2],D}function r(a,m,y,w){const D=w??new o(3),T=[],N=[];return T[0]=a[0]-m[0],T[1]=a[1]-m[1],T[2]=a[2]-m[2],N[0]=T[0]*Math.cos(y)-T[1]*Math.sin(y),N[1]=T[0]*Math.sin(y)+T[1]*Math.cos(y),N[2]=T[2],D[0]=N[0]+m[0],D[1]=N[1]+m[1],D[2]=N[2]+m[2],D}function h(a,m,y){const w=y??new o(3);return se(a,w),M(w,m,w)}function c(a,m,y){const w=y??new o(3);return te(a)>m?h(a,m,w):_e(a,w)}function d(a,m,y){const w=y??new o(3);return z(a,m,.5,w)}return{create:l,fromValues:f,set:S,ceil:g,floor:C,round:B,clamp:$,add:I,addScaled:V,angle:q,subtract:U,sub:Y,equalsApproximately:Z,equals:O,lerp:z,lerpV:F,max:W,min:j,mulScalar:M,scale:K,divScalar:oe,inverse:we,invert:ue,cross:ne,dot:he,length:te,len:Oe,lengthSq:Ge,lenSq:Le,distance:Te,dist:ge,distanceSq:Pe,distSq:ae,normalize:se,negate:ie,copy:_e,clone:pe,multiply:be,mul:Me,divide:ye,div:Be,random:Ve,zero:A,transformMat4:H,transformMat4Upper3x3:x,transformMat3:i,transformQuat:_,getTranslation:p,getAxis:v,getScaling:b,rotateX:P,rotateY:k,rotateZ:r,setLength:h,truncate:c,midpoint:d}}const Hr=new Map;function as(o){let l=Hr.get(o);return l||(l=Cl(o),Hr.set(o,l)),l}function kl(o){const l=di(o),f=as(o);function S(i,_,p,v,b,P,k,r,h){const c=new o(12);return c[3]=0,c[7]=0,c[11]=0,i!==void 0&&(c[0]=i,_!==void 0&&(c[1]=_,p!==void 0&&(c[2]=p,v!==void 0&&(c[4]=v,b!==void 0&&(c[5]=b,P!==void 0&&(c[6]=P,k!==void 0&&(c[8]=k,r!==void 0&&(c[9]=r,h!==void 0&&(c[10]=h))))))))),c}function g(i,_,p,v,b,P,k,r,h,c){const d=c??new o(12);return d[0]=i,d[1]=_,d[2]=p,d[3]=0,d[4]=v,d[5]=b,d[6]=P,d[7]=0,d[8]=k,d[9]=r,d[10]=h,d[11]=0,d}function C(i,_){const p=_??new o(12);return p[0]=i[0],p[1]=i[1],p[2]=i[2],p[3]=0,p[4]=i[4],p[5]=i[5],p[6]=i[6],p[7]=0,p[8]=i[8],p[9]=i[9],p[10]=i[10],p[11]=0,p}function B(i,_){const p=_??new o(12),v=i[0],b=i[1],P=i[2],k=i[3],r=v+v,h=b+b,c=P+P,d=v*r,a=b*r,m=b*h,y=P*r,w=P*h,D=P*c,T=k*r,N=k*h,re=k*c;return p[0]=1-m-D,p[1]=a+re,p[2]=y-N,p[3]=0,p[4]=a-re,p[5]=1-d-D,p[6]=w+T,p[7]=0,p[8]=y+N,p[9]=w-T,p[10]=1-d-m,p[11]=0,p}function $(i,_){const p=_??new o(12);return p[0]=-i[0],p[1]=-i[1],p[2]=-i[2],p[4]=-i[4],p[5]=-i[5],p[6]=-i[6],p[8]=-i[8],p[9]=-i[9],p[10]=-i[10],p}function I(i,_,p){const v=p??new o(12);return v[0]=i[0]*_,v[1]=i[1]*_,v[2]=i[2]*_,v[4]=i[4]*_,v[5]=i[5]*_,v[6]=i[6]*_,v[8]=i[8]*_,v[9]=i[9]*_,v[10]=i[10]*_,v}const V=I;function q(i,_,p){const v=p??new o(12);return v[0]=i[0]+_[0],v[1]=i[1]+_[1],v[2]=i[2]+_[2],v[4]=i[4]+_[4],v[5]=i[5]+_[5],v[6]=i[6]+_[6],v[8]=i[8]+_[8],v[9]=i[9]+_[9],v[10]=i[10]+_[10],v}function U(i,_){const p=_??new o(12);return p[0]=i[0],p[1]=i[1],p[2]=i[2],p[4]=i[4],p[5]=i[5],p[6]=i[6],p[8]=i[8],p[9]=i[9],p[10]=i[10],p}const Y=U;function Z(i,_){return Math.abs(i[0]-_[0])<De&&Math.abs(i[1]-_[1])<De&&Math.abs(i[2]-_[2])<De&&Math.abs(i[4]-_[4])<De&&Math.abs(i[5]-_[5])<De&&Math.abs(i[6]-_[6])<De&&Math.abs(i[8]-_[8])<De&&Math.abs(i[9]-_[9])<De&&Math.abs(i[10]-_[10])<De}function O(i,_){return i[0]===_[0]&&i[1]===_[1]&&i[2]===_[2]&&i[4]===_[4]&&i[5]===_[5]&&i[6]===_[6]&&i[8]===_[8]&&i[9]===_[9]&&i[10]===_[10]}function z(i){const _=i??new o(12);return _[0]=1,_[1]=0,_[2]=0,_[4]=0,_[5]=1,_[6]=0,_[8]=0,_[9]=0,_[10]=1,_}function F(i,_){const p=_??new o(12);if(p===i){let m;return m=i[1],i[1]=i[4],i[4]=m,m=i[2],i[2]=i[8],i[8]=m,m=i[6],i[6]=i[9],i[9]=m,p}const v=i[0*4+0],b=i[0*4+1],P=i[0*4+2],k=i[1*4+0],r=i[1*4+1],h=i[1*4+2],c=i[2*4+0],d=i[2*4+1],a=i[2*4+2];return p[0]=v,p[1]=k,p[2]=c,p[4]=b,p[5]=r,p[6]=d,p[8]=P,p[9]=h,p[10]=a,p}function W(i,_){const p=_??new o(12),v=i[0*4+0],b=i[0*4+1],P=i[0*4+2],k=i[1*4+0],r=i[1*4+1],h=i[1*4+2],c=i[2*4+0],d=i[2*4+1],a=i[2*4+2],m=a*r-h*d,y=-a*k+h*c,w=d*k-r*c,D=1/(v*m+b*y+P*w);return p[0]=m*D,p[1]=(-a*b+P*d)*D,p[2]=(h*b-P*r)*D,p[4]=y*D,p[5]=(a*v-P*c)*D,p[6]=(-h*v+P*k)*D,p[8]=w*D,p[9]=(-d*v+b*c)*D,p[10]=(r*v-b*k)*D,p}function j(i){const _=i[0],p=i[0*4+1],v=i[0*4+2],b=i[1*4+0],P=i[1*4+1],k=i[1*4+2],r=i[2*4+0],h=i[2*4+1],c=i[2*4+2];return _*(P*c-h*k)-b*(p*c-h*v)+r*(p*k-P*v)}const M=W;function K(i,_,p){const v=p??new o(12),b=i[0],P=i[1],k=i[2],r=i[4+0],h=i[4+1],c=i[4+2],d=i[8+0],a=i[8+1],m=i[8+2],y=_[0],w=_[1],D=_[2],T=_[4+0],N=_[4+1],re=_[4+2],J=_[8+0],X=_[8+1],fe=_[8+2];return v[0]=b*y+r*w+d*D,v[1]=P*y+h*w+a*D,v[2]=k*y+c*w+m*D,v[4]=b*T+r*N+d*re,v[5]=P*T+h*N+a*re,v[6]=k*T+c*N+m*re,v[8]=b*J+r*X+d*fe,v[9]=P*J+h*X+a*fe,v[10]=k*J+c*X+m*fe,v}const oe=K;function we(i,_,p){const v=p??z();return i!==v&&(v[0]=i[0],v[1]=i[1],v[2]=i[2],v[4]=i[4],v[5]=i[5],v[6]=i[6]),v[8]=_[0],v[9]=_[1],v[10]=1,v}function ue(i,_){const p=_??l.create();return p[0]=i[8],p[1]=i[9],p}function ne(i,_,p){const v=p??l.create(),b=_*4;return v[0]=i[b+0],v[1]=i[b+1],v}function he(i,_,p,v){const b=v===i?i:U(i,v),P=p*4;return b[P+0]=_[0],b[P+1]=_[1],b}function te(i,_){const p=_??l.create(),v=i[0],b=i[1],P=i[4],k=i[5];return p[0]=Math.sqrt(v*v+b*b),p[1]=Math.sqrt(P*P+k*k),p}function Oe(i,_){const p=_??f.create(),v=i[0],b=i[1],P=i[2],k=i[4],r=i[5],h=i[6],c=i[8],d=i[9],a=i[10];return p[0]=Math.sqrt(v*v+b*b+P*P),p[1]=Math.sqrt(k*k+r*r+h*h),p[2]=Math.sqrt(c*c+d*d+a*a),p}function Ge(i,_){const p=_??new o(12);return p[0]=1,p[1]=0,p[2]=0,p[4]=0,p[5]=1,p[6]=0,p[8]=i[0],p[9]=i[1],p[10]=1,p}function Le(i,_,p){const v=p??new o(12),b=_[0],P=_[1],k=i[0],r=i[1],h=i[2],c=i[1*4+0],d=i[1*4+1],a=i[1*4+2],m=i[2*4+0],y=i[2*4+1],w=i[2*4+2];return i!==v&&(v[0]=k,v[1]=r,v[2]=h,v[4]=c,v[5]=d,v[6]=a),v[8]=k*b+c*P+m,v[9]=r*b+d*P+y,v[10]=h*b+a*P+w,v}function Te(i,_){const p=_??new o(12),v=Math.cos(i),b=Math.sin(i);return p[0]=v,p[1]=b,p[2]=0,p[4]=-b,p[5]=v,p[6]=0,p[8]=0,p[9]=0,p[10]=1,p}function ge(i,_,p){const v=p??new o(12),b=i[0*4+0],P=i[0*4+1],k=i[0*4+2],r=i[1*4+0],h=i[1*4+1],c=i[1*4+2],d=Math.cos(_),a=Math.sin(_);return v[0]=d*b+a*r,v[1]=d*P+a*h,v[2]=d*k+a*c,v[4]=d*r-a*b,v[5]=d*h-a*P,v[6]=d*c-a*k,i!==v&&(v[8]=i[8],v[9]=i[9],v[10]=i[10]),v}function Pe(i,_){const p=_??new o(12),v=Math.cos(i),b=Math.sin(i);return p[0]=1,p[1]=0,p[2]=0,p[4]=0,p[5]=v,p[6]=b,p[8]=0,p[9]=-b,p[10]=v,p}function ae(i,_,p){const v=p??new o(12),b=i[4],P=i[5],k=i[6],r=i[8],h=i[9],c=i[10],d=Math.cos(_),a=Math.sin(_);return v[4]=d*b+a*r,v[5]=d*P+a*h,v[6]=d*k+a*c,v[8]=d*r-a*b,v[9]=d*h-a*P,v[10]=d*c-a*k,i!==v&&(v[0]=i[0],v[1]=i[1],v[2]=i[2]),v}function se(i,_){const p=_??new o(12),v=Math.cos(i),b=Math.sin(i);return p[0]=v,p[1]=0,p[2]=-b,p[4]=0,p[5]=1,p[6]=0,p[8]=b,p[9]=0,p[10]=v,p}function ie(i,_,p){const v=p??new o(12),b=i[0*4+0],P=i[0*4+1],k=i[0*4+2],r=i[2*4+0],h=i[2*4+1],c=i[2*4+2],d=Math.cos(_),a=Math.sin(_);return v[0]=d*b-a*r,v[1]=d*P-a*h,v[2]=d*k-a*c,v[8]=d*r+a*b,v[9]=d*h+a*P,v[10]=d*c+a*k,i!==v&&(v[4]=i[4],v[5]=i[5],v[6]=i[6]),v}const _e=Te,pe=ge;function be(i,_){const p=_??new o(12);return p[0]=i[0],p[1]=0,p[2]=0,p[4]=0,p[5]=i[1],p[6]=0,p[8]=0,p[9]=0,p[10]=1,p}function Me(i,_,p){const v=p??new o(12),b=_[0],P=_[1];return v[0]=b*i[0*4+0],v[1]=b*i[0*4+1],v[2]=b*i[0*4+2],v[4]=P*i[1*4+0],v[5]=P*i[1*4+1],v[6]=P*i[1*4+2],i!==v&&(v[8]=i[8],v[9]=i[9],v[10]=i[10]),v}function ye(i,_){const p=_??new o(12);return p[0]=i[0],p[1]=0,p[2]=0,p[4]=0,p[5]=i[1],p[6]=0,p[8]=0,p[9]=0,p[10]=i[2],p}function Be(i,_,p){const v=p??new o(12),b=_[0],P=_[1],k=_[2];return v[0]=b*i[0*4+0],v[1]=b*i[0*4+1],v[2]=b*i[0*4+2],v[4]=P*i[1*4+0],v[5]=P*i[1*4+1],v[6]=P*i[1*4+2],v[8]=k*i[2*4+0],v[9]=k*i[2*4+1],v[10]=k*i[2*4+2],v}function Ve(i,_){const p=_??new o(12);return p[0]=i,p[1]=0,p[2]=0,p[4]=0,p[5]=i,p[6]=0,p[8]=0,p[9]=0,p[10]=1,p}function A(i,_,p){const v=p??new o(12);return v[0]=_*i[0*4+0],v[1]=_*i[0*4+1],v[2]=_*i[0*4+2],v[4]=_*i[1*4+0],v[5]=_*i[1*4+1],v[6]=_*i[1*4+2],i!==v&&(v[8]=i[8],v[9]=i[9],v[10]=i[10]),v}function H(i,_){const p=_??new o(12);return p[0]=i,p[1]=0,p[2]=0,p[4]=0,p[5]=i,p[6]=0,p[8]=0,p[9]=0,p[10]=i,p}function x(i,_,p){const v=p??new o(12);return v[0]=_*i[0*4+0],v[1]=_*i[0*4+1],v[2]=_*i[0*4+2],v[4]=_*i[1*4+0],v[5]=_*i[1*4+1],v[6]=_*i[1*4+2],v[8]=_*i[2*4+0],v[9]=_*i[2*4+1],v[10]=_*i[2*4+2],v}return{add:q,clone:Y,copy:U,create:S,determinant:j,equals:O,equalsApproximately:Z,fromMat4:C,fromQuat:B,get3DScaling:Oe,getAxis:ne,getScaling:te,getTranslation:ue,identity:z,inverse:W,invert:M,mul:oe,mulScalar:V,multiply:K,multiplyScalar:I,negate:$,rotate:ge,rotateX:ae,rotateY:ie,rotateZ:pe,rotation:Te,rotationX:Pe,rotationY:se,rotationZ:_e,scale:Me,scale3D:Be,scaling:be,scaling3D:ye,set:g,setAxis:he,setTranslation:we,translate:Le,translation:Ge,transpose:F,uniformScale:A,uniformScale3D:x,uniformScaling:Ve,uniformScaling3D:H}}const Yr=new Map;function Bl(o){let l=Yr.get(o);return l||(l=kl(o),Yr.set(o,l)),l}function Tl(o){const l=as(o);function f(r,h,c,d,a,m,y,w,D,T,N,re,J,X,fe,me){const de=new o(16);return r!==void 0&&(de[0]=r,h!==void 0&&(de[1]=h,c!==void 0&&(de[2]=c,d!==void 0&&(de[3]=d,a!==void 0&&(de[4]=a,m!==void 0&&(de[5]=m,y!==void 0&&(de[6]=y,w!==void 0&&(de[7]=w,D!==void 0&&(de[8]=D,T!==void 0&&(de[9]=T,N!==void 0&&(de[10]=N,re!==void 0&&(de[11]=re,J!==void 0&&(de[12]=J,X!==void 0&&(de[13]=X,fe!==void 0&&(de[14]=fe,me!==void 0&&(de[15]=me)))))))))))))))),de}function S(r,h,c,d,a,m,y,w,D,T,N,re,J,X,fe,me,de){const ve=de??new o(16);return ve[0]=r,ve[1]=h,ve[2]=c,ve[3]=d,ve[4]=a,ve[5]=m,ve[6]=y,ve[7]=w,ve[8]=D,ve[9]=T,ve[10]=N,ve[11]=re,ve[12]=J,ve[13]=X,ve[14]=fe,ve[15]=me,ve}function g(r,h){const c=h??new o(16);return c[0]=r[0],c[1]=r[1],c[2]=r[2],c[3]=0,c[4]=r[4],c[5]=r[5],c[6]=r[6],c[7]=0,c[8]=r[8],c[9]=r[9],c[10]=r[10],c[11]=0,c[12]=0,c[13]=0,c[14]=0,c[15]=1,c}function C(r,h){const c=h??new o(16),d=r[0],a=r[1],m=r[2],y=r[3],w=d+d,D=a+a,T=m+m,N=d*w,re=a*w,J=a*D,X=m*w,fe=m*D,me=m*T,de=y*w,ve=y*D,Ae=y*T;return c[0]=1-J-me,c[1]=re+Ae,c[2]=X-ve,c[3]=0,c[4]=re-Ae,c[5]=1-N-me,c[6]=fe+de,c[7]=0,c[8]=X+ve,c[9]=fe-de,c[10]=1-N-J,c[11]=0,c[12]=0,c[13]=0,c[14]=0,c[15]=1,c}function B(r,h){const c=h??new o(16);return c[0]=-r[0],c[1]=-r[1],c[2]=-r[2],c[3]=-r[3],c[4]=-r[4],c[5]=-r[5],c[6]=-r[6],c[7]=-r[7],c[8]=-r[8],c[9]=-r[9],c[10]=-r[10],c[11]=-r[11],c[12]=-r[12],c[13]=-r[13],c[14]=-r[14],c[15]=-r[15],c}function $(r,h,c){const d=c??new o(16);return d[0]=r[0]+h[0],d[1]=r[1]+h[1],d[2]=r[2]+h[2],d[3]=r[3]+h[3],d[4]=r[4]+h[4],d[5]=r[5]+h[5],d[6]=r[6]+h[6],d[7]=r[7]+h[7],d[8]=r[8]+h[8],d[9]=r[9]+h[9],d[10]=r[10]+h[10],d[11]=r[11]+h[11],d[12]=r[12]+h[12],d[13]=r[13]+h[13],d[14]=r[14]+h[14],d[15]=r[15]+h[15],d}function I(r,h,c){const d=c??new o(16);return d[0]=r[0]*h,d[1]=r[1]*h,d[2]=r[2]*h,d[3]=r[3]*h,d[4]=r[4]*h,d[5]=r[5]*h,d[6]=r[6]*h,d[7]=r[7]*h,d[8]=r[8]*h,d[9]=r[9]*h,d[10]=r[10]*h,d[11]=r[11]*h,d[12]=r[12]*h,d[13]=r[13]*h,d[14]=r[14]*h,d[15]=r[15]*h,d}const V=I;function q(r,h){const c=h??new o(16);return c[0]=r[0],c[1]=r[1],c[2]=r[2],c[3]=r[3],c[4]=r[4],c[5]=r[5],c[6]=r[6],c[7]=r[7],c[8]=r[8],c[9]=r[9],c[10]=r[10],c[11]=r[11],c[12]=r[12],c[13]=r[13],c[14]=r[14],c[15]=r[15],c}const U=q;function Y(r,h){return Math.abs(r[0]-h[0])<De&&Math.abs(r[1]-h[1])<De&&Math.abs(r[2]-h[2])<De&&Math.abs(r[3]-h[3])<De&&Math.abs(r[4]-h[4])<De&&Math.abs(r[5]-h[5])<De&&Math.abs(r[6]-h[6])<De&&Math.abs(r[7]-h[7])<De&&Math.abs(r[8]-h[8])<De&&Math.abs(r[9]-h[9])<De&&Math.abs(r[10]-h[10])<De&&Math.abs(r[11]-h[11])<De&&Math.abs(r[12]-h[12])<De&&Math.abs(r[13]-h[13])<De&&Math.abs(r[14]-h[14])<De&&Math.abs(r[15]-h[15])<De}function Z(r,h){return r[0]===h[0]&&r[1]===h[1]&&r[2]===h[2]&&r[3]===h[3]&&r[4]===h[4]&&r[5]===h[5]&&r[6]===h[6]&&r[7]===h[7]&&r[8]===h[8]&&r[9]===h[9]&&r[10]===h[10]&&r[11]===h[11]&&r[12]===h[12]&&r[13]===h[13]&&r[14]===h[14]&&r[15]===h[15]}function O(r){const h=r??new o(16);return h[0]=1,h[1]=0,h[2]=0,h[3]=0,h[4]=0,h[5]=1,h[6]=0,h[7]=0,h[8]=0,h[9]=0,h[10]=1,h[11]=0,h[12]=0,h[13]=0,h[14]=0,h[15]=1,h}function z(r,h){const c=h??new o(16);if(c===r){let xe;return xe=r[1],r[1]=r[4],r[4]=xe,xe=r[2],r[2]=r[8],r[8]=xe,xe=r[3],r[3]=r[12],r[12]=xe,xe=r[6],r[6]=r[9],r[9]=xe,xe=r[7],r[7]=r[13],r[13]=xe,xe=r[11],r[11]=r[14],r[14]=xe,c}const d=r[0*4+0],a=r[0*4+1],m=r[0*4+2],y=r[0*4+3],w=r[1*4+0],D=r[1*4+1],T=r[1*4+2],N=r[1*4+3],re=r[2*4+0],J=r[2*4+1],X=r[2*4+2],fe=r[2*4+3],me=r[3*4+0],de=r[3*4+1],ve=r[3*4+2],Ae=r[3*4+3];return c[0]=d,c[1]=w,c[2]=re,c[3]=me,c[4]=a,c[5]=D,c[6]=J,c[7]=de,c[8]=m,c[9]=T,c[10]=X,c[11]=ve,c[12]=y,c[13]=N,c[14]=fe,c[15]=Ae,c}function F(r,h){const c=h??new o(16),d=r[0*4+0],a=r[0*4+1],m=r[0*4+2],y=r[0*4+3],w=r[1*4+0],D=r[1*4+1],T=r[1*4+2],N=r[1*4+3],re=r[2*4+0],J=r[2*4+1],X=r[2*4+2],fe=r[2*4+3],me=r[3*4+0],de=r[3*4+1],ve=r[3*4+2],Ae=r[3*4+3],xe=X*Ae,We=ve*fe,je=T*Ae,Ke=ve*N,Ye=T*fe,ze=X*N,nt=m*Ae,it=ve*y,ot=m*fe,Ze=X*y,et=m*N,st=T*y,Fe=re*de,at=me*J,Xe=w*de,ut=me*D,rt=w*J,Mt=re*D,wt=d*de,St=me*a,Et=d*J,Ct=re*a,Dt=d*D,Ot=w*a,kt=xe*D+Ke*J+Ye*de-(We*D+je*J+ze*de),Gt=We*a+nt*J+Ze*de-(xe*a+it*J+ot*de),ln=je*a+it*D+et*de-(Ke*a+nt*D+st*de),cn=ze*a+ot*D+st*J-(Ye*a+Ze*D+et*J),He=1/(d*kt+w*Gt+re*ln+me*cn);return c[0]=He*kt,c[1]=He*Gt,c[2]=He*ln,c[3]=He*cn,c[4]=He*(We*w+je*re+ze*me-(xe*w+Ke*re+Ye*me)),c[5]=He*(xe*d+it*re+ot*me-(We*d+nt*re+Ze*me)),c[6]=He*(Ke*d+nt*w+st*me-(je*d+it*w+et*me)),c[7]=He*(Ye*d+Ze*w+et*re-(ze*d+ot*w+st*re)),c[8]=He*(Fe*N+ut*fe+rt*Ae-(at*N+Xe*fe+Mt*Ae)),c[9]=He*(at*y+wt*fe+Ct*Ae-(Fe*y+St*fe+Et*Ae)),c[10]=He*(Xe*y+St*N+Dt*Ae-(ut*y+wt*N+Ot*Ae)),c[11]=He*(Mt*y+Et*N+Ot*fe-(rt*y+Ct*N+Dt*fe)),c[12]=He*(Xe*X+Mt*ve+at*T-(rt*ve+Fe*T+ut*X)),c[13]=He*(Et*ve+Fe*m+St*X-(wt*X+Ct*ve+at*m)),c[14]=He*(wt*T+Ot*ve+ut*m-(Dt*ve+Xe*m+St*T)),c[15]=He*(Dt*X+rt*m+Ct*T-(Et*T+Ot*X+Mt*m)),c}function W(r){const h=r[0],c=r[0*4+1],d=r[0*4+2],a=r[0*4+3],m=r[1*4+0],y=r[1*4+1],w=r[1*4+2],D=r[1*4+3],T=r[2*4+0],N=r[2*4+1],re=r[2*4+2],J=r[2*4+3],X=r[3*4+0],fe=r[3*4+1],me=r[3*4+2],de=r[3*4+3],ve=re*de,Ae=me*J,xe=w*de,We=me*D,je=w*J,Ke=re*D,Ye=d*de,ze=me*a,nt=d*J,it=re*a,ot=d*D,Ze=w*a,et=ve*y+We*N+je*fe-(Ae*y+xe*N+Ke*fe),st=Ae*c+Ye*N+it*fe-(ve*c+ze*N+nt*fe),Fe=xe*c+ze*y+ot*fe-(We*c+Ye*y+Ze*fe),at=Ke*c+nt*y+Ze*N-(je*c+it*y+ot*N);return h*et+m*st+T*Fe+X*at}const j=F;function M(r,h,c){const d=c??new o(16),a=r[0],m=r[1],y=r[2],w=r[3],D=r[4+0],T=r[4+1],N=r[4+2],re=r[4+3],J=r[8+0],X=r[8+1],fe=r[8+2],me=r[8+3],de=r[12+0],ve=r[12+1],Ae=r[12+2],xe=r[12+3],We=h[0],je=h[1],Ke=h[2],Ye=h[3],ze=h[4+0],nt=h[4+1],it=h[4+2],ot=h[4+3],Ze=h[8+0],et=h[8+1],st=h[8+2],Fe=h[8+3],at=h[12+0],Xe=h[12+1],ut=h[12+2],rt=h[12+3];return d[0]=a*We+D*je+J*Ke+de*Ye,d[1]=m*We+T*je+X*Ke+ve*Ye,d[2]=y*We+N*je+fe*Ke+Ae*Ye,d[3]=w*We+re*je+me*Ke+xe*Ye,d[4]=a*ze+D*nt+J*it+de*ot,d[5]=m*ze+T*nt+X*it+ve*ot,d[6]=y*ze+N*nt+fe*it+Ae*ot,d[7]=w*ze+re*nt+me*it+xe*ot,d[8]=a*Ze+D*et+J*st+de*Fe,d[9]=m*Ze+T*et+X*st+ve*Fe,d[10]=y*Ze+N*et+fe*st+Ae*Fe,d[11]=w*Ze+re*et+me*st+xe*Fe,d[12]=a*at+D*Xe+J*ut+de*rt,d[13]=m*at+T*Xe+X*ut+ve*rt,d[14]=y*at+N*Xe+fe*ut+Ae*rt,d[15]=w*at+re*Xe+me*ut+xe*rt,d}const K=M;function oe(r,h,c){const d=c??O();return r!==d&&(d[0]=r[0],d[1]=r[1],d[2]=r[2],d[3]=r[3],d[4]=r[4],d[5]=r[5],d[6]=r[6],d[7]=r[7],d[8]=r[8],d[9]=r[9],d[10]=r[10],d[11]=r[11]),d[12]=h[0],d[13]=h[1],d[14]=h[2],d[15]=1,d}function we(r,h){const c=h??l.create();return c[0]=r[12],c[1]=r[13],c[2]=r[14],c}function ue(r,h,c){const d=c??l.create(),a=h*4;return d[0]=r[a+0],d[1]=r[a+1],d[2]=r[a+2],d}function ne(r,h,c,d){const a=d===r?d:q(r,d),m=c*4;return a[m+0]=h[0],a[m+1]=h[1],a[m+2]=h[2],a}function he(r,h){const c=h??l.create(),d=r[0],a=r[1],m=r[2],y=r[4],w=r[5],D=r[6],T=r[8],N=r[9],re=r[10];return c[0]=Math.sqrt(d*d+a*a+m*m),c[1]=Math.sqrt(y*y+w*w+D*D),c[2]=Math.sqrt(T*T+N*N+re*re),c}function te(r,h,c,d,a){const m=a??new o(16),y=Math.tan(Math.PI*.5-.5*r);if(m[0]=y/h,m[1]=0,m[2]=0,m[3]=0,m[4]=0,m[5]=y,m[6]=0,m[7]=0,m[8]=0,m[9]=0,m[11]=-1,m[12]=0,m[13]=0,m[15]=0,Number.isFinite(d)){const w=1/(c-d);m[10]=d*w,m[14]=d*c*w}else m[10]=-1,m[14]=-c;return m}function Oe(r,h,c,d=1/0,a){const m=a??new o(16),y=1/Math.tan(r*.5);if(m[0]=y/h,m[1]=0,m[2]=0,m[3]=0,m[4]=0,m[5]=y,m[6]=0,m[7]=0,m[8]=0,m[9]=0,m[11]=-1,m[12]=0,m[13]=0,m[15]=0,d===1/0)m[10]=0,m[14]=c;else{const w=1/(d-c);m[10]=c*w,m[14]=d*c*w}return m}function Ge(r,h,c,d,a,m,y){const w=y??new o(16);return w[0]=2/(h-r),w[1]=0,w[2]=0,w[3]=0,w[4]=0,w[5]=2/(d-c),w[6]=0,w[7]=0,w[8]=0,w[9]=0,w[10]=1/(a-m),w[11]=0,w[12]=(h+r)/(r-h),w[13]=(d+c)/(c-d),w[14]=a/(a-m),w[15]=1,w}function Le(r,h,c,d,a,m,y){const w=y??new o(16),D=h-r,T=d-c,N=a-m;return w[0]=2*a/D,w[1]=0,w[2]=0,w[3]=0,w[4]=0,w[5]=2*a/T,w[6]=0,w[7]=0,w[8]=(r+h)/D,w[9]=(d+c)/T,w[10]=m/N,w[11]=-1,w[12]=0,w[13]=0,w[14]=a*m/N,w[15]=0,w}function Te(r,h,c,d,a,m=1/0,y){const w=y??new o(16),D=h-r,T=d-c;if(w[0]=2*a/D,w[1]=0,w[2]=0,w[3]=0,w[4]=0,w[5]=2*a/T,w[6]=0,w[7]=0,w[8]=(r+h)/D,w[9]=(d+c)/T,w[11]=-1,w[12]=0,w[13]=0,w[15]=0,m===1/0)w[10]=0,w[14]=a;else{const N=1/(m-a);w[10]=a*N,w[14]=m*a*N}return w}const ge=l.create(),Pe=l.create(),ae=l.create();function se(r,h,c,d){const a=d??new o(16);return l.normalize(l.subtract(h,r,ae),ae),l.normalize(l.cross(c,ae,ge),ge),l.normalize(l.cross(ae,ge,Pe),Pe),a[0]=ge[0],a[1]=ge[1],a[2]=ge[2],a[3]=0,a[4]=Pe[0],a[5]=Pe[1],a[6]=Pe[2],a[7]=0,a[8]=ae[0],a[9]=ae[1],a[10]=ae[2],a[11]=0,a[12]=r[0],a[13]=r[1],a[14]=r[2],a[15]=1,a}function ie(r,h,c,d){const a=d??new o(16);return l.normalize(l.subtract(r,h,ae),ae),l.normalize(l.cross(c,ae,ge),ge),l.normalize(l.cross(ae,ge,Pe),Pe),a[0]=ge[0],a[1]=ge[1],a[2]=ge[2],a[3]=0,a[4]=Pe[0],a[5]=Pe[1],a[6]=Pe[2],a[7]=0,a[8]=ae[0],a[9]=ae[1],a[10]=ae[2],a[11]=0,a[12]=r[0],a[13]=r[1],a[14]=r[2],a[15]=1,a}function _e(r,h,c,d){const a=d??new o(16);return l.normalize(l.subtract(r,h,ae),ae),l.normalize(l.cross(c,ae,ge),ge),l.normalize(l.cross(ae,ge,Pe),Pe),a[0]=ge[0],a[1]=Pe[0],a[2]=ae[0],a[3]=0,a[4]=ge[1],a[5]=Pe[1],a[6]=ae[1],a[7]=0,a[8]=ge[2],a[9]=Pe[2],a[10]=ae[2],a[11]=0,a[12]=-(ge[0]*r[0]+ge[1]*r[1]+ge[2]*r[2]),a[13]=-(Pe[0]*r[0]+Pe[1]*r[1]+Pe[2]*r[2]),a[14]=-(ae[0]*r[0]+ae[1]*r[1]+ae[2]*r[2]),a[15]=1,a}function pe(r,h){const c=h??new o(16);return c[0]=1,c[1]=0,c[2]=0,c[3]=0,c[4]=0,c[5]=1,c[6]=0,c[7]=0,c[8]=0,c[9]=0,c[10]=1,c[11]=0,c[12]=r[0],c[13]=r[1],c[14]=r[2],c[15]=1,c}function be(r,h,c){const d=c??new o(16),a=h[0],m=h[1],y=h[2],w=r[0],D=r[1],T=r[2],N=r[3],re=r[1*4+0],J=r[1*4+1],X=r[1*4+2],fe=r[1*4+3],me=r[2*4+0],de=r[2*4+1],ve=r[2*4+2],Ae=r[2*4+3],xe=r[3*4+0],We=r[3*4+1],je=r[3*4+2],Ke=r[3*4+3];return r!==d&&(d[0]=w,d[1]=D,d[2]=T,d[3]=N,d[4]=re,d[5]=J,d[6]=X,d[7]=fe,d[8]=me,d[9]=de,d[10]=ve,d[11]=Ae),d[12]=w*a+re*m+me*y+xe,d[13]=D*a+J*m+de*y+We,d[14]=T*a+X*m+ve*y+je,d[15]=N*a+fe*m+Ae*y+Ke,d}function Me(r,h){const c=h??new o(16),d=Math.cos(r),a=Math.sin(r);return c[0]=1,c[1]=0,c[2]=0,c[3]=0,c[4]=0,c[5]=d,c[6]=a,c[7]=0,c[8]=0,c[9]=-a,c[10]=d,c[11]=0,c[12]=0,c[13]=0,c[14]=0,c[15]=1,c}function ye(r,h,c){const d=c??new o(16),a=r[4],m=r[5],y=r[6],w=r[7],D=r[8],T=r[9],N=r[10],re=r[11],J=Math.cos(h),X=Math.sin(h);return d[4]=J*a+X*D,d[5]=J*m+X*T,d[6]=J*y+X*N,d[7]=J*w+X*re,d[8]=J*D-X*a,d[9]=J*T-X*m,d[10]=J*N-X*y,d[11]=J*re-X*w,r!==d&&(d[0]=r[0],d[1]=r[1],d[2]=r[2],d[3]=r[3],d[12]=r[12],d[13]=r[13],d[14]=r[14],d[15]=r[15]),d}function Be(r,h){const c=h??new o(16),d=Math.cos(r),a=Math.sin(r);return c[0]=d,c[1]=0,c[2]=-a,c[3]=0,c[4]=0,c[5]=1,c[6]=0,c[7]=0,c[8]=a,c[9]=0,c[10]=d,c[11]=0,c[12]=0,c[13]=0,c[14]=0,c[15]=1,c}function Ve(r,h,c){const d=c??new o(16),a=r[0*4+0],m=r[0*4+1],y=r[0*4+2],w=r[0*4+3],D=r[2*4+0],T=r[2*4+1],N=r[2*4+2],re=r[2*4+3],J=Math.cos(h),X=Math.sin(h);return d[0]=J*a-X*D,d[1]=J*m-X*T,d[2]=J*y-X*N,d[3]=J*w-X*re,d[8]=J*D+X*a,d[9]=J*T+X*m,d[10]=J*N+X*y,d[11]=J*re+X*w,r!==d&&(d[4]=r[4],d[5]=r[5],d[6]=r[6],d[7]=r[7],d[12]=r[12],d[13]=r[13],d[14]=r[14],d[15]=r[15]),d}function A(r,h){const c=h??new o(16),d=Math.cos(r),a=Math.sin(r);return c[0]=d,c[1]=a,c[2]=0,c[3]=0,c[4]=-a,c[5]=d,c[6]=0,c[7]=0,c[8]=0,c[9]=0,c[10]=1,c[11]=0,c[12]=0,c[13]=0,c[14]=0,c[15]=1,c}function H(r,h,c){const d=c??new o(16),a=r[0*4+0],m=r[0*4+1],y=r[0*4+2],w=r[0*4+3],D=r[1*4+0],T=r[1*4+1],N=r[1*4+2],re=r[1*4+3],J=Math.cos(h),X=Math.sin(h);return d[0]=J*a+X*D,d[1]=J*m+X*T,d[2]=J*y+X*N,d[3]=J*w+X*re,d[4]=J*D-X*a,d[5]=J*T-X*m,d[6]=J*N-X*y,d[7]=J*re-X*w,r!==d&&(d[8]=r[8],d[9]=r[9],d[10]=r[10],d[11]=r[11],d[12]=r[12],d[13]=r[13],d[14]=r[14],d[15]=r[15]),d}function x(r,h,c){const d=c??new o(16);let a=r[0],m=r[1],y=r[2];const w=Math.sqrt(a*a+m*m+y*y);a/=w,m/=w,y/=w;const D=a*a,T=m*m,N=y*y,re=Math.cos(h),J=Math.sin(h),X=1-re;return d[0]=D+(1-D)*re,d[1]=a*m*X+y*J,d[2]=a*y*X-m*J,d[3]=0,d[4]=a*m*X-y*J,d[5]=T+(1-T)*re,d[6]=m*y*X+a*J,d[7]=0,d[8]=a*y*X+m*J,d[9]=m*y*X-a*J,d[10]=N+(1-N)*re,d[11]=0,d[12]=0,d[13]=0,d[14]=0,d[15]=1,d}const i=x;function _(r,h,c,d){const a=d??new o(16);let m=h[0],y=h[1],w=h[2];const D=Math.sqrt(m*m+y*y+w*w);m/=D,y/=D,w/=D;const T=m*m,N=y*y,re=w*w,J=Math.cos(c),X=Math.sin(c),fe=1-J,me=T+(1-T)*J,de=m*y*fe+w*X,ve=m*w*fe-y*X,Ae=m*y*fe-w*X,xe=N+(1-N)*J,We=y*w*fe+m*X,je=m*w*fe+y*X,Ke=y*w*fe-m*X,Ye=re+(1-re)*J,ze=r[0],nt=r[1],it=r[2],ot=r[3],Ze=r[4],et=r[5],st=r[6],Fe=r[7],at=r[8],Xe=r[9],ut=r[10],rt=r[11];return a[0]=me*ze+de*Ze+ve*at,a[1]=me*nt+de*et+ve*Xe,a[2]=me*it+de*st+ve*ut,a[3]=me*ot+de*Fe+ve*rt,a[4]=Ae*ze+xe*Ze+We*at,a[5]=Ae*nt+xe*et+We*Xe,a[6]=Ae*it+xe*st+We*ut,a[7]=Ae*ot+xe*Fe+We*rt,a[8]=je*ze+Ke*Ze+Ye*at,a[9]=je*nt+Ke*et+Ye*Xe,a[10]=je*it+Ke*st+Ye*ut,a[11]=je*ot+Ke*Fe+Ye*rt,r!==a&&(a[12]=r[12],a[13]=r[13],a[14]=r[14],a[15]=r[15]),a}const p=_;function v(r,h){const c=h??new o(16);return c[0]=r[0],c[1]=0,c[2]=0,c[3]=0,c[4]=0,c[5]=r[1],c[6]=0,c[7]=0,c[8]=0,c[9]=0,c[10]=r[2],c[11]=0,c[12]=0,c[13]=0,c[14]=0,c[15]=1,c}function b(r,h,c){const d=c??new o(16),a=h[0],m=h[1],y=h[2];return d[0]=a*r[0*4+0],d[1]=a*r[0*4+1],d[2]=a*r[0*4+2],d[3]=a*r[0*4+3],d[4]=m*r[1*4+0],d[5]=m*r[1*4+1],d[6]=m*r[1*4+2],d[7]=m*r[1*4+3],d[8]=y*r[2*4+0],d[9]=y*r[2*4+1],d[10]=y*r[2*4+2],d[11]=y*r[2*4+3],r!==d&&(d[12]=r[12],d[13]=r[13],d[14]=r[14],d[15]=r[15]),d}function P(r,h){const c=h??new o(16);return c[0]=r,c[1]=0,c[2]=0,c[3]=0,c[4]=0,c[5]=r,c[6]=0,c[7]=0,c[8]=0,c[9]=0,c[10]=r,c[11]=0,c[12]=0,c[13]=0,c[14]=0,c[15]=1,c}function k(r,h,c){const d=c??new o(16);return d[0]=h*r[0*4+0],d[1]=h*r[0*4+1],d[2]=h*r[0*4+2],d[3]=h*r[0*4+3],d[4]=h*r[1*4+0],d[5]=h*r[1*4+1],d[6]=h*r[1*4+2],d[7]=h*r[1*4+3],d[8]=h*r[2*4+0],d[9]=h*r[2*4+1],d[10]=h*r[2*4+2],d[11]=h*r[2*4+3],r!==d&&(d[12]=r[12],d[13]=r[13],d[14]=r[14],d[15]=r[15]),d}return{add:$,aim:se,axisRotate:_,axisRotation:x,cameraAim:ie,clone:U,copy:q,create:f,determinant:W,equals:Z,equalsApproximately:Y,fromMat3:g,fromQuat:C,frustum:Le,frustumReverseZ:Te,getAxis:ue,getScaling:he,getTranslation:we,identity:O,inverse:F,invert:j,lookAt:_e,mul:K,mulScalar:V,multiply:M,multiplyScalar:I,negate:B,ortho:Ge,perspective:te,perspectiveReverseZ:Oe,rotate:p,rotateX:ye,rotateY:Ve,rotateZ:H,rotation:i,rotationX:Me,rotationY:Be,rotationZ:A,scale:b,scaling:v,set:S,setAxis:ne,setTranslation:oe,translate:be,translation:pe,transpose:z,uniformScale:k,uniformScaling:P}}const Zr=new Map;function Ml(o){let l=Zr.get(o);return l||(l=Tl(o),Zr.set(o,l)),l}function Al(o){const l=as(o);function f(A,H,x,i){const _=new o(4);return A!==void 0&&(_[0]=A,H!==void 0&&(_[1]=H,x!==void 0&&(_[2]=x,i!==void 0&&(_[3]=i)))),_}const S=f;function g(A,H,x,i,_){const p=_??new o(4);return p[0]=A,p[1]=H,p[2]=x,p[3]=i,p}function C(A,H,x){const i=x??new o(4),_=H*.5,p=Math.sin(_);return i[0]=p*A[0],i[1]=p*A[1],i[2]=p*A[2],i[3]=Math.cos(_),i}function B(A,H){const x=H??l.create(3),i=Math.acos(A[3])*2,_=Math.sin(i*.5);return _>De?(x[0]=A[0]/_,x[1]=A[1]/_,x[2]=A[2]/_):(x[0]=1,x[1]=0,x[2]=0),{angle:i,axis:x}}function $(A,H){const x=te(A,H);return Math.acos(2*x*x-1)}function I(A,H,x){const i=x??new o(4),_=A[0],p=A[1],v=A[2],b=A[3],P=H[0],k=H[1],r=H[2],h=H[3];return i[0]=_*h+b*P+p*r-v*k,i[1]=p*h+b*k+v*P-_*r,i[2]=v*h+b*r+_*k-p*P,i[3]=b*h-_*P-p*k-v*r,i}const V=I;function q(A,H,x){const i=x??new o(4),_=H*.5,p=A[0],v=A[1],b=A[2],P=A[3],k=Math.sin(_),r=Math.cos(_);return i[0]=p*r+P*k,i[1]=v*r+b*k,i[2]=b*r-v*k,i[3]=P*r-p*k,i}function U(A,H,x){const i=x??new o(4),_=H*.5,p=A[0],v=A[1],b=A[2],P=A[3],k=Math.sin(_),r=Math.cos(_);return i[0]=p*r-b*k,i[1]=v*r+P*k,i[2]=b*r+p*k,i[3]=P*r-v*k,i}function Y(A,H,x){const i=x??new o(4),_=H*.5,p=A[0],v=A[1],b=A[2],P=A[3],k=Math.sin(_),r=Math.cos(_);return i[0]=p*r+v*k,i[1]=v*r-p*k,i[2]=b*r+P*k,i[3]=P*r-b*k,i}function Z(A,H,x,i){const _=i??new o(4),p=A[0],v=A[1],b=A[2],P=A[3];let k=H[0],r=H[1],h=H[2],c=H[3],d=p*k+v*r+b*h+P*c;d<0&&(d=-d,k=-k,r=-r,h=-h,c=-c);let a,m;if(1-d>De){const y=Math.acos(d),w=Math.sin(y);a=Math.sin((1-x)*y)/w,m=Math.sin(x*y)/w}else a=1-x,m=x;return _[0]=a*p+m*k,_[1]=a*v+m*r,_[2]=a*b+m*h,_[3]=a*P+m*c,_}function O(A,H){const x=H??new o(4),i=A[0],_=A[1],p=A[2],v=A[3],b=i*i+_*_+p*p+v*v,P=b?1/b:0;return x[0]=-i*P,x[1]=-_*P,x[2]=-p*P,x[3]=v*P,x}function z(A,H){const x=H??new o(4);return x[0]=-A[0],x[1]=-A[1],x[2]=-A[2],x[3]=A[3],x}function F(A,H){const x=H??new o(4),i=A[0]+A[5]+A[10];if(i>0){const _=Math.sqrt(i+1);x[3]=.5*_;const p=.5/_;x[0]=(A[6]-A[9])*p,x[1]=(A[8]-A[2])*p,x[2]=(A[1]-A[4])*p}else{let _=0;A[5]>A[0]&&(_=1),A[10]>A[_*4+_]&&(_=2);const p=(_+1)%3,v=(_+2)%3,b=Math.sqrt(A[_*4+_]-A[p*4+p]-A[v*4+v]+1);x[_]=.5*b;const P=.5/b;x[3]=(A[p*4+v]-A[v*4+p])*P,x[p]=(A[p*4+_]+A[_*4+p])*P,x[v]=(A[v*4+_]+A[_*4+v])*P}return x}function W(A,H,x,i,_){const p=_??new o(4),v=A*.5,b=H*.5,P=x*.5,k=Math.sin(v),r=Math.cos(v),h=Math.sin(b),c=Math.cos(b),d=Math.sin(P),a=Math.cos(P);switch(i){case"xyz":p[0]=k*c*a+r*h*d,p[1]=r*h*a-k*c*d,p[2]=r*c*d+k*h*a,p[3]=r*c*a-k*h*d;break;case"xzy":p[0]=k*c*a-r*h*d,p[1]=r*h*a-k*c*d,p[2]=r*c*d+k*h*a,p[3]=r*c*a+k*h*d;break;case"yxz":p[0]=k*c*a+r*h*d,p[1]=r*h*a-k*c*d,p[2]=r*c*d-k*h*a,p[3]=r*c*a+k*h*d;break;case"yzx":p[0]=k*c*a+r*h*d,p[1]=r*h*a+k*c*d,p[2]=r*c*d-k*h*a,p[3]=r*c*a-k*h*d;break;case"zxy":p[0]=k*c*a-r*h*d,p[1]=r*h*a+k*c*d,p[2]=r*c*d+k*h*a,p[3]=r*c*a-k*h*d;break;case"zyx":p[0]=k*c*a-r*h*d,p[1]=r*h*a+k*c*d,p[2]=r*c*d-k*h*a,p[3]=r*c*a+k*h*d;break;default:throw new Error(`Unknown rotation order: ${i}`)}return p}function j(A,H){const x=H??new o(4);return x[0]=A[0],x[1]=A[1],x[2]=A[2],x[3]=A[3],x}const M=j;function K(A,H,x){const i=x??new o(4);return i[0]=A[0]+H[0],i[1]=A[1]+H[1],i[2]=A[2]+H[2],i[3]=A[3]+H[3],i}function oe(A,H,x){const i=x??new o(4);return i[0]=A[0]-H[0],i[1]=A[1]-H[1],i[2]=A[2]-H[2],i[3]=A[3]-H[3],i}const we=oe;function ue(A,H,x){const i=x??new o(4);return i[0]=A[0]*H,i[1]=A[1]*H,i[2]=A[2]*H,i[3]=A[3]*H,i}const ne=ue;function he(A,H,x){const i=x??new o(4);return i[0]=A[0]/H,i[1]=A[1]/H,i[2]=A[2]/H,i[3]=A[3]/H,i}function te(A,H){return A[0]*H[0]+A[1]*H[1]+A[2]*H[2]+A[3]*H[3]}function Oe(A,H,x,i){const _=i??new o(4);return _[0]=A[0]+x*(H[0]-A[0]),_[1]=A[1]+x*(H[1]-A[1]),_[2]=A[2]+x*(H[2]-A[2]),_[3]=A[3]+x*(H[3]-A[3]),_}function Ge(A){const H=A[0],x=A[1],i=A[2],_=A[3];return Math.sqrt(H*H+x*x+i*i+_*_)}const Le=Ge;function Te(A){const H=A[0],x=A[1],i=A[2],_=A[3];return H*H+x*x+i*i+_*_}const ge=Te;function Pe(A,H){const x=H??new o(4),i=A[0],_=A[1],p=A[2],v=A[3],b=Math.sqrt(i*i+_*_+p*p+v*v);return b>1e-5?(x[0]=i/b,x[1]=_/b,x[2]=p/b,x[3]=v/b):(x[0]=0,x[1]=0,x[2]=0,x[3]=1),x}function ae(A,H){return Math.abs(A[0]-H[0])<De&&Math.abs(A[1]-H[1])<De&&Math.abs(A[2]-H[2])<De&&Math.abs(A[3]-H[3])<De}function se(A,H){return A[0]===H[0]&&A[1]===H[1]&&A[2]===H[2]&&A[3]===H[3]}function ie(A){const H=A??new o(4);return H[0]=0,H[1]=0,H[2]=0,H[3]=1,H}const _e=l.create(),pe=l.create(),be=l.create();function Me(A,H,x){const i=x??new o(4),_=l.dot(A,H);return _<-.999999?(l.cross(pe,A,_e),l.len(_e)<1e-6&&l.cross(be,A,_e),l.normalize(_e,_e),C(_e,Math.PI,i),i):_>.999999?(i[0]=0,i[1]=0,i[2]=0,i[3]=1,i):(l.cross(A,H,_e),i[0]=_e[0],i[1]=_e[1],i[2]=_e[2],i[3]=1+_,Pe(i,i))}const ye=new o(4),Be=new o(4);function Ve(A,H,x,i,_,p){const v=p??new o(4);return Z(A,i,_,ye),Z(H,x,_,Be),Z(ye,Be,2*_*(1-_),v),v}return{create:f,fromValues:S,set:g,fromAxisAngle:C,toAxisAngle:B,angle:$,multiply:I,mul:V,rotateX:q,rotateY:U,rotateZ:Y,slerp:Z,inverse:O,conjugate:z,fromMat:F,fromEuler:W,copy:j,clone:M,add:K,subtract:oe,sub:we,mulScalar:ue,scale:ne,divScalar:he,dot:te,lerp:Oe,length:Ge,len:Le,lengthSq:Te,lenSq:ge,normalize:Pe,equalsApproximately:ae,equals:se,identity:ie,rotationTo:Me,sqlerp:Ve}}const Xr=new Map;function Dl(o){let l=Xr.get(o);return l||(l=Al(o),Xr.set(o,l)),l}function Gl(o){function l(x,i,_,p){const v=new o(4);return x!==void 0&&(v[0]=x,i!==void 0&&(v[1]=i,_!==void 0&&(v[2]=_,p!==void 0&&(v[3]=p)))),v}const f=l;function S(x,i,_,p,v){const b=v??new o(4);return b[0]=x,b[1]=i,b[2]=_,b[3]=p,b}function g(x,i){const _=i??new o(4);return _[0]=Math.ceil(x[0]),_[1]=Math.ceil(x[1]),_[2]=Math.ceil(x[2]),_[3]=Math.ceil(x[3]),_}function C(x,i){const _=i??new o(4);return _[0]=Math.floor(x[0]),_[1]=Math.floor(x[1]),_[2]=Math.floor(x[2]),_[3]=Math.floor(x[3]),_}function B(x,i){const _=i??new o(4);return _[0]=Math.round(x[0]),_[1]=Math.round(x[1]),_[2]=Math.round(x[2]),_[3]=Math.round(x[3]),_}function $(x,i=0,_=1,p){const v=p??new o(4);return v[0]=Math.min(_,Math.max(i,x[0])),v[1]=Math.min(_,Math.max(i,x[1])),v[2]=Math.min(_,Math.max(i,x[2])),v[3]=Math.min(_,Math.max(i,x[3])),v}function I(x,i,_){const p=_??new o(4);return p[0]=x[0]+i[0],p[1]=x[1]+i[1],p[2]=x[2]+i[2],p[3]=x[3]+i[3],p}function V(x,i,_,p){const v=p??new o(4);return v[0]=x[0]+i[0]*_,v[1]=x[1]+i[1]*_,v[2]=x[2]+i[2]*_,v[3]=x[3]+i[3]*_,v}function q(x,i,_){const p=_??new o(4);return p[0]=x[0]-i[0],p[1]=x[1]-i[1],p[2]=x[2]-i[2],p[3]=x[3]-i[3],p}const U=q;function Y(x,i){return Math.abs(x[0]-i[0])<De&&Math.abs(x[1]-i[1])<De&&Math.abs(x[2]-i[2])<De&&Math.abs(x[3]-i[3])<De}function Z(x,i){return x[0]===i[0]&&x[1]===i[1]&&x[2]===i[2]&&x[3]===i[3]}function O(x,i,_,p){const v=p??new o(4);return v[0]=x[0]+_*(i[0]-x[0]),v[1]=x[1]+_*(i[1]-x[1]),v[2]=x[2]+_*(i[2]-x[2]),v[3]=x[3]+_*(i[3]-x[3]),v}function z(x,i,_,p){const v=p??new o(4);return v[0]=x[0]+_[0]*(i[0]-x[0]),v[1]=x[1]+_[1]*(i[1]-x[1]),v[2]=x[2]+_[2]*(i[2]-x[2]),v[3]=x[3]+_[3]*(i[3]-x[3]),v}function F(x,i,_){const p=_??new o(4);return p[0]=Math.max(x[0],i[0]),p[1]=Math.max(x[1],i[1]),p[2]=Math.max(x[2],i[2]),p[3]=Math.max(x[3],i[3]),p}function W(x,i,_){const p=_??new o(4);return p[0]=Math.min(x[0],i[0]),p[1]=Math.min(x[1],i[1]),p[2]=Math.min(x[2],i[2]),p[3]=Math.min(x[3],i[3]),p}function j(x,i,_){const p=_??new o(4);return p[0]=x[0]*i,p[1]=x[1]*i,p[2]=x[2]*i,p[3]=x[3]*i,p}const M=j;function K(x,i,_){const p=_??new o(4);return p[0]=x[0]/i,p[1]=x[1]/i,p[2]=x[2]/i,p[3]=x[3]/i,p}function oe(x,i){const _=i??new o(4);return _[0]=1/x[0],_[1]=1/x[1],_[2]=1/x[2],_[3]=1/x[3],_}const we=oe;function ue(x,i){return x[0]*i[0]+x[1]*i[1]+x[2]*i[2]+x[3]*i[3]}function ne(x){const i=x[0],_=x[1],p=x[2],v=x[3];return Math.sqrt(i*i+_*_+p*p+v*v)}const he=ne;function te(x){const i=x[0],_=x[1],p=x[2],v=x[3];return i*i+_*_+p*p+v*v}const Oe=te;function Ge(x,i){const _=x[0]-i[0],p=x[1]-i[1],v=x[2]-i[2],b=x[3]-i[3];return Math.sqrt(_*_+p*p+v*v+b*b)}const Le=Ge;function Te(x,i){const _=x[0]-i[0],p=x[1]-i[1],v=x[2]-i[2],b=x[3]-i[3];return _*_+p*p+v*v+b*b}const ge=Te;function Pe(x,i){const _=i??new o(4),p=x[0],v=x[1],b=x[2],P=x[3],k=Math.sqrt(p*p+v*v+b*b+P*P);return k>1e-5?(_[0]=p/k,_[1]=v/k,_[2]=b/k,_[3]=P/k):(_[0]=0,_[1]=0,_[2]=0,_[3]=0),_}function ae(x,i){const _=i??new o(4);return _[0]=-x[0],_[1]=-x[1],_[2]=-x[2],_[3]=-x[3],_}function se(x,i){const _=i??new o(4);return _[0]=x[0],_[1]=x[1],_[2]=x[2],_[3]=x[3],_}const ie=se;function _e(x,i,_){const p=_??new o(4);return p[0]=x[0]*i[0],p[1]=x[1]*i[1],p[2]=x[2]*i[2],p[3]=x[3]*i[3],p}const pe=_e;function be(x,i,_){const p=_??new o(4);return p[0]=x[0]/i[0],p[1]=x[1]/i[1],p[2]=x[2]/i[2],p[3]=x[3]/i[3],p}const Me=be;function ye(x){const i=x??new o(4);return i[0]=0,i[1]=0,i[2]=0,i[3]=0,i}function Be(x,i,_){const p=_??new o(4),v=x[0],b=x[1],P=x[2],k=x[3];return p[0]=i[0]*v+i[4]*b+i[8]*P+i[12]*k,p[1]=i[1]*v+i[5]*b+i[9]*P+i[13]*k,p[2]=i[2]*v+i[6]*b+i[10]*P+i[14]*k,p[3]=i[3]*v+i[7]*b+i[11]*P+i[15]*k,p}function Ve(x,i,_){const p=_??new o(4);return Pe(x,p),j(p,i,p)}function A(x,i,_){const p=_??new o(4);return ne(x)>i?Ve(x,i,p):se(x,p)}function H(x,i,_){const p=_??new o(4);return O(x,i,.5,p)}return{create:l,fromValues:f,set:S,ceil:g,floor:C,round:B,clamp:$,add:I,addScaled:V,subtract:q,sub:U,equalsApproximately:Y,equals:Z,lerp:O,lerpV:z,max:F,min:W,mulScalar:j,scale:M,divScalar:K,inverse:oe,invert:we,dot:ue,length:ne,len:he,lengthSq:te,lenSq:Oe,distance:Ge,dist:Le,distanceSq:Te,distSq:ge,normalize:Pe,negate:ae,copy:se,clone:ie,multiply:_e,mul:pe,divide:be,div:Me,zero:ye,transformMat4:Be,setLength:Ve,truncate:A,midpoint:H}}const Qr=new Map;function Ll(o){let l=Qr.get(o);return l||(l=Gl(o),Qr.set(o,l)),l}function Ns(o,l,f,S,g,C){return{mat3:Bl(o),mat4:Ml(l),quat:Dl(f),vec2:di(S),vec3:as(g),vec4:Ll(C)}}const{mat3:Pt,mat4:dt,quat:ht,vec2:Jr,vec3:R,vec4:Yc}=Ns(Float32Array,Float32Array,Float32Array,Float32Array,Float32Array,Float32Array);Ns(Float64Array,Float64Array,Float64Array,Float64Array,Float64Array,Float64Array);Ns(Sl,Array,Array,Array,Array,Array);const ei=document.querySelector("#log");let vt=null,an=null;function pi(){if(vt)return vt;vt=document.createElement("div"),vt.className="ply-spinner-overlay";const o=document.createElement("div");return o.className="ply-spinner",vt.appendChild(o),an=document.createElement("div"),an.className="ply-spinner-label",vt.appendChild(an),vt.style.display="none",document.body.appendChild(vt),vt}function Ws(o){pi(),an&&o&&(an.textContent=o),vt&&(vt.style.opacity="1",vt.style.display="flex")}function Vt(o){pi(),an&&(an.textContent=o)}function Ln(){if(!vt)return;const o=vt;o.style.opacity="0",setTimeout(()=>{o.style.opacity==="0"&&(o.style.display="none")},220)}function hi(o,l){if(!ei)return;const f=document.createElement("p");f.innerText=o,l&&Object.assign(f.style,l),ei.appendChild(f)}async function Tt(o){console.log(o),hi(o)}async function zl(o){console.error(o),hi(o,{color:"red",backgroundColor:"rgba(255, 0, 0, 0.1)"})}let fi;function _i(){fi=performance.now()}function ti(o){const l=performance.now()-fi;Tt(`⏱️ ${o} Time: ${l.toFixed(0)} ms`)}function Rl(o,l){if(!o)throw new Error(l&&(typeof l=="string"?l:l()))}function Rn(o){return o+3&-4}const Il=2,Ul=3,Vl=5,Ol=6,zn=7,ns=8,ss=9,rs=10;function Fl(o){const l=new TextDecoder("ascii"),f=l.decode(new Uint8Array(o,0,4));if(f!=="NAT2")throw new Error(`NAT2 bad magic: '${f}'`);if(o.byteLength<4+64)throw new Error(`NAT2 truncated (${o.byteLength} bytes < 4 + 64)`);const S=new DataView(o),g=4,C=S.getUint32(g+0,!0),B=S.getUint32(g+4,!0),$=S.getUint32(g+8,!0),I=S.getUint32(g+12,!0),V=S.getUint32(g+16,!0),q=S.getFloat32(g+20,!0),U=S.getUint32(g+24,!0),Y=S.getUint32(g+28,!0),Z=S.getFloat32(g+32,!0),O=S.getFloat32(g+36,!0),z=S.getFloat32(g+40,!0),F=S.getUint32(g+44,!0),W=S.getFloat32(g+48,!0),j=S.getFloat32(g+52,!0),M=S.getUint32(g+56,!0),K=S.getUint32(g+60,!0),oe=Y===ss||Y===rs,we=oe?K:0,ue=oe?0:K,ne=ue>0?ue:1;if(Y===Vl||Y===Ol)throw new Error(`NAT2: paired-RVQ format=${Y} is retired 2026-07-23; re-bake with typeD (--bc7-codebook)`);const he=Y===ss||Y===rs;if(Y!==Il&&Y!==Ul&&Y!==zn&&Y!==ns&&!he)throw new Error(`NAT2: Halloumi-WS supports BC7 (2), ASTC 4x4 (3), BC7-codebook (7), ASTC-codebook (8), probe-BC7 (9) or probe-ASTC (10); got format=${Y}`);if(C%4!==0||F%4!==0)throw new Error(`NAT2 block-format dims must be 4-aligned: width=${C} layer_h=${F}`);let te=g+64;const Oe=(M+1)*4,Ge=new Uint32Array(o.slice(te,te+Oe));te+=Oe;let Le;if(ne>1){const pe=(ne+1)*4;if(te+pe>o.byteLength)throw new Error(`NAT2 truncated at column_cuts (need ${pe} from ${te})`);Le=new Uint32Array(o.slice(te,te+pe)),te+=pe}else Le=new Uint32Array([0,C]);let Te=0;for(let pe=0;pe<ne;pe++){const be=Le[pe+1]-Le[pe];be>Te&&(Te=be)}if(he){const pe=we&1?7:6,be=V*pe*4;if(te+be>o.byteLength)throw new Error(`NAT2 truncated at probes: need ${be} more bytes from offset ${te}, have ${o.byteLength-te}`);const Me=new Float32Array(o.slice(te,te+be));te+=be;const ye=C/4,Be=F/4,Ve=ye*Be*16,A=o.byteLength-te;if(A<Ve)throw new Error(`NAT2 probe atlas truncated: need ${Ve} bytes for ${C}x${F}, have ${A}`);const H=new Uint8Array(o.slice(te,te+Ve));return{width:C,height:B,channels:$,kernel_type:I,num_rects:V,uv_extent:q,sb_number:U,format:Y,sh_bias:Z,res_bias:O,compact_mult:z,layer_h:F,atlas_scale:W,atlas_offset:j,n_layers:M,n_cols:ne,layer_cuts:Ge,column_cuts:Le,slice_width:Te,rects_expanded:Me,atlas_bytes:H,probe_mode:we&1?2:1}}const ge=V*4*4;if(te+ge>o.byteLength)throw new Error(`NAT2 truncated at rects: need ${ge} more bytes from offset ${te}, have ${o.byteLength-te}`);const Pe=new Float32Array(o.slice(te,te+ge));te+=ge;const ae=new Float32Array(V*5);for(let pe=0;pe<V;pe++){const be=Pe[pe*4+0],Me=Pe[pe*4+1],ye=Pe[pe*4+2],Be=Pe[pe*4+3];let Ve=0;for(let _=1;_<=M&&Ge[_]<=Me;_++)Ve=_;let A=0;for(let _=1;_<=ne&&Le[_]<=be;_++)A=_;const H=Me-Ge[Ve],x=be-Le[A],i=A*M+Ve;ae[pe*5+0]=x,ae[pe*5+1]=H,ae[pe*5+2]=ye,ae[pe*5+3]=Be,ae[pe*5+4]=i}let se;const _e=C/4*16;if(Y===zn||Y===ns){if(te+24>o.byteLength)throw new Error("NAT2 truncated at typeD sub-header");const pe=Y===zn?"BCCB":"ACCB",be=l.decode(new Uint8Array(o,te,4));if(be!==pe)throw new Error(`NAT2 typeD bad sub-magic: expected '${pe}' got '${be}'`);const Me=S.getUint32(te+4,!0),ye=S.getUint32(te+8,!0),Be=S.getUint32(te+12,!0),Ve=S.getUint32(te+16,!0),A=S.getUint32(te+20,!0);if(Me!==1)throw new Error(`NAT2 BCCB unsupported version ${Me}`);if(Be!==B/4||Ve!==C/4||A!==Be*Ve)throw new Error(`NAT2 BCCB block grid mismatch: header ${C}×${B}, sub-header ${Ve}×${Be} (${A} blocks)`);te+=24;const H=ye*16;if(te+H>o.byteLength)throw new Error(`NAT2 BCCB truncated at codebook (need ${H}, have ${o.byteLength-te})`);const x=new Uint8Array(o,te,H);te+=H;const i=A*2;if(te+i>o.byteLength)throw new Error(`NAT2 BCCB truncated at indices (need ${i}, have ${o.byteLength-te})`);const _=new Uint16Array(o.slice(te,te+i));te+=i;const p=new Uint8Array(A*16);for(let v=0;v<A;v++){const b=_[v]*16;p.set(x.subarray(b,b+16),v*16)}se=p}else{let pe=0;for(let be=0;be<M;be++){const Me=Ge[be+1]-Ge[be];if(Me%4!==0)throw new Error(`NAT2 BC7 layer ${be} rows ${Me} not 4-aligned`);pe+=Me/4*_e}if(te+pe>o.byteLength)throw new Error(`NAT2 truncated at atlas payload: need ${pe} more bytes from offset ${te}, have ${o.byteLength-te}`);se=new Uint8Array(o.slice(te,te+pe))}return{width:C,height:B,channels:$,kernel_type:I,num_rects:V,uv_extent:q,sb_number:U,format:Y,sh_bias:Z,res_bias:O,compact_mult:z,layer_h:F,atlas_scale:W,atlas_offset:j,n_layers:M,n_cols:ne,layer_cuts:Ge,column_cuts:Le,slice_width:Te,rects_expanded:ae,atlas_bytes:se}}const Nl=32;function Wl(o,l,f){if(l.format===5||l.format===6)throw new Error(`paired-RVQ format=${l.format} is retired; re-bake with typeD (--bc7-codebook)`);let S,g,C,B;if(l.format===2||l.format===zn||l.format===ss){if(!o.features.has("texture-compression-bc"))return Tt(`⚠️  bundle is BC7 (format=${l.format}) but texture-compression-bc not supported — atlas disabled`),null;B=l.format===ss?"BC7 atlas (proberes: shared probe texture)":l.format===zn?"BC7 atlas (typeD: codebook gather)":"BC7 atlas",{texture:S,view:g,sampler:C}=ni(o,l,"bc7-rgba-unorm",B)}else if(l.format===3||l.format===ns||l.format===rs){if(!o.features.has("texture-compression-astc"))return Tt(`⚠️  bundle is ASTC 4x4 (format=${l.format}) but texture-compression-astc not supported — atlas disabled`),null;B=l.format===rs?"ASTC 4x4 atlas (proberes: shared probe texture)":l.format===ns?"ASTC 4x4 atlas (typeD-ASTC: codebook gather)":"ASTC 4x4 atlas",{texture:S,view:g,sampler:C}=ni(o,l,"astc-4x4-unorm",B)}else return Tt(`⚠️  unsupported atlas format ${l.format} — atlas disabled`),null;const{rects_expanded:$}=l,I=o.createBuffer({label:"atlas rects (5-stride)",size:Rn($.byteLength),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST});o.queue.writeBuffer(I,0,$);const V=o.createBuffer({label:"tex_params",size:48,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return mi(o,V,l,f),{texture:S,view:g,sampler:C,rectsBuffer:I,texParamsBuffer:V,meta:l}}function ni(o,l,f,S){const{width:g,layer_h:C,n_layers:B,n_cols:$,layer_cuts:I,column_cuts:V,slice_width:q,atlas_bytes:U}=l,Z=g/4*16,O=o.limits.maxTextureDimension2D;if(C>O||q>O)throw new Error(`⚠️  atlas slice dims ${q}x${C} exceed maxTextureDimension2D=${O}. Re-bake with smaller LAYER_H or pack with column-aware atlas widths.`);const z=$*B;if(z>o.limits.maxTextureArrayLayers)throw new Error(`⚠️  ${$} cols × ${B} layers = ${z} slices > maxTextureArrayLayers=${o.limits.maxTextureArrayLayers}.`);const F=o.createTexture({label:S,size:{width:q,height:C,depthOrArrayLayers:z},mipLevelCount:1,sampleCount:1,dimension:"2d",format:f,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});for(let M=0;M<$;M++){const K=V[M]/4,oe=(V[M+1]-V[M])/4;for(let we=0;we<B;we++){const ue=I[we]/4,ne=(I[we+1]-I[we])/4,he=M*B+we,te=ue*Z+K*16;o.queue.writeTexture({texture:F,mipLevel:0,origin:{x:0,y:0,z:he},aspect:"all"},U,{offset:te,bytesPerRow:Z,rowsPerImage:ne},{width:oe*4,height:ne*4,depthOrArrayLayers:1})}}const W=F.createView({label:`${S} view`,dimension:"2d-array"}),j=o.createSampler({label:`${S} sampler`,addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",addressModeW:"clamp-to-edge",magFilter:"linear",minFilter:"linear",mipmapFilter:"nearest"});return{texture:F,view:W,sampler:j}}function mi(o,l,f,S){const g=new ArrayBuffer(32),C=new Uint32Array(g),B=new Float32Array(g);C[0]=S?1:0,B[1]=f.atlas_scale,B[2]=f.atlas_offset,B[3]=f.res_bias,C[4]=f.probe_mode?f.probe_mode|0:0,o.queue.writeBuffer(l,0,g)}async function Rs(o,l){Tt(`loading ply file from File... : ${o.name}`),Ws("downloading PLY...");const f=await o.arrayBuffer();try{return await bi(f,l)}finally{Ln()}}async function $l(o,l){Tt(`loading ply file from URL... : ${o}`),Ws("downloading PLY...");try{_i();const f=new URL(o,self.location.href).href;return await bi({url:f},l)}finally{Ln()}}async function bi(o,l){return new Promise((f,S)=>{const g=new Worker(new URL(""+new URL("ply-worker-621cb083.js",import.meta.url).href,self.location),{type:"module"});g.onmessage=C=>{var $,I,V,q,U,Y,Z,O,z,F,W,j;const B=C.data;if((B==null?void 0:B.type)==="error"){zl(`PLY worker error: ${B.message??"unknown error"}`),g.terminate(),S(new Error(B.message??"Worker error"));return}else if((B==null?void 0:B.type)==="download_progress"){const M=B.totalBytes,K=B.loadedBytes/(1024*1024),oe=M?M/(1024*1024):void 0,we=(B.speedBps??0)/(1024*1024),ue=M?Math.min(99,Math.floor(B.loadedBytes/M*100)):void 0,ne=oe?`total ${oe.toFixed(1)} MB`:"total -- MB",he=oe&&ue!==void 0?`${K.toFixed(1)} MB downloaded (${ue}%)`:`${K.toFixed(1)} MB downloaded`,te=`${we.toFixed(2)} MB/s`;Vt(`downloading PLY ...
${ne}, ${he}
