...
}`,vi=32,Us=1,Vs=2,si=4,Os=8,gi=4,sc=7<<gi,ri=128,ii=256,rc=0,jt=new ArrayBuffer(vi),at={canvas_size:new Uint32Array(jt,0,2),accel_flags:new Uint32Array(jt,8,1),feature_mode:new Uint32Array(jt,12,1),gaussian_scaling:new Float32Array(jt,16,1),sh_bias:new Float32Array(jt,20,1),color_K:new Uint32Array(jt,24,1),walltime:new Float32Array(jt,28,1)};function ic(o){at.canvas_size[0]=o.width>>>0,at.canvas_size[1]=o.height>>>0,at.accel_flags[0]=(o.accel_flags??Us|Vs)>>>0,at.feature_mode[0]=(o.feature_mode??rc)>>>0,at.gaussian_scaling[0]=o.gaussian_scaling??1,at.sh_bias[0]=o.sh_bias??.5,at.color_K[0]=(o.color_K??0)>>>0,at.walltime[0]=o.walltime??0}function wi(o,a){o.queue.writeBuffer(a,0,jt)}function ls(o,a,h){h&&o&&a&&wi(o,a)}function es(o,a,h,S,g=!0){at.canvas_size[0]=o>>>0,at.canvas_size[1]=a>>>0,ls(h??null,S??null,g)}function oi(o,a,h,S=!0){at.gaussian_scaling[0]=o,ls(a??null,h??null,S)}function ai(o,a,h,S=!0){at.sh_bias[0]=o,ls(a??null,h??null,S)}function an(o,a,h,S=!0){let g=at.accel_flags[0];if(o.oac!==void 0&&(g=o.oac?g|Us:g&~Us),o.spr!==void 0&&(g=o.spr?g|Vs:g&~Vs),o.bfc!==void 0&&(g=o.bfc?g|si:g&~si),o.meshCull!==void 0&&(g=o.meshCull?g|Os:g&~Os),o.meshSampleMode!==void 0){const C=(o.meshSampleMode&7)<<gi;g=g&~sc|C}o.meshSilhouetteCull!==void 0&&(g=o.meshSilhouetteCull?g|ri:g&~ri),o.meshInvertDepth!==void 0&&(g=o.meshInvertDepth?g|ii:g&~ii),at.accel_flags[0]=g>>>0,ls(a??null,h??null,S)}const oc=256,ac=vi,lc=8,cc=96,uc=12,Ws=8,Gt=1<<Ws,ln=256,is=32/Ws,dc=0,li=is&1;function ci(o,a){return{sort_indices_buffer:a.createBuffer({label:"ping-pong payload (indices)",size:o*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC}),sort_depths_buffer:a.createBuffer({label:"ping-pong keys (depths)",size:o*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC})}}function pc(o,a){const h=o.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:4,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:5,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:6,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:7,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]}),S=o.createPipelineLayout({bindGroupLayouts:[h]}),g=C=>o.createComputePipeline({layout:S,compute:{module:a,entryPoint:C,constants:{WG_SIZE:ln}}});return{l0TileScan:g("prefix_l0_tile_scan"),l1TileScanOnL0:g("prefix_l1_tile_scan_on_l0_sums"),l1ScanSums:g("prefix_scan_l1_sums"),addL1ToL0:g("prefix_add_l1_to_l0_offsets"),addL0ToElems:g("prefix_add_l0_to_elements"),computeDigitBase:g("compute_digit_base"),prefixBindGroupLayout:h}}function hc(o,a,h){const S=o.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]}),g=o.createBindGroupLayout({entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:4,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:5,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:6,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}}]}),C=o.createPipelineLayout({bindGroupLayouts:[S]}),M=o.createPipelineLayout({bindGroupLayouts:[g]}),O=[];for(let L=0;L<is;L++){const V={PASS_ID:L+dc,RS_RADIX_LOG2:Ws,RS_RADIX_SIZE:Gt};O.push({localHistogram:o.createComputePipeline({layout:C,compute:{module:a,entryPoint:"local_histogram_pass",constants:V}}),scatterElements:o.createComputePipeline({layout:M,compute:{module:h,entryPoint:"scatter_elements",constants:V}})})}return{passes:O,localHistogramBindGroupLayout:S,scatterBindGroupLayout:g}}function fc(o){const a=o.createShaderModule({label:"local histogram",code:tc}),h=o.createShaderModule({label:"scatter",code:ec}),S=o.createShaderModule({label:"blelloch prefix",code:nc}),g=pc(o,S),C=hc(o,a,h);return{localHistogramBindGroupLayout:C.localHistogramBindGroupLayout,scatterBindGroupLayout:C.scatterBindGroupLayout,passes:C.passes,hierarchicalBlelloch:g}}function _c(o){const a=o.createTexture({label:"atlas stub (4x4x1 zero RGBA8)",size:{width:4,height:4,depthOrArrayLayers:1},format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),h=a.createView({dimension:"2d-array"}),S=o.createSampler({magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",addressModeW:"clamp-to-edge"}),g=o.createBuffer({label:"atlas rects stub (5 zero floats)",size:4*5,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),C=o.createBuffer({label:"tex_params stub (atlas_enabled=0)",size:32,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});o.queue.writeBuffer(C,0,new ArrayBuffer(32));const M={width:0,height:0,channels:0,kernel_type:0,num_rects:0,uv_extent:0,sb_number:0,format:4294967295,sh_bias:0,res_bias:0,compact_mult:0,layer_h:0,atlas_scale:0,atlas_offset:0,n_layers:0,n_cols:1,layer_cuts:new Uint32Array,column_cuts:new Uint32Array([0,0]),slice_width:0,rects_expanded:new Float32Array,atlas_bytes:new Uint8Array};return{texture:a,view:h,sampler:S,rectsBuffer:g,texParamsBuffer:C,meta:M}}class mc{constructor(a,h,S,g,C,M=null,O=null){R(this,"device");R(this,"pc");R(this,"presentationFormat");R(this,"camera_buffer");R(this,"render_settings_buffer");R(this,"draw_indirect_buffer");R(this,"splat_2d_buffer");R(this,"querySet");R(this,"resolveBuffer");R(this,"resultBuffer");R(this,"queriesPerFrame",lc);R(this,"queryCapacityFrames",200);R(this,"sort_prefixBindGroup");R(this,"sort_pipelines");R(this,"sort_localHistogramBindGroups");R(this,"sort_scatterBindGroups");R(this,"lastFrame",0);R(this,"frameCount",0);R(this,"preprocessPipeline");R(this,"cullPipeline");R(this,"renderPipeline");R(this,"indirectPipeline");R(this,"htEnabled",!1);R(this,"wsrEnabled",!1);R(this,"wsrPipeline",null);R(this,"wsrCompositePipeline",null);R(this,"htSortedTail",!1);R(this,"renderShaderModule");R(this,"betaKernel",1);R(this,"renderSettingsBgl");R(this,"renderSplatsBgl");R(this,"atlasBgl");R(this,"htCorePipeline",null);R(this,"htTailPipeline",null);R(this,"htTail2Pipeline",null);R(this,"htCompositePipeline",null);R(this,"htComposite2Pipeline",null);R(this,"htCompositeBgl",null);R(this,"htCompositeBindGroup",null);R(this,"htDepthTexture",null);R(this,"htDepthView",null);R(this,"htCoreTexture",null);R(this,"htCoreView",null);R(this,"htAccumTexture",null);R(this,"htAccumView",null);R(this,"htTransTexture",null);R(this,"htTransView",null);R(this,"htW",0);R(this,"htH",0);R(this,"htTailBgl",null);R(this,"htTailBindGroup",null);R(this,"htParamsBuffer",null);R(this,"htTailK",150);R(this,"sort_info_buffer");R(this,"sort_ping_pong");R(this,"crsBg");R(this,"gsBg");R(this,"cullBg2");R(this,"preprocessBg1");R(this,"renderSplatsBindGroup");R(this,"renderSettingsBindGroup");R(this,"atlasBindGroup");R(this,"indirectBindGroup");R(this,"sh_solvers_buffer");R(this,"mesh");R(this,"meshDepthPipeline",null);R(this,"meshDepthCameraBindGroup",null);R(this,"meshDepthMarginBindGroup",null);R(this,"meshMarginBuffer",null);R(this,"meshDepthTexture",null);R(this,"meshDepthView",null);R(this,"meshCullBindGroupLayout");R(this,"meshCullBindGroup");R(this,"meshCullWidth",0);R(this,"meshCullHeight",0);R(this,"meshStubTexture");R(this,"meshStubView");R(this,"bfcParamsBuffer");R(this,"meshOverlayPipeline",null);R(this,"meshOverlayEnabled",!1);R(this,"bgColor",[0,0,0,0]);R(this,"showPerfDialogNext",!1);R(this,"requestReorderNextFrame",!1);R(this,"reorderInFlight",!1);R(this,"downloadOnceNextRead",!1);R(this,"downloadOnceFileName","fps_metrics");R(this,"allFrameTimes",[]);R(this,"lastStageBreakdownMs",null);R(this,"timeQueryEnabled");R(this,"atlas");R(this,"atlasParamsBuffer");this.mesh=O;const L=C.includes("timestamp-query");this.timeQueryEnabled=L,L&&Mt("⏰ using timestamp-query"),this.pc=a,this.device=h,this.presentationFormat=S,this.camera_buffer=g,this.atlas=M??_c(h),this.atlasParamsBuffer=h.createBuffer({label:"atlas_params UBO",size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.writeAtlasParams(),h.addEventListener("uncapturederror",re=>{console.error("A WebGPU error was not captured:",re.error)}),this._setupTimestampQueries(),this._setupBuffers();const V=(Math.floor((this.pc.num_points+ln-1)/ln)+1)*ln,F=Math.ceil(V/ln);console.log(`keys count adjusted: ${V}`),console.log(`key size: ${this.pc.num_points}`);const D=h.createBuffer({label:"sort info",size:16*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC|GPUBufferUsage.INDIRECT});this.sort_pipelines=fc(h);const G=[ci(V,h),ci(V,h)],$=h.createBuffer({label:"workgroup histograms",size:F*Gt*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC}),I=h.createBuffer({label:"workgroup prefixes",size:F*Gt*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC}),j=h.createBuffer({label:"digit base",size:Gt*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC}),U=Math.ceil(F/ln),X=Math.ceil(U/ln),Y=h.createBuffer({label:"prefix l0 sums",size:U*Gt*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC}),H=h.createBuffer({label:"prefix l0 offsets",size:U*Gt*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC}),K=h.createBuffer({label:"prefix l1 sums",size:X*Gt*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC}),oe=h.createBuffer({label:"prefix l1 offsets",size:X*Gt*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC});this.sort_prefixBindGroup=h.createBindGroup({label:"prefix 2L bind group",layout:this.sort_pipelines.hierarchicalBlelloch.prefixBindGroupLayout,entries:[{binding:0,resource:{buffer:D}},{binding:1,resource:{buffer:$}},{binding:2,resource:{buffer:I}},{binding:3,resource:{buffer:Y}},{binding:4,resource:{buffer:H}},{binding:5,resource:{buffer:K}},{binding:6,resource:{buffer:oe}},{binding:7,resource:{buffer:j}}]}),this.sort_localHistogramBindGroups=[h.createBindGroup({label:"localHistogram src=0",layout:this.sort_pipelines.localHistogramBindGroupLayout,entries:[{binding:0,resource:{buffer:D}},{binding:1,resource:{buffer:G[0].sort_depths_buffer}},{binding:2,resource:{buffer:$}}]}),h.createBindGroup({label:"localHistogram src=1",layout:this.sort_pipelines.localHistogramBindGroupLayout,entries:[{binding:0,resource:{buffer:D}},{binding:1,resource:{buffer:G[1].sort_depths_buffer}},{binding:2,resource:{buffer:$}}]})],this.sort_scatterBindGroups=[h.createBindGroup({label:"scatter 0->1",layout:this.sort_pipelines.scatterBindGroupLayout,entries:[{binding:0,resource:{buffer:D}},{binding:1,resource:{buffer:j}},{binding:2,resource:{buffer:G[0].sort_depths_buffer}},{binding:3,resource:{buffer:G[1].sort_depths_buffer}},{binding:4,resource:{buffer:G[0].sort_indices_buffer}},{binding:5,resource:{buffer:G[1].sort_indices_buffer}},{binding:6,resource:{buffer:I}}]}),h.createBindGroup({label:"scatter 1->0",layout:this.sort_pipelines.scatterBindGroupLayout,entries:[{binding:0,resource:{buffer:D}},{binding:1,resource:{buffer:j}},{binding:2,resource:{buffer:G[1].sort_depths_buffer}},{binding:3,resource:{buffer:G[0].sort_depths_buffer}},{binding:4,resource:{buffer:G[1].sort_indices_buffer}},{binding:5,resource:{buffer:G[0].sort_indices_buffer}},{binding:6,resource:{buffer:I}}]})],this.sort_info_buffer=D,this.sort_ping_pong=G;const ge=this.device.createBindGroupLayout({label:"camera + renderSettings",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),ue=this.device.createBindGroupLayout({label:"gaussians + splats",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]}),se=this.device.createBindGroupLayout({label:"cullBgl2",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}}]}),_e=this.device.createBindGroupLayout({label:"preprocessBgl2",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:2,visibility:GPUShaderStage.COMPUTE,buffer:{type:"storage"}},{binding:3,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:4,visibility:GPUShaderStage.COMPUTE,buffer:{type:"read-only-storage"}},{binding:5,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]});this.crsBg=this.device.createBindGroup({label:"camera + renderSettings",layout:ge,entries:[{binding:0,resource:{buffer:this.camera_buffer}},{binding:1,resource:{buffer:this.render_settings_buffer}}]}),this.gsBg=this.device.createBindGroup({label:"surfels + splats",layout:ue,entries:[{binding:0,resource:{buffer:this.pc.surfel_buffer}},{binding:1,resource:{buffer:this.splat_2d_buffer}}]}),this.cullBg2=this.device.createBindGroup({label:"cullBg2",layout:se,entries:[{binding:0,resource:{buffer:this.sort_info_buffer}},{binding:1,resource:{buffer:this.sort_ping_pong[0].sort_depths_buffer}},{binding:2,resource:{buffer:this.sort_ping_pong[0].sort_indices_buffer}},{binding:3,resource:{buffer:this.sh_solvers_buffer}}]}),this.preprocessBg1=this.device.createBindGroup({label:"preprocessBg1",layout:_e,entries:[{binding:0,resource:{buffer:this.sort_info_buffer}},{binding:1,resource:{buffer:this.sh_solvers_buffer}},{binding:2,resource:{buffer:this.splat_2d_buffer}},{binding:3,resource:{buffer:this.pc.sv_params_buffer}},{binding:4,resource:{buffer:this.atlas.rectsBuffer}},{binding:5,resource:{buffer:this.atlasParamsBuffer}}]});const te=this.device.createShaderModule({code:Zl});this.indirectPipeline=this.device.createComputePipeline({label:"indirect dispatch calc",layout:"auto",compute:{module:te,entryPoint:"write_dispatch_triples",constants:{RS_RADIX_SIZE:256}}}),this.indirectBindGroup=this.device.createBindGroup({label:"indirect dispatch bind group",layout:this.indirectPipeline.getBindGroupLayout(0),entries:[{binding:0,resource:{buffer:this.sort_info_buffer}},{binding:1,resource:{buffer:this.draw_indirect_buffer}}]}),this.bfcParamsBuffer=this.device.createBuffer({label:"bfc params (uniform, 16 B)",size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.device.queue.writeBuffer(this.bfcParamsBuffer,0,new Float32Array([2,0,0,0])),this.meshCullBindGroupLayout=this.device.createBindGroupLayout({label:"mesh cull (cull group 3)",entries:[{binding:0,visibility:GPUShaderStage.COMPUTE,texture:{sampleType:"depth",viewDimension:"2d",multisampled:!1}},{binding:1,visibility:GPUShaderStage.COMPUTE,buffer:{type:"uniform"}}]}),this.meshStubTexture=this.device.createTexture({label:"mesh cull stub (1x1 depth32float)",size:{width:1,height:1,depthOrArrayLayers:1},format:"depth32float",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.RENDER_ATTACHMENT}),this.meshStubView=this.meshStubTexture.createView({dimension:"2d"}),this.meshCullBindGroup=this.device.createBindGroup({label:"mesh cull bind (stub)",layout:this.meshCullBindGroupLayout,entries:[{binding:0,resource:this.meshStubView},{binding:1,resource:{buffer:this.bfcParamsBuffer}}]});const Oe=this.device.createShaderModule({code:Xl});if(this.cullPipeline=this.device.createComputePipeline({label:"surfel_cull",layout:this.device.createPipelineLayout({bindGroupLayouts:[ge,ue,se,this.meshCullBindGroupLayout]}),compute:{module:Oe,entryPoint:"surfel_cull"}}),this.mesh!==null){const re=this.device.createBindGroupLayout({label:"mesh_depth camera (group 0)",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]});this.meshDepthCameraBindGroup=this.device.createBindGroup({label:"mesh_depth camera bind",layout:re,entries:[{binding:0,resource:{buffer:this.camera_buffer}}]});const ie=this.device.createBindGroupLayout({label:"mesh_depth margin (group 1)",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]});this.meshMarginBuffer=this.device.createBuffer({label:"mesh cull margin (uniform, 16 B)",size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.device.queue.writeBuffer(this.meshMarginBuffer,0,new Float32Array([0,0,0,0])),this.meshDepthMarginBindGroup=this.device.createBindGroup({label:"mesh_depth margin bind",layout:ie,entries:[{binding:0,resource:{buffer:this.meshMarginBuffer}}]});const me=this.device.createShaderModule({code:Ql});this.meshDepthPipeline=this.device.createRenderPipeline({label:"mesh_depth",layout:this.device.createPipelineLayout({bindGroupLayouts:[re,ie]}),vertex:{module:me,entryPoint:"vs_main",buffers:[{arrayStride:12,attributes:[{shaderLocation:0,offset:0,format:"float32x3"}]},{arrayStride:12,attributes:[{shaderLocation:1,offset:0,format:"float32x3"}]}]},primitive:{topology:"triangle-list",cullMode:"none"},depthStencil:{format:"depth32float",depthWriteEnabled:!0,depthCompare:"less"}})}const Ge=this.device.createShaderModule({code:Hl});this.preprocessPipeline=this.device.createComputePipeline({label:"preprocess_2dgs",layout:this.device.createPipelineLayout({bindGroupLayouts:[ge,_e]}),compute:{module:Ge,entryPoint:"preprocess"}});const Ie=this.device.createShaderModule({code:Kl});Ie.getCompilationInfo().then(re=>{re.messages.length>0?(console.group("[render_2dgs.wgsl] compilation messages"),re.messages.forEach(ie=>{(ie.type==="error"?console.error:ie.type==="warning"?console.warn:console.log)(`${ie.type} (line ${ie.lineNum}:${ie.linePos}): ${ie.message}`)}),console.groupEnd()):console.log("[render_2dgs.wgsl] compiled clean")});const Te=this.device.createBindGroupLayout({label:"render_settings (vertex)",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),ve=this.device.createBindGroupLayout({label:"splats_2d + indices (vertex)",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}},{binding:1,visibility:GPUShaderStage.VERTEX,buffer:{type:"read-only-storage"}}]}),ye=this.device.createBindGroupLayout({label:"atlas (fragment)",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"float",viewDimension:"2d-array",multisampled:!1}},{binding:1,visibility:GPUShaderStage.FRAGMENT,sampler:{type:"filtering"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}},{binding:3,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"read-only-storage"}}]}),le=this.atlas.meta.format!==4294967295&&this.atlas.meta.kernel_type===0?0:1;this.device.pushErrorScope("validation"),this.renderPipeline=this.device.createRenderPipeline({label:"render_2dgs",layout:this.device.createPipelineLayout({bindGroupLayouts:[Te,ve,ye]}),vertex:{module:Ie,entryPoint:"vs_main"},fragment:{module:Ie,entryPoint:"fs_main",constants:{BETA_KERNEL:le},targets:[{format:this.presentationFormat,blend:{color:{operation:"add",srcFactor:"one",dstFactor:"one-minus-src-alpha"},alpha:{operation:"add",srcFactor:"one",dstFactor:"one-minus-src-alpha"}}}]},primitive:{topology:"triangle-strip",cullMode:"none"}}),this.device.popErrorScope().then(re=>{re?console.error("[render_2dgs] pipeline create validation error:",re.message):console.log("[render_2dgs] pipeline created OK")}),this.renderSettingsBindGroup=this.device.createBindGroup({label:"render_settings (vertex)",layout:Te,entries:[{binding:0,resource:{buffer:this.render_settings_buffer}}]}),this.renderSplatsBindGroup=this.device.createBindGroup({label:"splats_2d + indices (vertex)",layout:ve,entries:[{binding:0,resource:{buffer:this.splat_2d_buffer}},{binding:1,resource:{buffer:this.sort_ping_pong[li].sort_indices_buffer}}]}),this.atlasBindGroup=this.device.createBindGroup({label:"atlas (fragment)",layout:ye,entries:[{binding:0,resource:this.atlas.view},{binding:1,resource:this.atlas.sampler},{binding:2,resource:{buffer:this.atlas.texParamsBuffer}},{binding:3,resource:{buffer:this.atlas.rectsBuffer}}]}),this.renderShaderModule=Ie,this.betaKernel=le,this.renderSettingsBgl=Te,this.renderSplatsBgl=ve,this.atlasBgl=ye}get totalQueryCount(){return this.queriesPerFrame*this.queryCapacityFrames}setHtTailK(a){this.htTailK=a,this.htParamsBuffer!==null&&this.device.queue.writeBuffer(this.htParamsBuffer,0,new Float32Array([a,0,0,0]))}setMeshOverlayEnabled(a){this.meshOverlayEnabled=a&&this.mesh!==null}setMeshCullEnabled(a){an({meshCull:a&&this.mesh!==null},this.device,this.render_settings_buffer)}setMeshMargin(a){this.meshMarginBuffer!==null&&this.device.queue.writeBuffer(this.meshMarginBuffer,0,new Float32Array([a]))}setBfcParams(a,h){this.device.queue.writeBuffer(this.bfcParamsBuffer,0,new Float32Array([a,h[0],h[1],h[2]]))}get hasMesh(){return this.mesh!==null}get texParamsBuffer(){return this.atlas.texParamsBuffer}get hasAtlas(){return this.atlas.meta.format!==4294967295}writeAtlasParams(){const a=new ArrayBuffer(16),h=new Uint32Array(a),S=new Float32Array(a);h[0]=this.atlas.meta.width|0,h[1]=this.atlas.meta.layer_h|0,S[2]=this.atlas.meta.uv_extent||0,h[3]=this.atlas.meta.probe_mode|0||0,this.device.queue.writeBuffer(this.atlasParamsBuffer,0,a)}ensureHtResources(a,h){var C,M,O,L;if(this.htCorePipeline===null){const V=this.device.createPipelineLayout({bindGroupLayouts:[this.renderSettingsBgl,this.renderSplatsBgl,this.atlasBgl]});this.htTailBgl=this.device.createBindGroupLayout({label:"ht_tail depth-weighting (group 3)",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"depth",viewDimension:"2d",multisampled:!1}},{binding:1,visibility:GPUShaderStage.FRAGMENT,buffer:{type:"uniform"}}]}),this.htParamsBuffer=this.device.createBuffer({label:"ht params (uniform, 16 B)",size:16,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST}),this.device.queue.writeBuffer(this.htParamsBuffer,0,new Float32Array([this.htTailK,0,0,0]));const F=this.device.createPipelineLayout({bindGroupLayouts:[this.renderSettingsBgl,this.renderSplatsBgl,this.atlasBgl,this.htTailBgl]});this.htCorePipeline=this.device.createRenderPipeline({label:"ht_core",layout:V,vertex:{module:this.renderShaderModule,entryPoint:"vs_main"},fragment:{module:this.renderShaderModule,entryPoint:"fs_core",constants:{BETA_KERNEL:this.betaKernel},targets:[{format:"rgba16float"}]},primitive:{topology:"triangle-strip",cullMode:"none"},depthStencil:{format:"depth32float",depthWriteEnabled:!0,depthCompare:"less"}}),this.htTailPipeline=this.device.createRenderPipeline({label:"ht_tail",layout:F,vertex:{module:this.renderShaderModule,entryPoint:"vs_main"},fragment:{module:this.renderShaderModule,entryPoint:"fs_tail",constants:{BETA_KERNEL:this.betaKernel},targets:[{format:"rgba16float",blend:{color:{operation:"add",srcFactor:"one",dstFactor:"one"},alpha:{operation:"add",srcFactor:"one",dstFactor:"one"}}},{format:"r16float",blend:{color:{operation:"add",srcFactor:"zero",dstFactor:"one-minus-src"},alpha:{operation:"add",srcFactor:"zero",dstFactor:"one-minus-src-alpha"}}}]},primitive:{topology:"triangle-strip",cullMode:"none"},depthStencil:{format:"depth32float",depthWriteEnabled:!1,depthCompare:"greater"}}),this.htTail2Pipeline=this.device.createRenderPipeline({label:"ht_tail_sorted",layout:V,vertex:{module:this.renderShaderModule,entryPoint:"vs_main"},fragment:{module:this.renderShaderModule,entryPoint:"fs_tail_sorted",constants:{BETA_KERNEL:this.betaKernel},targets:[{format:"rgba16float",blend:{color:{operation:"add",srcFactor:"one",dstFactor:"one-minus-src-alpha"},alpha:{operation:"add",srcFactor:"one",dstFactor:"one-minus-src-alpha"}}}]},primitive:{topology:"triangle-strip",cullMode:"none"},depthStencil:{format:"depth32float",depthWriteEnabled:!1,depthCompare:"greater"}}),this.wsrPipeline=this.device.createRenderPipeline({label:"wsr_accumulate",layout:V,vertex:{module:this.renderShaderModule,entryPoint:"vs_main"},fragment:{module:this.renderShaderModule,entryPoint:"fs_wsr",constants:{BETA_KERNEL:this.betaKernel},targets:[{format:"rgba16float",blend:{color:{operation:"add",srcFactor:"one",dstFactor:"one"},alpha:{operation:"add",srcFactor:"one",dstFactor:"one"}}},{format:"r16float",blend:{color:{operation:"add",srcFactor:"zero",dstFactor:"one-minus-src"},alpha:{operation:"add",srcFactor:"zero",dstFactor:"one-minus-src-alpha"}}}]},primitive:{topology:"triangle-strip",cullMode:"none"}});const D=this.device.createShaderModule({label:"ht_composite",code:Yl});this.htCompositeBgl=this.device.createBindGroupLayout({label:"ht_composite inputs",entries:[{binding:0,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float"}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float"}},{binding:2,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:"unfilterable-float"}}]}),this.htCompositePipeline=this.device.createRenderPipeline({label:"ht_composite",layout:this.device.createPipelineLayout({bindGroupLayouts:[this.htCompositeBgl]}),vertex:{module:D,entryPoint:"vs_main"},fragment:{module:D,entryPoint:"fs_main",targets:[{format:this.presentationFormat,blend:{color:{operation:"add",srcFactor:"one",dstFactor:"one-minus-src-alpha"},alpha:{operation:"add",srcFactor:"one",dstFactor:"one-minus-src-alpha"}}}]},primitive:{topology:"triangle-list"}}),this.wsrCompositePipeline=this.device.createRenderPipeline({label:"wsr_composite",layout:this.device.createPipelineLayout({bindGroupLayouts:[this.htCompositeBgl]}),vertex:{module:D,entryPoint:"vs_main"},fragment:{module:D,entryPoint:"fs_wsr_composite",targets:[{format:this.presentationFormat,blend:{color:{operation:"add",srcFactor:"one",dstFactor:"one-minus-src-alpha"},alpha:{operation:"add",srcFactor:"one",dstFactor:"one-minus-src-alpha"}}}]},primitive:{topology:"triangle-list"}}),this.htComposite2Pipeline=this.device.createRenderPipeline({label:"ht_composite_sorted",layout:this.device.createPipelineLayout({bindGroupLayouts:[this.htCompositeBgl]}),vertex:{module:D,entryPoint:"vs_main"},fragment:{module:D,entryPoint:"fs_sorted_tail",targets:[{format:this.presentationFormat,blend:{color:{operation:"add",srcFactor:"one",dstFactor:"one-minus-src-alpha"},alpha:{operation:"add",srcFactor:"one",dstFactor:"one-minus-src-alpha"}}}]},primitive:{topology:"triangle-list"}})}if(this.htCoreTexture!==null&&this.htW===a&&this.htH===h)return;(C=this.htDepthTexture)==null||C.destroy(),(M=this.htCoreTexture)==null||M.destroy(),(O=this.htAccumTexture)==null||O.destroy(),(L=this.htTransTexture)==null||L.destroy();const S={width:Math.max(1,a),height:Math.max(1,h),depthOrArrayLayers:1},g=GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING;this.htDepthTexture=this.device.createTexture({label:"ht depth",size:S,format:"depth32float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),this.htCoreTexture=this.device.createTexture({label:"ht core",size:S,format:"rgba16float",usage:g}),this.htAccumTexture=this.device.createTexture({label:"ht accum",size:S,format:"rgba16float",usage:g}),this.htTransTexture=this.device.createTexture({label:"ht trans",size:S,format:"r16float",usage:g}),this.htDepthView=this.htDepthTexture.createView(),this.htCoreView=this.htCoreTexture.createView(),this.htAccumView=this.htAccumTexture.createView(),this.htTransView=this.htTransTexture.createView(),this.htCompositeBindGroup=this.device.createBindGroup({label:"ht composite bind",layout:this.htCompositeBgl,entries:[{binding:0,resource:this.htCoreView},{binding:1,resource:this.htAccumView},{binding:2,resource:this.htTransView}]}),this.htTailBindGroup=this.device.createBindGroup({label:"ht tail bind (group 3)",layout:this.htTailBgl,entries:[{binding:0,resource:this.htDepthView},{binding:1,resource:{buffer:this.htParamsBuffer}}]}),this.htW=a,this.htH=h}ensureMeshDepthTexture(a,h){var S;this.mesh!==null&&(this.meshDepthTexture!==null&&this.meshCullWidth===a&&this.meshCullHeight===h||((S=this.meshDepthTexture)==null||S.destroy(),this.meshDepthTexture=this.device.createTexture({label:"mesh_depth attachment",size:{width:Math.max(1,a),height:Math.max(1,h),depthOrArrayLayers:1},format:"depth32float",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.TEXTURE_BINDING}),this.meshDepthView=this.meshDepthTexture.createView({dimension:"2d"}),this.meshCullBindGroup=this.device.createBindGroup({label:"mesh cull bind (live)",layout:this.meshCullBindGroupLayout,entries:[{binding:0,resource:this.meshDepthView},{binding:1,resource:{buffer:this.bfcParamsBuffer}}]}),this.meshCullWidth=a,this.meshCullHeight=h))}setAtlasEnabled(a){this.atlas.meta.format!==4294967295&&mi(this.device,this.atlas.texParamsBuffer,this.atlas.meta,a)}async debugReadSortedIndices(a=30){const h=Math.max(0,Math.min(a,this.pc.num_points)),S=h*Uint32Array.BYTES_PER_ELEMENT;if(S===0){console.log("[DEBUG] No indices to read.");return}const g=this.device.createBuffer({size:S,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ}),C=this.device.createCommandEncoder();C.copyBufferToBuffer(this.sort_ping_pong[li].sort_indices_buffer,0,g,0,S),this.device.queue.submit([C.finish()]),await g.mapAsync(GPUMapMode.READ);const M=new Uint32Array(g.getMappedRange());console.log("[DEBUG] Sorted indices (first",h,"):",Array.from(M)),g.unmap()}frame(a,h,S=!0){var V,F;const C=(this.lastFrame+this.frameCount)%this.queryCapacityFrames*this.queriesPerFrame,M=S&&this.timeQueryEnabled;if(this.mesh!==null&&this.meshDepthPipeline!==null&&(at.accel_flags[0]&Os)!==0){const D=at.canvas_size[0],G=at.canvas_size[1];this.ensureMeshDepthTexture(D,G);const $={label:"mesh_depth",colorAttachments:[],depthStencilAttachment:{view:this.meshDepthView,depthLoadOp:"clear",depthClearValue:1,depthStoreOp:"store"}},I=a.beginRenderPass($);I.setPipeline(this.meshDepthPipeline),I.setBindGroup(0,this.meshDepthCameraBindGroup),I.setBindGroup(1,this.meshDepthMarginBindGroup),I.setVertexBuffer(0,this.mesh.vertexBuffer),I.setVertexBuffer(1,this.mesh.normalBuffer),I.setIndexBuffer(this.mesh.indexBuffer,"uint32"),I.drawIndexed(this.mesh.numIndices),I.end()}{a.clearBuffer(this.sort_info_buffer,0,4);const D={label:"cull"};M&&(D.timestampWrites={querySet:this.querySet,beginningOfPassWriteIndex:C+0,endOfPassWriteIndex:C+1});const G=a.beginComputePass(D);G.setPipeline(this.cullPipeline),G.setBindGroup(0,this.crsBg),G.setBindGroup(1,this.gsBg),G.setBindGroup(2,this.cullBg2),G.setBindGroup(3,this.meshCullBindGroup);const $=Math.ceil(this.pc.num_points/oc);G.dispatchWorkgroups($,1,1),G.end()}{const D=a.beginComputePass({label:"calculate indirect dispatch"});D.setPipeline(this.indirectPipeline),D.setBindGroup(0,this.indirectBindGroup),D.dispatchWorkgroups(1,1,1),D.end()}{const D={label:"preprocess"};M&&(D.timestampWrites={querySet:this.querySet,beginningOfPassWriteIndex:C+2,endOfPassWriteIndex:C+3});const G=a.beginComputePass(D);G.setPipeline(this.preprocessPipeline),G.setBindGroup(0,this.crsBg),G.setBindGroup(1,this.preprocessBg1),G.dispatchWorkgroupsIndirect(this.sort_info_buffer,4),G.end()}const L=this.wsrEnabled&&(((F=(V=this.atlas)==null?void 0:V.meta)==null?void 0:F.probe_mode)|0)===2;if(!this.htEnabled&&!L||this.htSortedTail)for(let D=0;D<is;D++){const G=D&1,$=this.sort_pipelines.passes[D],I=this.sort_localHistogramBindGroups[G],j=this.sort_scatterBindGroups[G];{const U={label:`upsweep_round${D}`};M&&!this.htEnabled&&D==0&&(U.timestampWrites={querySet:this.querySet,beginningOfPassWriteIndex:C+4});const X=a.beginComputePass(U);X.setPipeline($.localHistogram),X.setBindGroup(0,I),X.dispatchWorkgroupsIndirect(this.sort_info_buffer,4),X.end()}{const U=a.beginComputePass({label:`prefix_round${D} - l0TileScan`});U.setPipeline(this.sort_pipelines.hierarchicalBlelloch.l0TileScan),U.setBindGroup(0,this.sort_prefixBindGroup),U.dispatchWorkgroupsIndirect(this.sort_info_buffer,16),U.end()}{const U=a.beginComputePass({label:`prefix_round${D} - l1TileScanOnL0`});U.setPipeline(this.sort_pipelines.hierarchicalBlelloch.l1TileScanOnL0),U.setBindGroup(0,this.sort_prefixBindGroup),U.dispatchWorkgroupsIndirect(this.sort_info_buffer,32),U.end()}{const U=a.beginComputePass({label:`prefix_round${D} - l1ScanSums`});U.setPipeline(this.sort_pipelines.hierarchicalBlelloch.l1ScanSums),U.setBindGroup(0,this.sort_prefixBindGroup),U.dispatchWorkgroups(1,Gt,1),U.end()}{const U=a.beginComputePass({label:`prefix_round${D} - addL1ToL0`});U.setPipeline(this.sort_pipelines.hierarchicalBlelloch.addL1ToL0),U.setBindGroup(0,this.sort_prefixBindGroup),U.dispatchWorkgroupsIndirect(this.sort_info_buffer,32),U.end()}{const U=a.beginComputePass({label:`prefix_round${D} - addL0ToElems`});U.setPipeline(this.sort_pipelines.hierarchicalBlelloch.addL0ToElems),U.setBindGroup(0,this.sort_prefixBindGroup),U.dispatchWorkgroupsIndirect(this.sort_info_buffer,16),U.end()}{const U=a.beginComputePass({label:`prefix_round${D} - computeDigitBase`});U.setPipeline(this.sort_pipelines.hierarchicalBlelloch.computeDigitBase),U.setBindGroup(0,this.sort_prefixBindGroup),U.dispatchWorkgroups(1,1,1),U.end()}{const U={label:`scatter_round${D}`};M&&!this.htEnabled&&D==is-1&&(U.timestampWrites={querySet:this.querySet,endOfPassWriteIndex:C+5});const X=a.beginComputePass(U);X.setPipeline($.scatterElements),X.setBindGroup(0,j),X.dispatchWorkgroupsIndirect(this.sort_info_buffer,4),X.end()}}if(L){const D=at.canvas_size[0],G=at.canvas_size[1];this.ensureHtResources(D,G);{const $={label:"wsr_accumulate",colorAttachments:[{view:this.htAccumView,loadOp:"clear",storeOp:"store",clearValue:[0,0,0,0]},{view:this.htTransView,loadOp:"clear",storeOp:"store",clearValue:[1,0,0,1]}]};M&&($.timestampWrites={querySet:this.querySet,beginningOfPassWriteIndex:C+4,endOfPassWriteIndex:C+5});const I=a.beginRenderPass($);I.setPipeline(this.wsrPipeline),I.setBindGroup(0,this.renderSettingsBindGroup),I.setBindGroup(1,this.renderSplatsBindGroup),I.setBindGroup(2,this.atlasBindGroup),I.drawIndirect(this.draw_indirect_buffer,0),I.end()}{const $={label:"wsr_composite",colorAttachments:[{view:h,loadOp:"clear",storeOp:"store",clearValue:this.bgColor}]};M&&($.timestampWrites={querySet:this.querySet,endOfPassWriteIndex:C+7});const I=a.beginRenderPass($);I.setPipeline(this.wsrCompositePipeline),I.setBindGroup(0,this.htCompositeBindGroup),I.draw(3),I.end()}}else if(this.htEnabled){const D=at.canvas_size[0],G=at.canvas_size[1];this.ensureHtResources(D,G);{const $={label:"ht_core",colorAttachments:[{view:this.htCoreView,loadOp:"clear",storeOp:"store",clearValue:[0,0,0,0]}],depthStencilAttachment:{view:this.htDepthView,depthLoadOp:"clear",depthClearValue:1,depthStoreOp:"store"}};M&&($.timestampWrites={querySet:this.querySet,beginningOfPassWriteIndex:C+4,endOfPassWriteIndex:C+5});const I=a.beginRenderPass($);I.setPipeline(this.htCorePipeline),I.setBindGroup(0,this.renderSettingsBindGroup),I.setBindGroup(1,this.renderSplatsBindGroup),I.setBindGroup(2,this.atlasBindGroup),I.drawIndirect(this.draw_indirect_buffer,0),I.end()}if(this.htSortedTail){const $={label:"ht_tail_sorted",colorAttachments:[{view:this.htAccumView,loadOp:"clear",storeOp:"store",clearValue:[0,0,0,0]}],depthStencilAttachment:{view:this.htDepthView,depthReadOnly:!0}};M&&($.timestampWrites={querySet:this.querySet,beginningOfPassWriteIndex:C+6});const I=a.beginRenderPass($);I.setPipeline(this.htTail2Pipeline),I.setBindGroup(0,this.renderSettingsBindGroup),I.setBindGroup(1,this.renderSplatsBindGroup),I.setBindGroup(2,this.atlasBindGroup),I.drawIndirect(this.draw_indirect_buffer,0),I.end()}else{const $={label:"ht_tail",colorAttachments:[{view:this.htAccumView,loadOp:"clear",storeOp:"store",clearValue:[0,0,0,0]},{view:this.htTransView,loadOp:"clear",storeOp:"store",clearValue:[1,0,0,1]}],depthStencilAttachment:{view:this.htDepthView,depthReadOnly:!0}};M&&($.timestampWrites={querySet:this.querySet,beginningOfPassWriteIndex:C+6});const I=a.beginRenderPass($);I.setPipeline(this.htTailPipeline),I.setBindGroup(0,this.renderSettingsBindGroup),I.setBindGroup(1,this.renderSplatsBindGroup),I.setBindGroup(2,this.atlasBindGroup),I.setBindGroup(3,this.htTailBindGroup),I.drawIndirect(this.draw_indirect_buffer,0),I.end()}{const $={label:"ht_composite",colorAttachments:[{view:h,loadOp:"clear",storeOp:"store",clearValue:this.bgColor}]};M&&($.timestampWrites={querySet:this.querySet,endOfPassWriteIndex:C+7});const I=a.beginRenderPass($);I.setPipeline(this.htSortedTail?this.htComposite2Pipeline:this.htCompositePipeline),I.setBindGroup(0,this.htCompositeBindGroup),I.draw(3),I.end()}}else{const D={label:"render",colorAttachments:[{view:h,loadOp:"clear",storeOp:"store",clearValue:this.bgColor}]};M&&(D.timestampWrites={querySet:this.querySet,beginningOfPassWriteIndex:C+6,endOfPassWriteIndex:C+7});const G=a.beginRenderPass(D);G.setPipeline(this.renderPipeline),G.setBindGroup(0,this.renderSettingsBindGroup),G.setBindGroup(1,this.renderSplatsBindGroup),G.setBindGroup(2,this.atlasBindGroup),G.drawIndirect(this.draw_indirect_buffer,0),G.end()}if(this.meshOverlayEnabled&&this.mesh!==null){if(this.meshOverlayPipeline===null){const $=this.device.createShaderModule({code:Jl}),I=this.device.createBindGroupLayout({label:"mesh_overlay camera (group 0)",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]}),j=this.device.createBindGroupLayout({label:"mesh_overlay margin (group 1)",entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:"uniform"}}]});this.meshOverlayPipeline=this.device.createRenderPipeline({label:"mesh_overlay",layout:this.device.createPipelineLayout({bindGroupLayouts:[I,j]}),vertex:{module:$,entryPoint:"vs_main",buffers:[{arrayStride:12,attributes:[{shaderLocation:0,offset:0,format:"float32x3"}]},{arrayStride:12,attributes:[{shaderLocation:1,offset:0,format:"float32x3"}]}]},fragment:{module:$,entryPoint:"fs_main",targets:[{format:this.presentationFormat,blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha",operation:"add"},alpha:{srcFactor:"one",dstFactor:"one-minus-src-alpha",operation:"add"}}}]},primitive:{topology:"triangle-list",cullMode:"none"}})}const D={label:"mesh_overlay",colorAttachments:[{view:h,loadOp:"load",storeOp:"store"}]},G=a.beginRenderPass(D);G.setPipeline(this.meshOverlayPipeline),G.setBindGroup(0,this.meshDepthCameraBindGroup),G.setBindGroup(1,this.meshDepthMarginBindGroup),G.setVertexBuffer(0,this.mesh.vertexBuffer),G.setVertexBuffer(1,this.mesh.normalBuffer),G.setIndexBuffer(this.mesh.indexBuffer,"uint32"),G.drawIndexed(this.mesh.numIndices),G.end()}this.frameCount++}async readPerfMetrics(a){const h=(a==null?void 0:a.silent)??!1;if(this.frameCount<=0)return;const S=this.device.createCommandEncoder({label:"timestamp resolve encoder"});S.resolveQuerySet(this.querySet,0,this.totalQueryCount,this.resolveBuffer,0),S.copyBufferToBuffer(this.resolveBuffer,0,this.resultBuffer,0,this.totalQueryCount*8),this.device.queue.submit([S.finish()]),await this.device.queue.onSubmittedWorkDone();const g=[["Total",7,0],["Culling",1,0],["Preprocess",3,2],["Sort",5,4],["Render",7,6]];await this.resultBuffer.mapAsync(GPUMapMode.READ);const C=new BigInt64Array(this.resultBuffer.getMappedRange()),M=Math.min(this.frameCount,this.queryCapacityFrames),O=(this.lastFrame+this.frameCount-M)%this.queryCapacityFrames,L=Array.from({length:g.length},()=>[]);let V=0;for(let X=0;X<M;X++){const Y=(O+X)%this.queryCapacityFrames,H=Y*this.queriesPerFrame;let K=!0;for(let oe=0;oe<g.length;oe++){const[ge,ue,se]=g[oe];if(C[H+se]===0n||C[H+ue]===0n||C[H+ue]<C[H+se]){K=!1;break}}if(!K){!h&&Y%60===0&&console.debug("[timestamp] frame slot",Y,"contains unwritten (0) timestamps, skipped in stats");continue}V++;for(let oe=0;oe<g.length;oe++){const[ge,ue,se]=g[oe],_e=Number(C[H+se]),te=Number(C[H+ue]);L[oe].push((te-_e)/1e6)}}if(V===0){this.resultBuffer.unmap(),h||console.warn("[timestamp] No complete frames available (some timestamps are 0). It may be the first frame or the GPU is still filling.");return}this.allFrameTimes.push(...L[0]);const F=[];let D=0,G=0,$=0;for(let X=0;X<g.length;X++){const Y=g[X][0],H=L[X];let K=0;if(Y==="Total"){const oe=this.allFrameTimes;K=oe.reduce((se,_e)=>se+_e,0)/oe.length;const ge=[...oe].sort((se,_e)=>se-_e);D=ge[Math.floor(ge.length*.99)]||0;const ue=oe.reduce((se,_e)=>se+Math.pow(_e-K,2),0)/oe.length;G=Math.sqrt(ue),$=K}else K=H.reduce((oe,ge)=>oe+ge,0)/H.length;F.push([Y,K])}this.lastFrame+=this.frameCount,this.frameCount=0;const I=Object.fromEntries(F);this.lastStageBreakdownMs={cull:I.Culling??0,preprocess:I.Preprocess??0,sort:I.Sort??0,render:I.Render??0,total:I.Total??0};const U=`[TIMESTAMP - ${this.constructor.name}]
`+F.map(([X,Y])=>`${X}: ${Y.toFixed(3)}ms`).join(`
`)+`
Total P99: ${D.toFixed(3)}ms
Total STD: ${G.toFixed(3)}ms
Total AVG: ${$.toFixed(3)}ms
Stats computed over ${this.allFrameTimes.length} frames (cumulative)
${this.lastFrame} frames rendered since start`;if(h||(console.log(U),console.log("All Frame Times (Total, ms):",JSON.stringify(this.allFrameTimes))),this.downloadOnceNextRead){this.downloadOnceNextRead=!1;const X=`Stage,ms
`,Y=F.map(([oe,ge])=>`${oe},${ge.toFixed(3)}`).join(`
`),H="data:text/csv;charset=utf-8,"+encodeURIComponent(X+Y),K=document.createElement("a");K.href=H,K.download=`${this.downloadOnceFileName}.csv`,document.body.appendChild(K),K.click(),K.remove()}if(this.showPerfDialogNext){this.showPerfDialogNext=!1;try{alert(U)}catch{console.warn("Unable to show dialog; metrics printed to console.")}}this.resultBuffer.unmap()}_setupTimestampQueries(){this.querySet=this.device.createQuerySet({type:"timestamp",count:this.totalQueryCount});const a=this.totalQueryCount*8;this.resolveBuffer=this.device.createBuffer({size:a,usage:GPUBufferUsage.QUERY_RESOLVE|GPUBufferUsage.COPY_SRC}),this.resultBuffer=this.device.createBuffer({size:a,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ})}_setupBuffers(){this.render_settings_buffer=this.device.createBuffer({label:"render settings",size:ac,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});const a=document.querySelector("canvas"),h=a?a.width:1,S=a?a.height:1;ic({width:h,height:S,sh_bias:this.pc.sh_bias,color_K:this.pc.K,feature_mode:this.pc.feature_mode}),wi(this.device,this.render_settings_buffer),this.splat_2d_buffer=this.device.createBuffer({label:"splats_2d (Splat2DGS)",size:In(this.pc.num_points*cc),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST}),this.draw_indirect_buffer=this.device.createBuffer({label:"draw indirect",size:4*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC|GPUBufferUsage.INDIRECT}),this.device.queue.writeBuffer(this.draw_indirect_buffer,0,new Uint32Array([4,0,0,0])),this.sh_solvers_buffer=this.device.createBuffer({label:"sh_solvers",size:In(this.pc.num_points*uc),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST})}requestPerfDialog(){this.showPerfDialogNext=!0}requestDownloadMetrics(a){if(a&&a.trim().length>0){const h=a.trim().replace(/[^a-zA-Z0-9_\-]/g,"_");this.downloadOnceFileName=h.length>0?h:this.downloadOnceFileName}else{const h=new Date,S=`${h.getFullYear()}${String(h.getMonth()+1).padStart(2,"0")}${String(h.getDate()).padStart(2,"0")}_${String(h.getHours()).padStart(2,"0")}${String(h.getMinutes()).padStart(2,"0")}${String(h.getSeconds()).padStart(2,"0")}`;this.downloadOnceFileName=`fps_metrics_${S}`}this.downloadOnceNextRead=!0}requestReorder(){}async maybeReorderAfterSubmit(){}}function bc(o,a){return 2*Math.atan(a/(2*o))}function vc(o,a,h,S){const g=Math.tan(S/2),C=Math.tan(h/2),M=g*o,O=-M,L=C*o,V=-L,F=dt.create();return F[0]=2*o/(L-V),F[5]=-2*o/(M-O),F[2]=(L+V)/(L-V),F[6]=(M+O)/(M-O),F[14]=1,F[10]=a/(a-o),F[11]=-(a*o)/(a-o),dt.transpose(F,F),F}async function gc(o){Mt(`loading scene camera file... : ${o}`);const h=await(await fetch(o)).json();return Mt(`loaded cameras count: ${h.length}`),h.map(S=>{const g=z.clone(S.position),C=Et.create(...S.rotation.flat()),M=C[0],O=C[4],L=C[8],V=C[1],F=C[5],D=C[9],G=C[2],$=C[6],I=C[10];M*(F*I-D*$)-O*(V*I-D*G)+L*(V*$-F*G)<0&&(C[1]=-C[1],C[5]=-C[5],C[9]=-C[9]);const U=dt.fromMat3(C);return{position:g,rotation:U,img_name:S.img_name,id:S.id}})}const wc=4*2,xc=4*16,xi=4*xc+2*wc;function yc(o){return o.createBuffer({label:"camera uniform",size:xi,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}const on=new Float32Array(xi/Float32Array.BYTES_PER_ELEMENT),os=class os{constructor(a,h){R(this,"uniform_buffer");R(this,"position",z.create());R(this,"rotation",dt.create());R(this,"fovY",45/180*Math.PI);R(this,"fovX");R(this,"focal",Jr.create());R(this,"viewport",Jr.create());R(this,"view_matrix",dt.identity());R(this,"view_inv_matrix",dt.identity());R(this,"proj_matrix",dt.identity());R(this,"proj_inv_matrix",dt.identity());R(this,"_negPos",z.create());R(this,"look",z.create(0,0,1));R(this,"up",z.create(0,1,0));R(this,"right",z.create(1,0,0));this.canvas=a,this.device=h,this.uniform_buffer=yc(h),this.on_update_canvas()}on_update_canvas(){const a=.5*this.canvas.height/Math.tan(this.fovY*.5);this.focal[0]=a,this.focal[1]=a,this.fovX=bc(a,this.canvas.width),this.viewport[0]=this.canvas.width,this.viewport[1]=this.canvas.height,this.proj_matrix=vc(.01,100,this.fovX,this.fovY),dt.inverse(this.proj_matrix,this.proj_inv_matrix),this.update_buffer()}update_buffer(){this._negPos[0]=-this.position[0],this._negPos[1]=-this.position[1],this._negPos[2]=-this.position[2],dt.copy(this.rotation,this.view_matrix),dt.translate(this.view_matrix,this._negPos,this.view_matrix),dt.inverse(this.view_matrix,this.view_inv_matrix),z.transformMat4Upper3x3(os.Z_AXIS,this.view_inv_matrix,this.look),z.normalize(this.look,this.look),z.cross(this.up,this.look,this.right),z.normalize(this.right,this.right);let a=0;on.set(this.view_matrix,a),a+=16,on.set(this.view_inv_matrix,a),a+=16,on.set(this.proj_matrix,a),a+=16,on.set(this.proj_inv_matrix,a),a+=16,on.set(this.viewport,a),a+=2,on.set(this.focal,a),a+=2,this.device.queue.writeBuffer(this.uniform_buffer,0,on)}set_preset(a){z.copy(a.position,this.position),dt.copy(a.rotation,this.rotation),this.update_buffer()}setFov(a){this.fovY=a,this.on_update_canvas()}getFov(){return this.fovY}};R(os,"Z_AXIS",z.create(0,0,1));let Fs=os;const Pc=z.create(1,0,0),Sc=z.create(0,1,0);function Ec(o,a){const h=o[0],S=o[4],g=o[8],C=o[1],M=o[5],O=o[9],L=o[2],V=o[6],F=o[10],D=h+M+F;let G,$,I,j;if(D>0){const U=.5/Math.sqrt(D+1);G=.25/U,$=(V-O)*U,I=(g-L)*U,j=(C-S)*U}else if(h>M&&h>F){const U=2*Math.sqrt(1+h-M-F);G=(V-O)/U,$=.25*U,I=(S+C)/U,j=(g+L)/U}else if(M>F){const U=2*Math.sqrt(1+M-h-F);G=(g-L)/U,$=(S+C)/U,I=.25*U,j=(O+V)/U}else{const U=2*Math.sqrt(1+F-h-M);G=(C-S)/U,$=(g+L)/U,I=(O+V)/U,j=.25*U}return a[0]=$,a[1]=I,a[2]=j,a[3]=G,a}class Cc{constructor(a){R(this,"element");R(this,"enabled",!0);R(this,"center",z.create(0,0,0));R(this,"up",z.create(0,1,0));R(this,"rotation",[0,0]);R(this,"shift",[0,0]);R(this,"scroll",0);R(this,"speed",.1);R(this,"sensitivity",.08);R(this,"leftPressed",!1);R(this,"rightPressed",!1);R(this,"leftDragPans",!1);R(this,"lastX",0);R(this,"lastY",0);R(this,"touches",new Map);R(this,"lastTouchCenter",null);R(this,"lastPinchDistance",null);R(this,"lastTwoFingerAngle",null);R(this,"lastTouchCount",0);R(this,"roll",0);R(this,"_dir",z.create());R(this,"_right",z.create());R(this,"_upCam",z.create());R(this,"_scratch",z.create());R(this,"_qY",ht.create());R(this,"_qX",ht.create());R(this,"_qRot",ht.create());R(this,"_qLocal",ht.create());R(this,"_qWorldToCam",ht.create());R(this,"_scratchMat3",Et.create());R(this,"bboxMin",null);R(this,"bboxMax",null);R(this,"anchor",z.create(0,0,0));R(this,"downCallback",a=>{var h,S,g,C;if(this.enabled){if(a.pointerType==="touch"){this.touches.set(a.pointerId,{x:a.pageX,y:a.pageY}),this.handleTouchGestures(),(S=(h=a.target)==null?void 0:h.setPointerCapture)==null||S.call(h,a.pointerId),a.preventDefault();return}a.isPrimary&&(a.button===0?(this.leftPressed=!0,this.leftDragPans=a.shiftKey):a.button===2?this.rightPressed=!0:this.rightPressed=!0,this.lastX=a.pageX,this.lastY=a.pageY,(C=(g=a.target)==null?void 0:g.setPointerCapture)==null||C.call(g,a.pointerId),a.preventDefault())}});R(this,"moveCallback",a=>{if(!this.enabled)return;if(a.pointerType==="touch"){if(!this.touches.has(a.pointerId))return;this.touches.set(a.pointerId,{x:a.pageX,y:a.pageY}),this.handleTouchGestures(),a.preventDefault();return}if(!a.isPrimary||!this.leftPressed&&!this.rightPressed)return;a.preventDefault();const h=a.pageX-this.lastX,S=a.pageY-this.lastY;this.lastX=a.pageX,this.lastY=a.pageY,this.leftPressed&&!this.leftDragPans?(this.rotation[0]+=h,this.rotation[1]-=S):(this.rightPressed||this.leftPressed&&this.leftDragPans)&&(this.shift[1]-=h,this.shift[0]+=S)});R(this,"upCallback",a=>{var h,S,g,C;if(a.pointerType==="touch"){this.touches.delete(a.pointerId),this.handleTouchGestures(),(S=(h=a.target)==null?void 0:h.releasePointerCapture)==null||S.call(h,a.pointerId),a.preventDefault();return}a.button===0?this.leftPressed=!1:a.button===2?this.rightPressed=!1:this.rightPressed=!1,(C=(g=a.target)==null?void 0:g.releasePointerCapture)==null||C.call(g,a.pointerId),a.preventDefault()});R(this,"wheelCallback",a=>{if(!this.enabled||(a.preventDefault(),this.rightPressed))return;let h=a.deltaY;a.deltaMode===1?h*=16:a.deltaMode===2&&(h*=100),this.scroll+=h*.01});this.camera=a,this.registerElement(a.canvas)}registerElement(a){this.element&&this.element!==a&&(this.element.removeEventListener("pointerdown",this.downCallback),this.element.removeEventListener("pointermove",this.moveCallback),this.element.removeEventListener("pointerup",this.upCallback),this.element.removeEventListener("wheel",this.wheelCallback)),this.element=a,this.element.addEventListener("pointerdown",this.downCallback),this.element.addEventListener("pointermove",this.moveCallback),this.element.addEventListener("pointerup",this.upCallback),this.element.addEventListener("wheel",this.wheelCallback,{passive:!1}),this.element.addEventListener("contextmenu",h=>h.preventDefault())}setCenter(a){z.copy(a,this.center),z.copy(a,this.anchor)}setOrbitPivot(a){z.set(a[0],a[1],a[2],this.center),this._reorientCameraToCenter()}setOrbitDepth(a){if(!isFinite(a)||a<.001)return;const h=this.camera.rotation;z.set(h[2],h[6],h[10],this._dir),z.normalize(this._dir,this._dir),z.scale(this._dir,a,this._dir),z.add(this.camera.position,this._dir,this.center)}_reorientCameraToCenter(){const a=this.camera;if(z.subtract(this.center,a.position,this._scratch),z.length(this._scratch)<1e-6)return;z.normalize(this._scratch,this._scratch),z.cross(this.up,this._scratch,this._right),z.length(this._right)<1e-6&&z.set(1,0,0,this._right),z.normalize(this._right,this._right),z.cross(this._scratch,this._right,this._upCam),z.normalize(this._upCam,this._upCam);const h=a.rotation;h[0]=this._right[0],h[1]=this._upCam[0],h[2]=this._scratch[0],h[3]=0,h[4]=this._right[1],h[5]=this._upCam[1],h[6]=this._scratch[1],h[7]=0,h[8]=this._right[2],h[9]=this._upCam[2],h[10]=this._scratch[2],h[11]=0,h[12]=0,h[13]=0,h[14]=0,h[15]=1,a.update_buffer()}setBbox(a,h){this.bboxMin=z.create(a[0],a[1],a[2]),this.bboxMax=z.create(h[0],h[1],h[2]);const S=(a[0]+h[0])*.5,g=(a[1]+h[1])*.5,C=(a[2]+h[2])*.5;z.set(S,g,C,this.center),z.set(S,g,C,this.anchor)}resetToCamera(){const a=this.camera.rotation;z.set(a[2],a[6],a[10],this._dir),z.normalize(this._dir,this._dir);let h=null;if(this.bboxMin&&this.bboxMax){let S=-1/0,g=1/0,C=!1;for(let M=0;M<3;M++){const O=this._dir[M],L=this.bboxMin[M]-this.camera.position[M],V=this.bboxMax[M]-this.camera.position[M];if(Math.abs(O)>1e-8){const F=L/O,D=V/O;S=Math.max(S,Math.min(F,D)),g=Math.min(g,Math.max(F,D))}else if(L>0||V<0){C=!0;break}}!C&&S<=g&&g>0&&(h=(Math.max(S,0)+g)*.5)}if(h===null||!isFinite(h)||h<.001){z.subtract(this.anchor,this.camera.position,this._scratch);const S=z.dot(this._scratch,this._dir);h=S>.001?S:z.length(this._scratch)}h=Math.max(.1,h),z.scale(this._dir,h,this._dir),z.add(this.camera.position,this._dir,this.center)}handleTouchGestures(){const a=this.touches.size;if(a!==this.lastTouchCount&&(this.lastTouchCenter=null,this.lastPinchDistance=null,this.lastTwoFingerAngle=null),this.lastTouchCount=a,a===1){const h=this.touches.values().next().value;if(this.lastTouchCenter){const S=h.x-this.lastTouchCenter[0],g=h.y-this.lastTouchCenter[1];this.rotation[0]+=S*.3,this.rotation[1]-=g*.3}this.lastTouchCenter=[h.x,h.y]}else if(a===2){const h=Array.from(this.touches.values()),S=(h[0].x+h[1].x)*.5,g=(h[0].y+h[1].y)*.5,C=h[1].x-h[0].x,M=h[1].y-h[0].y,O=Math.hypot(C,M),L=Math.atan2(M,C);if(this.lastTouchCenter!==null&&this.lastPinchDistance!==null&&this.lastTwoFingerAngle!==null){const V=S-this.lastTouchCenter[0],F=g-this.lastTouchCenter[1],D=Math.hypot(V,F),G=Math.abs(O-this.lastPinchDistance);let $=L-this.lastTwoFingerAngle;$>Math.PI&&($-=2*Math.PI),$<-Math.PI&&($+=2*Math.PI),D>.5&&(this.shift[1]-=V,this.shift[0]+=F),G>1&&this.lastPinchDistance>.001&&(this.scroll+=-Math.log(O/this.lastPinchDistance)*10),Math.abs($)>.0087&&(this.roll+=-$)}this.lastTouchCenter=[S,g],this.lastPinchDistance=O,this.lastTwoFingerAngle=L}}update(a){if(!this.enabled||Math.abs(this.rotation[0])<1e-4&&Math.abs(this.rotation[1])<1e-4&&Math.abs(this.shift[0])<1e-4&&Math.abs(this.shift[1])<1e-4&&Math.abs(this.scroll)<1e-4&&Math.abs(this.roll)<1e-4)return;const h=this.camera;{const j=h.rotation;this.up[0]=j[1],this.up[1]=j[5],this.up[2]=j[9],z.length(this.up)>1e-6?z.normalize(this.up,this.up):z.set(0,1,0,this.up)}let S=!1;if(Math.abs(this.roll)>1e-4){const j=h.rotation;z.set(j[2],j[6],j[10],this._scratch),z.normalize(this._scratch,this._scratch),ht.fromAxisAngle(this._scratch,this.roll,this._qRot),z.transformQuat(this.up,this._qRot,this.up),z.normalize(this.up,this.up),this.roll=0,S=!0}z.subtract(h.position,this.center,this._dir);let g=z.length(this._dir);g<1e-6&&(g=1e-6);const C=Math.exp(Math.log(g)+this.scroll*a*10*this.speed);z.scale(this._dir,C/g,this._dir),g=C;const M=h.rotation;this._right[0]=M[0],this._right[1]=M[4],this._right[2]=M[8],z.normalize(this._right,this._right),z.length(this._right)<1e-6&&z.set(1,0,0,this._right);const O=z.create(M[1],M[5],M[9]);z.normalize(O,O),z.length(O)<1e-6&&z.set(0,1,0,O);const L=a*this.speed*.1*g,V=this.shift[1]*L,F=-this.shift[0]*L;z.scale(this._right,V,this._scratch),z.add(this.center,this._scratch,this.center),z.add(h.position,this._scratch,h.position),z.scale(O,F,this._scratch),z.add(this.center,this._scratch,this.center),z.add(h.position,this._scratch,h.position);const D=this.rotation[0]*a*this.sensitivity,G=this.rotation[1]*a*this.sensitivity;if(Math.abs(D)>1e-5||Math.abs(G)>1e-5||S){const j=h.rotation;Ec(j,this._qWorldToCam),ht.fromAxisAngle(Pc,-G,this._qX),ht.fromAxisAngle(Sc,-D,this._qY),ht.multiply(this._qX,this._qY,this._qLocal),ht.normalize(this._qLocal,this._qLocal),ht.multiply(this._qLocal,this._qWorldToCam,this._qWorldToCam),ht.normalize(this._qWorldToCam,this._qWorldToCam),Et.fromQuat(this._qWorldToCam,this._scratchMat3),dt.fromMat3(this._scratchMat3,h.rotation);const U=h.rotation,X=U[2],Y=U[6],H=U[10];h.position[0]=this.center[0]-X*g,h.position[1]=this.center[1]-Y*g,h.position[2]=this.center[2]-H*g,this.up[0]=U[1],this.up[1]=U[5],this.up[2]=U[9],z.normalize(this.up,this.up)}else z.add(this.center,this._dir,h.position);h.update_buffer();const I=Math.pow(.8,a*60);this.rotation[0]*=I,Math.abs(this.rotation[0])<1e-4&&(this.rotation[0]=0),this.rotation[1]*=I,Math.abs(this.rotation[1])<1e-4&&(this.rotation[1]=0),this.shift[0]*=I,Math.abs(this.shift[0])<1e-4&&(this.shift[0]=0),this.shift[1]*=I,Math.abs(this.shift[1])<1e-4&&(this.shift[1]=0),this.scroll*=I,Math.abs(this.scroll)<1e-4&&(this.scroll=0)}}function yi(o){const a=z.create();for(const h of o)z.add(a,h,a);return z.scale(a,1/Math.max(o.length,1),a)}function Pi(o,a){const h=Et.create();Et.inverse(o,h);const S=z.create();return S[0]=h[0]*a[0]+h[4]*a[1]+h[8]*a[2],S[1]=h[1]*a[0]+h[5]*a[1]+h[9]*a[2],S[2]=h[2]*a[0]+h[6]*a[1]+h[10]*a[2],S}function kc(o){const a=o.slice(),h=[1,0,0,0,1,0,0,0,1],S=(L,V)=>a[L*3+V],g=(L,V,F)=>{a[L*3+V]=F},C=(L,V)=>h[L*3+V],M=(L,V,F)=>{h[L*3+V]=F};for(let L=0;L<30;L++){let V=0,F=1,D=Math.abs(S(0,1));if(Math.abs(S(0,2))>D&&(V=0,F=2,D=Math.abs(S(0,2))),Math.abs(S(1,2))>D&&(V=1,F=2,D=Math.abs(S(1,2))),D<1e-12)break;const G=S(V,V),$=S(F,F),I=S(V,F);let j;Math.abs(G-$)<1e-30?j=Math.PI/4*Math.sign(I):j=.5*Math.atan2(2*I,G-$);const U=Math.cos(j),X=Math.sin(j);for(let Y=0;Y<3;Y++){const H=S(Y,V),K=S(Y,F);g(Y,V,U*H+X*K),g(Y,F,-X*H+U*K)}for(let Y=0;Y<3;Y++){const H=S(V,Y),K=S(F,Y);g(V,Y,U*H+X*K),g(F,Y,-X*H+U*K)}for(let Y=0;Y<3;Y++){const H=C(Y,V),K=C(Y,F);M(Y,V,U*H+X*K),M(Y,F,-X*H+U*K)}}const O=[];for(let L=0;L<3;L++)O.push({val:S(L,L),vec:z.create(C(0,L),C(1,L),C(2,L))});return O.sort((L,V)=>V.val-L.val),{vals:[O[0].val,O[1].val,O[2].val],vecs:[O[0].vec,O[1].vec,O[2].vec]}}function Mc(o,a){const h=yi(o);let S=0,g=0,C=0,M=0,O=0,L=0;for(const I of o){const j=I[0]-h[0],U=I[1]-h[1],X=I[2]-h[2];S+=j*j,g+=j*U,C+=j*X,M+=U*U,O+=U*X,L+=X*X}const V=[S,g,C,g,M,O,C,O,L],{vecs:F}=kc(V);let D=F[0],G=F[1],$=F[2];return z.dot($,a)<0&&(z.scale($,-1,$),z.scale(G,-1,G)),{centroid:h,normal:$,u:D,v:G}}function Bc(o){let a=0,h=0,S=0,g=0,C=0,M=0,O=0,L=0,V=0;for(const[U,X]of o){const Y=-2*U,H=-2*X,K=1,oe=-(U*U+X*X);a+=Y*Y,h+=Y*H,S+=Y*K,g+=H*H,C+=H*K,M+=K*K,O+=Y*oe,L+=H*oe,V+=K*oe}const F=Et.create(a,h,S,h,g,C,S,C,M),D=Pi(F,z.create(O,L,V)),G=D[0],$=D[1],I=D[2],j=G*G+$*$-I;return{center:[G,$],radius:Math.sqrt(Math.max(j,1e-12))}}function Tc(o,a){let h=0,S=0,g=0,C=0,M=0,O=0,L=0,V=0,F=0;for(let G=0;G<o.length;G++){const $=o[G],I=z.normalize(a[G],z.create()),j=1-I[0]*I[0],U=-I[0]*I[1],X=-I[0]*I[2],Y=1-I[1]*I[1],H=-I[1]*I[2],K=1-I[2]*I[2];h+=j,S+=U,g+=X,C+=Y,M+=H,O+=K,L+=j*$[0]+U*$[1]+X*$[2],V+=U*$[0]+Y*$[1]+H*$[2],F+=X*$[0]+H*$[1]+K*$[2]}const D=Et.create(h,S,g,S,C,M,g,M,O);return Pi(D,z.create(L,V,F))}function Si(o,a={}){if(o.length===0)return null;const h=a.tiltDownDeg??8,S=a.radiusScale??1,g=a.alignFirst??!0,C=(a.direction??"ccw")==="ccw"?1:-1,M=o.map(se=>z.clone(se.position)),O=o.map(se=>{const _e=se.rotation;return z.create(_e[8],_e[9],_e[10])}),L=o.map(se=>{const _e=se.rotation;return z.create(_e[4],_e[5],_e[6])}),V=yi(L),F=z.normalize(z.scale(V,-1,z.create())),{centroid:D,normal:G,u:$,v:I}=Mc(M,F),j=M.map(se=>{const _e=z.sub(se,D,z.create());return[z.dot(_e,$),z.dot(_e,I)]}),{center:U,radius:X}=Bc(j),Y=X*S,H=z.add(D,z.add(z.scale($,U[0],z.create()),z.scale(I,U[1],z.create()),z.create()),z.create()),K=Tc(M,O),oe=Y*Math.tan(h*Math.PI/180),ge=z.sub(K,z.scale(G,oe,z.create()),z.create());let ue=0;if(g){const se=z.sub(M[0],H,z.create());ue=Math.atan2(z.dot(se,I),z.dot(se,$))/(2*Math.PI)%1,ue<0&&(ue+=1)}return console.log(`[orbit] fit ${o.length} train cams: radius=${Y.toFixed(2)}, tilt=${h}°, normal=[${G[0].toFixed(2)}, ${G[1].toFixed(2)}, ${G[2].toFixed(2)}], startPhase=${ue.toFixed(3)}`),{center:H,radius:Y,normal:G,u:$,v:I,lookAt:ge,startPhase:ue,direction:C}}function Ei(o,a){const h=(o.startPhase+a*o.direction)*2*Math.PI,S=Math.cos(h),g=Math.sin(h),C=z.add(o.center,z.add(z.scale(o.u,o.radius*S,z.create()),z.scale(o.v,o.radius*g,z.create()),z.create()),z.create()),M=z.normalize(z.sub(o.lookAt,C,z.create())),O=z.cross(M,o.normal,z.create());z.length(O)<1e-6&&z.copy(o.u,O),z.normalize(O,O);const L=z.cross(M,O,z.create());z.normalize(L,L);const V=dt.create();return V[0]=O[0],V[1]=L[0],V[2]=M[0],V[3]=0,V[4]=O[1],V[5]=L[1],V[6]=M[1],V[7]=0,V[8]=O[2],V[9]=L[2],V[10]=M[2],V[11]=0,V[12]=0,V[13]=0,V[14]=0,V[15]=1,{position:C,rotation:V,img_name:`orbit_${(a*1e3).toFixed(0)}`,id:0}}function Ac(o,a={}){const h=Si(o,a);if(!h)return[];const S=a.numViews??120;return Array.from({length:S},(g,C)=>({...Ei(h,C/S),img_name:`circle_${C.toString().padStart(4,"0")}`,id:C}))}function Dc(o){const a=new Uint8Array(o),h=Math.min(a.byteLength,65536),S=new TextDecoder("ascii").decode(a.subarray(0,h)),g=S.indexOf("end_header");if(g<0)throw new Error("mesh PLY: 'end_header' not found in first 64KB");const C=g+10+1,M=S.slice(0,g).split(/\r?\n/).map(ie=>ie.trim()).filter(Boolean);if(M[0]!=="ply")throw new Error("mesh PLY: missing 'ply' magic");const O=M.find(ie=>ie.startsWith("format"));if(!O||!O.includes("binary_little_endian"))throw new Error(`mesh PLY: only binary_little_endian supported (got: ${O??"<none>"})`);const L={char:1,uchar:1,int8:1,uint8:1,short:2,ushort:2,int16:2,uint16:2,int:4,uint:4,int32:4,uint32:4,float:4,float32:4,double:8,float64:8},V=[];let F=null;for(const ie of M)if(ie.startsWith("element ")){const[,me,he]=ie.split(/\s+/);F={name:me,count:parseInt(he,10),props:[],bytesPerRecord:0,hasList:!1},V.push(F)}else if(ie.startsWith("property ")&&F){const me=ie.split(/\s+/);if(me[1]==="list"){const he=me[2],be=me[3],Ae=me[4];F.props.push({name:Ae,type:be,isList:!0,listCountType:he,listItemType:be}),F.hasList=!0}else{const he=me[1],be=me[2];if(F.props.push({name:be,type:he,isList:!1}),L[he]===void 0)throw new Error(`mesh PLY: unsupported prop type '${he}'`);F.bytesPerRecord+=L[he]}}const D=V.find(ie=>ie.name==="vertex"),G=V.find(ie=>ie.name==="face"||ie.name==="faces");if(!D)throw new Error("mesh PLY: missing 'element vertex'");if(!G)throw new Error("mesh PLY: missing 'element face' (mesh has no triangles)");if(D.hasList)throw new Error("mesh PLY: unexpected list property on vertex element");const $=D.props.find(ie=>ie.name==="x"),I=D.props.find(ie=>ie.name==="y"),j=D.props.find(ie=>ie.name==="z");if(!$||!I||!j)throw new Error("mesh PLY: vertex must have x/y/z");let U=0;const X=new Map;for(const ie of D.props)X.set(ie.name,{off:U,type:ie.type}),U+=L[ie.type];const Y=X.get("x"),H=X.get("y"),K=X.get("z");if(Y.type!==H.type||Y.type!==K.type)throw new Error(`mesh PLY: x/y/z must share a type (got ${Y.type}/${H.type}/${K.type})`);const oe=Y.type,ge=oe==="double"||oe==="float64";if(!ge&&oe!=="float"&&oe!=="float32")throw new Error(`mesh PLY: x/y/z must be float or double (got '${oe}')`);const ue=new Float32Array(D.count*3),se=new DataView(o),_e=C,te=D.bytesPerRecord;for(let ie=0;ie<D.count;ie++){const me=_e+ie*te;ge?(ue[ie*3+0]=se.getFloat64(me+Y.off,!0),ue[ie*3+1]=se.getFloat64(me+H.off,!0),ue[ie*3+2]=se.getFloat64(me+K.off,!0)):(ue[ie*3+0]=se.getFloat32(me+Y.off,!0),ue[ie*3+1]=se.getFloat32(me+H.off,!0),ue[ie*3+2]=se.getFloat32(me+K.off,!0))}const Oe=_e+D.count*te,Ge=G.props.find(ie=>ie.isList);if(!Ge)throw new Error("mesh PLY: face element has no list property");const Ie=L[Ge.listCountType],Te=L[Ge.listItemType];if(Ie!==1)throw new Error(`mesh PLY: unsupported face list count size ${Ie}`);let ve=Oe,ye=0;for(let ie=0;ie<G.count;ie++){const me=se.getUint8(ve);me===3&&ye++,ve+=1+me*Te}const le=new Uint32Array(ye*3);ve=Oe;let re=0;for(let ie=0;ie<G.count;ie++){const me=se.getUint8(ve);if(ve+=1,me===3)for(let he=0;he<3;he++){const be=ve+he*Te;let Ae;if(Te===4)Ae=se.getUint32(be,!0);else if(Te===2)Ae=se.getUint16(be,!0);else if(Te===1)Ae=se.getUint8(be);else throw new Error(`mesh PLY: unsupported face index size ${Te}`);le[re++]=Ae}ve+=me*Te}return{positions:ue,indices:le}}function zc(o){const a=new DataView(o);if(o.byteLength<8)throw new Error("mesh .bin: too small (need at least 8-byte header)");const h=a.getUint32(0,!0),S=a.getUint32(4,!0),g=h*12,C=S*4;if(o.byteLength<8+g+C)throw new Error(`mesh .bin: truncated (expected ${8+g+C} B, got ${o.byteLength} B)`);const M=new Float32Array(o.slice(8,8+g)),O=new Uint32Array(o.slice(8+g,8+g+C));return{positions:M,indices:O}}function Ci(o,a){return(a??"").toLowerCase().endsWith(".ply")?Dc(o):zc(o)}function Lc(o,a){const h=o.length/3,S=new Float32Array(h*3);for(let g=0;g<a.length;g+=3){const C=a[g]*3,M=a[g+1]*3,O=a[g+2]*3,L=o[C],V=o[C+1],F=o[C+2],D=o[M],G=o[M+1],$=o[M+2],I=o[O],j=o[O+1],U=o[O+2],X=D-L,Y=G-V,H=$-F,K=I-L,oe=j-V,ge=U-F,ue=Y*ge-H*oe,se=H*K-X*ge,_e=X*oe-Y*K;S[C]+=ue,S[C+1]+=se,S[C+2]+=_e,S[M]+=ue,S[M+1]+=se,S[M+2]+=_e,S[O]+=ue,S[O+1]+=se,S[O+2]+=_e}for(let g=0;g<h;g++){const C=g*3,M=S[C],O=S[C+1],L=S[C+2],V=Math.sqrt(M*M+O*O+L*L);if(V>1e-12){const F=1/V;S[C]=M*F,S[C+1]=O*F,S[C+2]=L*F}}return S}function ki(o,a){const h=o.createBuffer({label:"mesh-cull vertex buffer",size:a.positions.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});o.queue.writeBuffer(h,0,a.positions);const S=Lc(a.positions,a.indices),g=o.createBuffer({label:"mesh-cull normal buffer",size:S.byteLength,usage:GPUBufferUsage.VERTEX|GPUBufferUsage.COPY_DST});o.queue.writeBuffer(g,0,S);const C=o.createBuffer({label:"mesh-cull index buffer",size:a.indices.byteLength,usage:GPUBufferUsage.INDEX|GPUBufferUsage.COPY_DST});return o.queue.writeBuffer(C,0,a.indices),{vertexBuffer:h,normalBuffer:g,indexBuffer:C,numVerts:a.positions.length/3,numIndices:a.indices.length}}async function Gc(o,a){try{const h=await fetch(a);if(!h.ok)return console.warn(`[mesh-cull] fetch failed for ${a}: ${h.status}`),null;const S=await h.arrayBuffer(),g=Ci(S,a);return console.log(`[mesh-cull] loaded ${a}: ${g.positions.length/3} verts, ${g.indices.length/3} tris`),ki(o,g)}catch(h){return console.warn(`[mesh-cull] load error for ${a}:`,h),null}}function Ic(o,a,h){try{const S=Ci(a,h);return console.log(`[mesh-cull] loaded from bundle: ${S.positions.length/3} verts, ${S.indices.length/3} tris`),ki(o,S)}catch(S){return console.warn("[mesh-cull] parse error:",S),null}}const Mi="BITYMI01",Rc=0,Uc=1,Vc=2,Oc=3,Fc=4,Nc=5,$c=6;function ts(o){const a=(o&32768)>>15,h=(o&31744)>>10,S=o&1023;return h===0?(a?-1:1)*Math.pow(2,-14)*(S/1024):h===31?S?NaN:a?-1/0:1/0:(a?-1:1)*Math.pow(2,h-15)*(1+S/1024)}function ui(o,a,h,S,g,C){const M=(o-h.width*.5)/S.focal[0],O=-((a-h.height*.5)/S.focal[1]),L=S.rotation,V=L[0],F=L[4],D=L[8],G=L[1],$=L[5],I=L[9],j=L[2],U=L[6],X=L[10];let Y=M*V+O*G+j,H=M*F+O*$+U,K=M*D+O*I+X;const oe=Math.hypot(Y,H,K)||1;Y/=oe,H/=oe,K/=oe;const ge=S.position[0],ue=S.position[1],se=S.position[2],_e=C*.005,te=_e*_e,Oe=new Uint32Array(g.buffer,g.byteOffset,g.length),Ge=g.length/8;let Ie=1/0,Te=0,ve=0,ye=0,le=-1;for(let re=0;re<Ge;re++){const ie=re*8,me=g[ie+0]-ge,he=g[ie+1]-ue,be=g[ie+2]-se,Ae=me*Y+he*H+be*K;if(Ae<=0)continue;const xe=me-Ae*Y,ke=he-Ae*H,Ue=be-Ae*K;if(xe*xe+ke*ke+Ue*Ue>=te||!(Oe[ie+7]>>>16&1))continue;const x=Oe[ie+5],i=Oe[ie+6],f=ts(x&65535),c=ts(x>>>16&65535),v=ts(i&65535),P=ts(i>>>16&65535),k=Math.hypot(f,c,v,P)||1,w=f/k,r=c/k,_=v/k,d=P/k,p=2*(r*d+w*_),l=2*(_*d-w*r),m=1-2*(r*r+_*_),y=Y*p+H*l+K*m;let b;Math.abs(y)>1e-6?(b=(me*p+he*l+be*m)/y,(!isFinite(b)||b<=0)&&(b=Ae)):b=Ae,b<Ie&&(Ie=b,Te=ge+b*Y,ve=ue+b*H,ye=se+b*K,le=re)}return le<0?null:[Te,ve,ye]}function Bi(o){const a=new Uint8Array(o),h=new TextDecoder().decode(a.subarray(0,8));if(h!==Mi)throw new Error(`Not a BITYMI bundle (bad magic '${h}')`);const S=new DataView(o),g=S.getUint32(8,!0),C=12,M=20;let O=null,L=null,V=null,F=null;for(let D=0;D<g;D++){const G=C+D*M,$=S.getUint32(G+0,!0),I=Number(S.getBigUint64(G+4,!0)),j=Number(S.getBigUint64(G+12,!0)),U=a.slice(I,I+j).buffer;$===Rc||$===Uc||$===Nc?O=U:$===Vc?L=U:$===Oc||$===Fc?V=U:$===$c&&(F=U)}if(O===null)throw new Error("BITYMI bundle has no point cloud chunk");return{pcBuffer:O,camerasBuffer:L,atlasBuffer:V,meshBuffer:F}}async function Wc(o,a){var M;const h=await fetch(o);if(!h.ok)throw new Error(`fetch failed: ${h.status} ${h.statusText}`);const S=(()=>{const O=h.headers.get("content-length");return O&&parseInt(O,10)||void 0})(),g=(M=h.body)==null?void 0:M.getReader();let C;if(!g)C=await h.arrayBuffer(),a&&a(C.byteLength,S,0);else{const O=[];let L=0,V=performance.now(),F=0;for(;;){const{done:$,value:I}=await g.read();if($)break;O.push(I),L+=I.byteLength;const j=performance.now();if(j-V>=150&&a){const U=(L-F)/((j-V)/1e3);a(L,S,U),V=j,F=L}}const D=new Uint8Array(L);let G=0;for(const $ of O)D.set($,G),G+=$.byteLength;C=D.buffer,a&&a(L,S,0)}return C.byteLength>=8&&new TextDecoder().decode(new Uint8Array(C,0,8))===Mi?{bundle:Bi(C),rawPly:null}:{bundle:null,rawPly:C}}function qc(o){return new Promise(a=>{const h=document.createElement("input");h.type="file",h.accept=o,h.style.display="none",h.onchange=()=>{var S;return a(((S=h.files)==null?void 0:S[0])??null)},document.body.appendChild(h),h.click(),setTimeout(()=>document.body.removeChild(h),1e3)})}function jc(o,a,h){const S=document.getElementById("ui-panel-container"),g=document.getElementById("load-button"),C=document.getElementById("quick-links");g&&(g.onclick=async()=>{const F=await qc(".ply,.bitymi");if(F)if(S&&(S.style.display="none"),F.name.toLowerCase().endsWith(".bitymi")){const D=await F.arrayBuffer(),{pcBuffer:G}=Bi(D),$=new File([G],F.name.replace(/\.bitymi$/i,".ply"),{type:"application/octet-stream"}),I=await Is($,o);a(I)}else{const D=await Is(F,o);a(D)}}),C&&(C.innerHTML="");const M=new URLSearchParams(window.location.search),O=M.get("bundle")??M.get("model_url"),L=M.get("camera_url"),V=M.get("mesh_url");O&&(S&&(S.style.display="none"),h(O,L,V))}async function Hc(o,a,h,S){const g=new Fs(o,h),C=new Cc(g);let M=!1;o.addEventListener("pointerdown",()=>{M=!0}),window.addEventListener("pointerup",()=>{M=!1});const O=typeof window<"u"&&window.parent!==window,L={pos:new Float32Array(3),rot:new Float32Array(16)};if(O){window.addEventListener("message",w=>{const r=w.data;if(!(!r||r.type!=="halloumi_sync_pose")&&!(!Array.isArray(r.position)||r.position.length!==3)&&!(!Array.isArray(r.rotation)||r.rotation.length!==16)){for(let _=0;_<3;_++)g.position[_]=r.position[_];for(let _=0;_<16;_++)g.rotation[_]=r.rotation[_];g.update_buffer(),C.resetToCamera();for(let _=0;_<3;_++)L.pos[_]=g.position[_];for(let _=0;_<16;_++)L.rot[_]=g.rotation[_]}});try{window.parent.postMessage({type:"halloumi_sync_ready"},"*")}catch{}}const V=()=>{if(!O)return;const w=g.position,r=g.rotation;let _=!1;for(let d=0;d<3;d++)if(Math.abs(w[d]-L.pos[d])>1e-6){_=!0;break}if(!_){for(let d=0;d<16;d++)if(Math.abs(r[d]-L.rot[d])>1e-6){_=!0;break}}if(_){for(let d=0;d<3;d++)L.pos[d]=w[d];for(let d=0;d<16;d++)L.rot[d]=r[d];try{window.parent.postMessage({type:"halloumi_camera_state",position:[w[0],w[1],w[2]],rotation:Array.from(r)},"*")}catch{}}},F="rgba8unorm";a.configure({device:h,format:F,alphaMode:"opaque",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.STORAGE_BINDING});let D=null;const G=()=>{g.on_update_canvas(),D!==null&&es(o.width,o.height,h,D.render_settings_buffer)};new ResizeObserver(()=>{const w=Math.max(.25,c.render_scale),r=Math.max(1,Math.ceil(w*o.clientWidth)),_=Math.max(1,Math.ceil(w*o.clientHeight));o.width===r&&o.height===_||(o.width=r,o.height=_,G())}).observe(o);let I=0,j=0;const U=()=>{(o.width!==I||o.height!==j)&&(I=o.width,j=o.height,G())},X=new URLSearchParams(window.location.search);let H=X.get("animation")==="1";C.enabled=!H;const K=X.get("camera_url"),oe=X.get("mesh_cull"),ge=oe==="1"||oe==="true",ue=X.get("mesh_normal_margin")??X.get("mesh_margin"),se=ue!==null?Number(ue):NaN,_e=Number.isFinite(se)?se:0,te=X.get("mesh_debug"),Oe=te==="1"||te==="true",Ge=X.get("bfc"),Ie=Ge==="1"||Ge==="true",Te=X.get("bfc_cos"),ve=Te!==null?Number(Te):NaN,ye=Number.isFinite(ve)?ve:2,le=X.get("mesh_sample_mode"),re=le!==null?parseInt(le,10):NaN,ie=Number.isFinite(re)&&re>=0&&re<=7?re:1,me=X.get("mesh_silhouette"),he=me==="1"||me==="true",be=X.get("mesh_invert_depth"),Ae=be==="1"||be==="true",xe=X.get("ht"),ke=xe==="2"?2:xe==="1"||xe==="true"?1:0,Ue=X.get("ht_k"),T=Ue!==null?Number(Ue):NaN,q=Number.isFinite(T)?T:150,x=X.get("wsr"),i=x==="1"||x==="true",f=Math.max(1,window.devicePixelRatio||1),c={gaussian_scaling:1,sh_bias:.5,animate:H,animateMode:"presets",bg:{r:0,g:0,b:0,a:0},atlas_enabled:!1,bfc:Ie,bfc_cos:ye,ht_mode:ke,ht_k:q,wsr:i,mesh_cull:ge,mesh_margin:_e,mesh_debug:Oe,mesh_sample_mode:ie,mesh_silhouette:he,mesh_invert_depth:Ae,render_scale:1},v=new jl.Pane({title:"Config",expanded:!0});v.addInput(c,"animate",{label:"Animate"}).on("change",w=>{const r=H;H=w.value,C.enabled=!w.value,!r&&H&&P.value&&P.value.onAnimateStart(),r&&!H&&P.value&&P.value.onAnimateStop()}),v.addInput(c,"animateMode",{label:"Anim path",options:{"Training views":"presets","Circle orbit":"circle"}});const P={value:null};jc(h,w=>k(w,[],null,null),async(w,r,_)=>{let d=r??K,p,l=null,m=null;const y=w.toLowerCase();if(y.endsWith(".bitymi")||y.includes(".bitymi?")){$s("downloading bundle ...");try{const{bundle:B}=await Wc(w,(W,ne,ee)=>{const Z=W/1048576,fe=ne?ne/(1024*1024):void 0,we=ee/(1024*1024),de=ne?Math.min(99,Math.floor(W/ne*100)):void 0,ae=fe?`total ${fe.toFixed(1)} MB`:"total -- MB",Me=fe&&de!==void 0?`${Z.toFixed(1)} MB downloaded (${de}%)`:`${Z.toFixed(1)} MB downloaded`,Be=`${we.toFixed(2)} MB/s`;It(`downloading bundle ...
${ae}, ${Me}
${Be}`)});if(!B)throw new Error("Expected a .bitymi bundle");It("parsing PLY ...");const N=new File([B.pcBuffer],"bundle.ply",{type:"application/octet-stream"});if(p=await Is(N,h),!d&&B.camerasBuffer&&(d=URL.createObjectURL(new Blob([B.camerasBuffer],{type:"application/json"}))),B.atlasBuffer){const W=B.atlasBuffer.byteLength/1048576;It(`uploading atlas ...
${W.toFixed(1)} MB BC7`);try{const ne=Fl(B.atlasBuffer);l=$l(h,ne,!0)}catch(ne){console.warn("[atlas] failed to parse/upload atlas:",ne)}}B.meshBuffer&&!_&&(It("uploading mesh ..."),m=Ic(h,B.meshBuffer,"bundle.mesh"))}catch(B){throw Ln(),B}}else p=await Wl(w,h);_&&(It("loading mesh ..."),m=await Gc(h,_));const b=d?await gc(d):[];b.length>0&&g.set_preset(b[0]),k(p,b,l,m)});function k(w,r=[],_=null,d=null){const p=[(w.bbox.min[0]+w.bbox.max[0])/2,(w.bbox.min[1]+w.bbox.max[1])/2,(w.bbox.min[2]+w.bbox.max[2])/2];C.setBbox(w.bbox.min,w.bbox.max);const l=.5*Math.sqrt((w.bbox.max[0]-w.bbox.min[0])**2+(w.bbox.max[1]-w.bbox.min[1])**2+(w.bbox.max[2]-w.bbox.min[2])**2);function m(Q,pe){const ce=ui(Q,pe,o,g,w.surfel_data,l);ce&&(C.setOrbitPivot(ce),console.log(`[pick] orbit pivot → (${ce[0].toFixed(3)}, ${ce[1].toFixed(3)}, ${ce[2].toFixed(3)})`))}function y(){const Q=o.width*.5,pe=o.height*.5,ce=ui(Q,pe,o,g,w.surfel_data,l);if(!ce)return;const De=g.rotation,Ve=De[2],Se=De[6],Ce=De[10],$e=ce[0]-g.position[0],Ze=ce[1]-g.position[1],lt=ce[2]-g.position[2],wt=$e*Ve+Ze*Se+lt*Ce;wt>0&&C.setOrbitDepth(wt)}if(r.length===0){const Q=w.bbox.max[0]-w.bbox.min[0],pe=w.bbox.max[1]-w.bbox.min[1],ce=w.bbox.max[2]-w.bbox.min[2],Ve=.5*Math.sqrt(Q*Q+pe*pe+ce*ce)*.5;z.set(p[0]-Ve,p[1]-Ve,p[2]-Ve,g.position);const Se=z.create(Ve,Ve,Ve);z.normalize(Se,Se);const Ce=z.create(0,1,0),$e=z.create();z.cross(Ce,Se,$e),z.normalize($e,$e);const Ze=z.create();z.cross(Se,$e,Ze);const lt=Et.create($e[0],Ze[0],Se[0],$e[1],Ze[1],Se[1],$e[2],Ze[2],Se[2]);dt.fromMat3(lt,g.rotation),g.update_buffer()}C.setCenter(z.create(w.centroid[0],w.centroid[1],w.centroid[2]));const b=new mc(w,h,F,g.uniform_buffer,S,_,d);D=b,es(o.width,o.height,h,b.render_settings_buffer),c.atlas_enabled=_!==null,d===null&&(c.mesh_cull=!1),b.setMeshCullEnabled(c.mesh_cull),b.setMeshMargin(c.mesh_margin),d===null&&(c.mesh_debug=!1),b.setMeshOverlayEnabled(c.mesh_debug);{const Q=w.surfel_data,pe=Q.length/8;let ce=0,De=0,Ve=0;for(let Ce=0;Ce<pe;Ce++)ce+=Q[Ce*8],De+=Q[Ce*8+1],Ve+=Q[Ce*8+2];const Se=pe>0?[ce/pe,De/pe,Ve/pe]:[0,0,0];b.setBfcParams(c.bfc_cos,Se),an({bfc:c.bfc},h,b.render_settings_buffer),console.log(`[bfc] flag=${c.bfc} cos=${c.bfc_cos} centroid=(${Se[0].toFixed(3)}, ${Se[1].toFixed(3)}, ${Se[2].toFixed(3)})`)}b.htEnabled=c.ht_mode>0,b.htSortedTail=c.ht_mode===2,b.setHtTailK(c.ht_k),c.ht_mode>0&&console.log(`[ht] hybrid transparency ON (mode ${c.ht_mode}: ${c.ht_mode===2?"exact core + SORTED tail":"K=1 core + OIT tail"}, tail_k=${c.ht_k})`),b.wsrEnabled=c.wsr,c.wsr&&console.log("[wsr] sort-free weighted-sum mode requested — active only on probe_mode-2 bundles (stride-7 probes with learned occlusion)"),an({meshSampleMode:c.mesh_sample_mode,meshSilhouetteCull:c.mesh_silhouette,meshInvertDepth:c.mesh_invert_depth},h,b.render_settings_buffer),console.log(`[mesh-cull] ${d!==null?"mesh loaded":"no mesh"} · toggle=${c.mesh_cull} · margin=${c.mesh_margin}m · debug=${c.mesh_debug} · sample_mode=${c.mesh_sample_mode} · silhouette=${c.mesh_silhouette} · invert=${c.mesh_invert_depth}`);let B=!1;const N=(()=>{if(_!==null)return`${_.meta.format===2?"BC7":_.meta.format===3?"ASTC 4×4":_.meta.format===7?"BC7 codebook gather (typeD)":`format=${_.meta.format}`} ${_.meta.width}×${_.meta.height}, ${_.meta.n_layers} layers`;const Q=h.features.has("texture-compression-bc"),pe=h.features.has("texture-compression-astc");return`no atlas in bundle (GPU supports: ${(Q?["BC7"]:[]).concat(pe?["ASTC"]:[]).join("+")||"none"})`})();console.log("[atlas]",N),ai(w.sh_bias,h,b.render_settings_buffer),oi(c.gaussian_scaling,h,b.render_settings_buffer),c.sh_bias=w.sh_bias;const W=w.num_points.toLocaleString(),ne={stats:`${W} surfels · -- fps`};v.addMonitor(ne,"stats",{label:"Stats",interval:200}),v.addMonitor({atlas:N},"atlas",{label:"Atlas"});const ee={stages:"— ms · awaiting timestamp data"};v.addMonitor(ee,"stages",{label:"Stages",interval:500});let Z=null;if(b.timeQueryEnabled){Z=document.createElement("canvas"),Z.width=280,Z.height=24,Z.style.cssText="position:fixed;right:8px;bottom:8px;width:280px;height:24px;background:#0008;border:1px solid #2a2a2a;border-radius:4px;font-family:ui-monospace,Menlo,monospace;pointer-events:none;z-index:1000;",document.body.appendChild(Z);const Q=ce=>{const De=Z.getContext("2d");if(!De)return;const Ve=Z.width,Se=Z.height;if(De.clearRect(0,0,Ve,Se),!ce||ce.total<=0){De.fillStyle="#888",De.font="11px ui-monospace,Menlo,monospace",De.fillText("awaiting GPU timestamps…",8,16);return}const Ce=[{label:"cull",ms:ce.cull,color:"#3aa3ff"},{label:"pre",ms:ce.preprocess,color:"#3ad27a"},{label:"sort",ms:ce.sort,color:"#ffa53a"},{label:"render",ms:ce.render,color:"#ff5566"}],$e=Math.max(.001,Ce.reduce((lt,wt)=>lt+wt.ms,0));let Ze=0;De.font="10px ui-monospace,Menlo,monospace",De.textBaseline="middle";for(const lt of Ce){const wt=lt.ms/$e*Ve;De.fillStyle=lt.color,De.fillRect(Ze,0,wt,Se),wt>=38&&(De.fillStyle="#000c",De.fillText(`${lt.label} ${lt.ms.toFixed(1)}`,Ze+4,Se/2)),Ze+=wt}};setInterval(()=>{B||b.readPerfMetrics({silent:!0}).then(()=>{const ce=b.lastStageBreakdownMs;Q(ce),ce&&(ee.stages=`${ce.total.toFixed(1)} ms · cull ${ce.cull.toFixed(1)} / pre ${ce.preprocess.toFixed(1)} / sort ${ce.sort.toFixed(1)} / render ${ce.render.toFixed(1)}`)}).catch(ce=>console.warn("[perf] readPerfMetrics failed:",ce))},500)}const fe=.4,we=3,de=.3;let ae=null,Me=0,Be=0;const We=ht.create(),Xe=Et.create();let ze=r.length>0?0:-1;const je={view:r.length>0?`${ze+1} / ${r.length}: ${r[ze].img_name??ze}`:"— no presets —"};v.addMonitor(je,"view",{label:"View",interval:100});function et(Q){const pe=Et.create(Q[0],Q[1],Q[2],Q[4],Q[5],Q[6],Q[8],Q[9],Q[10]);return ht.fromMat(pe)}function rt(Q,pe){ae={fromPos:z.clone(g.position),toPos:z.clone(Q.position),fromQuat:ht.normalize(et(g.rotation)),toQuat:ht.normalize(et(Q.rotation)),target:Q,t:0,duration:Math.max(.01,pe)}}const Qe=(Q,pe=!0)=>{if(r.length===0)return;ze=(Q%r.length+r.length)%r.length;const ce=r[ze];pe?rt(ce,fe):(g.set_preset(ce),C.resetToCamera(),y()),je.view=`${ze+1} / ${r.length}: ${r[ze].img_name??ze}`};r.length>0&&(v.addButton({title:"◀ Prev view"}).on("click",()=>Qe(ze-1)),v.addButton({title:"Next view ▶"}).on("click",()=>Qe(ze+1)));const tt=r.length>0?Si(r,{tiltDownDeg:15,alignFirst:!0}):null,it=tt?Ac(r,{numViews:120,tiltDownDeg:15,alignFirst:!0}):[];let He=0;const ot=12;P.value={onAnimateStart:()=>{He=0},onAnimateStop:()=>{C.resetToCamera(),y()}},v.addInput(c,"render_scale",{label:"Render scale",min:.25,max:f,step:.25}).on("change",Q=>{const pe=Math.max(.25,Q.value),ce=Math.max(1,Math.ceil(pe*o.clientWidth)),De=Math.max(1,Math.ceil(pe*o.clientHeight));(o.width!==ce||o.height!==De)&&(o.width=ce,o.height=De,G())}),v.addInput(c,"gaussian_scaling",{label:"Surfel scale",min:0,max:1}).on("change",Q=>oi(Q.value,h,b.render_settings_buffer)),v.addInput(c,"sh_bias",{label:"SH bias",min:0,max:2,step:.01}).on("change",Q=>ai(Q.value,h,b.render_settings_buffer)),v.addInput(c,"bg",{label:"Background",color:{type:"float",alpha:!0}}).on("change",Q=>{b.bgColor=[Q.value.r,Q.value.g,Q.value.b,Q.value.a]});const qe=_?_.meta.format===3?"Atlas (ASTC)":"Atlas (BC7)":"Atlas";v.addInput(c,"atlas_enabled",{label:qe}).on("change",Q=>b.setAtlasEnabled(Q.value)),v.addInput(c,"bfc",{label:"Backface"}).on("change",Q=>an({bfc:Q.value},h,b.render_settings_buffer)),v.addInput(c,"ht_mode",{label:"HybridT",options:{"off (sorted)":0,"OIT tail (no sort)":1,"sorted tail":2}}).on("change",Q=>{b.htEnabled=Q.value>0,b.htSortedTail=Q.value===2}),v.addInput(c,"ht_k",{label:"HybridT tail k",min:0,max:2e3,step:10}).on("change",Q=>b.setHtTailK(Q.value)),v.addInput(c,"wsr",{label:"WSR (sort-free)"}).on("change",Q=>{b.wsrEnabled=Q.value});const nt=v.addInput(c,"mesh_cull",{label:"Mesh cull"});nt.on("change",Q=>b.setMeshCullEnabled(Q.value)),b.hasMesh||(nt.disabled=!0);const Ke=v.addInput(c,"mesh_margin",{label:"Mesh normal margin (m)",min:-.5,max:.5,step:.005});Ke.on("change",Q=>b.setMeshMargin(Q.value)),b.hasMesh||(Ke.disabled=!0);const ut=v.addInput(c,"mesh_debug",{label:"Mesh debug"});ut.on("change",Q=>b.setMeshOverlayEnabled(Q.value)),b.hasMesh||(ut.disabled=!0);const st=v.addInput(c,"mesh_sample_mode",{label:"MeshCull pixel formula",options:{"0: (ndc+1)/2 baseline":0,"1: y-flipped":1,"2: x-flipped":2,"3: both flipped":3,"4: swap axes":4,"5: swap + y-flip":5,"6: swap + x-flip":6,"7: swap + both flip":7}});st.on("change",Q=>an({meshSampleMode:Q.value},h,b.render_settings_buffer)),b.hasMesh||(st.disabled=!0);const Bt=v.addInput(c,"mesh_silhouette",{label:"Silhouette cull"});Bt.on("change",Q=>an({meshSilhouetteCull:Q.value},h,b.render_settings_buffer)),b.hasMesh||(Bt.disabled=!0);const yt=v.addInput(c,"mesh_invert_depth",{label:"Invert depth cull"});yt.on("change",Q=>an({meshInvertDepth:Q.value},h,b.render_settings_buffer)),b.hasMesh||(yt.disabled=!0),v.addButton({title:"🎯 Reset camera"}).on("click",()=>{if(r.length>0)g.set_preset(r[0]);else{const Q=w.bbox.max[0]-w.bbox.min[0],pe=w.bbox.max[1]-w.bbox.min[1],ce=w.bbox.max[2]-w.bbox.min[2],Ve=.5*Math.sqrt(Q*Q+pe*pe+ce*ce)*.5;z.set(p[0]-Ve,p[1]-Ve,p[2]-Ve,g.position);const Se=z.create(Ve,Ve,Ve);z.normalize(Se,Se);const Ce=z.create();z.cross(z.create(0,1,0),Se,Ce),z.normalize(Ce,Ce);const $e=z.create();z.cross(Se,Ce,$e);const Ze=Et.create(Ce[0],$e[0],Se[0],Ce[1],$e[1],Se[1],Ce[2],$e[2],Se[2]);dt.fromMat3(Ze,g.rotation),g.update_buffer()}C.resetToCamera(),y()});const vt={result:"— click Benchmark —"};v.addMonitor(vt,"result",{label:"Bench",interval:500,multiline:!0,lineCount:4});const Ct={bicycle:{w:1237,h:822,fovY:2*Math.atan(3286/(2*4627.3))},flowers:{w:1256,h:828,fovY:2*Math.atan(3312/(2*4285.5))},garden:{w:1297,h:840,fovY:2*Math.atan(3361/(2*3852.4))},stump:{w:1245,h:825,fovY:2*Math.atan(3300/(2*4528.1))},treehill:{w:1267,h:832,fovY:2*Math.atan(3326/(2*4205.6))},bonsai:{w:1559,h:1039,fovY:2*Math.atan(2078/(2*3222.7))},counter:{w:1558,h:1038,fovY:2*Math.atan(2076/(2*3192.7))},kitchen:{w:1558,h:1039,fovY:2*Math.atan(2078/(2*3240.8))},room:{w:1557,h:1038,fovY:2*Math.atan(2075/(2*3174))}};function Rt(){const pe=((new URLSearchParams(window.location.search).get("bundle")??"").split("/").pop()??"").toLowerCase();for(const ce of Object.keys(Ct))if(pe.startsWith(ce))return ce;return null}const gt=document.createElement("div");gt.id="bench-overlay",gt.style.cssText=["position:fixed","top:50%","left:50%","transform:translate(-50%,-50%)","background:rgba(0,0,0,0.9)","color:#fff","padding:24px 32px","border-radius:8px","font-family:monospace","font-size:14px","min-width:340px","text-align:left","box-shadow:0 4px 24px rgba(0,0,0,0.6)","display:none","z-index:9999","pointer-events:none"].join(";"),document.body.appendChild(gt);function Tt(Q,pe,ce){const De=Math.floor(pe/Math.max(1,ce)*100),Ve=32,Se=Math.floor(pe/Math.max(1,ce)*Ve),Ce="█".repeat(Se)+"░".repeat(Ve-Se);gt.innerHTML=`<div style="margin-bottom:10px;font-weight:bold">📊 ${Q}</div><div>[${Ce}] ${De}%</div><div style="margin-top:6px;font-size:11px;opacity:0.7">${pe} / ${ce} frames · offscreen · pipelined · no vsync</div>`,gt.style.display="block"}function un(){gt.style.display="none"}async function Ut(Q=10,pe=200){if(B)return;if(r.length===0){vt.result="no cameras to benchmark";return}B=!0;const ce=H,De=c.animate,Ve=new Float32Array(g.position),Se=new Float32Array(g.rotation);H=!1,c.animate=!1,v.refresh(),ae=null,C.enabled=!1;const Ce=Rt(),$e=Ce?Ct[Ce]:null,Ze=($e==null?void 0:$e.w)??o.width,lt=($e==null?void 0:$e.h)??o.height,wt=($e==null?void 0:$e.fovY)??g.getFov(),Zt=Ce?`${Ce} · ${Ze>=4e3/4+500?"images_4":"images_2"}`:"custom",Un=o.width,yn=o.height,Vn=g.getFov();o.width=Ze,o.height=lt,g.setFov(wt),es(Ze,lt,h,b.render_settings_buffer);const On=h.createTexture({size:[Ze,lt,1],format:F,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.STORAGE_BINDING}),cs=On.createView(),us=()=>{const ft=h.createCommandEncoder();b.frame(ft,cs,!1),h.queue.submit([ft.finish()])},Fn=()=>new Promise(ft=>setTimeout(ft,0)),Nn=20,$n=async(ft,Xt)=>{let pn=0,xt=0;for(Tt(Xt,0,ft),await Fn();xt<ft;){const _t=Math.min(Nn,ft-xt),kt=performance.now();for(let hn=0;hn<_t;hn++)g.set_preset(r[(xt+hn)%r.length]),us();await h.queue.onSubmittedWorkDone();const Qt=performance.now();pn+=Qt-kt,xt+=_t,Tt(Xt,xt,ft),await Fn()}return pn};try{await $n(Q,"Warming up");const Xt=await $n(pe,"Benchmarking")/pe,pn=1e3/Xt,xt=w.num_points??w.surfel_data.length/8,_t=(wt*180/Math.PI).toFixed(1),kt=`${pn.toFixed(1)} FPS  (${Xt.toFixed(2)} ms/frame)
${Ze}×${lt} · fovY ${_t}° · ${Zt}
${xt.toLocaleString()} surfels · ${Q}w+${pe}b · pipelined`;vt.result=kt,console.log("[bench]",kt.replace(/\n/g,"  |  "))}catch(ft){console.error("[bench] failed:",ft),vt.result=`bench failed: ${ft}`}finally{un(),On.destroy(),o.width=Un,o.height=yn,g.setFov(Vn),es(Un,yn,h,b.render_settings_buffer),g.position.set(Ve),g.rotation.set(Se),g.update_buffer(),C.enabled=!ce,H=ce,c.animate=De,v.refresh(),B=!1}}v.addButton({title:"📊 Benchmark"}).on("click",()=>Ut()),document.addEventListener("keydown",Q=>{const pe=Q.key;if(pe>="0"&&pe<="9"&&r.length>0){const ce=parseInt(pe);ce<r.length&&Qe(ce)}else pe==="ArrowLeft"||pe==="PageUp"?(Qe(ze-1),Q.preventDefault()):pe==="ArrowRight"||pe==="PageDown"?(Qe(ze+1),Q.preventDefault()):(pe==="d"||pe==="D")&&b.debugReadSortedIndices(30).catch(ce=>console.error("[DEBUG] readback failed:",ce))});function Ht(Q,pe){const ce=o.getBoundingClientRect(),De=window.devicePixelRatio||1;return[(Q-ce.left)*De,(pe-ce.top)*De]}o.addEventListener("dblclick",Q=>{const[pe,ce]=Ht(Q.clientX,Q.clientY);m(pe,ce)});let Vt=0,Ye=0,wn=0;o.addEventListener("pointerdown",Q=>{if(Q.pointerType!=="touch")return;const pe=performance.now(),ce=pe-Vt,De=Q.clientX-Ye,Ve=Q.clientY-wn;if(ce>0&&ce<300&&De*De+Ve*Ve<40*40){const[Se,Ce]=Ht(Q.clientX,Q.clientY);m(Se,Ce),Vt=0}else Vt=pe,Ye=Q.clientX,wn=Q.clientY});function Rn(){return M}let dn=performance.now(),xn=60,At=Promise.resolve(),Kt=0;async function Yt(){var Ve;const Q=performance.now(),pe=Math.min((Q-dn)/1e3,.1);if(dn=Q,pe>0){const Se=((Ve=b.lastStageBreakdownMs)==null?void 0:Ve.total)??0,Ce=Se>.5?1e3/Se:1/pe;xn=xn*.9+Ce*.1,ne.stats=`${W} surfels · ${Math.round(xn)} fps`}if(B){requestAnimationFrame(Yt);return}if(Rn()&&(ae||H)&&(ae=null,C.resetToCamera(),y(),H&&(H=!1,c.animate=!1,v.refresh())),H&&c.animateMode==="circle"&&tt){He+=pe/ot,He>=1&&(He-=1);const Se=Ei(tt,He);g.set_preset(Se),C.update(pe);const Ce=h.createCommandEncoder();b.frame(Ce,a.getCurrentTexture().createView()),h.queue.submit([Ce.finish()]),Kt++,Kt===2&&Ln(),requestAnimationFrame(Yt);return}if(ae){ae.t+=pe/ae.duration;const Se=Math.min(1,ae.t),Ce=Se*Se*(3-2*Se);z.lerp(ae.fromPos,ae.toPos,Ce,g.position),ht.slerp(ae.fromQuat,ae.toQuat,Ce,We),Et.fromQuat(We,Xe),dt.fromMat3(Xe,g.rotation),g.update_buffer(),ae.t>=1&&(g.set_preset(ae.target),ae=null,H?r.length>0&&(Me=de):(C.resetToCamera(),y()))}else if(H&&!Rn()){const Se=c.animateMode==="circle"&&it.length>0,Ce=Se?it:r;if(Ce.length!==0){if(Me-=pe,Me<=0){const Ze=((Se?Be:ze)+1)%Ce.length;Se?Be=Ze:ze=Ze;const lt=Se?we/8:we;rt(Ce[Ze],lt),Se||(je.view=`${ze+1} / ${r.length}: ${r[ze].img_name??ze}`)}}}C.update(pe),V(),U(),await At;const ce=h.createCommandEncoder(),De=a.getCurrentTexture().createView();b.frame(ce,De),h.queue.submit([ce.finish()]),At=h.queue.onSubmittedWorkDone(),Kt++,Kt===2&&Ln(),requestAnimationFrame(Yt)}requestAnimationFrame(Yt)}}(function(){let a="dev";for(const S of Array.from(document.querySelectorAll('script[type="module"]'))){const C=S.src.match(/\/assets\/index-([0-9a-z]+)\.js$/i);if(C){a=C[1];break}}const h=document.createElement("div");h.textContent="v "+a,h.title="viewer build hash (Vite content hash of index-*.js)",Object.assign(h.style,{position:"fixed",right:"6px",bottom:"6px",font:"10px ui-monospace, SFMono-Regular, Menlo, monospace",color:"rgba(255,255,255,0.55)",background:"rgba(0,0,0,0.35)",padding:"2px 6px",borderRadius:"4px",pointerEvents:"none",zIndex:"9999",userSelect:"all"}),document.body.appendChild(h)})();(async()=>{if(navigator.gpu===void 0){const C=document.querySelector("#title");C.innerText="WebGPU is not supported in this browser.";return}const o=await navigator.gpu.requestAdapter({powerPreference:"high-performance"});if(o===null){const C=document.querySelector("#title");C.innerText="No adapter is available for WebGPU.";return}const a=[];o.features.has("timestamp-query")&&a.push("timestamp-query"),o.features.has("texture-compression-bc")&&a.push("texture-compression-bc"),o.features.has("texture-compression-astc")&&a.push("texture-compression-astc"),console.log("[adapter]",o.info??"(unknown)"),console.log("[adapter] features:",Array.from(o.features)),console.log("[adapter] BC7:",o.features.has("texture-compression-bc")),console.log("[adapter] ASTC:",o.features.has("texture-compression-astc")),console.log("[adapter] limits:",{maxStorageBuffersPerShaderStage:o.limits.maxStorageBuffersPerShaderStage,maxComputeWorkgroupStorageSize:o.limits.maxComputeWorkgroupStorageSize,maxBufferSize:o.limits.maxBufferSize,maxStorageBufferBindingSize:o.limits.maxStorageBufferBindingSize,maxTextureDimension2D:o.limits.maxTextureDimension2D});const h=await o.requestDevice({requiredFeatures:a,requiredLimits:{maxStorageBuffersPerShaderStage:10,maxComputeWorkgroupStorageSize:o.limits.maxComputeWorkgroupStorageSize,maxBufferSize:o.limits.maxBufferSize,maxStorageBufferBindingSize:o.limits.maxStorageBufferBindingSize}}),S=document.querySelector("#webgpu-canvas");Il(S!==null);const g=S.getContext("webgpu");Hc(S,g,h,a)})();
