var ml=Object.defineProperty;var bl=(o,l,h)=>l in o?ml(o,l,{enumerable:!0,configurable:!0,writable:!0,value:h}):o[l]=h;var tt=(o,l,h)=>(bl(o,typeof l!="symbol"?l+"":l,h),h);(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const x of document.querySelectorAll('link[rel="modulepreload"]'))C(x);new MutationObserver(x=>{for(const E of x)if(E.type==="childList")for(const M of E.addedNodes)M.tagName==="LINK"&&M.rel==="modulepreload"&&C(M)}).observe(document,{childList:!0,subtree:!0});function h(x){const E={};return x.integrity&&(E.integrity=x.integrity),x.referrerPolicy&&(E.referrerPolicy=x.referrerPolicy),x.crossOrigin==="use-credentials"?E.credentials="include":x.crossOrigin==="anonymous"?E.credentials="omit":E.credentials="same-origin",E}function C(x){if(x.ep)return;x.ep=!0;const E=h(x);fetch(x.href,E)}})();function vl(o,l){return class extends o{constructor(...h){super(...h),l(this)}}}const gl=vl(Array,o=>o.fill(0));let Lt=1e-6;function wl(o){function l(y=0,S=0){const k=new o(2);return y!==void 0&&(k[0]=y,S!==void 0&&(k[1]=S)),k}const h=l;function C(y,S,k){const r=k??new o(2);return r[0]=y,r[1]=S,r}function x(y,S){const k=S??new o(2);return k[0]=Math.ceil(y[0]),k[1]=Math.ceil(y[1]),k}function E(y,S){const k=S??new o(2);return k[0]=Math.floor(y[0]),k[1]=Math.floor(y[1]),k}function M(y,S){const k=S??new o(2);return k[0]=Math.round(y[0]),k[1]=Math.round(y[1]),k}function G(y,S=0,k=1,r){const m=r??new o(2);return m[0]=Math.min(k,Math.max(S,y[0])),m[1]=Math.min(k,Math.max(S,y[1])),m}function A(y,S,k){const r=k??new o(2);return r[0]=y[0]+S[0],r[1]=y[1]+S[1],r}function L(y,S,k,r){const m=r??new o(2);return m[0]=y[0]+S[0]*k,m[1]=y[1]+S[1]*k,m}function V(y,S){const k=y[0],r=y[1],m=S[0],u=S[1],p=Math.sqrt(k*k+r*r),a=Math.sqrt(m*m+u*u),_=p*a,w=_&&et(y,S)/_;return Math.acos(w)}function q(y,S,k){const r=k??new o(2);return r[0]=y[0]-S[0],r[1]=y[1]-S[1],r}const Z=q;function J(y,S){return Math.abs(y[0]-S[0])<Lt&&Math.abs(y[1]-S[1])<Lt}function F(y,S){return y[0]===S[0]&&y[1]===S[1]}function z(y,S,k,r){const m=r??new o(2);return m[0]=y[0]+k*(S[0]-y[0]),m[1]=y[1]+k*(S[1]-y[1]),m}function W(y,S,k,r){const m=r??new o(2);return m[0]=y[0]+k[0]*(S[0]-y[0]),m[1]=y[1]+k[1]*(S[1]-y[1]),m}function ut(y,S,k){const r=k??new o(2);return r[0]=Math.max(y[0],S[0]),r[1]=Math.max(y[1],S[1]),r}function O(y,S,k){const r=k??new o(2);return r[0]=Math.min(y[0],S[0]),r[1]=Math.min(y[1],S[1]),r}function R(y,S,k){const r=k??new o(2);return r[0]=y[0]*S,r[1]=y[1]*S,r}const U=R;function lt(y,S,k){const r=k??new o(2);return r[0]=y[0]/S,r[1]=y[1]/S,r}function K(y,S){const k=S??new o(2);return k[0]=1/y[0],k[1]=1/y[1],k}const X=K;function Y(y,S,k){const r=k??new o(3),m=y[0]*S[1]-y[1]*S[0];return r[0]=0,r[1]=0,r[2]=m,r}function et(y,S){return y[0]*S[0]+y[1]*S[1]}function _t(y){const S=y[0],k=y[1];return Math.sqrt(S*S+k*k)}const Vt=_t;function Rt(y){const S=y[0],k=y[1];return S*S+k*k}const Dt=Rt;function pt(y,S){const k=y[0]-S[0],r=y[1]-S[1];return Math.sqrt(k*k+r*r)}const kt=pt;function wt(y,S){const k=y[0]-S[0],r=y[1]-S[1];return k*k+r*r}const H=wt;function st(y,S){const k=S??new o(2),r=y[0],m=y[1],u=Math.sqrt(r*r+m*m);return u>1e-5?(k[0]=r/u,k[1]=m/u):(k[0]=0,k[1]=0),k}function It(y,S){const k=S??new o(2);return k[0]=-y[0],k[1]=-y[1],k}function Mt(y,S){const k=S??new o(2);return k[0]=y[0],k[1]=y[1],k}const zt=Mt;function Tt(y,S,k){const r=k??new o(2);return r[0]=y[0]*S[0],r[1]=y[1]*S[1],r}const Ot=Tt;function xt(y,S,k){const r=k??new o(2);return r[0]=y[0]/S[0],r[1]=y[1]/S[1],r}const ht=xt;function Wt(y=1,S){const k=S??new o(2),r=Math.random()*2*Math.PI;return k[0]=Math.cos(r)*y,k[1]=Math.sin(r)*y,k}function B(y){const S=y??new o(2);return S[0]=0,S[1]=0,S}function j(y,S,k){const r=k??new o(2),m=y[0],u=y[1];return r[0]=m*S[0]+u*S[4]+S[12],r[1]=m*S[1]+u*S[5]+S[13],r}function g(y,S,k){const r=k??new o(2),m=y[0],u=y[1];return r[0]=S[0]*m+S[4]*u+S[8],r[1]=S[1]*m+S[5]*u+S[9],r}function i(y,S,k,r){const m=r??new o(2),u=y[0]-S[0],p=y[1]-S[1],a=Math.sin(k),_=Math.cos(k);return m[0]=u*_-p*a+S[0],m[1]=u*a+p*_+S[1],m}function f(y,S,k){const r=k??new o(2);return st(y,r),R(r,S,r)}function d(y,S,k){const r=k??new o(2);return _t(y)>S?f(y,S,r):Mt(y,r)}function b(y,S,k){const r=k??new o(2);return z(y,S,.5,r)}return{create:l,fromValues:h,set:C,ceil:x,floor:E,round:M,clamp:G,add:A,addScaled:L,angle:V,subtract:q,sub:Z,equalsApproximately:J,equals:F,lerp:z,lerpV:W,max:ut,min:O,mulScalar:R,scale:U,divScalar:lt,inverse:K,invert:X,cross:Y,dot:et,length:_t,len:Vt,lengthSq:Rt,lenSq:Dt,distance:pt,dist:kt,distanceSq:wt,distSq:H,normalize:st,negate:It,copy:Mt,clone:zt,multiply:Tt,mul:Ot,divide:xt,div:ht,random:Wt,zero:B,transformMat4:j,transformMat3:g,rotate:i,setLength:f,truncate:d,midpoint:b}}const Tr=new Map;function Kr(o){let l=Tr.get(o);return l||(l=wl(o),Tr.set(o,l)),l}function xl(o){function l(a,_,w){const v=new o(3);return a!==void 0&&(v[0]=a,_!==void 0&&(v[1]=_,w!==void 0&&(v[2]=w))),v}const h=l;function C(a,_,w,v){const D=v??new o(3);return D[0]=a,D[1]=_,D[2]=w,D}function x(a,_){const w=_??new o(3);return w[0]=Math.ceil(a[0]),w[1]=Math.ceil(a[1]),w[2]=Math.ceil(a[2]),w}function E(a,_){const w=_??new o(3);return w[0]=Math.floor(a[0]),w[1]=Math.floor(a[1]),w[2]=Math.floor(a[2]),w}function M(a,_){const w=_??new o(3);return w[0]=Math.round(a[0]),w[1]=Math.round(a[1]),w[2]=Math.round(a[2]),w}function G(a,_=0,w=1,v){const D=v??new o(3);return D[0]=Math.min(w,Math.max(_,a[0])),D[1]=Math.min(w,Math.max(_,a[1])),D[2]=Math.min(w,Math.max(_,a[2])),D}function A(a,_,w){const v=w??new o(3);return v[0]=a[0]+_[0],v[1]=a[1]+_[1],v[2]=a[2]+_[2],v}function L(a,_,w,v){const D=v??new o(3);return D[0]=a[0]+_[0]*w,D[1]=a[1]+_[1]*w,D[2]=a[2]+_[2]*w,D}function V(a,_){const w=a[0],v=a[1],D=a[2],N=_[0],$=_[1],ct=_[2],it=Math.sqrt(w*w+v*v+D*D),rt=Math.sqrt(N*N+$*$+ct*ct),ft=it*rt,yt=ft&&et(a,_)/ft;return Math.acos(yt)}function q(a,_,w){const v=w??new o(3);return v[0]=a[0]-_[0],v[1]=a[1]-_[1],v[2]=a[2]-_[2],v}const Z=q;function J(a,_){return Math.abs(a[0]-_[0])<Lt&&Math.abs(a[1]-_[1])<Lt&&Math.abs(a[2]-_[2])<Lt}function F(a,_){return a[0]===_[0]&&a[1]===_[1]&&a[2]===_[2]}function z(a,_,w,v){const D=v??new o(3);return D[0]=a[0]+w*(_[0]-a[0]),D[1]=a[1]+w*(_[1]-a[1]),D[2]=a[2]+w*(_[2]-a[2]),D}function W(a,_,w,v){const D=v??new o(3);return D[0]=a[0]+w[0]*(_[0]-a[0]),D[1]=a[1]+w[1]*(_[1]-a[1]),D[2]=a[2]+w[2]*(_[2]-a[2]),D}function ut(a,_,w){const v=w??new o(3);return v[0]=Math.max(a[0],_[0]),v[1]=Math.max(a[1],_[1]),v[2]=Math.max(a[2],_[2]),v}function O(a,_,w){const v=w??new o(3);return v[0]=Math.min(a[0],_[0]),v[1]=Math.min(a[1],_[1]),v[2]=Math.min(a[2],_[2]),v}function R(a,_,w){const v=w??new o(3);return v[0]=a[0]*_,v[1]=a[1]*_,v[2]=a[2]*_,v}const U=R;function lt(a,_,w){const v=w??new o(3);return v[0]=a[0]/_,v[1]=a[1]/_,v[2]=a[2]/_,v}function K(a,_){const w=_??new o(3);return w[0]=1/a[0],w[1]=1/a[1],w[2]=1/a[2],w}const X=K;function Y(a,_,w){const v=w??new o(3),D=a[2]*_[0]-a[0]*_[2],N=a[0]*_[1]-a[1]*_[0];return v[0]=a[1]*_[2]-a[2]*_[1],v[1]=D,v[2]=N,v}function et(a,_){return a[0]*_[0]+a[1]*_[1]+a[2]*_[2]}function _t(a){const _=a[0],w=a[1],v=a[2];return Math.sqrt(_*_+w*w+v*v)}const Vt=_t;function Rt(a){const _=a[0],w=a[1],v=a[2];return _*_+w*w+v*v}const Dt=Rt;function pt(a,_){const w=a[0]-_[0],v=a[1]-_[1],D=a[2]-_[2];return Math.sqrt(w*w+v*v+D*D)}const kt=pt;function wt(a,_){const w=a[0]-_[0],v=a[1]-_[1],D=a[2]-_[2];return w*w+v*v+D*D}const H=wt;function st(a,_){const w=_??new o(3),v=a[0],D=a[1],N=a[2],$=Math.sqrt(v*v+D*D+N*N);return $>1e-5?(w[0]=v/$,w[1]=D/$,w[2]=N/$):(w[0]=0,w[1]=0,w[2]=0),w}function It(a,_){const w=_??new o(3);return w[0]=-a[0],w[1]=-a[1],w[2]=-a[2],w}function Mt(a,_){const w=_??new o(3);return w[0]=a[0],w[1]=a[1],w[2]=a[2],w}const zt=Mt;function Tt(a,_,w){const v=w??new o(3);return v[0]=a[0]*_[0],v[1]=a[1]*_[1],v[2]=a[2]*_[2],v}const Ot=Tt;function xt(a,_,w){const v=w??new o(3);return v[0]=a[0]/_[0],v[1]=a[1]/_[1],v[2]=a[2]/_[2],v}const ht=xt;function Wt(a=1,_){const w=_??new o(3),v=Math.random()*2*Math.PI,D=Math.random()*2-1,N=Math.sqrt(1-D*D)*a;return w[0]=Math.cos(v)*N,w[1]=Math.sin(v)*N,w[2]=D*a,w}function B(a){const _=a??new o(3);return _[0]=0,_[1]=0,_[2]=0,_}function j(a,_,w){const v=w??new o(3),D=a[0],N=a[1],$=a[2],ct=_[3]*D+_[7]*N+_[11]*$+_[15]||1;return v[0]=(_[0]*D+_[4]*N+_[8]*$+_[12])/ct,v[1]=(_[1]*D+_[5]*N+_[9]*$+_[13])/ct,v[2]=(_[2]*D+_[6]*N+_[10]*$+_[14])/ct,v}function g(a,_,w){const v=w??new o(3),D=a[0],N=a[1],$=a[2];return v[0]=D*_[0*4+0]+N*_[1*4+0]+$*_[2*4+0],v[1]=D*_[0*4+1]+N*_[1*4+1]+$*_[2*4+1],v[2]=D*_[0*4+2]+N*_[1*4+2]+$*_[2*4+2],v}function i(a,_,w){const v=w??new o(3),D=a[0],N=a[1],$=a[2];return v[0]=D*_[0]+N*_[4]+$*_[8],v[1]=D*_[1]+N*_[5]+$*_[9],v[2]=D*_[2]+N*_[6]+$*_[10],v}function f(a,_,w){const v=w??new o(3),D=_[0],N=_[1],$=_[2],ct=_[3]*2,it=a[0],rt=a[1],ft=a[2],yt=N*ft-$*rt,dt=$*it-D*ft,bt=D*rt-N*it;return v[0]=it+yt*ct+(N*bt-$*dt)*2,v[1]=rt+dt*ct+($*yt-D*bt)*2,v[2]=ft+bt*ct+(D*dt-N*yt)*2,v}function d(a,_){const w=_??new o(3);return w[0]=a[12],w[1]=a[13],w[2]=a[14],w}function b(a,_,w){const v=w??new o(3),D=_*4;return v[0]=a[D+0],v[1]=a[D+1],v[2]=a[D+2],v}function y(a,_){const w=_??new o(3),v=a[0],D=a[1],N=a[2],$=a[4],ct=a[5],it=a[6],rt=a[8],ft=a[9],yt=a[10];return w[0]=Math.sqrt(v*v+D*D+N*N),w[1]=Math.sqrt($*$+ct*ct+it*it),w[2]=Math.sqrt(rt*rt+ft*ft+yt*yt),w}function S(a,_,w,v){const D=v??new o(3),N=[],$=[];return N[0]=a[0]-_[0],N[1]=a[1]-_[1],N[2]=a[2]-_[2],$[0]=N[0],$[1]=N[1]*Math.cos(w)-N[2]*Math.sin(w),$[2]=N[1]*Math.sin(w)+N[2]*Math.cos(w),D[0]=$[0]+_[0],D[1]=$[1]+_[1],D[2]=$[2]+_[2],D}function k(a,_,w,v){const D=v??new o(3),N=[],$=[];return N[0]=a[0]-_[0],N[1]=a[1]-_[1],N[2]=a[2]-_[2],$[0]=N[2]*Math.sin(w)+N[0]*Math.cos(w),$[1]=N[1],$[2]=N[2]*Math.cos(w)-N[0]*Math.sin(w),D[0]=$[0]+_[0],D[1]=$[1]+_[1],D[2]=$[2]+_[2],D}function r(a,_,w,v){const D=v??new o(3),N=[],$=[];return N[0]=a[0]-_[0],N[1]=a[1]-_[1],N[2]=a[2]-_[2],$[0]=N[0]*Math.cos(w)-N[1]*Math.sin(w),$[1]=N[0]*Math.sin(w)+N[1]*Math.cos(w),$[2]=N[2],D[0]=$[0]+_[0],D[1]=$[1]+_[1],D[2]=$[2]+_[2],D}function m(a,_,w){const v=w??new o(3);return st(a,v),R(v,_,v)}function u(a,_,w){const v=w??new o(3);return _t(a)>_?m(a,_,v):Mt(a,v)}function p(a,_,w){const v=w??new o(3);return z(a,_,.5,v)}return{create:l,fromValues:h,set:C,ceil:x,floor:E,round:M,clamp:G,add:A,addScaled:L,angle:V,subtract:q,sub:Z,equalsApproximately:J,equals:F,lerp:z,lerpV:W,max:ut,min:O,mulScalar:R,scale:U,divScalar:lt,inverse:K,invert:X,cross:Y,dot:et,length:_t,len:Vt,lengthSq:Rt,lenSq:Dt,distance:pt,dist:kt,distanceSq:wt,distSq:H,normalize:st,negate:It,copy:Mt,clone:zt,multiply:Tt,mul:Ot,divide:xt,div:ht,random:Wt,zero:B,transformMat4:j,transformMat4Upper3x3:g,transformMat3:i,transformQuat:f,getTranslation:d,getAxis:b,getScaling:y,rotateX:S,rotateY:k,rotateZ:r,setLength:m,truncate:u,midpoint:p}}const Dr=new Map;function Ln(o){let l=Dr.get(o);return l||(l=xl(o),Dr.set(o,l)),l}function yl(o){const l=Kr(o),h=Ln(o);function C(i,f,d,b,y,S,k,r,m){const u=new o(12);return u[3]=0,u[7]=0,u[11]=0,i!==void 0&&(u[0]=i,f!==void 0&&(u[1]=f,d!==void 0&&(u[2]=d,b!==void 0&&(u[4]=b,y!==void 0&&(u[5]=y,S!==void 0&&(u[6]=S,k!==void 0&&(u[8]=k,r!==void 0&&(u[9]=r,m!==void 0&&(u[10]=m))))))))),u}function x(i,f,d,b,y,S,k,r,m,u){const p=u??new o(12);return p[0]=i,p[1]=f,p[2]=d,p[3]=0,p[4]=b,p[5]=y,p[6]=S,p[7]=0,p[8]=k,p[9]=r,p[10]=m,p[11]=0,p}function E(i,f){const d=f??new o(12);return d[0]=i[0],d[1]=i[1],d[2]=i[2],d[3]=0,d[4]=i[4],d[5]=i[5],d[6]=i[6],d[7]=0,d[8]=i[8],d[9]=i[9],d[10]=i[10],d[11]=0,d}function M(i,f){const d=f??new o(12),b=i[0],y=i[1],S=i[2],k=i[3],r=b+b,m=y+y,u=S+S,p=b*r,a=y*r,_=y*m,w=S*r,v=S*m,D=S*u,N=k*r,$=k*m,ct=k*u;return d[0]=1-_-D,d[1]=a+ct,d[2]=w-$,d[3]=0,d[4]=a-ct,d[5]=1-p-D,d[6]=v+N,d[7]=0,d[8]=w+$,d[9]=v-N,d[10]=1-p-_,d[11]=0,d}function G(i,f){const d=f??new o(12);return d[0]=-i[0],d[1]=-i[1],d[2]=-i[2],d[4]=-i[4],d[5]=-i[5],d[6]=-i[6],d[8]=-i[8],d[9]=-i[9],d[10]=-i[10],d}function A(i,f,d){const b=d??new o(12);return b[0]=i[0]*f,b[1]=i[1]*f,b[2]=i[2]*f,b[4]=i[4]*f,b[5]=i[5]*f,b[6]=i[6]*f,b[8]=i[8]*f,b[9]=i[9]*f,b[10]=i[10]*f,b}const L=A;function V(i,f,d){const b=d??new o(12);return b[0]=i[0]+f[0],b[1]=i[1]+f[1],b[2]=i[2]+f[2],b[4]=i[4]+f[4],b[5]=i[5]+f[5],b[6]=i[6]+f[6],b[8]=i[8]+f[8],b[9]=i[9]+f[9],b[10]=i[10]+f[10],b}function q(i,f){const d=f??new o(12);return d[0]=i[0],d[1]=i[1],d[2]=i[2],d[4]=i[4],d[5]=i[5],d[6]=i[6],d[8]=i[8],d[9]=i[9],d[10]=i[10],d}const Z=q;function J(i,f){return Math.abs(i[0]-f[0])<Lt&&Math.abs(i[1]-f[1])<Lt&&Math.abs(i[2]-f[2])<Lt&&Math.abs(i[4]-f[4])<Lt&&Math.abs(i[5]-f[5])<Lt&&Math.abs(i[6]-f[6])<Lt&&Math.abs(i[8]-f[8])<Lt&&Math.abs(i[9]-f[9])<Lt&&Math.abs(i[10]-f[10])<Lt}function F(i,f){return i[0]===f[0]&&i[1]===f[1]&&i[2]===f[2]&&i[4]===f[4]&&i[5]===f[5]&&i[6]===f[6]&&i[8]===f[8]&&i[9]===f[9]&&i[10]===f[10]}function z(i){const f=i??new o(12);return f[0]=1,f[1]=0,f[2]=0,f[4]=0,f[5]=1,f[6]=0,f[8]=0,f[9]=0,f[10]=1,f}function W(i,f){const d=f??new o(12);if(d===i){let _;return _=i[1],i[1]=i[4],i[4]=_,_=i[2],i[2]=i[8],i[8]=_,_=i[6],i[6]=i[9],i[9]=_,d}const b=i[0*4+0],y=i[0*4+1],S=i[0*4+2],k=i[1*4+0],r=i[1*4+1],m=i[1*4+2],u=i[2*4+0],p=i[2*4+1],a=i[2*4+2];return d[0]=b,d[1]=k,d[2]=u,d[4]=y,d[5]=r,d[6]=p,d[8]=S,d[9]=m,d[10]=a,d}function ut(i,f){const d=f??new o(12),b=i[0*4+0],y=i[0*4+1],S=i[0*4+2],k=i[1*4+0],r=i[1*4+1],m=i[1*4+2],u=i[2*4+0],p=i[2*4+1],a=i[2*4+2],_=a*r-m*p,w=-a*k+m*u,v=p*k-r*u,D=1/(b*_+y*w+S*v);return d[0]=_*D,d[1]=(-a*y+S*p)*D,d[2]=(m*y-S*r)*D,d[4]=w*D,d[5]=(a*b-S*u)*D,d[6]=(-m*b+S*k)*D,d[8]=v*D,d[9]=(-p*b+y*u)*D,d[10]=(r*b-y*k)*D,d}function O(i){const f=i[0],d=i[0*4+1],b=i[0*4+2],y=i[1*4+0],S=i[1*4+1],k=i[1*4+2],r=i[2*4+0],m=i[2*4+1],u=i[2*4+2];return f*(S*u-m*k)-y*(d*u-m*b)+r*(d*k-S*b)}const R=ut;function U(i,f,d){const b=d??new o(12),y=i[0],S=i[1],k=i[2],r=i[4+0],m=i[4+1],u=i[4+2],p=i[8+0],a=i[8+1],_=i[8+2],w=f[0],v=f[1],D=f[2],N=f[4+0],$=f[4+1],ct=f[4+2],it=f[8+0],rt=f[8+1],ft=f[8+2];return b[0]=y*w+r*v+p*D,b[1]=S*w+m*v+a*D,b[2]=k*w+u*v+_*D,b[4]=y*N+r*$+p*ct,b[5]=S*N+m*$+a*ct,b[6]=k*N+u*$+_*ct,b[8]=y*it+r*rt+p*ft,b[9]=S*it+m*rt+a*ft,b[10]=k*it+u*rt+_*ft,b}const lt=U;function K(i,f,d){const b=d??z();return i!==b&&(b[0]=i[0],b[1]=i[1],b[2]=i[2],b[4]=i[4],b[5]=i[5],b[6]=i[6]),b[8]=f[0],b[9]=f[1],b[10]=1,b}function X(i,f){const d=f??l.create();return d[0]=i[8],d[1]=i[9],d}function Y(i,f,d){const b=d??l.create(),y=f*4;return b[0]=i[y+0],b[1]=i[y+1],b}function et(i,f,d,b){const y=b===i?i:q(i,b),S=d*4;return y[S+0]=f[0],y[S+1]=f[1],y}function _t(i,f){const d=f??l.create(),b=i[0],y=i[1],S=i[4],k=i[5];return d[0]=Math.sqrt(b*b+y*y),d[1]=Math.sqrt(S*S+k*k),d}function Vt(i,f){const d=f??h.create(),b=i[0],y=i[1],S=i[2],k=i[4],r=i[5],m=i[6],u=i[8],p=i[9],a=i[10];return d[0]=Math.sqrt(b*b+y*y+S*S),d[1]=Math.sqrt(k*k+r*r+m*m),d[2]=Math.sqrt(u*u+p*p+a*a),d}function Rt(i,f){const d=f??new o(12);return d[0]=1,d[1]=0,d[2]=0,d[4]=0,d[5]=1,d[6]=0,d[8]=i[0],d[9]=i[1],d[10]=1,d}function Dt(i,f,d){const b=d??new o(12),y=f[0],S=f[1],k=i[0],r=i[1],m=i[2],u=i[1*4+0],p=i[1*4+1],a=i[1*4+2],_=i[2*4+0],w=i[2*4+1],v=i[2*4+2];return i!==b&&(b[0]=k,b[1]=r,b[2]=m,b[4]=u,b[5]=p,b[6]=a),b[8]=k*y+u*S+_,b[9]=r*y+p*S+w,b[10]=m*y+a*S+v,b}function pt(i,f){const d=f??new o(12),b=Math.cos(i),y=Math.sin(i);return d[0]=b,d[1]=y,d[2]=0,d[4]=-y,d[5]=b,d[6]=0,d[8]=0,d[9]=0,d[10]=1,d}function kt(i,f,d){const b=d??new o(12),y=i[0*4+0],S=i[0*4+1],k=i[0*4+2],r=i[1*4+0],m=i[1*4+1],u=i[1*4+2],p=Math.cos(f),a=Math.sin(f);return b[0]=p*y+a*r,b[1]=p*S+a*m,b[2]=p*k+a*u,b[4]=p*r-a*y,b[5]=p*m-a*S,b[6]=p*u-a*k,i!==b&&(b[8]=i[8],b[9]=i[9],b[10]=i[10]),b}function wt(i,f){const d=f??new o(12),b=Math.cos(i),y=Math.sin(i);return d[0]=1,d[1]=0,d[2]=0,d[4]=0,d[5]=b,d[6]=y,d[8]=0,d[9]=-y,d[10]=b,d}function H(i,f,d){const b=d??new o(12),y=i[4],S=i[5],k=i[6],r=i[8],m=i[9],u=i[10],p=Math.cos(f),a=Math.sin(f);return b[4]=p*y+a*r,b[5]=p*S+a*m,b[6]=p*k+a*u,b[8]=p*r-a*y,b[9]=p*m-a*S,b[10]=p*u-a*k,i!==b&&(b[0]=i[0],b[1]=i[1],b[2]=i[2]),b}function st(i,f){const d=f??new o(12),b=Math.cos(i),y=Math.sin(i);return d[0]=b,d[1]=0,d[2]=-y,d[4]=0,d[5]=1,d[6]=0,d[8]=y,d[9]=0,d[10]=b,d}function It(i,f,d){const b=d??new o(12),y=i[0*4+0],S=i[0*4+1],k=i[0*4+2],r=i[2*4+0],m=i[2*4+1],u=i[2*4+2],p=Math.cos(f),a=Math.sin(f);return b[0]=p*y-a*r,b[1]=p*S-a*m,b[2]=p*k-a*u,b[8]=p*r+a*y,b[9]=p*m+a*S,b[10]=p*u+a*k,i!==b&&(b[4]=i[4],b[5]=i[5],b[6]=i[6]),b}const Mt=pt,zt=kt;function Tt(i,f){const d=f??new o(12);return d[0]=i[0],d[1]=0,d[2]=0,d[4]=0,d[5]=i[1],d[6]=0,d[8]=0,d[9]=0,d[10]=1,d}function Ot(i,f,d){const b=d??new o(12),y=f[0],S=f[1];return b[0]=y*i[0*4+0],b[1]=y*i[0*4+1],b[2]=y*i[0*4+2],b[4]=S*i[1*4+0],b[5]=S*i[1*4+1],b[6]=S*i[1*4+2],i!==b&&(b[8]=i[8],b[9]=i[9],b[10]=i[10]),b}function xt(i,f){const d=f??new o(12);return d[0]=i[0],d[1]=0,d[2]=0,d[4]=0,d[5]=i[1],d[6]=0,d[8]=0,d[9]=0,d[10]=i[2],d}function ht(i,f,d){const b=d??new o(12),y=f[0],S=f[1],k=f[2];return b[0]=y*i[0*4+0],b[1]=y*i[0*4+1],b[2]=y*i[0*4+2],b[4]=S*i[1*4+0],b[5]=S*i[1*4+1],b[6]=S*i[1*4+2],b[8]=k*i[2*4+0],b[9]=k*i[2*4+1],b[10]=k*i[2*4+2],b}function Wt(i,f){const d=f??new o(12);return d[0]=i,d[1]=0,d[2]=0,d[4]=0,d[5]=i,d[6]=0,d[8]=0,d[9]=0,d[10]=1,d}function B(i,f,d){const b=d??new o(12);return b[0]=f*i[0*4+0],b[1]=f*i[0*4+1],b[2]=f*i[0*4+2],b[4]=f*i[1*4+0],b[5]=f*i[1*4+1],b[6]=f*i[1*4+2],i!==b&&(b[8]=i[8],b[9]=i[9],b[10]=i[10]),b}function j(i,f){const d=f??new o(12);return d[0]=i,d[1]=0,d[2]=0,d[4]=0,d[5]=i,d[6]=0,d[8]=0,d[9]=0,d[10]=i,d}function g(i,f,d){const b=d??new o(12);return b[0]=f*i[0*4+0],b[1]=f*i[0*4+1],b[2]=f*i[0*4+2],b[4]=f*i[1*4+0],b[5]=f*i[1*4+1],b[6]=f*i[1*4+2],b[8]=f*i[2*4+0],b[9]=f*i[2*4+1],b[10]=f*i[2*4+2],b}return{add:V,clone:Z,copy:q,create:C,determinant:O,equals:F,equalsApproximately:J,fromMat4:E,fromQuat:M,get3DScaling:Vt,getAxis:Y,getScaling:_t,getTranslation:X,identity:z,inverse:ut,invert:R,mul:lt,mulScalar:L,multiply:U,multiplyScalar:A,negate:G,rotate:kt,rotateX:H,rotateY:It,rotateZ:zt,rotation:pt,rotationX:wt,rotationY:st,rotationZ:Mt,scale:Ot,scale3D:ht,scaling:Tt,scaling3D:xt,set:x,setAxis:et,setTranslation:K,translate:Dt,translation:Rt,transpose:W,uniformScale:B,uniformScale3D:g,uniformScaling:Wt,uniformScaling3D:j}}const Ar=new Map;function Pl(o){let l=Ar.get(o);return l||(l=yl(o),Ar.set(o,l)),l}function Sl(o){const l=Ln(o);function h(r,m,u,p,a,_,w,v,D,N,$,ct,it,rt,ft,yt){const dt=new o(16);return r!==void 0&&(dt[0]=r,m!==void 0&&(dt[1]=m,u!==void 0&&(dt[2]=u,p!==void 0&&(dt[3]=p,a!==void 0&&(dt[4]=a,_!==void 0&&(dt[5]=_,w!==void 0&&(dt[6]=w,v!==void 0&&(dt[7]=v,D!==void 0&&(dt[8]=D,N!==void 0&&(dt[9]=N,$!==void 0&&(dt[10]=$,ct!==void 0&&(dt[11]=ct,it!==void 0&&(dt[12]=it,rt!==void 0&&(dt[13]=rt,ft!==void 0&&(dt[14]=ft,yt!==void 0&&(dt[15]=yt)))))))))))))))),dt}function C(r,m,u,p,a,_,w,v,D,N,$,ct,it,rt,ft,yt,dt){const bt=dt??new o(16);return bt[0]=r,bt[1]=m,bt[2]=u,bt[3]=p,bt[4]=a,bt[5]=_,bt[6]=w,bt[7]=v,bt[8]=D,bt[9]=N,bt[10]=$,bt[11]=ct,bt[12]=it,bt[13]=rt,bt[14]=ft,bt[15]=yt,bt}function x(r,m){const u=m??new o(16);return u[0]=r[0],u[1]=r[1],u[2]=r[2],u[3]=0,u[4]=r[4],u[5]=r[5],u[6]=r[6],u[7]=0,u[8]=r[8],u[9]=r[9],u[10]=r[10],u[11]=0,u[12]=0,u[13]=0,u[14]=0,u[15]=1,u}function E(r,m){const u=m??new o(16),p=r[0],a=r[1],_=r[2],w=r[3],v=p+p,D=a+a,N=_+_,$=p*v,ct=a*v,it=a*D,rt=_*v,ft=_*D,yt=_*N,dt=w*v,bt=w*D,Ct=w*N;return u[0]=1-it-yt,u[1]=ct+Ct,u[2]=rt-bt,u[3]=0,u[4]=ct-Ct,u[5]=1-$-yt,u[6]=ft+dt,u[7]=0,u[8]=rt+bt,u[9]=ft-dt,u[10]=1-$-it,u[11]=0,u[12]=0,u[13]=0,u[14]=0,u[15]=1,u}function M(r,m){const u=m??new o(16);return u[0]=-r[0],u[1]=-r[1],u[2]=-r[2],u[3]=-r[3],u[4]=-r[4],u[5]=-r[5],u[6]=-r[6],u[7]=-r[7],u[8]=-r[8],u[9]=-r[9],u[10]=-r[10],u[11]=-r[11],u[12]=-r[12],u[13]=-r[13],u[14]=-r[14],u[15]=-r[15],u}function G(r,m,u){const p=u??new o(16);return p[0]=r[0]+m[0],p[1]=r[1]+m[1],p[2]=r[2]+m[2],p[3]=r[3]+m[3],p[4]=r[4]+m[4],p[5]=r[5]+m[5],p[6]=r[6]+m[6],p[7]=r[7]+m[7],p[8]=r[8]+m[8],p[9]=r[9]+m[9],p[10]=r[10]+m[10],p[11]=r[11]+m[11],p[12]=r[12]+m[12],p[13]=r[13]+m[13],p[14]=r[14]+m[14],p[15]=r[15]+m[15],p}function A(r,m,u){const p=u??new o(16);return p[0]=r[0]*m,p[1]=r[1]*m,p[2]=r[2]*m,p[3]=r[3]*m,p[4]=r[4]*m,p[5]=r[5]*m,p[6]=r[6]*m,p[7]=r[7]*m,p[8]=r[8]*m,p[9]=r[9]*m,p[10]=r[10]*m,p[11]=r[11]*m,p[12]=r[12]*m,p[13]=r[13]*m,p[14]=r[14]*m,p[15]=r[15]*m,p}const L=A;function V(r,m){const u=m??new o(16);return u[0]=r[0],u[1]=r[1],u[2]=r[2],u[3]=r[3],u[4]=r[4],u[5]=r[5],u[6]=r[6],u[7]=r[7],u[8]=r[8],u[9]=r[9],u[10]=r[10],u[11]=r[11],u[12]=r[12],u[13]=r[13],u[14]=r[14],u[15]=r[15],u}const q=V;function Z(r,m){return Math.abs(r[0]-m[0])<Lt&&Math.abs(r[1]-m[1])<Lt&&Math.abs(r[2]-m[2])<Lt&&Math.abs(r[3]-m[3])<Lt&&Math.abs(r[4]-m[4])<Lt&&Math.abs(r[5]-m[5])<Lt&&Math.abs(r[6]-m[6])<Lt&&Math.abs(r[7]-m[7])<Lt&&Math.abs(r[8]-m[8])<Lt&&Math.abs(r[9]-m[9])<Lt&&Math.abs(r[10]-m[10])<Lt&&Math.abs(r[11]-m[11])<Lt&&Math.abs(r[12]-m[12])<Lt&&Math.abs(r[13]-m[13])<Lt&&Math.abs(r[14]-m[14])<Lt&&Math.abs(r[15]-m[15])<Lt}function J(r,m){return r[0]===m[0]&&r[1]===m[1]&&r[2]===m[2]&&r[3]===m[3]&&r[4]===m[4]&&r[5]===m[5]&&r[6]===m[6]&&r[7]===m[7]&&r[8]===m[8]&&r[9]===m[9]&&r[10]===m[10]&&r[11]===m[11]&&r[12]===m[12]&&r[13]===m[13]&&r[14]===m[14]&&r[15]===m[15]}function F(r){const m=r??new o(16);return m[0]=1,m[1]=0,m[2]=0,m[3]=0,m[4]=0,m[5]=1,m[6]=0,m[7]=0,m[8]=0,m[9]=0,m[10]=1,m[11]=0,m[12]=0,m[13]=0,m[14]=0,m[15]=1,m}function z(r,m){const u=m??new o(16);if(u===r){let At;return At=r[1],r[1]=r[4],r[4]=At,At=r[2],r[2]=r[8],r[8]=At,At=r[3],r[3]=r[12],r[12]=At,At=r[6],r[6]=r[9],r[9]=At,At=r[7],r[7]=r[13],r[13]=At,At=r[11],r[11]=r[14],r[14]=At,u}const p=r[0*4+0],a=r[0*4+1],_=r[0*4+2],w=r[0*4+3],v=r[1*4+0],D=r[1*4+1],N=r[1*4+2],$=r[1*4+3],ct=r[2*4+0],it=r[2*4+1],rt=r[2*4+2],ft=r[2*4+3],yt=r[3*4+0],dt=r[3*4+1],bt=r[3*4+2],Ct=r[3*4+3];return u[0]=p,u[1]=v,u[2]=ct,u[3]=yt,u[4]=a,u[5]=D,u[6]=it,u[7]=dt,u[8]=_,u[9]=N,u[10]=rt,u[11]=bt,u[12]=w,u[13]=$,u[14]=ft,u[15]=Ct,u}function W(r,m){const u=m??new o(16),p=r[0*4+0],a=r[0*4+1],_=r[0*4+2],w=r[0*4+3],v=r[1*4+0],D=r[1*4+1],N=r[1*4+2],$=r[1*4+3],ct=r[2*4+0],it=r[2*4+1],rt=r[2*4+2],ft=r[2*4+3],yt=r[3*4+0],dt=r[3*4+1],bt=r[3*4+2],Ct=r[3*4+3],At=rt*Ct,Q=bt*ft,at=N*Ct,ot=bt*$,gt=N*ft,Pt=rt*$,Et=_*Ct,mt=bt*w,vt=_*ft,Gt=rt*w,Ut=_*$,qt=N*w,Kt=ct*dt,Xt=yt*it,Ht=v*dt,ee=yt*D,Qt=v*it,be=ct*D,fe=p*dt,_e=yt*a,me=p*it,ve=ct*a,Jt=p*D,ue=v*a,ge=At*D+ot*it+gt*dt-(Q*D+at*it+Pt*dt),oe=Q*a+Et*it+Gt*dt-(At*a+mt*it+vt*dt),we=at*a+mt*D+Ut*dt-(ot*a+Et*D+qt*dt),xe=Pt*a+vt*D+qt*it-(gt*a+Gt*D+Ut*it),Yt=1/(p*ge+v*oe+ct*we+yt*xe);return u[0]=Yt*ge,u[1]=Yt*oe,u[2]=Yt*we,u[3]=Yt*xe,u[4]=Yt*(Q*v+at*ct+Pt*yt-(At*v+ot*ct+gt*yt)),u[5]=Yt*(At*p+mt*ct+vt*yt-(Q*p+Et*ct+Gt*yt)),u[6]=Yt*(ot*p+Et*v+qt*yt-(at*p+mt*v+Ut*yt)),u[7]=Yt*(gt*p+Gt*v+Ut*ct-(Pt*p+vt*v+qt*ct)),u[8]=Yt*(Kt*$+ee*ft+Qt*Ct-(Xt*$+Ht*ft+be*Ct)),u[9]=Yt*(Xt*w+fe*ft+ve*Ct-(Kt*w+_e*ft+me*Ct)),u[10]=Yt*(Ht*w+_e*$+Jt*Ct-(ee*w+fe*$+ue*Ct)),u[11]=Yt*(be*w+me*$+ue*ft-(Qt*w+ve*$+Jt*ft)),u[12]=Yt*(Ht*rt+be*bt+Xt*N-(Qt*bt+Kt*N+ee*rt)),u[13]=Yt*(me*bt+Kt*_+_e*rt-(fe*rt+ve*bt+Xt*_)),u[14]=Yt*(fe*N+ue*bt+ee*_-(Jt*bt+Ht*_+_e*N)),u[15]=Yt*(Jt*rt+Qt*_+ve*N-(me*N+ue*rt+be*_)),u}function ut(r){const m=r[0],u=r[0*4+1],p=r[0*4+2],a=r[0*4+3],_=r[1*4+0],w=r[1*4+1],v=r[1*4+2],D=r[1*4+3],N=r[2*4+0],$=r[2*4+1],ct=r[2*4+2],it=r[2*4+3],rt=r[3*4+0],ft=r[3*4+1],yt=r[3*4+2],dt=r[3*4+3],bt=ct*dt,Ct=yt*it,At=v*dt,Q=yt*D,at=v*it,ot=ct*D,gt=p*dt,Pt=yt*a,Et=p*it,mt=ct*a,vt=p*D,Gt=v*a,Ut=bt*w+Q*$+at*ft-(Ct*w+At*$+ot*ft),qt=Ct*u+gt*$+mt*ft-(bt*u+Pt*$+Et*ft),Kt=At*u+Pt*w+vt*ft-(Q*u+gt*w+Gt*ft),Xt=ot*u+Et*w+Gt*$-(at*u+mt*w+vt*$);return m*Ut+_*qt+N*Kt+rt*Xt}const O=W;function R(r,m,u){const p=u??new o(16),a=r[0],_=r[1],w=r[2],v=r[3],D=r[4+0],N=r[4+1],$=r[4+2],ct=r[4+3],it=r[8+0],rt=r[8+1],ft=r[8+2],yt=r[8+3],dt=r[12+0],bt=r[12+1],Ct=r[12+2],At=r[12+3],Q=m[0],at=m[1],ot=m[2],gt=m[3],Pt=m[4+0],Et=m[4+1],mt=m[4+2],vt=m[4+3],Gt=m[8+0],Ut=m[8+1],qt=m[8+2],Kt=m[8+3],Xt=m[12+0],Ht=m[12+1],ee=m[12+2],Qt=m[12+3];return p[0]=a*Q+D*at+it*ot+dt*gt,p[1]=_*Q+N*at+rt*ot+bt*gt,p[2]=w*Q+$*at+ft*ot+Ct*gt,p[3]=v*Q+ct*at+yt*ot+At*gt,p[4]=a*Pt+D*Et+it*mt+dt*vt,p[5]=_*Pt+N*Et+rt*mt+bt*vt,p[6]=w*Pt+$*Et+ft*mt+Ct*vt,p[7]=v*Pt+ct*Et+yt*mt+At*vt,p[8]=a*Gt+D*Ut+it*qt+dt*Kt,p[9]=_*Gt+N*Ut+rt*qt+bt*Kt,p[10]=w*Gt+$*Ut+ft*qt+Ct*Kt,p[11]=v*Gt+ct*Ut+yt*qt+At*Kt,p[12]=a*Xt+D*Ht+it*ee+dt*Qt,p[13]=_*Xt+N*Ht+rt*ee+bt*Qt,p[14]=w*Xt+$*Ht+ft*ee+Ct*Qt,p[15]=v*Xt+ct*Ht+yt*ee+At*Qt,p}const U=R;function lt(r,m,u){const p=u??F();return r!==p&&(p[0]=r[0],p[1]=r[1],p[2]=r[2],p[3]=r[3],p[4]=r[4],p[5]=r[5],p[6]=r[6],p[7]=r[7],p[8]=r[8],p[9]=r[9],p[10]=r[10],p[11]=r[11]),p[12]=m[0],p[13]=m[1],p[14]=m[2],p[15]=1,p}function K(r,m){const u=m??l.create();return u[0]=r[12],u[1]=r[13],u[2]=r[14],u}function X(r,m,u){const p=u??l.create(),a=m*4;return p[0]=r[a+0],p[1]=r[a+1],p[2]=r[a+2],p}function Y(r,m,u,p){const a=p===r?p:V(r,p),_=u*4;return a[_+0]=m[0],a[_+1]=m[1],a[_+2]=m[2],a}function et(r,m){const u=m??l.create(),p=r[0],a=r[1],_=r[2],w=r[4],v=r[5],D=r[6],N=r[8],$=r[9],ct=r[10];return u[0]=Math.sqrt(p*p+a*a+_*_),u[1]=Math.sqrt(w*w+v*v+D*D),u[2]=Math.sqrt(N*N+$*$+ct*ct),u}function _t(r,m,u,p,a){const _=a??new o(16),w=Math.tan(Math.PI*.5-.5*r);if(_[0]=w/m,_[1]=0,_[2]=0,_[3]=0,_[4]=0,_[5]=w,_[6]=0,_[7]=0,_[8]=0,_[9]=0,_[11]=-1,_[12]=0,_[13]=0,_[15]=0,Number.isFinite(p)){const v=1/(u-p);_[10]=p*v,_[14]=p*u*v}else _[10]=-1,_[14]=-u;return _}function Vt(r,m,u,p=1/0,a){const _=a??new o(16),w=1/Math.tan(r*.5);if(_[0]=w/m,_[1]=0,_[2]=0,_[3]=0,_[4]=0,_[5]=w,_[6]=0,_[7]=0,_[8]=0,_[9]=0,_[11]=-1,_[12]=0,_[13]=0,_[15]=0,p===1/0)_[10]=0,_[14]=u;else{const v=1/(p-u);_[10]=u*v,_[14]=p*u*v}return _}function Rt(r,m,u,p,a,_,w){const v=w??new o(16);return v[0]=2/(m-r),v[1]=0,v[2]=0,v[3]=0,v[4]=0,v[5]=2/(p-u),v[6]=0,v[7]=0,v[8]=0,v[9]=0,v[10]=1/(a-_),v[11]=0,v[12]=(m+r)/(r-m),v[13]=(p+u)/(u-p),v[14]=a/(a-_),v[15]=1,v}function Dt(r,m,u,p,a,_,w){const v=w??new o(16),D=m-r,N=p-u,$=a-_;return v[0]=2*a/D,v[1]=0,v[2]=0,v[3]=0,v[4]=0,v[5]=2*a/N,v[6]=0,v[7]=0,v[8]=(r+m)/D,v[9]=(p+u)/N,v[10]=_/$,v[11]=-1,v[12]=0,v[13]=0,v[14]=a*_/$,v[15]=0,v}function pt(r,m,u,p,a,_=1/0,w){const v=w??new o(16),D=m-r,N=p-u;if(v[0]=2*a/D,v[1]=0,v[2]=0,v[3]=0,v[4]=0,v[5]=2*a/N,v[6]=0,v[7]=0,v[8]=(r+m)/D,v[9]=(p+u)/N,v[11]=-1,v[12]=0,v[13]=0,v[15]=0,_===1/0)v[10]=0,v[14]=a;else{const $=1/(_-a);v[10]=a*$,v[14]=_*a*$}return v}const kt=l.create(),wt=l.create(),H=l.create();function st(r,m,u,p){const a=p??new o(16);return l.normalize(l.subtract(m,r,H),H),l.normalize(l.cross(u,H,kt),kt),l.normalize(l.cross(H,kt,wt),wt),a[0]=kt[0],a[1]=kt[1],a[2]=kt[2],a[3]=0,a[4]=wt[0],a[5]=wt[1],a[6]=wt[2],a[7]=0,a[8]=H[0],a[9]=H[1],a[10]=H[2],a[11]=0,a[12]=r[0],a[13]=r[1],a[14]=r[2],a[15]=1,a}function It(r,m,u,p){const a=p??new o(16);return l.normalize(l.subtract(r,m,H),H),l.normalize(l.cross(u,H,kt),kt),l.normalize(l.cross(H,kt,wt),wt),a[0]=kt[0],a[1]=kt[1],a[2]=kt[2],a[3]=0,a[4]=wt[0],a[5]=wt[1],a[6]=wt[2],a[7]=0,a[8]=H[0],a[9]=H[1],a[10]=H[2],a[11]=0,a[12]=r[0],a[13]=r[1],a[14]=r[2],a[15]=1,a}function Mt(r,m,u,p){const a=p??new o(16);return l.normalize(l.subtract(r,m,H),H),l.normalize(l.cross(u,H,kt),kt),l.normalize(l.cross(H,kt,wt),wt),a[0]=kt[0],a[1]=wt[0],a[2]=H[0],a[3]=0,a[4]=kt[1],a[5]=wt[1],a[6]=H[1],a[7]=0,a[8]=kt[2],a[9]=wt[2],a[10]=H[2],a[11]=0,a[12]=-(kt[0]*r[0]+kt[1]*r[1]+kt[2]*r[2]),a[13]=-(wt[0]*r[0]+wt[1]*r[1]+wt[2]*r[2]),a[14]=-(H[0]*r[0]+H[1]*r[1]+H[2]*r[2]),a[15]=1,a}function zt(r,m){const u=m??new o(16);return u[0]=1,u[1]=0,u[2]=0,u[3]=0,u[4]=0,u[5]=1,u[6]=0,u[7]=0,u[8]=0,u[9]=0,u[10]=1,u[11]=0,u[12]=r[0],u[13]=r[1],u[14]=r[2],u[15]=1,u}function Tt(r,m,u){const p=u??new o(16),a=m[0],_=m[1],w=m[2],v=r[0],D=r[1],N=r[2],$=r[3],ct=r[1*4+0],it=r[1*4+1],rt=r[1*4+2],ft=r[1*4+3],yt=r[2*4+0],dt=r[2*4+1],bt=r[2*4+2],Ct=r[2*4+3],At=r[3*4+0],Q=r[3*4+1],at=r[3*4+2],ot=r[3*4+3];return r!==p&&(p[0]=v,p[1]=D,p[2]=N,p[3]=$,p[4]=ct,p[5]=it,p[6]=rt,p[7]=ft,p[8]=yt,p[9]=dt,p[10]=bt,p[11]=Ct),p[12]=v*a+ct*_+yt*w+At,p[13]=D*a+it*_+dt*w+Q,p[14]=N*a+rt*_+bt*w+at,p[15]=$*a+ft*_+Ct*w+ot,p}function Ot(r,m){const u=m??new o(16),p=Math.cos(r),a=Math.sin(r);return u[0]=1,u[1]=0,u[2]=0,u[3]=0,u[4]=0,u[5]=p,u[6]=a,u[7]=0,u[8]=0,u[9]=-a,u[10]=p,u[11]=0,u[12]=0,u[13]=0,u[14]=0,u[15]=1,u}function xt(r,m,u){const p=u??new o(16),a=r[4],_=r[5],w=r[6],v=r[7],D=r[8],N=r[9],$=r[10],ct=r[11],it=Math.cos(m),rt=Math.sin(m);return p[4]=it*a+rt*D,p[5]=it*_+rt*N,p[6]=it*w+rt*$,p[7]=it*v+rt*ct,p[8]=it*D-rt*a,p[9]=it*N-rt*_,p[10]=it*$-rt*w,p[11]=it*ct-rt*v,r!==p&&(p[0]=r[0],p[1]=r[1],p[2]=r[2],p[3]=r[3],p[12]=r[12],p[13]=r[13],p[14]=r[14],p[15]=r[15]),p}function ht(r,m){const u=m??new o(16),p=Math.cos(r),a=Math.sin(r);return u[0]=p,u[1]=0,u[2]=-a,u[3]=0,u[4]=0,u[5]=1,u[6]=0,u[7]=0,u[8]=a,u[9]=0,u[10]=p,u[11]=0,u[12]=0,u[13]=0,u[14]=0,u[15]=1,u}function Wt(r,m,u){const p=u??new o(16),a=r[0*4+0],_=r[0*4+1],w=r[0*4+2],v=r[0*4+3],D=r[2*4+0],N=r[2*4+1],$=r[2*4+2],ct=r[2*4+3],it=Math.cos(m),rt=Math.sin(m);return p[0]=it*a-rt*D,p[1]=it*_-rt*N,p[2]=it*w-rt*$,p[3]=it*v-rt*ct,p[8]=it*D+rt*a,p[9]=it*N+rt*_,p[10]=it*$+rt*w,p[11]=it*ct+rt*v,r!==p&&(p[4]=r[4],p[5]=r[5],p[6]=r[6],p[7]=r[7],p[12]=r[12],p[13]=r[13],p[14]=r[14],p[15]=r[15]),p}function B(r,m){const u=m??new o(16),p=Math.cos(r),a=Math.sin(r);return u[0]=p,u[1]=a,u[2]=0,u[3]=0,u[4]=-a,u[5]=p,u[6]=0,u[7]=0,u[8]=0,u[9]=0,u[10]=1,u[11]=0,u[12]=0,u[13]=0,u[14]=0,u[15]=1,u}function j(r,m,u){const p=u??new o(16),a=r[0*4+0],_=r[0*4+1],w=r[0*4+2],v=r[0*4+3],D=r[1*4+0],N=r[1*4+1],$=r[1*4+2],ct=r[1*4+3],it=Math.cos(m),rt=Math.sin(m);return p[0]=it*a+rt*D,p[1]=it*_+rt*N,p[2]=it*w+rt*$,p[3]=it*v+rt*ct,p[4]=it*D-rt*a,p[5]=it*N-rt*_,p[6]=it*$-rt*w,p[7]=it*ct-rt*v,r!==p&&(p[8]=r[8],p[9]=r[9],p[10]=r[10],p[11]=r[11],p[12]=r[12],p[13]=r[13],p[14]=r[14],p[15]=r[15]),p}function g(r,m,u){const p=u??new o(16);let a=r[0],_=r[1],w=r[2];const v=Math.sqrt(a*a+_*_+w*w);a/=v,_/=v,w/=v;const D=a*a,N=_*_,$=w*w,ct=Math.cos(m),it=Math.sin(m),rt=1-ct;return p[0]=D+(1-D)*ct,p[1]=a*_*rt+w*it,p[2]=a*w*rt-_*it,p[3]=0,p[4]=a*_*rt-w*it,p[5]=N+(1-N)*ct,p[6]=_*w*rt+a*it,p[7]=0,p[8]=a*w*rt+_*it,p[9]=_*w*rt-a*it,p[10]=$+(1-$)*ct,p[11]=0,p[12]=0,p[13]=0,p[14]=0,p[15]=1,p}const i=g;function f(r,m,u,p){const a=p??new o(16);let _=m[0],w=m[1],v=m[2];const D=Math.sqrt(_*_+w*w+v*v);_/=D,w/=D,v/=D;const N=_*_,$=w*w,ct=v*v,it=Math.cos(u),rt=Math.sin(u),ft=1-it,yt=N+(1-N)*it,dt=_*w*ft+v*rt,bt=_*v*ft-w*rt,Ct=_*w*ft-v*rt,At=$+(1-$)*it,Q=w*v*ft+_*rt,at=_*v*ft+w*rt,ot=w*v*ft-_*rt,gt=ct+(1-ct)*it,Pt=r[0],Et=r[1],mt=r[2],vt=r[3],Gt=r[4],Ut=r[5],qt=r[6],Kt=r[7],Xt=r[8],Ht=r[9],ee=r[10],Qt=r[11];return a[0]=yt*Pt+dt*Gt+bt*Xt,a[1]=yt*Et+dt*Ut+bt*Ht,a[2]=yt*mt+dt*qt+bt*ee,a[3]=yt*vt+dt*Kt+bt*Qt,a[4]=Ct*Pt+At*Gt+Q*Xt,a[5]=Ct*Et+At*Ut+Q*Ht,a[6]=Ct*mt+At*qt+Q*ee,a[7]=Ct*vt+At*Kt+Q*Qt,a[8]=at*Pt+ot*Gt+gt*Xt,a[9]=at*Et+ot*Ut+gt*Ht,a[10]=at*mt+ot*qt+gt*ee,a[11]=at*vt+ot*Kt+gt*Qt,r!==a&&(a[12]=r[12],a[13]=r[13],a[14]=r[14],a[15]=r[15]),a}const d=f;function b(r,m){const u=m??new o(16);return u[0]=r[0],u[1]=0,u[2]=0,u[3]=0,u[4]=0,u[5]=r[1],u[6]=0,u[7]=0,u[8]=0,u[9]=0,u[10]=r[2],u[11]=0,u[12]=0,u[13]=0,u[14]=0,u[15]=1,u}function y(r,m,u){const p=u??new o(16),a=m[0],_=m[1],w=m[2];return p[0]=a*r[0*4+0],p[1]=a*r[0*4+1],p[2]=a*r[0*4+2],p[3]=a*r[0*4+3],p[4]=_*r[1*4+0],p[5]=_*r[1*4+1],p[6]=_*r[1*4+2],p[7]=_*r[1*4+3],p[8]=w*r[2*4+0],p[9]=w*r[2*4+1],p[10]=w*r[2*4+2],p[11]=w*r[2*4+3],r!==p&&(p[12]=r[12],p[13]=r[13],p[14]=r[14],p[15]=r[15]),p}function S(r,m){const u=m??new o(16);return u[0]=r,u[1]=0,u[2]=0,u[3]=0,u[4]=0,u[5]=r,u[6]=0,u[7]=0,u[8]=0,u[9]=0,u[10]=r,u[11]=0,u[12]=0,u[13]=0,u[14]=0,u[15]=1,u}function k(r,m,u){const p=u??new o(16);return p[0]=m*r[0*4+0],p[1]=m*r[0*4+1],p[2]=m*r[0*4+2],p[3]=m*r[0*4+3],p[4]=m*r[1*4+0],p[5]=m*r[1*4+1],p[6]=m*r[1*4+2],p[7]=m*r[1*4+3],p[8]=m*r[2*4+0],p[9]=m*r[2*4+1],p[10]=m*r[2*4+2],p[11]=m*r[2*4+3],r!==p&&(p[12]=r[12],p[13]=r[13],p[14]=r[14],p[15]=r[15]),p}return{add:G,aim:st,axisRotate:f,axisRotation:g,cameraAim:It,clone:q,copy:V,create:h,determinant:ut,equals:J,equalsApproximately:Z,fromMat3:x,fromQuat:E,frustum:Dt,frustumReverseZ:pt,getAxis:X,getScaling:et,getTranslation:K,identity:F,inverse:W,invert:O,lookAt:Mt,mul:U,mulScalar:L,multiply:R,multiplyScalar:A,negate:M,ortho:Rt,perspective:_t,perspectiveReverseZ:Vt,rotate:d,rotateX:xt,rotateY:Wt,rotateZ:j,rotation:i,rotationX:Ot,rotationY:ht,rotationZ:B,scale:y,scaling:b,set:C,setAxis:Y,setTranslation:lt,translate:Tt,translation:zt,transpose:z,uniformScale:k,uniformScaling:S}}const Rr=new Map;function kl(o){let l=Rr.get(o);return l||(l=Sl(o),Rr.set(o,l)),l}function Cl(o){const l=Ln(o);function h(B,j,g,i){const f=new o(4);return B!==void 0&&(f[0]=B,j!==void 0&&(f[1]=j,g!==void 0&&(f[2]=g,i!==void 0&&(f[3]=i)))),f}const C=h;function x(B,j,g,i,f){const d=f??new o(4);return d[0]=B,d[1]=j,d[2]=g,d[3]=i,d}function E(B,j,g){const i=g??new o(4),f=j*.5,d=Math.sin(f);return i[0]=d*B[0],i[1]=d*B[1],i[2]=d*B[2],i[3]=Math.cos(f),i}function M(B,j){const g=j??l.create(3),i=Math.acos(B[3])*2,f=Math.sin(i*.5);return f>Lt?(g[0]=B[0]/f,g[1]=B[1]/f,g[2]=B[2]/f):(g[0]=1,g[1]=0,g[2]=0),{angle:i,axis:g}}function G(B,j){const g=_t(B,j);return Math.acos(2*g*g-1)}function A(B,j,g){const i=g??new o(4),f=B[0],d=B[1],b=B[2],y=B[3],S=j[0],k=j[1],r=j[2],m=j[3];return i[0]=f*m+y*S+d*r-b*k,i[1]=d*m+y*k+b*S-f*r,i[2]=b*m+y*r+f*k-d*S,i[3]=y*m-f*S-d*k-b*r,i}const L=A;function V(B,j,g){const i=g??new o(4),f=j*.5,d=B[0],b=B[1],y=B[2],S=B[3],k=Math.sin(f),r=Math.cos(f);return i[0]=d*r+S*k,i[1]=b*r+y*k,i[2]=y*r-b*k,i[3]=S*r-d*k,i}function q(B,j,g){const i=g??new o(4),f=j*.5,d=B[0],b=B[1],y=B[2],S=B[3],k=Math.sin(f),r=Math.cos(f);return i[0]=d*r-y*k,i[1]=b*r+S*k,i[2]=y*r+d*k,i[3]=S*r-b*k,i}function Z(B,j,g){const i=g??new o(4),f=j*.5,d=B[0],b=B[1],y=B[2],S=B[3],k=Math.sin(f),r=Math.cos(f);return i[0]=d*r+b*k,i[1]=b*r-d*k,i[2]=y*r+S*k,i[3]=S*r-y*k,i}function J(B,j,g,i){const f=i??new o(4),d=B[0],b=B[1],y=B[2],S=B[3];let k=j[0],r=j[1],m=j[2],u=j[3],p=d*k+b*r+y*m+S*u;p<0&&(p=-p,k=-k,r=-r,m=-m,u=-u);let a,_;if(1-p>Lt){const w=Math.acos(p),v=Math.sin(w);a=Math.sin((1-g)*w)/v,_=Math.sin(g*w)/v}else a=1-g,_=g;return f[0]=a*d+_*k,f[1]=a*b+_*r,f[2]=a*y+_*m,f[3]=a*S+_*u,f}function F(B,j){const g=j??new o(4),i=B[0],f=B[1],d=B[2],b=B[3],y=i*i+f*f+d*d+b*b,S=y?1/y:0;return g[0]=-i*S,g[1]=-f*S,g[2]=-d*S,g[3]=b*S,g}function z(B,j){const g=j??new o(4);return g[0]=-B[0],g[1]=-B[1],g[2]=-B[2],g[3]=B[3],g}function W(B,j){const g=j??new o(4),i=B[0]+B[5]+B[10];if(i>0){const f=Math.sqrt(i+1);g[3]=.5*f;const d=.5/f;g[0]=(B[6]-B[9])*d,g[1]=(B[8]-B[2])*d,g[2]=(B[1]-B[4])*d}else{let f=0;B[5]>B[0]&&(f=1),B[10]>B[f*4+f]&&(f=2);const d=(f+1)%3,b=(f+2)%3,y=Math.sqrt(B[f*4+f]-B[d*4+d]-B[b*4+b]+1);g[f]=.5*y;const S=.5/y;g[3]=(B[d*4+b]-B[b*4+d])*S,g[d]=(B[d*4+f]+B[f*4+d])*S,g[b]=(B[b*4+f]+B[f*4+b])*S}return g}function ut(B,j,g,i,f){const d=f??new o(4),b=B*.5,y=j*.5,S=g*.5,k=Math.sin(b),r=Math.cos(b),m=Math.sin(y),u=Math.cos(y),p=Math.sin(S),a=Math.cos(S);switch(i){case"xyz":d[0]=k*u*a+r*m*p,d[1]=r*m*a-k*u*p,d[2]=r*u*p+k*m*a,d[3]=r*u*a-k*m*p;break;case"xzy":d[0]=k*u*a-r*m*p,d[1]=r*m*a-k*u*p,d[2]=r*u*p+k*m*a,d[3]=r*u*a+k*m*p;break;case"yxz":d[0]=k*u*a+r*m*p,d[1]=r*m*a-k*u*p,d[2]=r*u*p-k*m*a,d[3]=r*u*a+k*m*p;break;case"yzx":d[0]=k*u*a+r*m*p,d[1]=r*m*a+k*u*p,d[2]=r*u*p-k*m*a,d[3]=r*u*a-k*m*p;break;case"zxy":d[0]=k*u*a-r*m*p,d[1]=r*m*a+k*u*p,d[2]=r*u*p+k*m*a,d[3]=r*u*a-k*m*p;break;case"zyx":d[0]=k*u*a-r*m*p,d[1]=r*m*a+k*u*p,d[2]=r*u*p-k*m*a,d[3]=r*u*a+k*m*p;break;default:throw new Error(`Unknown rotation order: ${i}`)}return d}function O(B,j){const g=j??new o(4);return g[0]=B[0],g[1]=B[1],g[2]=B[2],g[3]=B[3],g}const R=O;function U(B,j,g){const i=g??new o(4);return i[0]=B[0]+j[0],i[1]=B[1]+j[1],i[2]=B[2]+j[2],i[3]=B[3]+j[3],i}function lt(B,j,g){const i=g??new o(4);return i[0]=B[0]-j[0],i[1]=B[1]-j[1],i[2]=B[2]-j[2],i[3]=B[3]-j[3],i}const K=lt;function X(B,j,g){const i=g??new o(4);return i[0]=B[0]*j,i[1]=B[1]*j,i[2]=B[2]*j,i[3]=B[3]*j,i}const Y=X;function et(B,j,g){const i=g??new o(4);return i[0]=B[0]/j,i[1]=B[1]/j,i[2]=B[2]/j,i[3]=B[3]/j,i}function _t(B,j){return B[0]*j[0]+B[1]*j[1]+B[2]*j[2]+B[3]*j[3]}function Vt(B,j,g,i){const f=i??new o(4);return f[0]=B[0]+g*(j[0]-B[0]),f[1]=B[1]+g*(j[1]-B[1]),f[2]=B[2]+g*(j[2]-B[2]),f[3]=B[3]+g*(j[3]-B[3]),f}function Rt(B){const j=B[0],g=B[1],i=B[2],f=B[3];return Math.sqrt(j*j+g*g+i*i+f*f)}const Dt=Rt;function pt(B){const j=B[0],g=B[1],i=B[2],f=B[3];return j*j+g*g+i*i+f*f}const kt=pt;function wt(B,j){const g=j??new o(4),i=B[0],f=B[1],d=B[2],b=B[3],y=Math.sqrt(i*i+f*f+d*d+b*b);return y>1e-5?(g[0]=i/y,g[1]=f/y,g[2]=d/y,g[3]=b/y):(g[0]=0,g[1]=0,g[2]=0,g[3]=1),g}function H(B,j){return Math.abs(B[0]-j[0])<Lt&&Math.abs(B[1]-j[1])<Lt&&Math.abs(B[2]-j[2])<Lt&&Math.abs(B[3]-j[3])<Lt}function st(B,j){return B[0]===j[0]&&B[1]===j[1]&&B[2]===j[2]&&B[3]===j[3]}function It(B){const j=B??new o(4);return j[0]=0,j[1]=0,j[2]=0,j[3]=1,j}const Mt=l.create(),zt=l.create(),Tt=l.create();function Ot(B,j,g){const i=g??new o(4),f=l.dot(B,j);return f<-.999999?(l.cross(zt,B,Mt),l.len(Mt)<1e-6&&l.cross(Tt,B,Mt),l.normalize(Mt,Mt),E(Mt,Math.PI,i),i):f>.999999?(i[0]=0,i[1]=0,i[2]=0,i[3]=1,i):(l.cross(B,j,Mt),i[0]=Mt[0],i[1]=Mt[1],i[2]=Mt[2],i[3]=1+f,wt(i,i))}const xt=new o(4),ht=new o(4);function Wt(B,j,g,i,f,d){const b=d??new o(4);return J(B,i,f,xt),J(j,g,f,ht),J(xt,ht,2*f*(1-f),b),b}return{create:h,fromValues:C,set:x,fromAxisAngle:E,toAxisAngle:M,angle:G,multiply:A,mul:L,rotateX:V,rotateY:q,rotateZ:Z,slerp:J,inverse:F,conjugate:z,fromMat:W,fromEuler:ut,copy:O,clone:R,add:U,subtract:lt,sub:K,mulScalar:X,scale:Y,divScalar:et,dot:_t,lerp:Vt,length:Rt,len:Dt,lengthSq:pt,lenSq:kt,normalize:wt,equalsApproximately:H,equals:st,identity:It,rotationTo:Ot,sqlerp:Wt}}const Ir=new Map;function El(o){let l=Ir.get(o);return l||(l=Cl(o),Ir.set(o,l)),l}function Ml(o){function l(g,i,f,d){const b=new o(4);return g!==void 0&&(b[0]=g,i!==void 0&&(b[1]=i,f!==void 0&&(b[2]=f,d!==void 0&&(b[3]=d)))),b}const h=l;function C(g,i,f,d,b){const y=b??new o(4);return y[0]=g,y[1]=i,y[2]=f,y[3]=d,y}function x(g,i){const f=i??new o(4);return f[0]=Math.ceil(g[0]),f[1]=Math.ceil(g[1]),f[2]=Math.ceil(g[2]),f[3]=Math.ceil(g[3]),f}function E(g,i){const f=i??new o(4);return f[0]=Math.floor(g[0]),f[1]=Math.floor(g[1]),f[2]=Math.floor(g[2]),f[3]=Math.floor(g[3]),f}function M(g,i){const f=i??new o(4);return f[0]=Math.round(g[0]),f[1]=Math.round(g[1]),f[2]=Math.round(g[2]),f[3]=Math.round(g[3]),f}function G(g,i=0,f=1,d){const b=d??new o(4);return b[0]=Math.min(f,Math.max(i,g[0])),b[1]=Math.min(f,Math.max(i,g[1])),b[2]=Math.min(f,Math.max(i,g[2])),b[3]=Math.min(f,Math.max(i,g[3])),b}function A(g,i,f){const d=f??new o(4);return d[0]=g[0]+i[0],d[1]=g[1]+i[1],d[2]=g[2]+i[2],d[3]=g[3]+i[3],d}function L(g,i,f,d){const b=d??new o(4);return b[0]=g[0]+i[0]*f,b[1]=g[1]+i[1]*f,b[2]=g[2]+i[2]*f,b[3]=g[3]+i[3]*f,b}function V(g,i,f){const d=f??new o(4);return d[0]=g[0]-i[0],d[1]=g[1]-i[1],d[2]=g[2]-i[2],d[3]=g[3]-i[3],d}const q=V;function Z(g,i){return Math.abs(g[0]-i[0])<Lt&&Math.abs(g[1]-i[1])<Lt&&Math.abs(g[2]-i[2])<Lt&&Math.abs(g[3]-i[3])<Lt}function J(g,i){return g[0]===i[0]&&g[1]===i[1]&&g[2]===i[2]&&g[3]===i[3]}function F(g,i,f,d){const b=d??new o(4);return b[0]=g[0]+f*(i[0]-g[0]),b[1]=g[1]+f*(i[1]-g[1]),b[2]=g[2]+f*(i[2]-g[2]),b[3]=g[3]+f*(i[3]-g[3]),b}function z(g,i,f,d){const b=d??new o(4);return b[0]=g[0]+f[0]*(i[0]-g[0]),b[1]=g[1]+f[1]*(i[1]-g[1]),b[2]=g[2]+f[2]*(i[2]-g[2]),b[3]=g[3]+f[3]*(i[3]-g[3]),b}function W(g,i,f){const d=f??new o(4);return d[0]=Math.max(g[0],i[0]),d[1]=Math.max(g[1],i[1]),d[2]=Math.max(g[2],i[2]),d[3]=Math.max(g[3],i[3]),d}function ut(g,i,f){const d=f??new o(4);return d[0]=Math.min(g[0],i[0]),d[1]=Math.min(g[1],i[1]),d[2]=Math.min(g[2],i[2]),d[3]=Math.min(g[3],i[3]),d}function O(g,i,f){const d=f??new o(4);return d[0]=g[0]*i,d[1]=g[1]*i,d[2]=g[2]*i,d[3]=g[3]*i,d}const R=O;function U(g,i,f){const d=f??new o(4);return d[0]=g[0]/i,d[1]=g[1]/i,d[2]=g[2]/i,d[3]=g[3]/i,d}function lt(g,i){const f=i??new o(4);return f[0]=1/g[0],f[1]=1/g[1],f[2]=1/g[2],f[3]=1/g[3],f}const K=lt;function X(g,i){return g[0]*i[0]+g[1]*i[1]+g[2]*i[2]+g[3]*i[3]}function Y(g){const i=g[0],f=g[1],d=g[2],b=g[3];return Math.sqrt(i*i+f*f+d*d+b*b)}const et=Y;function _t(g){const i=g[0],f=g[1],d=g[2],b=g[3];return i*i+f*f+d*d+b*b}const Vt=_t;function Rt(g,i){const f=g[0]-i[0],d=g[1]-i[1],b=g[2]-i[2],y=g[3]-i[3];return Math.sqrt(f*f+d*d+b*b+y*y)}const Dt=Rt;function pt(g,i){const f=g[0]-i[0],d=g[1]-i[1],b=g[2]-i[2],y=g[3]-i[3];return f*f+d*d+b*b+y*y}const kt=pt;function wt(g,i){const f=i??new o(4),d=g[0],b=g[1],y=g[2],S=g[3],k=Math.sqrt(d*d+b*b+y*y+S*S);return k>1e-5?(f[0]=d/k,f[1]=b/k,f[2]=y/k,f[3]=S/k):(f[0]=0,f[1]=0,f[2]=0,f[3]=0),f}function H(g,i){const f=i??new o(4);return f[0]=-g[0],f[1]=-g[1],f[2]=-g[2],f[3]=-g[3],f}function st(g,i){const f=i??new o(4);return f[0]=g[0],f[1]=g[1],f[2]=g[2],f[3]=g[3],f}const It=st;function Mt(g,i,f){const d=f??new o(4);return d[0]=g[0]*i[0],d[1]=g[1]*i[1],d[2]=g[2]*i[2],d[3]=g[3]*i[3],d}const zt=Mt;function Tt(g,i,f){const d=f??new o(4);return d[0]=g[0]/i[0],d[1]=g[1]/i[1],d[2]=g[2]/i[2],d[3]=g[3]/i[3],d}const Ot=Tt;function xt(g){const i=g??new o(4);return i[0]=0,i[1]=0,i[2]=0,i[3]=0,i}function ht(g,i,f){const d=f??new o(4),b=g[0],y=g[1],S=g[2],k=g[3];return d[0]=i[0]*b+i[4]*y+i[8]*S+i[12]*k,d[1]=i[1]*b+i[5]*y+i[9]*S+i[13]*k,d[2]=i[2]*b+i[6]*y+i[10]*S+i[14]*k,d[3]=i[3]*b+i[7]*y+i[11]*S+i[15]*k,d}function Wt(g,i,f){const d=f??new o(4);return wt(g,d),O(d,i,d)}function B(g,i,f){const d=f??new o(4);return Y(g)>i?Wt(g,i,d):st(g,d)}function j(g,i,f){const d=f??new o(4);return F(g,i,.5,d)}return{create:l,fromValues:h,set:C,ceil:x,floor:E,round:M,clamp:G,add:A,addScaled:L,subtract:V,sub:q,equalsApproximately:Z,equals:J,lerp:F,lerpV:z,max:W,min:ut,mulScalar:O,scale:R,divScalar:U,inverse:lt,invert:K,dot:X,length:Y,len:et,lengthSq:_t,lenSq:Vt,distance:Rt,dist:Dt,distanceSq:pt,distSq:kt,normalize:wt,negate:H,copy:st,clone:It,multiply:Mt,mul:zt,divide:Tt,div:Ot,zero:xt,transformMat4:ht,setLength:Wt,truncate:B,midpoint:j}}const Lr=new Map;function Bl(o){let l=Lr.get(o);return l||(l=Ml(o),Lr.set(o,l)),l}function fs(o,l,h,C,x,E){return{mat3:Pl(o),mat4:kl(l),quat:El(h),vec2:Kr(C),vec3:Ln(x),vec4:Bl(E)}}const{mat3:he,mat4:jt,quat:se,vec2:Ur,vec3:I,vec4:Vc}=fs(Float32Array,Float32Array,Float32Array,Float32Array,Float32Array,Float32Array);fs(Float64Array,Float64Array,Float64Array,Float64Array,Float64Array,Float64Array);fs(gl,Array,Array,Array,Array,Array);const Vr=document.querySelector("#log");let le=null,We=null;function Hr(){if(le)return le;le=document.createElement("div"),le.className="ply-spinner-overlay";const o=document.createElement("div");return o.className="ply-spinner",le.appendChild(o),We=document.createElement("div"),We.className="ply-spinner-label",le.appendChild(We),le.style.display="none",document.body.appendChild(le),le}function _s(o){Hr(),We&&o&&(We.textContent=o),le&&(le.style.opacity="1",le.style.display="flex")}function Ne(o){Hr(),We&&(We.textContent=o)}function gn(){if(!le)return;const o=le;o.style.opacity="0",setTimeout(()=>{o.style.opacity==="0"&&(o.style.display="none")},220)}function Yr(o,l){if(!Vr)return;const h=document.createElement("p");h.innerText=o,l&&Object.assign(h.style,l),Vr.appendChild(h)}async function ie(o){console.log(o),Yr(o)}async function Tl(o){console.error(o),Yr(o,{color:"red",backgroundColor:"rgba(255, 0, 0, 0.1)"})}let Zr;function Xr(){Zr=performance.now()}function Gr(o){const l=performance.now()-Zr;ie(`⏱️ ${o} Time: ${l.toFixed(0)} ms`)}function Dl(o,l){if(!o)throw new Error(l&&(typeof l=="string"?l:l()))}function en(o){return o+3&-4}const Al=2,Rl=3,wn=5,$e=6,xn=7;function Il(o){const l=new TextDecoder("ascii"),h=l.decode(new Uint8Array(o,0,4));if(h!=="NAT2")throw new Error(`NAT2 bad magic: '${h}'`);if(o.byteLength<4+64)throw new Error(`NAT2 truncated (${o.byteLength} bytes < 4 + 64)`);const C=new DataView(o),x=4,E=C.getUint32(x+0,!0),M=C.getUint32(x+4,!0),G=C.getUint32(x+8,!0),A=C.getUint32(x+12,!0),L=C.getUint32(x+16,!0),V=C.getFloat32(x+20,!0),q=C.getUint32(x+24,!0),Z=C.getUint32(x+28,!0),J=C.getFloat32(x+32,!0),F=C.getFloat32(x+36,!0),z=C.getFloat32(x+40,!0),W=C.getUint32(x+44,!0),ut=C.getFloat32(x+48,!0),O=C.getFloat32(x+52,!0),R=C.getUint32(x+56,!0),U=C.getUint32(x+60,!0),lt=U>0?U:1;if(Z!==Al&&Z!==Rl&&Z!==wn&&Z!==$e&&Z!==xn)throw new Error(`NAT2: Halloumi-WS supports BC7 (2), ASTC 4x4 (3), RVQ-paired (5), RVQ-paired+BC7-codebook (6), or BC7-codebook (7); got format=${Z}`);if(Z!==wn&&Z!==$e&&(E%4!==0||W%4!==0))throw new Error(`NAT2 block-format dims must be 4-aligned: width=${E} layer_h=${W}`);let K=x+64;const X=(R+1)*4,Y=new Uint32Array(o.slice(K,K+X));K+=X;let et;if(lt>1){const H=(lt+1)*4;if(K+H>o.byteLength)throw new Error(`NAT2 truncated at column_cuts (need ${H} from ${K})`);et=new Uint32Array(o.slice(K,K+H)),K+=H}else et=new Uint32Array([0,E]);let _t=0;for(let H=0;H<lt;H++){const st=et[H+1]-et[H];st>_t&&(_t=st)}const Vt=L*4*4;if(K+Vt>o.byteLength)throw new Error(`NAT2 truncated at rects: need ${Vt} more bytes from offset ${K}, have ${o.byteLength-K}`);const Rt=new Float32Array(o.slice(K,K+Vt));K+=Vt;const Dt=new Float32Array(L*5);for(let H=0;H<L;H++){const st=Rt[H*4+0],It=Rt[H*4+1],Mt=Rt[H*4+2],zt=Rt[H*4+3];let Tt=0;for(let B=1;B<=R&&Y[B]<=It;B++)Tt=B;let Ot=0;for(let B=1;B<=lt&&et[B]<=st;B++)Ot=B;const xt=It-Y[Tt],ht=st-et[Ot],Wt=Ot*R+Tt;Dt[H*5+0]=ht,Dt[H*5+1]=xt,Dt[H*5+2]=Mt,Dt[H*5+3]=zt,Dt[H*5+4]=Wt}if(Z===wn||Z===$e){if(K+24>o.byteLength)throw new Error("NAT2 truncated at RVQP sub-header");const H=l.decode(new Uint8Array(o,K,4));if(H!=="RVQP")throw new Error(`NAT2 RVQP bad sub-magic: '${H}'`);const st=C.getUint32(K+4,!0),It=C.getUint32(K+8,!0),Mt=C.getUint32(K+12,!0),zt=C.getUint32(K+16,!0),Tt=C.getUint32(K+20,!0);if(st!==1)throw new Error(`NAT2 RVQP unsupported version ${st}`);if(zt!==L)throw new Error(`NAT2 RVQP num_rects ${zt} != header num_rects ${L}`);if(K+=24,K+16>o.byteLength)throw new Error("NAT2 truncated at RVQP dequant");const Ot=new Float32Array(o.slice(K,K+8)),xt=new Float32Array(o.slice(K+8,K+16));K+=16;const ht=It*Mt,Wt=2*It*Mt,B=Z===$e?(ht>>2)*(Wt>>2)*16:ht*Wt*4;if(K+B>o.byteLength)throw new Error(`NAT2 RVQP truncated at codebook (need ${B}, have ${o.byteLength-K})`);const j=new Uint8Array(o.slice(K,K+B));K+=B;const g=Tt*4;if(K+g>o.byteLength)throw new Error(`NAT2 RVQP truncated at indices (need ${g}, have ${o.byteLength-K})`);const i=new Uint32Array(o.slice(K,K+g));K+=g;const f=(L+1)*4;if(K+f>o.byteLength)throw new Error(`NAT2 RVQP truncated at surfel_offsets (need ${f}, have ${o.byteLength-K})`);const d=new Uint32Array(o.slice(K,K+f));return K+=f,{width:E,height:M,channels:G,kernel_type:A,num_rects:L,uv_extent:V,sb_number:q,format:Z,sh_bias:J,res_bias:F,compact_mult:z,layer_h:W,atlas_scale:ut,atlas_offset:O,n_layers:R,n_cols:lt,layer_cuts:Y,column_cuts:et,slice_width:_t,rects_expanded:Dt,atlas_bytes:new Uint8Array,rvq_paired:{K_orig:It,B:Mt,N_used:Tt,pair_scale:Ot,pair_offset:xt,codebook_image:j,packed_indices:i,surfel_offsets:d}}}let pt;const wt=E/4*16;if(Z===xn){if(K+24>o.byteLength)throw new Error("NAT2 truncated at BCCB sub-header");const H=l.decode(new Uint8Array(o,K,4));if(H!=="BCCB")throw new Error(`NAT2 BCCB bad sub-magic: '${H}'`);const st=C.getUint32(K+4,!0),It=C.getUint32(K+8,!0),Mt=C.getUint32(K+12,!0),zt=C.getUint32(K+16,!0),Tt=C.getUint32(K+20,!0);if(st!==1)throw new Error(`NAT2 BCCB unsupported version ${st}`);if(Mt!==M/4||zt!==E/4||Tt!==Mt*zt)throw new Error(`NAT2 BCCB block grid mismatch: header ${E}×${M}, sub-header ${zt}×${Mt} (${Tt} blocks)`);K+=24;const Ot=It*16;if(K+Ot>o.byteLength)throw new Error(`NAT2 BCCB truncated at codebook (need ${Ot}, have ${o.byteLength-K})`);const xt=new Uint8Array(o,K,Ot);K+=Ot;const ht=Tt*2;if(K+ht>o.byteLength)throw new Error(`NAT2 BCCB truncated at indices (need ${ht}, have ${o.byteLength-K})`);const Wt=new Uint16Array(o.slice(K,K+ht));K+=ht;const B=new Uint8Array(Tt*16);for(let j=0;j<Tt;j++){const g=Wt[j]*16;B.set(xt.subarray(g,g+16),j*16)}pt=B}else{let H=0;for(let st=0;st<R;st++){const It=Y[st+1]-Y[st];if(It%4!==0)throw new Error(`NAT2 BC7 layer ${st} rows ${It} not 4-aligned`);H+=It/4*wt}if(K+H>o.byteLength)throw new Error(`NAT2 truncated at atlas payload: need ${H} more bytes from offset ${K}, have ${o.byteLength-K}`);pt=new Uint8Array(o.slice(K,K+H))}return{width:E,height:M,channels:G,kernel_type:A,num_rects:L,uv_extent:V,sb_number:q,format:Z,sh_bias:J,res_bias:F,compact_mult:z,layer_h:W,atlas_scale:ut,atlas_offset:O,n_layers:R,n_cols:lt,layer_cuts:Y,column_cuts:et,slice_width:_t,rects_expanded:Dt,atlas_bytes:pt}}const Ll=32;function Ul(o){const l=o.createTexture({label:"atlas_array stub (4x4x1 zero rgba8unorm)",size:{width:4,height:4,depthOrArrayLayers:1},format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),h=l.createView({dimension:"2d-array"}),C=o.createSampler({magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",addressModeW:"clamp-to-edge"});return{tex:l,view:h,sampler:C}}function Vl(o){const l=o.createTexture({label:"rvq codebook stub (4x4 zero rgba8)",size:{width:4,height:4,depthOrArrayLayers:1},format:"rgba8unorm",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),h=l.createView({dimension:"2d"}),C=o.createSampler({label:"rvq codebook stub sampler",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),x=o.createTexture({label:"rvq packed_indices stub (1x1 r32uint zero)",size:{width:1,height:1,depthOrArrayLayers:1},format:"r32uint",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST}),E=x.createView({dimension:"2d"}),M=o.createBuffer({label:"rvq surfel_offsets stub",size:16,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST});return{cbTex:l,cbView:h,cbSamp:C,packedTex:x,packedView:E,offsetsBuf:M}}function Gl(o,l,h){const C=l.format===wn||l.format===$e,x=l.format===$e;let E,M,G,A;if(C){const O=Ul(o);E=O.tex,M=O.view,G=O.sampler,A="RVQ-paired atlas"}else if(l.format===2||l.format===xn){if(!o.features.has("texture-compression-bc"))return ie(`⚠️  bundle is BC7 (format=${l.format}) but texture-compression-bc not supported — atlas disabled`),null;A=l.format===xn?"BC7 atlas (typeD: codebook gather)":"BC7 atlas",{texture:E,view:M,sampler:G}=zr(o,l,"bc7-rgba-unorm",A)}else if(l.format===3){if(!o.features.has("texture-compression-astc"))return ie("⚠️  bundle is ASTC 4x4 but texture-compression-astc not supported — atlas disabled"),null;A="ASTC 4x4 atlas",{texture:E,view:M,sampler:G}=zr(o,l,"astc-4x4-unorm",A)}else return ie(`⚠️  unsupported atlas format ${l.format} — atlas disabled`),null;const{rects_expanded:L}=l,V=o.createBuffer({label:"atlas rects (5-stride)",size:en(L.byteLength),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST});o.queue.writeBuffer(V,0,L);let q,Z,J,F,z,W;if(C){if(!l.rvq_paired)throw new Error("atlas.format = 5 but rvq_paired payload missing");const O=l.rvq_paired,R=O.K_orig*O.B,U=2*O.K_orig*O.B;if(R>o.limits.maxTextureDimension2D||U>o.limits.maxTextureDimension2D)return ie(`⚠️  RVQ codebook ${R}x${U} exceeds maxTextureDimension2D=${o.limits.maxTextureDimension2D} — atlas disabled`),null;let lt,K;if(x){if(!o.features.has("texture-compression-bc"))return ie("⚠️  bundle is RVQ-paired typeB (BC7 codebook) but texture-compression-bc unsupported — atlas disabled"),null;lt="bc7-rgba-unorm",K=(R>>2)*16}else lt="rgba8unorm",K=R*4;const X=o.createTexture({label:x?"rvq paired codebook (BC7)":"rvq paired codebook (rgba8)",size:{width:R,height:U,depthOrArrayLayers:1},format:lt,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});o.queue.writeTexture({texture:X},O.codebook_image,{offset:0,bytesPerRow:K,rowsPerImage:U},{width:R,height:U,depthOrArrayLayers:1}),q=X,Z=X.createView({dimension:"2d"}),J=o.createSampler({label:"rvq paired codebook sampler (linear)",magFilter:"linear",minFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"});const Y=8192,et=O.N_used,_t=Math.ceil(et/Y);if(_t>o.limits.maxTextureDimension2D||Y>o.limits.maxTextureDimension2D)return ie(`⚠️  RVQ packed_indices texture ${Y}x${_t} exceeds maxTextureDimension2D=${o.limits.maxTextureDimension2D} — atlas disabled`),null;F=o.createTexture({label:"rvq packed_indices (r32uint)",size:{width:Y,height:_t,depthOrArrayLayers:1},format:"r32uint",usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});const Vt=Y*_t;let Rt;if(Vt===et)Rt=new Uint8Array(O.packed_indices.buffer,O.packed_indices.byteOffset,O.packed_indices.byteLength);else{const Dt=new Uint32Array(Vt);Dt.set(O.packed_indices),Rt=new Uint8Array(Dt.buffer)}o.queue.writeTexture({texture:F},Rt,{offset:0,bytesPerRow:Y*4,rowsPerImage:_t},{width:Y,height:_t,depthOrArrayLayers:1}),z=F.createView({dimension:"2d"}),W=o.createBuffer({label:"rvq surfel_offsets",size:en(O.surfel_offsets.byteLength),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST}),o.queue.writeBuffer(W,0,O.surfel_offsets),ie(`🪡 RVQ-paired atlas wired: codebook ${R}x${U} (${(O.codebook_image.byteLength/1024/1024).toFixed(1)} MB), ${et.toLocaleString()} packed indices as r32uint ${Y}x${_t} (${(O.packed_indices.byteLength/1024/1024).toFixed(1)} MB), ${O.surfel_offsets.length} surfel_offsets`)}else{const O=Vl(o);q=O.cbTex,Z=O.cbView,J=O.cbSamp,F=O.packedTex,z=O.packedView,W=O.offsetsBuf}const ut=o.createBuffer({label:"tex_params",size:48,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});return Qr(o,ut,l,h),{texture:E,view:M,sampler:G,rectsBuffer:V,texParamsBuffer:ut,meta:l,rvqCodebookTexture:q,rvqCodebookView:Z,rvqCodebookSampler:J,rvqPackedIndicesTexture:F,rvqPackedIndicesView:z,rvqSurfelOffsetsBuffer:W}}function zr(o,l,h,C){const{width:x,layer_h:E,n_layers:M,n_cols:G,layer_cuts:A,column_cuts:L,slice_width:V,atlas_bytes:q}=l,J=x/4*16,F=o.limits.maxTextureDimension2D;if(E>F||V>F)throw new Error(`⚠️  atlas slice dims ${V}x${E} exceed maxTextureDimension2D=${F}. Re-bake with smaller LAYER_H or pack with column-aware atlas widths.`);const z=G*M;if(z>o.limits.maxTextureArrayLayers)throw new Error(`⚠️  ${G} cols × ${M} layers = ${z} slices > maxTextureArrayLayers=${o.limits.maxTextureArrayLayers}.`);const W=o.createTexture({label:C,size:{width:V,height:E,depthOrArrayLayers:z},mipLevelCount:1,sampleCount:1,dimension:"2d",format:h,usage:GPUTextureUsage.TEXTURE_BINDING|GPUTextureUsage.COPY_DST});for(let R=0;R<G;R++){const U=L[R]/4,lt=(L[R+1]-L[R])/4;for(let K=0;K<M;K++){const X=A[K]/4,Y=(A[K+1]-A[K])/4,et=R*M+K,_t=X*J+U*16;o.queue.writeTexture({texture:W,mipLevel:0,origin:{x:0,y:0,z:et},aspect:"all"},q,{offset:_t,bytesPerRow:J,rowsPerImage:Y},{width:lt*4,height:Y*4,depthOrArrayLayers:1})}}const ut=W.createView({label:`${C} view`,dimension:"2d-array"}),O=o.createSampler({label:`${C} sampler`,addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",addressModeW:"clamp-to-edge",magFilter:"linear",minFilter:"linear",mipmapFilter:"nearest"});return{texture:W,view:ut,sampler:O}}function Qr(o,l,h,C){const x=new ArrayBuffer(48),E=new Uint32Array(x),M=new Float32Array(x),G=h.slice_width||h.width;E[0]=C?G:0,E[1]=h.layer_h;let A=h.format;A===$e&&(A=wn),A===xn&&(A=2),E[2]=A,M[3]=h.atlas_scale,M[4]=h.atlas_offset,M[5]=h.uv_extent,M[6]=h.res_bias,h.rvq_paired?(E[7]=h.rvq_paired.B,M[8]=h.rvq_paired.pair_scale[0],M[9]=h.rvq_paired.pair_scale[1],M[10]=h.rvq_paired.pair_offset[0],M[11]=h.rvq_paired.pair_offset[1]):(E[7]=0,M[8]=0,M[9]=0,M[10]=0,M[11]=0),o.queue.writeBuffer(l,0,x)}async function cs(o,l){ie(`loading ply file from File... : ${o.name}`),_s("downloading PLY...");const h=await o.arrayBuffer();try{return await Jr(h,l)}finally{gn()}}async function zl(o,l){ie(`loading ply file from URL... : ${o}`),_s("downloading PLY...");try{Xr();const h=new URL(o,self.location.href).href;return await Jr({url:h},l)}finally{gn()}}async function Jr(o,l){return new Promise((h,C)=>{const x=new Worker(new URL(""+new URL("ply-worker-621cb083.js",import.meta.url).href,self.location),{type:"module"});x.onmessage=E=>{var G,A,L,V,q,Z,J,F,z,W,ut,O;const M=E.data;if((M==null?void 0:M.type)==="error"){Tl(`PLY worker error: ${M.message??"unknown error"}`),x.terminate(),C(new Error(M.message??"Worker error"));return}else if((M==null?void 0:M.type)==="download_progress"){const R=M.totalBytes,U=M.loadedBytes/(1024*1024),lt=R?R/(1024*1024):void 0,K=(M.speedBps??0)/(1024*1024),X=R?Math.min(99,Math.floor(M.loadedBytes/R*100)):void 0,Y=lt?`total ${lt.toFixed(1)} MB`:"total -- MB",et=lt&&X!==void 0?`${U.toFixed(1)} MB downloaded (${X}%)`:`${U.toFixed(1)} MB downloaded`,_t=`${K.toFixed(2)} MB/s`;Ne(`downloading PLY ...
${Y}, ${et}
${_t}`);return}else if((M==null?void 0:M.type)==="fetched"){ie(`💾 Fetched (${M.byteLength} bytes)`),Gr("Download"),Ne("parsing PLY..."),Xr();return}else if((M==null?void 0:M.type)==="parse_progress"){const R=M.total??0,U=M.read??0,lt=R>0?Math.floor(U/R*100):0;Ne(`parsing PLY ...
${U}/${R} surfels (${lt}%)`);return}else if((M==null?void 0:M.type)==="done"){const R=M.num_points,U=M.K,lt=M.feature_mode??0,K=M.sh_bias,X=M.kernel_type,Y=M.surfelBuffer,et=M.svParamsBuffer;ie(`🪐 Total surfels: ${R}, mode=${lt===1?"SB":"SV"}, K=${U}, sh_bias=${K}, kernel_type=${X}`);const Vt=l.createBuffer({label:"surfel input buffer",size:en(R*Ll),usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.STORAGE});l.queue.writeBuffer(Vt,0,Y);const Rt=et.byteLength>0?et.byteLength:16,Dt=l.createBuffer({label:lt===1?"color_params buffer (SB)":"color_params buffer (SV)",size:en(Rt),usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.STORAGE});et.byteLength>0&&l.queue.writeBuffer(Dt,0,et),x.terminate(),Gr("Parse"),h({num_points:R,K:U,feature_mode:lt,sh_bias:K,kernel_type:X,surfel_buffer:Vt,surfel_data:new Float32Array(Y),sv_params_buffer:Dt,bbox:M.bbox??{min:[-1,-1,-1],max:[1,1,1]},centroid:M.centroid??[((((A=(G=M.bbox)==null?void 0:G.min)==null?void 0:A[0])??-1)+(((V=(L=M.bbox)==null?void 0:L.max)==null?void 0:V[0])??1))/2,((((Z=(q=M.bbox)==null?void 0:q.min)==null?void 0:Z[1])??-1)+(((F=(J=M.bbox)==null?void 0:J.max)==null?void 0:F[1])??1))/2,((((W=(z=M.bbox)==null?void 0:z.min)==null?void 0:W[2])??-1)+(((O=(ut=M.bbox)==null?void 0:ut.max)==null?void 0:O[2])??1))/2]})}},x.onerror=E=>{x.terminate(),C(E)},o instanceof ArrayBuffer?(Ne("parsing PLY..."),x.postMessage({type:"start",plyBuffer:o},[o])):x.postMessage({type:"start_url",url:o.url})})}var Ol=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},us={exports:{}};/*! Tweakpane 3.1.10 (c) 2016 cocopon, licensed under the MIT license. */(function(o,l){(function(h,C){C(l)})(Ol,function(h){class C{constructor(t){const[e,s]=t.split("-"),c=e.split(".");this.major=parseInt(c[0],10),this.minor=parseInt(c[1],10),this.patch=parseInt(c[2],10),this.prerelease=s??null}toString(){const t=[this.major,this.minor,this.patch].join(".");return this.prerelease!==null?[t,this.prerelease].join("-"):t}}class x{constructor(t){this.controller_=t}get element(){return this.controller_.view.element}get disabled(){return this.controller_.viewProps.get("disabled")}set disabled(t){this.controller_.viewProps.set("disabled",t)}get hidden(){return this.controller_.viewProps.get("hidden")}set hidden(t){this.controller_.viewProps.set("hidden",t)}dispose(){this.controller_.viewProps.set("disposed",!0)}}class E{constructor(t){this.target=t}}class M extends E{constructor(t,e,s,c){super(t),this.value=e,this.presetKey=s,this.last=c??!0}}class G extends E{constructor(t,e,s){super(t),this.value=e,this.presetKey=s}}class A extends E{constructor(t,e){super(t),this.expanded=e}}class L extends E{constructor(t,e){super(t),this.index=e}}function V(n){return n}function q(n){return n==null}function Z(n,t){if(n.length!==t.length)return!1;for(let e=0;e<n.length;e++)if(n[e]!==t[e])return!1;return!0}function J(n,t){let e=n;do{const s=Object.getOwnPropertyDescriptor(e,t);if(s&&(s.set!==void 0||s.writable===!0))return!0;e=Object.getPrototypeOf(e)}while(e!==null);return!1}const F={alreadydisposed:()=>"View has been already disposed",invalidparams:n=>`Invalid parameters for '${n.name}'`,nomatchingcontroller:n=>`No matching controller for '${n.key}'`,nomatchingview:n=>`No matching view for '${JSON.stringify(n.params)}'`,notbindable:()=>"Value is not bindable",propertynotfound:n=>`Property '${n.name}' not found`,shouldneverhappen:()=>"This error should never happen"};class z{static alreadyDisposed(){return new z({type:"alreadydisposed"})}static notBindable(){return new z({type:"notbindable"})}static propertyNotFound(t){return new z({type:"propertynotfound",context:{name:t}})}static shouldNeverHappen(){return new z({type:"shouldneverhappen"})}constructor(t){var e;this.message=(e=F[t.type](t.context))!==null&&e!==void 0?e:"Unexpected error",this.name=this.constructor.name,this.stack=new Error(this.message).stack,this.type=t.type}}class W{constructor(t,e,s){this.obj_=t,this.key_=e,this.presetKey_=s??e}static isBindable(t){return!(t===null||typeof t!="object"&&typeof t!="function")}get key(){return this.key_}get presetKey(){return this.presetKey_}read(){return this.obj_[this.key_]}write(t){this.obj_[this.key_]=t}writeProperty(t,e){const s=this.read();if(!W.isBindable(s))throw z.notBindable();if(!(t in s))throw z.propertyNotFound(t);s[t]=e}}class ut extends x{get label(){return this.controller_.props.get("label")}set label(t){this.controller_.props.set("label",t)}get title(){var t;return(t=this.controller_.valueController.props.get("title"))!==null&&t!==void 0?t:""}set title(t){this.controller_.valueController.props.set("title",t)}on(t,e){const s=e.bind(this);return this.controller_.valueController.emitter.on(t,()=>{s(new E(this))}),this}}class O{constructor(){this.observers_={}}on(t,e){let s=this.observers_[t];return s||(s=this.observers_[t]=[]),s.push({handler:e}),this}off(t,e){const s=this.observers_[t];return s&&(this.observers_[t]=s.filter(c=>c.handler!==e)),this}emit(t,e){const s=this.observers_[t];s&&s.forEach(c=>{c.handler(e)})}}const R="tp";function U(n){return(e,s)=>[R,"-",n,"v",e?`_${e}`:"",s?`-${s}`:""].join("")}function lt(n,t){return e=>t(n(e))}function K(n){return n.rawValue}function X(n,t){n.emitter.on("change",lt(K,t)),t(n.rawValue)}function Y(n,t,e){X(n.value(t),e)}function et(n,t,e){e?n.classList.add(t):n.classList.remove(t)}function _t(n,t){return e=>{et(n,t,e)}}function Vt(n,t){X(n,e=>{t.textContent=e??""})}const Rt=U("btn");class Dt{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(Rt()),e.viewProps.bindClassModifiers(this.element);const s=t.createElement("button");s.classList.add(Rt("b")),e.viewProps.bindDisabled(s),this.element.appendChild(s),this.buttonElement=s;const c=t.createElement("div");c.classList.add(Rt("t")),Vt(e.props.value("title"),c),this.buttonElement.appendChild(c)}}class pt{constructor(t,e){this.emitter=new O,this.onClick_=this.onClick_.bind(this),this.props=e.props,this.viewProps=e.viewProps,this.view=new Dt(t,{props:this.props,viewProps:this.viewProps}),this.view.buttonElement.addEventListener("click",this.onClick_)}onClick_(){this.emitter.emit("click",{sender:this})}}class kt{constructor(t,e){var s;this.constraint_=e==null?void 0:e.constraint,this.equals_=(s=e==null?void 0:e.equals)!==null&&s!==void 0?s:(c,P)=>c===P,this.emitter=new O,this.rawValue_=t}get constraint(){return this.constraint_}get rawValue(){return this.rawValue_}set rawValue(t){this.setRawValue(t,{forceEmit:!1,last:!0})}setRawValue(t,e){const s=e??{forceEmit:!1,last:!0},c=this.constraint_?this.constraint_.constrain(t):t,P=this.rawValue_;this.equals_(P,c)&&!s.forceEmit||(this.emitter.emit("beforechange",{sender:this}),this.rawValue_=c,this.emitter.emit("change",{options:s,previousRawValue:P,rawValue:c,sender:this}))}}class wt{constructor(t){this.emitter=new O,this.value_=t}get rawValue(){return this.value_}set rawValue(t){this.setRawValue(t,{forceEmit:!1,last:!0})}setRawValue(t,e){const s=e??{forceEmit:!1,last:!0},c=this.value_;c===t&&!s.forceEmit||(this.emitter.emit("beforechange",{sender:this}),this.value_=t,this.emitter.emit("change",{options:s,previousRawValue:c,rawValue:this.value_,sender:this}))}}function H(n,t){const e=t==null?void 0:t.constraint,s=t==null?void 0:t.equals;return!e&&!s?new wt(n):new kt(n,t)}class st{constructor(t){this.emitter=new O,this.valMap_=t;for(const e in this.valMap_)this.valMap_[e].emitter.on("change",()=>{this.emitter.emit("change",{key:e,sender:this})})}static createCore(t){return Object.keys(t).reduce((s,c)=>Object.assign(s,{[c]:H(t[c])}),{})}static fromObject(t){const e=this.createCore(t);return new st(e)}get(t){return this.valMap_[t].rawValue}set(t,e){this.valMap_[t].rawValue=e}value(t){return this.valMap_[t]}}function It(n,t){const s=Object.keys(t).reduce((c,P)=>{if(c===void 0)return;const T=t[P],nt=T(n[P]);return nt.succeeded?Object.assign(Object.assign({},c),{[P]:nt.value}):void 0},{});return s}function Mt(n,t){return n.reduce((e,s)=>{if(e===void 0)return;const c=t(s);if(!(!c.succeeded||c.value===void 0))return[...e,c.value]},[])}function zt(n){return n===null?!1:typeof n=="object"}function Tt(n){return t=>e=>{if(!t&&e===void 0)return{succeeded:!1,value:void 0};if(t&&e===void 0)return{succeeded:!0,value:void 0};const s=n(e);return s!==void 0?{succeeded:!0,value:s}:{succeeded:!1,value:void 0}}}function Ot(n){return{custom:t=>Tt(t)(n),boolean:Tt(t=>typeof t=="boolean"?t:void 0)(n),number:Tt(t=>typeof t=="number"?t:void 0)(n),string:Tt(t=>typeof t=="string"?t:void 0)(n),function:Tt(t=>typeof t=="function"?t:void 0)(n),constant:t=>Tt(e=>e===t?t:void 0)(n),raw:Tt(t=>t)(n),object:t=>Tt(e=>{if(zt(e))return It(e,t)})(n),array:t=>Tt(e=>{if(Array.isArray(e))return Mt(e,t)})(n)}}const xt={optional:Ot(!0),required:Ot(!1)};function ht(n,t){const e=xt.required.object(t)(n);return e.succeeded?e.value:void 0}function Wt(n){console.warn([`Missing '${n.key}' of ${n.target} in ${n.place}.`,"Please rebuild plugins with the latest core package."].join(" "))}function B(n){return n&&n.parentElement&&n.parentElement.removeChild(n),null}class j{constructor(t){this.value_=t}static create(t){return[new j(t),(e,s)=>{t.setRawValue(e,s)}]}get emitter(){return this.value_.emitter}get rawValue(){return this.value_.rawValue}}const g=U("");function i(n,t){return _t(n,g(void 0,t))}class f extends st{constructor(t){var e;super(t),this.onDisabledChange_=this.onDisabledChange_.bind(this),this.onParentChange_=this.onParentChange_.bind(this),this.onParentGlobalDisabledChange_=this.onParentGlobalDisabledChange_.bind(this),[this.globalDisabled_,this.setGlobalDisabled_]=j.create(H(this.getGlobalDisabled_())),this.value("disabled").emitter.on("change",this.onDisabledChange_),this.value("parent").emitter.on("change",this.onParentChange_),(e=this.get("parent"))===null||e===void 0||e.globalDisabled.emitter.on("change",this.onParentGlobalDisabledChange_)}static create(t){var e,s,c;const P=t??{};return new f(st.createCore({disabled:(e=P.disabled)!==null&&e!==void 0?e:!1,disposed:!1,hidden:(s=P.hidden)!==null&&s!==void 0?s:!1,parent:(c=P.parent)!==null&&c!==void 0?c:null}))}get globalDisabled(){return this.globalDisabled_}bindClassModifiers(t){X(this.globalDisabled_,i(t,"disabled")),Y(this,"hidden",i(t,"hidden"))}bindDisabled(t){X(this.globalDisabled_,e=>{t.disabled=e})}bindTabIndex(t){X(this.globalDisabled_,e=>{t.tabIndex=e?-1:0})}handleDispose(t){this.value("disposed").emitter.on("change",e=>{e&&t()})}getGlobalDisabled_(){const t=this.get("parent");return(t?t.globalDisabled.rawValue:!1)||this.get("disabled")}updateGlobalDisabled_(){this.setGlobalDisabled_(this.getGlobalDisabled_())}onDisabledChange_(){this.updateGlobalDisabled_()}onParentGlobalDisabledChange_(){this.updateGlobalDisabled_()}onParentChange_(t){var e;const s=t.previousRawValue;s==null||s.globalDisabled.emitter.off("change",this.onParentGlobalDisabledChange_),(e=this.get("parent"))===null||e===void 0||e.globalDisabled.emitter.on("change",this.onParentGlobalDisabledChange_),this.updateGlobalDisabled_()}}function d(){return["veryfirst","first","last","verylast"]}const b=U(""),y={veryfirst:"vfst",first:"fst",last:"lst",verylast:"vlst"};class S{constructor(t){this.parent_=null,this.blade=t.blade,this.view=t.view,this.viewProps=t.viewProps;const e=this.view.element;this.blade.value("positions").emitter.on("change",()=>{d().forEach(s=>{e.classList.remove(b(void 0,y[s]))}),this.blade.get("positions").forEach(s=>{e.classList.add(b(void 0,y[s]))})}),this.viewProps.handleDispose(()=>{B(e)})}get parent(){return this.parent_}set parent(t){if(this.parent_=t,!("parent"in this.viewProps.valMap_)){Wt({key:"parent",target:f.name,place:"BladeController.parent"});return}this.viewProps.set("parent",this.parent_?this.parent_.viewProps:null)}}const k="http://www.w3.org/2000/svg";function r(n){n.offsetHeight}function m(n,t){const e=n.style.transition;n.style.transition="none",t(),n.style.transition=e}function u(n){return n.ontouchstart!==void 0}function p(){return globalThis}function a(){return p().document}function _(n){const t=n.ownerDocument.defaultView;return t&&"document"in t?n.getContext("2d",{willReadFrequently:!0}):null}const w={check:'<path d="M2 8l4 4l8 -8"/>',dropdown:'<path d="M5 7h6l-3 3 z"/>',p2dpad:'<path d="M8 4v8"/><path d="M4 8h8"/><circle cx="12" cy="12" r="1.2"/>'};function v(n,t){const e=n.createElementNS(k,"svg");return e.innerHTML=w[t],e}function D(n,t,e){n.insertBefore(t,n.children[e])}function N(n){n.parentElement&&n.parentElement.removeChild(n)}function $(n){for(;n.children.length>0;)n.removeChild(n.children[0])}function ct(n){for(;n.childNodes.length>0;)n.removeChild(n.childNodes[0])}function it(n){return n.relatedTarget?n.relatedTarget:"explicitOriginalTarget"in n?n.explicitOriginalTarget:null}const rt=U("lbl");function ft(n,t){const e=n.createDocumentFragment();return t.split(`
`).map(c=>n.createTextNode(c)).forEach((c,P)=>{P>0&&e.appendChild(n.createElement("br")),e.appendChild(c)}),e}class yt{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(rt()),e.viewProps.bindClassModifiers(this.element);const s=t.createElement("div");s.classList.add(rt("l")),Y(e.props,"label",P=>{q(P)?this.element.classList.add(rt(void 0,"nol")):(this.element.classList.remove(rt(void 0,"nol")),ct(s),s.appendChild(ft(t,P)))}),this.element.appendChild(s),this.labelElement=s;const c=t.createElement("div");c.classList.add(rt("v")),this.element.appendChild(c),this.valueElement=c}}class dt extends S{constructor(t,e){const s=e.valueController.viewProps;super(Object.assign(Object.assign({},e),{view:new yt(t,{props:e.props,viewProps:s}),viewProps:s})),this.props=e.props,this.valueController=e.valueController,this.view.valueElement.appendChild(this.valueController.view.element)}}const bt={id:"button",type:"blade",accept(n){const t=xt,e=ht(n,{title:t.required.string,view:t.required.constant("button"),label:t.optional.string});return e?{params:e}:null},controller(n){return new dt(n.document,{blade:n.blade,props:st.fromObject({label:n.params.label}),valueController:new pt(n.document,{props:st.fromObject({title:n.params.title}),viewProps:n.viewProps})})},api(n){return!(n.controller instanceof dt)||!(n.controller.valueController instanceof pt)?null:new ut(n.controller)}};class Ct extends S{constructor(t){super(t),this.value=t.value}}function At(){return new st({positions:H([],{equals:Z})})}class Q extends st{constructor(t){super(t)}static create(t){const e={completed:!0,expanded:t,expandedHeight:null,shouldFixHeight:!1,temporaryExpanded:null},s=st.createCore(e);return new Q(s)}get styleExpanded(){var t;return(t=this.get("temporaryExpanded"))!==null&&t!==void 0?t:this.get("expanded")}get styleHeight(){if(!this.styleExpanded)return"0";const t=this.get("expandedHeight");return this.get("shouldFixHeight")&&!q(t)?`${t}px`:"auto"}bindExpandedClass(t,e){const s=()=>{this.styleExpanded?t.classList.add(e):t.classList.remove(e)};Y(this,"expanded",s),Y(this,"temporaryExpanded",s)}cleanUpTransition(){this.set("shouldFixHeight",!1),this.set("expandedHeight",null),this.set("completed",!0)}}function at(n,t){let e=0;return m(t,()=>{n.set("expandedHeight",null),n.set("temporaryExpanded",!0),r(t),e=t.clientHeight,n.set("temporaryExpanded",null),r(t)}),e}function ot(n,t){t.style.height=n.styleHeight}function gt(n,t){n.value("expanded").emitter.on("beforechange",()=>{if(n.set("completed",!1),q(n.get("expandedHeight"))){const e=at(n,t);e>0&&n.set("expandedHeight",e)}n.set("shouldFixHeight",!0),r(t)}),n.emitter.on("change",()=>{ot(n,t)}),ot(n,t),t.addEventListener("transitionend",e=>{e.propertyName==="height"&&n.cleanUpTransition()})}class Pt extends x{constructor(t,e){super(t),this.rackApi_=e}}function Et(n,t){return n.addBlade(Object.assign(Object.assign({},t),{view:"button"}))}function mt(n,t){return n.addBlade(Object.assign(Object.assign({},t),{view:"folder"}))}function vt(n,t){const e=t??{};return n.addBlade(Object.assign(Object.assign({},e),{view:"separator"}))}function Gt(n,t){return n.addBlade(Object.assign(Object.assign({},t),{view:"tab"}))}class Ut{constructor(t){this.emitter=new O,this.items_=[],this.cache_=new Set,this.onSubListAdd_=this.onSubListAdd_.bind(this),this.onSubListRemove_=this.onSubListRemove_.bind(this),this.extract_=t}get items(){return this.items_}allItems(){return Array.from(this.cache_)}find(t){for(const e of this.allItems())if(t(e))return e;return null}includes(t){return this.cache_.has(t)}add(t,e){if(this.includes(t))throw z.shouldNeverHappen();const s=e!==void 0?e:this.items_.length;this.items_.splice(s,0,t),this.cache_.add(t);const c=this.extract_(t);c&&(c.emitter.on("add",this.onSubListAdd_),c.emitter.on("remove",this.onSubListRemove_),c.allItems().forEach(P=>{this.cache_.add(P)})),this.emitter.emit("add",{index:s,item:t,root:this,target:this})}remove(t){const e=this.items_.indexOf(t);if(e<0)return;this.items_.splice(e,1),this.cache_.delete(t);const s=this.extract_(t);s&&(s.emitter.off("add",this.onSubListAdd_),s.emitter.off("remove",this.onSubListRemove_)),this.emitter.emit("remove",{index:e,item:t,root:this,target:this})}onSubListAdd_(t){this.cache_.add(t.item),this.emitter.emit("add",{index:t.index,item:t.item,root:this,target:t.target})}onSubListRemove_(t){this.cache_.delete(t.item),this.emitter.emit("remove",{index:t.index,item:t.item,root:this,target:t.target})}}class qt extends x{constructor(t){super(t),this.onBindingChange_=this.onBindingChange_.bind(this),this.emitter_=new O,this.controller_.binding.emitter.on("change",this.onBindingChange_)}get label(){return this.controller_.props.get("label")}set label(t){this.controller_.props.set("label",t)}on(t,e){const s=e.bind(this);return this.emitter_.on(t,c=>{s(c.event)}),this}refresh(){this.controller_.binding.read()}onBindingChange_(t){const e=t.sender.target.read();this.emitter_.emit("change",{event:new M(this,e,this.controller_.binding.target.presetKey,t.options.last)})}}class Kt extends dt{constructor(t,e){super(t,e),this.binding=e.binding}}class Xt extends x{constructor(t){super(t),this.onBindingUpdate_=this.onBindingUpdate_.bind(this),this.emitter_=new O,this.controller_.binding.emitter.on("update",this.onBindingUpdate_)}get label(){return this.controller_.props.get("label")}set label(t){this.controller_.props.set("label",t)}on(t,e){const s=e.bind(this);return this.emitter_.on(t,c=>{s(c.event)}),this}refresh(){this.controller_.binding.read()}onBindingUpdate_(t){const e=t.sender.target.read();this.emitter_.emit("update",{event:new G(this,e,this.controller_.binding.target.presetKey)})}}class Ht extends dt{constructor(t,e){super(t,e),this.binding=e.binding,this.viewProps.bindDisabled(this.binding.ticker),this.viewProps.handleDispose(()=>{this.binding.dispose()})}}function ee(n){return n instanceof fe?n.apiSet_:n instanceof Pt?n.rackApi_.apiSet_:null}function Qt(n,t){const e=n.find(s=>s.controller_===t);if(!e)throw z.shouldNeverHappen();return e}function be(n,t,e){if(!W.isBindable(n))throw z.notBindable();return new W(n,t,e)}class fe extends x{constructor(t,e){super(t),this.onRackAdd_=this.onRackAdd_.bind(this),this.onRackRemove_=this.onRackRemove_.bind(this),this.onRackInputChange_=this.onRackInputChange_.bind(this),this.onRackMonitorUpdate_=this.onRackMonitorUpdate_.bind(this),this.emitter_=new O,this.apiSet_=new Ut(ee),this.pool_=e;const s=this.controller_.rack;s.emitter.on("add",this.onRackAdd_),s.emitter.on("remove",this.onRackRemove_),s.emitter.on("inputchange",this.onRackInputChange_),s.emitter.on("monitorupdate",this.onRackMonitorUpdate_),s.children.forEach(c=>{this.setUpApi_(c)})}get children(){return this.controller_.rack.children.map(t=>Qt(this.apiSet_,t))}addInput(t,e,s){const c=s??{},P=this.controller_.view.element.ownerDocument,T=this.pool_.createInput(P,be(t,e,c.presetKey),c),nt=new qt(T);return this.add(nt,c.index)}addMonitor(t,e,s){const c=s??{},P=this.controller_.view.element.ownerDocument,T=this.pool_.createMonitor(P,be(t,e),c),nt=new Xt(T);return this.add(nt,c.index)}addFolder(t){return mt(this,t)}addButton(t){return Et(this,t)}addSeparator(t){return vt(this,t)}addTab(t){return Gt(this,t)}add(t,e){this.controller_.rack.add(t.controller_,e);const s=this.apiSet_.find(c=>c.controller_===t.controller_);return s&&this.apiSet_.remove(s),this.apiSet_.add(t),t}remove(t){this.controller_.rack.remove(t.controller_)}addBlade(t){const e=this.controller_.view.element.ownerDocument,s=this.pool_.createBlade(e,t),c=this.pool_.createBladeApi(s);return this.add(c,t.index)}on(t,e){const s=e.bind(this);return this.emitter_.on(t,c=>{s(c.event)}),this}setUpApi_(t){this.apiSet_.find(s=>s.controller_===t)||this.apiSet_.add(this.pool_.createBladeApi(t))}onRackAdd_(t){this.setUpApi_(t.bladeController)}onRackRemove_(t){if(t.isRoot){const e=Qt(this.apiSet_,t.bladeController);this.apiSet_.remove(e)}}onRackInputChange_(t){const e=t.bladeController;if(e instanceof Kt){const s=Qt(this.apiSet_,e),c=e.binding;this.emitter_.emit("change",{event:new M(s,c.target.read(),c.target.presetKey,t.options.last)})}else if(e instanceof Ct){const s=Qt(this.apiSet_,e);this.emitter_.emit("change",{event:new M(s,e.value.rawValue,void 0,t.options.last)})}}onRackMonitorUpdate_(t){if(!(t.bladeController instanceof Ht))throw z.shouldNeverHappen();const e=Qt(this.apiSet_,t.bladeController),s=t.bladeController.binding;this.emitter_.emit("update",{event:new G(e,s.target.read(),s.target.presetKey)})}}class _e extends Pt{constructor(t,e){super(t,new fe(t.rackController,e)),this.emitter_=new O,this.controller_.foldable.value("expanded").emitter.on("change",s=>{this.emitter_.emit("fold",{event:new A(this,s.sender.rawValue)})}),this.rackApi_.on("change",s=>{this.emitter_.emit("change",{event:s})}),this.rackApi_.on("update",s=>{this.emitter_.emit("update",{event:s})})}get expanded(){return this.controller_.foldable.get("expanded")}set expanded(t){this.controller_.foldable.set("expanded",t)}get title(){return this.controller_.props.get("title")}set title(t){this.controller_.props.set("title",t)}get children(){return this.rackApi_.children}addInput(t,e,s){return this.rackApi_.addInput(t,e,s)}addMonitor(t,e,s){return this.rackApi_.addMonitor(t,e,s)}addFolder(t){return this.rackApi_.addFolder(t)}addButton(t){return this.rackApi_.addButton(t)}addSeparator(t){return this.rackApi_.addSeparator(t)}addTab(t){return this.rackApi_.addTab(t)}add(t,e){return this.rackApi_.add(t,e)}remove(t){this.rackApi_.remove(t)}addBlade(t){return this.rackApi_.addBlade(t)}on(t,e){const s=e.bind(this);return this.emitter_.on(t,c=>{s(c.event)}),this}}class me extends S{constructor(t){super({blade:t.blade,view:t.view,viewProps:t.rackController.viewProps}),this.rackController=t.rackController}}class ve{constructor(t,e){const s=U(e.viewName);this.element=t.createElement("div"),this.element.classList.add(s()),e.viewProps.bindClassModifiers(this.element)}}function Jt(n,t){for(let e=0;e<n.length;e++){const s=n[e];if(s instanceof Kt&&s.binding===t)return s}return null}function ue(n,t){for(let e=0;e<n.length;e++){const s=n[e];if(s instanceof Ht&&s.binding===t)return s}return null}function ge(n,t){for(let e=0;e<n.length;e++){const s=n[e];if(s instanceof Ct&&s.value===t)return s}return null}function oe(n){return n instanceof Yt?n.rack:n instanceof me?n.rackController.rack:null}function we(n){const t=oe(n);return t?t.bcSet_:null}class xe{constructor(t){var e,s;this.onBladePositionsChange_=this.onBladePositionsChange_.bind(this),this.onSetAdd_=this.onSetAdd_.bind(this),this.onSetRemove_=this.onSetRemove_.bind(this),this.onChildDispose_=this.onChildDispose_.bind(this),this.onChildPositionsChange_=this.onChildPositionsChange_.bind(this),this.onChildInputChange_=this.onChildInputChange_.bind(this),this.onChildMonitorUpdate_=this.onChildMonitorUpdate_.bind(this),this.onChildValueChange_=this.onChildValueChange_.bind(this),this.onChildViewPropsChange_=this.onChildViewPropsChange_.bind(this),this.onDescendantLayout_=this.onDescendantLayout_.bind(this),this.onDescendantInputChange_=this.onDescendantInputChange_.bind(this),this.onDescendantMonitorUpdate_=this.onDescendantMonitorUpdate_.bind(this),this.emitter=new O,this.blade_=(e=t.blade)!==null&&e!==void 0?e:null,(s=this.blade_)===null||s===void 0||s.value("positions").emitter.on("change",this.onBladePositionsChange_),this.viewProps=t.viewProps,this.bcSet_=new Ut(we),this.bcSet_.emitter.on("add",this.onSetAdd_),this.bcSet_.emitter.on("remove",this.onSetRemove_)}get children(){return this.bcSet_.items}add(t,e){var s;(s=t.parent)===null||s===void 0||s.remove(t),J(t,"parent")?t.parent=this:(t.parent_=this,Wt({key:"parent",target:"BladeController",place:"BladeRack.add"})),this.bcSet_.add(t,e)}remove(t){J(t,"parent")?t.parent=null:(t.parent_=null,Wt({key:"parent",target:"BladeController",place:"BladeRack.remove"})),this.bcSet_.remove(t)}find(t){return this.bcSet_.allItems().filter(e=>e instanceof t)}onSetAdd_(t){this.updatePositions_();const e=t.target===t.root;if(this.emitter.emit("add",{bladeController:t.item,index:t.index,isRoot:e,sender:this}),!e)return;const s=t.item;if(s.viewProps.emitter.on("change",this.onChildViewPropsChange_),s.blade.value("positions").emitter.on("change",this.onChildPositionsChange_),s.viewProps.handleDispose(this.onChildDispose_),s instanceof Kt)s.binding.emitter.on("change",this.onChildInputChange_);else if(s instanceof Ht)s.binding.emitter.on("update",this.onChildMonitorUpdate_);else if(s instanceof Ct)s.value.emitter.on("change",this.onChildValueChange_);else{const c=oe(s);if(c){const P=c.emitter;P.on("layout",this.onDescendantLayout_),P.on("inputchange",this.onDescendantInputChange_),P.on("monitorupdate",this.onDescendantMonitorUpdate_)}}}onSetRemove_(t){this.updatePositions_();const e=t.target===t.root;if(this.emitter.emit("remove",{bladeController:t.item,isRoot:e,sender:this}),!e)return;const s=t.item;if(s instanceof Kt)s.binding.emitter.off("change",this.onChildInputChange_);else if(s instanceof Ht)s.binding.emitter.off("update",this.onChildMonitorUpdate_);else if(s instanceof Ct)s.value.emitter.off("change",this.onChildValueChange_);else{const c=oe(s);if(c){const P=c.emitter;P.off("layout",this.onDescendantLayout_),P.off("inputchange",this.onDescendantInputChange_),P.off("monitorupdate",this.onDescendantMonitorUpdate_)}}}updatePositions_(){const t=this.bcSet_.items.filter(c=>!c.viewProps.get("hidden")),e=t[0],s=t[t.length-1];this.bcSet_.items.forEach(c=>{const P=[];c===e&&(P.push("first"),(!this.blade_||this.blade_.get("positions").includes("veryfirst"))&&P.push("veryfirst")),c===s&&(P.push("last"),(!this.blade_||this.blade_.get("positions").includes("verylast"))&&P.push("verylast")),c.blade.set("positions",P)})}onChildPositionsChange_(){this.updatePositions_(),this.emitter.emit("layout",{sender:this})}onChildViewPropsChange_(t){this.updatePositions_(),this.emitter.emit("layout",{sender:this})}onChildDispose_(){this.bcSet_.items.filter(e=>e.viewProps.get("disposed")).forEach(e=>{this.bcSet_.remove(e)})}onChildInputChange_(t){const e=Jt(this.find(Kt),t.sender);if(!e)throw z.alreadyDisposed();this.emitter.emit("inputchange",{bladeController:e,options:t.options,sender:this})}onChildMonitorUpdate_(t){const e=ue(this.find(Ht),t.sender);if(!e)throw z.alreadyDisposed();this.emitter.emit("monitorupdate",{bladeController:e,sender:this})}onChildValueChange_(t){const e=ge(this.find(Ct),t.sender);if(!e)throw z.alreadyDisposed();this.emitter.emit("inputchange",{bladeController:e,options:t.options,sender:this})}onDescendantLayout_(t){this.updatePositions_(),this.emitter.emit("layout",{sender:this})}onDescendantInputChange_(t){this.emitter.emit("inputchange",{bladeController:t.bladeController,options:t.options,sender:this})}onDescendantMonitorUpdate_(t){this.emitter.emit("monitorupdate",{bladeController:t.bladeController,sender:this})}onBladePositionsChange_(){this.updatePositions_()}}class Yt extends S{constructor(t,e){super(Object.assign(Object.assign({},e),{view:new ve(t,{viewName:"brk",viewProps:e.viewProps})})),this.onRackAdd_=this.onRackAdd_.bind(this),this.onRackRemove_=this.onRackRemove_.bind(this);const s=new xe({blade:e.root?void 0:e.blade,viewProps:e.viewProps});s.emitter.on("add",this.onRackAdd_),s.emitter.on("remove",this.onRackRemove_),this.rack=s,this.viewProps.handleDispose(()=>{for(let c=this.rack.children.length-1;c>=0;c--)this.rack.children[c].viewProps.set("disposed",!0)})}onRackAdd_(t){t.isRoot&&D(this.view.element,t.bladeController.view.element,t.index)}onRackRemove_(t){t.isRoot&&N(t.bladeController.view.element)}}const je=U("cnt");class ci{constructor(t,e){var s;this.className_=U((s=e.viewName)!==null&&s!==void 0?s:"fld"),this.element=t.createElement("div"),this.element.classList.add(this.className_(),je()),e.viewProps.bindClassModifiers(this.element),this.foldable_=e.foldable,this.foldable_.bindExpandedClass(this.element,this.className_(void 0,"expanded")),Y(this.foldable_,"completed",_t(this.element,this.className_(void 0,"cpl")));const c=t.createElement("button");c.classList.add(this.className_("b")),Y(e.props,"title",Bt=>{q(Bt)?this.element.classList.add(this.className_(void 0,"not")):this.element.classList.remove(this.className_(void 0,"not"))}),e.viewProps.bindDisabled(c),this.element.appendChild(c),this.buttonElement=c;const P=t.createElement("div");P.classList.add(this.className_("i")),this.element.appendChild(P);const T=t.createElement("div");T.classList.add(this.className_("t")),Vt(e.props.value("title"),T),this.buttonElement.appendChild(T),this.titleElement=T;const nt=t.createElement("div");nt.classList.add(this.className_("m")),this.buttonElement.appendChild(nt);const St=e.containerElement;St.classList.add(this.className_("c")),this.element.appendChild(St),this.containerElement=St}}class Vn extends me{constructor(t,e){var s;const c=Q.create((s=e.expanded)!==null&&s!==void 0?s:!0),P=new Yt(t,{blade:e.blade,root:e.root,viewProps:e.viewProps});super(Object.assign(Object.assign({},e),{rackController:P,view:new ci(t,{containerElement:P.view.element,foldable:c,props:e.props,viewName:e.root?"rot":void 0,viewProps:e.viewProps})})),this.onTitleClick_=this.onTitleClick_.bind(this),this.props=e.props,this.foldable=c,gt(this.foldable,this.view.containerElement),this.rackController.rack.emitter.on("add",()=>{this.foldable.cleanUpTransition()}),this.rackController.rack.emitter.on("remove",()=>{this.foldable.cleanUpTransition()}),this.view.buttonElement.addEventListener("click",this.onTitleClick_)}get document(){return this.view.element.ownerDocument}onTitleClick_(){this.foldable.set("expanded",!this.foldable.get("expanded"))}}const ui={id:"folder",type:"blade",accept(n){const t=xt,e=ht(n,{title:t.required.string,view:t.required.constant("folder"),expanded:t.optional.boolean});return e?{params:e}:null},controller(n){return new Vn(n.document,{blade:n.blade,expanded:n.params.expanded,props:st.fromObject({title:n.params.title}),viewProps:n.viewProps})},api(n){return n.controller instanceof Vn?new _e(n.controller,n.pool):null}};class Ke extends Ct{constructor(t,e){const s=e.valueController.viewProps;super(Object.assign(Object.assign({},e),{value:e.valueController.value,view:new yt(t,{props:e.props,viewProps:s}),viewProps:s})),this.props=e.props,this.valueController=e.valueController,this.view.valueElement.appendChild(this.valueController.view.element)}}class bs extends x{}const vs=U("spr");class di{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(vs()),e.viewProps.bindClassModifiers(this.element);const s=t.createElement("hr");s.classList.add(vs("r")),this.element.appendChild(s)}}class gs extends S{constructor(t,e){super(Object.assign(Object.assign({},e),{view:new di(t,{viewProps:e.viewProps})}))}}const pi={id:"separator",type:"blade",accept(n){const e=ht(n,{view:xt.required.constant("separator")});return e?{params:e}:null},controller(n){return new gs(n.document,{blade:n.blade,viewProps:n.viewProps})},api(n){return n.controller instanceof gs?new bs(n.controller):null}},nn=U("tbi");class hi{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(nn()),e.viewProps.bindClassModifiers(this.element),Y(e.props,"selected",P=>{P?this.element.classList.add(nn(void 0,"sel")):this.element.classList.remove(nn(void 0,"sel"))});const s=t.createElement("button");s.classList.add(nn("b")),e.viewProps.bindDisabled(s),this.element.appendChild(s),this.buttonElement=s;const c=t.createElement("div");c.classList.add(nn("t")),Vt(e.props.value("title"),c),this.buttonElement.appendChild(c),this.titleElement=c}}class fi{constructor(t,e){this.emitter=new O,this.onClick_=this.onClick_.bind(this),this.props=e.props,this.viewProps=e.viewProps,this.view=new hi(t,{props:e.props,viewProps:e.viewProps}),this.view.buttonElement.addEventListener("click",this.onClick_)}onClick_(){this.emitter.emit("click",{sender:this})}}class ws{constructor(t,e){this.onItemClick_=this.onItemClick_.bind(this),this.ic_=new fi(t,{props:e.itemProps,viewProps:f.create()}),this.ic_.emitter.on("click",this.onItemClick_),this.cc_=new Yt(t,{blade:At(),viewProps:f.create()}),this.props=e.props,Y(this.props,"selected",s=>{this.itemController.props.set("selected",s),this.contentController.viewProps.set("hidden",!s)})}get itemController(){return this.ic_}get contentController(){return this.cc_}onItemClick_(){this.props.set("selected",!0)}}class xs{constructor(t,e){this.controller_=t,this.rackApi_=e}get title(){var t;return(t=this.controller_.itemController.props.get("title"))!==null&&t!==void 0?t:""}set title(t){this.controller_.itemController.props.set("title",t)}get selected(){return this.controller_.props.get("selected")}set selected(t){this.controller_.props.set("selected",t)}get children(){return this.rackApi_.children}addButton(t){return this.rackApi_.addButton(t)}addFolder(t){return this.rackApi_.addFolder(t)}addSeparator(t){return this.rackApi_.addSeparator(t)}addTab(t){return this.rackApi_.addTab(t)}add(t,e){this.rackApi_.add(t,e)}remove(t){this.rackApi_.remove(t)}addInput(t,e,s){return this.rackApi_.addInput(t,e,s)}addMonitor(t,e,s){return this.rackApi_.addMonitor(t,e,s)}addBlade(t){return this.rackApi_.addBlade(t)}}class ys extends Pt{constructor(t,e){super(t,new fe(t.rackController,e)),this.onPageAdd_=this.onPageAdd_.bind(this),this.onPageRemove_=this.onPageRemove_.bind(this),this.onSelect_=this.onSelect_.bind(this),this.emitter_=new O,this.pageApiMap_=new Map,this.rackApi_.on("change",s=>{this.emitter_.emit("change",{event:s})}),this.rackApi_.on("update",s=>{this.emitter_.emit("update",{event:s})}),this.controller_.tab.selectedIndex.emitter.on("change",this.onSelect_),this.controller_.pageSet.emitter.on("add",this.onPageAdd_),this.controller_.pageSet.emitter.on("remove",this.onPageRemove_),this.controller_.pageSet.items.forEach(s=>{this.setUpPageApi_(s)})}get pages(){return this.controller_.pageSet.items.map(t=>{const e=this.pageApiMap_.get(t);if(!e)throw z.shouldNeverHappen();return e})}addPage(t){const e=this.controller_.view.element.ownerDocument,s=new ws(e,{itemProps:st.fromObject({selected:!1,title:t.title}),props:st.fromObject({selected:!1})});this.controller_.add(s,t.index);const c=this.pageApiMap_.get(s);if(!c)throw z.shouldNeverHappen();return c}removePage(t){this.controller_.remove(t)}on(t,e){const s=e.bind(this);return this.emitter_.on(t,c=>{s(c.event)}),this}setUpPageApi_(t){const e=this.rackApi_.apiSet_.find(c=>c.controller_===t.contentController);if(!e)throw z.shouldNeverHappen();const s=new xs(t,e);this.pageApiMap_.set(t,s)}onPageAdd_(t){this.setUpPageApi_(t.item)}onPageRemove_(t){if(!this.pageApiMap_.get(t.item))throw z.shouldNeverHappen();this.pageApiMap_.delete(t.item)}onSelect_(t){this.emitter_.emit("select",{event:new L(this,t.rawValue)})}}const Ps=-1;class _i{constructor(){this.onItemSelectedChange_=this.onItemSelectedChange_.bind(this),this.empty=H(!0),this.selectedIndex=H(Ps),this.items_=[]}add(t,e){const s=e??this.items_.length;this.items_.splice(s,0,t),t.emitter.on("change",this.onItemSelectedChange_),this.keepSelection_()}remove(t){const e=this.items_.indexOf(t);e<0||(this.items_.splice(e,1),t.emitter.off("change",this.onItemSelectedChange_),this.keepSelection_())}keepSelection_(){if(this.items_.length===0){this.selectedIndex.rawValue=Ps,this.empty.rawValue=!0;return}const t=this.items_.findIndex(e=>e.rawValue);t<0?(this.items_.forEach((e,s)=>{e.rawValue=s===0}),this.selectedIndex.rawValue=0):(this.items_.forEach((e,s)=>{e.rawValue=s===t}),this.selectedIndex.rawValue=t),this.empty.rawValue=!1}onItemSelectedChange_(t){if(t.rawValue){const e=this.items_.findIndex(s=>s===t.sender);this.items_.forEach((s,c)=>{s.rawValue=c===e}),this.selectedIndex.rawValue=e}else this.keepSelection_()}}const sn=U("tab");class mi{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(sn(),je()),e.viewProps.bindClassModifiers(this.element),X(e.empty,_t(this.element,sn(void 0,"nop")));const s=t.createElement("div");s.classList.add(sn("t")),this.element.appendChild(s),this.itemsElement=s;const c=t.createElement("div");c.classList.add(sn("i")),this.element.appendChild(c);const P=e.contentsElement;P.classList.add(sn("c")),this.element.appendChild(P),this.contentsElement=P}}class Ss extends me{constructor(t,e){const s=new Yt(t,{blade:e.blade,viewProps:e.viewProps}),c=new _i;super({blade:e.blade,rackController:s,view:new mi(t,{contentsElement:s.view.element,empty:c.empty,viewProps:e.viewProps})}),this.onPageAdd_=this.onPageAdd_.bind(this),this.onPageRemove_=this.onPageRemove_.bind(this),this.pageSet_=new Ut(()=>null),this.pageSet_.emitter.on("add",this.onPageAdd_),this.pageSet_.emitter.on("remove",this.onPageRemove_),this.tab=c}get pageSet(){return this.pageSet_}add(t,e){this.pageSet_.add(t,e)}remove(t){this.pageSet_.remove(this.pageSet_.items[t])}onPageAdd_(t){const e=t.item;D(this.view.itemsElement,e.itemController.view.element,t.index),e.itemController.viewProps.set("parent",this.viewProps),this.rackController.rack.add(e.contentController,t.index),this.tab.add(e.props.value("selected"))}onPageRemove_(t){const e=t.item;N(e.itemController.view.element),e.itemController.viewProps.set("parent",null),this.rackController.rack.remove(e.contentController),this.tab.remove(e.props.value("selected"))}}const ks={id:"tab",type:"blade",accept(n){const t=xt,e=ht(n,{pages:t.required.array(t.required.object({title:t.required.string})),view:t.required.constant("tab")});return!e||e.pages.length===0?null:{params:e}},controller(n){const t=new Ss(n.document,{blade:n.blade,viewProps:n.viewProps});return n.params.pages.forEach(e=>{const s=new ws(n.document,{itemProps:st.fromObject({selected:!1,title:e.title}),props:st.fromObject({selected:!1})});t.add(s)}),t},api(n){return n.controller instanceof Ss?new ys(n.controller,n.pool):null}};function bi(n,t){const e=n.accept(t.params);if(!e)return null;const s=xt.optional.boolean(t.params.disabled).value,c=xt.optional.boolean(t.params.hidden).value;return n.controller({blade:At(),document:t.document,params:Object.assign(Object.assign({},e.params),{disabled:s,hidden:c}),viewProps:f.create({disabled:s,hidden:c})})}class vi{constructor(){this.disabled=!1,this.emitter=new O}dispose(){}tick(){this.disabled||this.emitter.emit("tick",{sender:this})}}class gi{constructor(t,e){this.disabled_=!1,this.timerId_=null,this.onTick_=this.onTick_.bind(this),this.doc_=t,this.emitter=new O,this.interval_=e,this.setTimer_()}get disabled(){return this.disabled_}set disabled(t){this.disabled_=t,this.disabled_?this.clearTimer_():this.setTimer_()}dispose(){this.clearTimer_()}clearTimer_(){if(this.timerId_===null)return;const t=this.doc_.defaultView;t&&t.clearInterval(this.timerId_),this.timerId_=null}setTimer_(){if(this.clearTimer_(),this.interval_<=0)return;const t=this.doc_.defaultView;t&&(this.timerId_=t.setInterval(this.onTick_,this.interval_))}onTick_(){this.disabled_||this.emitter.emit("tick",{sender:this})}}class wi{constructor(t){this.onValueChange_=this.onValueChange_.bind(this),this.reader=t.reader,this.writer=t.writer,this.emitter=new O,this.value=t.value,this.value.emitter.on("change",this.onValueChange_),this.target=t.target,this.read()}read(){const t=this.target.read();t!==void 0&&(this.value.rawValue=this.reader(t))}write_(t){this.writer(this.target,t)}onValueChange_(t){this.write_(t.rawValue),this.emitter.emit("change",{options:t.options,rawValue:t.rawValue,sender:this})}}function Cs(n,t){for(;n.length<t;)n.push(void 0)}function xi(n){const t=[];return Cs(t,n),H(t)}function yi(n){const t=n.indexOf(void 0);return t<0?n:n.slice(0,t)}function Pi(n,t){const e=[...yi(n),t];return e.length>n.length?e.splice(0,e.length-n.length):Cs(e,n.length),e}class Si{constructor(t){this.onTick_=this.onTick_.bind(this),this.reader_=t.reader,this.target=t.target,this.emitter=new O,this.value=t.value,this.ticker=t.ticker,this.ticker.emitter.on("tick",this.onTick_),this.read()}dispose(){this.ticker.dispose()}read(){const t=this.target.read();if(t===void 0)return;const e=this.value.rawValue,s=this.reader_(t);this.value.rawValue=Pi(e,s),this.emitter.emit("update",{rawValue:s,sender:this})}onTick_(t){this.read()}}class rn{constructor(t){this.constraints=t}constrain(t){return this.constraints.reduce((e,s)=>s.constrain(e),t)}}function ye(n,t){if(n instanceof t)return n;if(n instanceof rn){const e=n.constraints.reduce((s,c)=>s||(c instanceof t?c:null),null);if(e)return e}return null}class He{constructor(t){this.values=st.fromObject({max:t.max,min:t.min})}constrain(t){const e=this.values.get("max"),s=this.values.get("min");return Math.min(Math.max(t,s),e)}}class on{constructor(t){this.values=st.fromObject({options:t})}get options(){return this.values.get("options")}constrain(t){const e=this.values.get("options");return e.length===0||e.filter(c=>c.value===t).length>0?t:e[0].value}}class Es{constructor(t){this.values=st.fromObject({max:t.max,min:t.min})}get maxValue(){return this.values.get("max")}get minValue(){return this.values.get("min")}constrain(t){const e=this.values.get("max"),s=this.values.get("min");let c=t;return q(s)||(c=Math.max(c,s)),q(e)||(c=Math.min(c,e)),c}}class yn{constructor(t,e=0){this.step=t,this.origin=e}constrain(t){const e=this.origin%this.step,s=Math.round((t-e)/this.step);return e+s*this.step}}const Gn=U("lst");class ki{constructor(t,e){this.onValueChange_=this.onValueChange_.bind(this),this.props_=e.props,this.element=t.createElement("div"),this.element.classList.add(Gn()),e.viewProps.bindClassModifiers(this.element);const s=t.createElement("select");s.classList.add(Gn("s")),e.viewProps.bindDisabled(s),this.element.appendChild(s),this.selectElement=s;const c=t.createElement("div");c.classList.add(Gn("m")),c.appendChild(v(t,"dropdown")),this.element.appendChild(c),e.value.emitter.on("change",this.onValueChange_),this.value_=e.value,Y(this.props_,"options",P=>{$(this.selectElement),P.forEach(T=>{const nt=t.createElement("option");nt.textContent=T.text,this.selectElement.appendChild(nt)}),this.update_()})}update_(){const t=this.props_.get("options").map(e=>e.value);this.selectElement.selectedIndex=t.indexOf(this.value_.rawValue)}onValueChange_(){this.update_()}}class an{constructor(t,e){this.onSelectChange_=this.onSelectChange_.bind(this),this.props=e.props,this.value=e.value,this.viewProps=e.viewProps,this.view=new ki(t,{props:this.props,value:this.value,viewProps:this.viewProps}),this.view.selectElement.addEventListener("change",this.onSelectChange_)}onSelectChange_(t){const e=t.currentTarget;this.value.rawValue=this.props.get("options")[e.selectedIndex].value}}const Ms=U("pop");class Ci{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(Ms()),e.viewProps.bindClassModifiers(this.element),X(e.shows,_t(this.element,Ms(void 0,"v")))}}class Bs{constructor(t,e){this.shows=H(!1),this.viewProps=e.viewProps,this.view=new Ci(t,{shows:this.shows,viewProps:this.viewProps})}}const Ts=U("txt");class Ei{constructor(t,e){this.onChange_=this.onChange_.bind(this),this.element=t.createElement("div"),this.element.classList.add(Ts()),e.viewProps.bindClassModifiers(this.element),this.props_=e.props,this.props_.emitter.on("change",this.onChange_);const s=t.createElement("input");s.classList.add(Ts("i")),s.type="text",e.viewProps.bindDisabled(s),this.element.appendChild(s),this.inputElement=s,e.value.emitter.on("change",this.onChange_),this.value_=e.value,this.refresh()}refresh(){const t=this.props_.get("formatter");this.inputElement.value=t(this.value_.rawValue)}onChange_(){this.refresh()}}class Pn{constructor(t,e){this.onInputChange_=this.onInputChange_.bind(this),this.parser_=e.parser,this.props=e.props,this.value=e.value,this.viewProps=e.viewProps,this.view=new Ei(t,{props:e.props,value:this.value,viewProps:this.viewProps}),this.view.inputElement.addEventListener("change",this.onInputChange_)}onInputChange_(t){const s=t.currentTarget.value,c=this.parser_(s);q(c)||(this.value.rawValue=c),this.view.refresh()}}function Mi(n){return String(n)}function Ds(n){return n==="false"?!1:!!n}function As(n){return Mi(n)}class Bi{constructor(t){this.text=t}evaluate(){return Number(this.text)}toString(){return this.text}}const Ti={"**":(n,t)=>Math.pow(n,t),"*":(n,t)=>n*t,"/":(n,t)=>n/t,"%":(n,t)=>n%t,"+":(n,t)=>n+t,"-":(n,t)=>n-t,"<<":(n,t)=>n<<t,">>":(n,t)=>n>>t,">>>":(n,t)=>n>>>t,"&":(n,t)=>n&t,"^":(n,t)=>n^t,"|":(n,t)=>n|t};class Di{constructor(t,e,s){this.left=e,this.operator=t,this.right=s}evaluate(){const t=Ti[this.operator];if(!t)throw new Error(`unexpected binary operator: '${this.operator}`);return t(this.left.evaluate(),this.right.evaluate())}toString(){return["b(",this.left.toString(),this.operator,this.right.toString(),")"].join(" ")}}const Ai={"+":n=>n,"-":n=>-n,"~":n=>~n};class Ri{constructor(t,e){this.operator=t,this.expression=e}evaluate(){const t=Ai[this.operator];if(!t)throw new Error(`unexpected unary operator: '${this.operator}`);return t(this.expression.evaluate())}toString(){return["u(",this.operator,this.expression.toString(),")"].join(" ")}}function zn(n){return(t,e)=>{for(let s=0;s<n.length;s++){const c=n[s](t,e);if(c!=="")return c}return""}}function ln(n,t){var e;const s=n.substr(t).match(/^\s+/);return(e=s&&s[0])!==null&&e!==void 0?e:""}function Ii(n,t){const e=n.substr(t,1);return e.match(/^[1-9]$/)?e:""}function cn(n,t){var e;const s=n.substr(t).match(/^[0-9]+/);return(e=s&&s[0])!==null&&e!==void 0?e:""}function Li(n,t){const e=cn(n,t);if(e!=="")return e;const s=n.substr(t,1);if(t+=1,s!=="-"&&s!=="+")return"";const c=cn(n,t);return c===""?"":s+c}function On(n,t){const e=n.substr(t,1);if(t+=1,e.toLowerCase()!=="e")return"";const s=Li(n,t);return s===""?"":e+s}function Rs(n,t){const e=n.substr(t,1);if(e==="0")return e;const s=Ii(n,t);return t+=s.length,s===""?"":s+cn(n,t)}function Ui(n,t){const e=Rs(n,t);if(t+=e.length,e==="")return"";const s=n.substr(t,1);if(t+=s.length,s!==".")return"";const c=cn(n,t);return t+=c.length,e+s+c+On(n,t)}function Vi(n,t){const e=n.substr(t,1);if(t+=e.length,e!==".")return"";const s=cn(n,t);return t+=s.length,s===""?"":e+s+On(n,t)}function Gi(n,t){const e=Rs(n,t);return t+=e.length,e===""?"":e+On(n,t)}const zi=zn([Ui,Vi,Gi]);function Oi(n,t){var e;const s=n.substr(t).match(/^[01]+/);return(e=s&&s[0])!==null&&e!==void 0?e:""}function Fi(n,t){const e=n.substr(t,2);if(t+=e.length,e.toLowerCase()!=="0b")return"";const s=Oi(n,t);return s===""?"":e+s}function qi(n,t){var e;const s=n.substr(t).match(/^[0-7]+/);return(e=s&&s[0])!==null&&e!==void 0?e:""}function Ni(n,t){const e=n.substr(t,2);if(t+=e.length,e.toLowerCase()!=="0o")return"";const s=qi(n,t);return s===""?"":e+s}function $i(n,t){var e;const s=n.substr(t).match(/^[0-9a-f]+/i);return(e=s&&s[0])!==null&&e!==void 0?e:""}function Wi(n,t){const e=n.substr(t,2);if(t+=e.length,e.toLowerCase()!=="0x")return"";const s=$i(n,t);return s===""?"":e+s}const ji=zn([Fi,Ni,Wi]),Ki=zn([ji,zi]);function Hi(n,t){const e=Ki(n,t);return t+=e.length,e===""?null:{evaluable:new Bi(e),cursor:t}}function Yi(n,t){const e=n.substr(t,1);if(t+=e.length,e!=="(")return null;const s=Ls(n,t);if(!s)return null;t=s.cursor,t+=ln(n,t).length;const c=n.substr(t,1);return t+=c.length,c!==")"?null:{evaluable:s.evaluable,cursor:t}}function Zi(n,t){var e;return(e=Hi(n,t))!==null&&e!==void 0?e:Yi(n,t)}function Is(n,t){const e=Zi(n,t);if(e)return e;const s=n.substr(t,1);if(t+=s.length,s!=="+"&&s!=="-"&&s!=="~")return null;const c=Is(n,t);return c?(t=c.cursor,{cursor:t,evaluable:new Ri(s,c.evaluable)}):null}function Xi(n,t,e){e+=ln(t,e).length;const s=n.filter(c=>t.startsWith(c,e))[0];return s?(e+=s.length,e+=ln(t,e).length,{cursor:e,operator:s}):null}function Qi(n,t){return(e,s)=>{const c=n(e,s);if(!c)return null;s=c.cursor;let P=c.evaluable;for(;;){const T=Xi(t,e,s);if(!T)break;s=T.cursor;const nt=n(e,s);if(!nt)return null;s=nt.cursor,P=new Di(T.operator,P,nt.evaluable)}return P?{cursor:s,evaluable:P}:null}}const Ji=[["**"],["*","/","%"],["+","-"],["<<",">>>",">>"],["&"],["^"],["|"]].reduce((n,t)=>Qi(n,t),Is);function Ls(n,t){return t+=ln(n,t).length,Ji(n,t)}function to(n){const t=Ls(n,0);return!t||t.cursor+ln(n,t.cursor).length!==n.length?null:t.evaluable}function Pe(n){var t;const e=to(n);return(t=e==null?void 0:e.evaluate())!==null&&t!==void 0?t:null}function Us(n){if(typeof n=="number")return n;if(typeof n=="string"){const t=Pe(n);if(!q(t))return t}return 0}function eo(n){return String(n)}function ne(n){return t=>t.toFixed(Math.max(Math.min(n,20),0))}const no=ne(0);function Sn(n){return no(n)+"%"}function Vs(n){return String(n)}function Fn(n){return n}function un({primary:n,secondary:t,forward:e,backward:s}){let c=!1;function P(T){c||(c=!0,T(),c=!1)}n.emitter.on("change",T=>{P(()=>{t.setRawValue(e(n,t),T.options)})}),t.emitter.on("change",T=>{P(()=>{n.setRawValue(s(n,t),T.options)}),P(()=>{t.setRawValue(e(n,t),T.options)})}),P(()=>{t.setRawValue(e(n,t),{forceEmit:!1,last:!0})})}function ae(n,t){const e=n*(t.altKey?.1:1)*(t.shiftKey?10:1);return t.upKey?+e:t.downKey?-e:0}function dn(n){return{altKey:n.altKey,downKey:n.key==="ArrowDown",shiftKey:n.shiftKey,upKey:n.key==="ArrowUp"}}function Se(n){return{altKey:n.altKey,downKey:n.key==="ArrowLeft",shiftKey:n.shiftKey,upKey:n.key==="ArrowRight"}}function so(n){return n==="ArrowUp"||n==="ArrowDown"}function Gs(n){return so(n)||n==="ArrowLeft"||n==="ArrowRight"}function qn(n,t){var e,s;const c=t.ownerDocument.defaultView,P=t.getBoundingClientRect();return{x:n.pageX-(((e=c&&c.scrollX)!==null&&e!==void 0?e:0)+P.left),y:n.pageY-(((s=c&&c.scrollY)!==null&&s!==void 0?s:0)+P.top)}}class Ie{constructor(t){this.lastTouch_=null,this.onDocumentMouseMove_=this.onDocumentMouseMove_.bind(this),this.onDocumentMouseUp_=this.onDocumentMouseUp_.bind(this),this.onMouseDown_=this.onMouseDown_.bind(this),this.onTouchEnd_=this.onTouchEnd_.bind(this),this.onTouchMove_=this.onTouchMove_.bind(this),this.onTouchStart_=this.onTouchStart_.bind(this),this.elem_=t,this.emitter=new O,t.addEventListener("touchstart",this.onTouchStart_,{passive:!1}),t.addEventListener("touchmove",this.onTouchMove_,{passive:!0}),t.addEventListener("touchend",this.onTouchEnd_),t.addEventListener("mousedown",this.onMouseDown_)}computePosition_(t){const e=this.elem_.getBoundingClientRect();return{bounds:{width:e.width,height:e.height},point:t?{x:t.x,y:t.y}:null}}onMouseDown_(t){var e;t.preventDefault(),(e=t.currentTarget)===null||e===void 0||e.focus();const s=this.elem_.ownerDocument;s.addEventListener("mousemove",this.onDocumentMouseMove_),s.addEventListener("mouseup",this.onDocumentMouseUp_),this.emitter.emit("down",{altKey:t.altKey,data:this.computePosition_(qn(t,this.elem_)),sender:this,shiftKey:t.shiftKey})}onDocumentMouseMove_(t){this.emitter.emit("move",{altKey:t.altKey,data:this.computePosition_(qn(t,this.elem_)),sender:this,shiftKey:t.shiftKey})}onDocumentMouseUp_(t){const e=this.elem_.ownerDocument;e.removeEventListener("mousemove",this.onDocumentMouseMove_),e.removeEventListener("mouseup",this.onDocumentMouseUp_),this.emitter.emit("up",{altKey:t.altKey,data:this.computePosition_(qn(t,this.elem_)),sender:this,shiftKey:t.shiftKey})}onTouchStart_(t){t.preventDefault();const e=t.targetTouches.item(0),s=this.elem_.getBoundingClientRect();this.emitter.emit("down",{altKey:t.altKey,data:this.computePosition_(e?{x:e.clientX-s.left,y:e.clientY-s.top}:void 0),sender:this,shiftKey:t.shiftKey}),this.lastTouch_=e}onTouchMove_(t){const e=t.targetTouches.item(0),s=this.elem_.getBoundingClientRect();this.emitter.emit("move",{altKey:t.altKey,data:this.computePosition_(e?{x:e.clientX-s.left,y:e.clientY-s.top}:void 0),sender:this,shiftKey:t.shiftKey}),this.lastTouch_=e}onTouchEnd_(t){var e;const s=(e=t.targetTouches.item(0))!==null&&e!==void 0?e:this.lastTouch_,c=this.elem_.getBoundingClientRect();this.emitter.emit("up",{altKey:t.altKey,data:this.computePosition_(s?{x:s.clientX-c.left,y:s.clientY-c.top}:void 0),sender:this,shiftKey:t.shiftKey})}}function Zt(n,t,e,s,c){const P=(n-t)/(e-t);return s+P*(c-s)}function zs(n){return String(n.toFixed(10)).split(".")[1].replace(/0+$/,"").length}function te(n,t,e){return Math.min(Math.max(n,t),e)}function Os(n,t){return(n%t+t)%t}const de=U("txt");class ro{constructor(t,e){this.onChange_=this.onChange_.bind(this),this.props_=e.props,this.props_.emitter.on("change",this.onChange_),this.element=t.createElement("div"),this.element.classList.add(de(),de(void 0,"num")),e.arrayPosition&&this.element.classList.add(de(void 0,e.arrayPosition)),e.viewProps.bindClassModifiers(this.element);const s=t.createElement("input");s.classList.add(de("i")),s.type="text",e.viewProps.bindDisabled(s),this.element.appendChild(s),this.inputElement=s,this.onDraggingChange_=this.onDraggingChange_.bind(this),this.dragging_=e.dragging,this.dragging_.emitter.on("change",this.onDraggingChange_),this.element.classList.add(de()),this.inputElement.classList.add(de("i"));const c=t.createElement("div");c.classList.add(de("k")),this.element.appendChild(c),this.knobElement=c;const P=t.createElementNS(k,"svg");P.classList.add(de("g")),this.knobElement.appendChild(P);const T=t.createElementNS(k,"path");T.classList.add(de("gb")),P.appendChild(T),this.guideBodyElem_=T;const nt=t.createElementNS(k,"path");nt.classList.add(de("gh")),P.appendChild(nt),this.guideHeadElem_=nt;const St=t.createElement("div");St.classList.add(U("tt")()),this.knobElement.appendChild(St),this.tooltipElem_=St,e.value.emitter.on("change",this.onChange_),this.value=e.value,this.refresh()}onDraggingChange_(t){if(t.rawValue===null){this.element.classList.remove(de(void 0,"drg"));return}this.element.classList.add(de(void 0,"drg"));const e=t.rawValue/this.props_.get("draggingScale"),s=e+(e>0?-1:e<0?1:0),c=te(-s,-4,4);this.guideHeadElem_.setAttributeNS(null,"d",[`M ${s+c},0 L${s},4 L${s+c},8`,`M ${e},-1 L${e},9`].join(" ")),this.guideBodyElem_.setAttributeNS(null,"d",`M 0,4 L${e},4`);const P=this.props_.get("formatter");this.tooltipElem_.textContent=P(this.value.rawValue),this.tooltipElem_.style.left=`${e}px`}refresh(){const t=this.props_.get("formatter");this.inputElement.value=t(this.value.rawValue)}onChange_(){this.refresh()}}class pn{constructor(t,e){var s;this.originRawValue_=0,this.onInputChange_=this.onInputChange_.bind(this),this.onInputKeyDown_=this.onInputKeyDown_.bind(this),this.onInputKeyUp_=this.onInputKeyUp_.bind(this),this.onPointerDown_=this.onPointerDown_.bind(this),this.onPointerMove_=this.onPointerMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.baseStep_=e.baseStep,this.parser_=e.parser,this.props=e.props,this.sliderProps_=(s=e.sliderProps)!==null&&s!==void 0?s:null,this.value=e.value,this.viewProps=e.viewProps,this.dragging_=H(null),this.view=new ro(t,{arrayPosition:e.arrayPosition,dragging:this.dragging_,props:this.props,value:this.value,viewProps:this.viewProps}),this.view.inputElement.addEventListener("change",this.onInputChange_),this.view.inputElement.addEventListener("keydown",this.onInputKeyDown_),this.view.inputElement.addEventListener("keyup",this.onInputKeyUp_);const c=new Ie(this.view.knobElement);c.emitter.on("down",this.onPointerDown_),c.emitter.on("move",this.onPointerMove_),c.emitter.on("up",this.onPointerUp_)}constrainValue_(t){var e,s;const c=(e=this.sliderProps_)===null||e===void 0?void 0:e.get("minValue"),P=(s=this.sliderProps_)===null||s===void 0?void 0:s.get("maxValue");let T=t;return c!==void 0&&(T=Math.max(T,c)),P!==void 0&&(T=Math.min(T,P)),T}onInputChange_(t){const s=t.currentTarget.value,c=this.parser_(s);q(c)||(this.value.rawValue=this.constrainValue_(c)),this.view.refresh()}onInputKeyDown_(t){const e=ae(this.baseStep_,dn(t));e!==0&&this.value.setRawValue(this.constrainValue_(this.value.rawValue+e),{forceEmit:!1,last:!1})}onInputKeyUp_(t){ae(this.baseStep_,dn(t))!==0&&this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}onPointerDown_(){this.originRawValue_=this.value.rawValue,this.dragging_.rawValue=0}computeDraggingValue_(t){if(!t.point)return null;const e=t.point.x-t.bounds.width/2;return this.constrainValue_(this.originRawValue_+e*this.props.get("draggingScale"))}onPointerMove_(t){const e=this.computeDraggingValue_(t.data);e!==null&&(this.value.setRawValue(e,{forceEmit:!1,last:!1}),this.dragging_.rawValue=this.value.rawValue-this.originRawValue_)}onPointerUp_(t){const e=this.computeDraggingValue_(t.data);e!==null&&(this.value.setRawValue(e,{forceEmit:!0,last:!0}),this.dragging_.rawValue=null)}}const Nn=U("sld");class io{constructor(t,e){this.onChange_=this.onChange_.bind(this),this.props_=e.props,this.props_.emitter.on("change",this.onChange_),this.element=t.createElement("div"),this.element.classList.add(Nn()),e.viewProps.bindClassModifiers(this.element);const s=t.createElement("div");s.classList.add(Nn("t")),e.viewProps.bindTabIndex(s),this.element.appendChild(s),this.trackElement=s;const c=t.createElement("div");c.classList.add(Nn("k")),this.trackElement.appendChild(c),this.knobElement=c,e.value.emitter.on("change",this.onChange_),this.value=e.value,this.update_()}update_(){const t=te(Zt(this.value.rawValue,this.props_.get("minValue"),this.props_.get("maxValue"),0,100),0,100);this.knobElement.style.width=`${t}%`}onChange_(){this.update_()}}class oo{constructor(t,e){this.onKeyDown_=this.onKeyDown_.bind(this),this.onKeyUp_=this.onKeyUp_.bind(this),this.onPointerDownOrMove_=this.onPointerDownOrMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.baseStep_=e.baseStep,this.value=e.value,this.viewProps=e.viewProps,this.props=e.props,this.view=new io(t,{props:this.props,value:this.value,viewProps:this.viewProps}),this.ptHandler_=new Ie(this.view.trackElement),this.ptHandler_.emitter.on("down",this.onPointerDownOrMove_),this.ptHandler_.emitter.on("move",this.onPointerDownOrMove_),this.ptHandler_.emitter.on("up",this.onPointerUp_),this.view.trackElement.addEventListener("keydown",this.onKeyDown_),this.view.trackElement.addEventListener("keyup",this.onKeyUp_)}handlePointerEvent_(t,e){t.point&&this.value.setRawValue(Zt(te(t.point.x,0,t.bounds.width),0,t.bounds.width,this.props.get("minValue"),this.props.get("maxValue")),e)}onPointerDownOrMove_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerUp_(t){this.handlePointerEvent_(t.data,{forceEmit:!0,last:!0})}onKeyDown_(t){const e=ae(this.baseStep_,Se(t));e!==0&&this.value.setRawValue(this.value.rawValue+e,{forceEmit:!1,last:!1})}onKeyUp_(t){ae(this.baseStep_,Se(t))!==0&&this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}}const $n=U("sldtxt");class ao{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add($n());const s=t.createElement("div");s.classList.add($n("s")),this.sliderView_=e.sliderView,s.appendChild(this.sliderView_.element),this.element.appendChild(s);const c=t.createElement("div");c.classList.add($n("t")),this.textView_=e.textView,c.appendChild(this.textView_.element),this.element.appendChild(c)}}class Wn{constructor(t,e){this.value=e.value,this.viewProps=e.viewProps,this.sliderC_=new oo(t,{baseStep:e.baseStep,props:e.sliderProps,value:e.value,viewProps:this.viewProps}),this.textC_=new pn(t,{baseStep:e.baseStep,parser:e.parser,props:e.textProps,sliderProps:e.sliderProps,value:e.value,viewProps:e.viewProps}),this.view=new ao(t,{sliderView:this.sliderC_.view,textView:this.textC_.view})}get sliderController(){return this.sliderC_}get textController(){return this.textC_}}function hn(n,t){n.write(t)}function kn(n){const t=xt;if(Array.isArray(n))return t.required.array(t.required.object({text:t.required.string,value:t.required.raw}))(n).value;if(typeof n=="object")return t.required.raw(n).value}function Fs(n){if(n==="inline"||n==="popup")return n}function Ee(n){const t=xt;return t.required.object({max:t.optional.number,min:t.optional.number,step:t.optional.number})(n).value}function qs(n){if(Array.isArray(n))return n;const t=[];return Object.keys(n).forEach(e=>{t.push({text:e,value:n[e]})}),t}function jn(n){return q(n)?null:new on(qs(n))}function lo(n){const t=n?ye(n,yn):null;return t?t.step:null}function Cn(n,t){const e=n&&ye(n,yn);return e?zs(e.step):Math.max(zs(t),2)}function Ye(n){const t=lo(n);return t??1}function Ze(n,t){var e;const s=n&&ye(n,yn),c=Math.abs((e=s==null?void 0:s.step)!==null&&e!==void 0?e:t);return c===0?.1:Math.pow(10,Math.floor(Math.log10(c))-1)}const En=U("ckb");class co{constructor(t,e){this.onValueChange_=this.onValueChange_.bind(this),this.element=t.createElement("div"),this.element.classList.add(En()),e.viewProps.bindClassModifiers(this.element);const s=t.createElement("label");s.classList.add(En("l")),this.element.appendChild(s);const c=t.createElement("input");c.classList.add(En("i")),c.type="checkbox",s.appendChild(c),this.inputElement=c,e.viewProps.bindDisabled(this.inputElement);const P=t.createElement("div");P.classList.add(En("w")),s.appendChild(P);const T=v(t,"check");P.appendChild(T),e.value.emitter.on("change",this.onValueChange_),this.value=e.value,this.update_()}update_(){this.inputElement.checked=this.value.rawValue}onValueChange_(){this.update_()}}class uo{constructor(t,e){this.onInputChange_=this.onInputChange_.bind(this),this.value=e.value,this.viewProps=e.viewProps,this.view=new co(t,{value:this.value,viewProps:this.viewProps}),this.view.inputElement.addEventListener("change",this.onInputChange_)}onInputChange_(t){const e=t.currentTarget;this.value.rawValue=e.checked}}function po(n){const t=[],e=jn(n.options);return e&&t.push(e),new rn(t)}const ho={id:"input-bool",type:"input",accept:(n,t)=>{if(typeof n!="boolean")return null;const s=ht(t,{options:xt.optional.custom(kn)});return s?{initialValue:n,params:s}:null},binding:{reader:n=>Ds,constraint:n=>po(n.params),writer:n=>hn},controller:n=>{const t=n.document,e=n.value,s=n.constraint,c=s&&ye(s,on);return c?new an(t,{props:new st({options:c.values.value("options")}),value:e,viewProps:n.viewProps}):new uo(t,{value:e,viewProps:n.viewProps})}},Le=U("col");class fo{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(Le()),e.foldable.bindExpandedClass(this.element,Le(void 0,"expanded")),Y(e.foldable,"completed",_t(this.element,Le(void 0,"cpl")));const s=t.createElement("div");s.classList.add(Le("h")),this.element.appendChild(s);const c=t.createElement("div");c.classList.add(Le("s")),s.appendChild(c),this.swatchElement=c;const P=t.createElement("div");if(P.classList.add(Le("t")),s.appendChild(P),this.textElement=P,e.pickerLayout==="inline"){const T=t.createElement("div");T.classList.add(Le("p")),this.element.appendChild(T),this.pickerElement=T}else this.pickerElement=null}}function _o(n,t,e){const s=te(n/255,0,1),c=te(t/255,0,1),P=te(e/255,0,1),T=Math.max(s,c,P),nt=Math.min(s,c,P),St=T-nt;let Bt=0,Nt=0;const $t=(nt+T)/2;return St!==0&&(Nt=St/(1-Math.abs(T+nt-1)),s===T?Bt=(c-P)/St:c===T?Bt=2+(P-s)/St:Bt=4+(s-c)/St,Bt=Bt/6+(Bt<0?1:0)),[Bt*360,Nt*100,$t*100]}function mo(n,t,e){const s=(n%360+360)%360,c=te(t/100,0,1),P=te(e/100,0,1),T=(1-Math.abs(2*P-1))*c,nt=T*(1-Math.abs(s/60%2-1)),St=P-T/2;let Bt,Nt,$t;return s>=0&&s<60?[Bt,Nt,$t]=[T,nt,0]:s>=60&&s<120?[Bt,Nt,$t]=[nt,T,0]:s>=120&&s<180?[Bt,Nt,$t]=[0,T,nt]:s>=180&&s<240?[Bt,Nt,$t]=[0,nt,T]:s>=240&&s<300?[Bt,Nt,$t]=[nt,0,T]:[Bt,Nt,$t]=[T,0,nt],[(Bt+St)*255,(Nt+St)*255,($t+St)*255]}function bo(n,t,e){const s=te(n/255,0,1),c=te(t/255,0,1),P=te(e/255,0,1),T=Math.max(s,c,P),nt=Math.min(s,c,P),St=T-nt;let Bt;St===0?Bt=0:T===s?Bt=60*(((c-P)/St%6+6)%6):T===c?Bt=60*((P-s)/St+2):Bt=60*((s-c)/St+4);const Nt=T===0?0:St/T,$t=T;return[Bt,Nt*100,$t*100]}function Ns(n,t,e){const s=Os(n,360),c=te(t/100,0,1),P=te(e/100,0,1),T=P*c,nt=T*(1-Math.abs(s/60%2-1)),St=P-T;let Bt,Nt,$t;return s>=0&&s<60?[Bt,Nt,$t]=[T,nt,0]:s>=60&&s<120?[Bt,Nt,$t]=[nt,T,0]:s>=120&&s<180?[Bt,Nt,$t]=[0,T,nt]:s>=180&&s<240?[Bt,Nt,$t]=[0,nt,T]:s>=240&&s<300?[Bt,Nt,$t]=[nt,0,T]:[Bt,Nt,$t]=[T,0,nt],[(Bt+St)*255,(Nt+St)*255,($t+St)*255]}function vo(n,t,e){const s=e+t*(100-Math.abs(2*e-100))/200;return[n,s!==0?t*(100-Math.abs(2*e-100))/s:0,e+t*(100-Math.abs(2*e-100))/(2*100)]}function go(n,t,e){const s=100-Math.abs(e*(200-t)/100-100);return[n,s!==0?t*e/s:0,e*(200-t)/(2*100)]}function Ue(n){return[n[0],n[1],n[2]]}function $s(n,t){return[n[0],n[1],n[2],t]}const wo={hsl:{hsl:(n,t,e)=>[n,t,e],hsv:vo,rgb:mo},hsv:{hsl:go,hsv:(n,t,e)=>[n,t,e],rgb:Ns},rgb:{hsl:_o,hsv:bo,rgb:(n,t,e)=>[n,t,e]}};function Mn(n,t){return[t==="float"?1:n==="rgb"?255:360,t==="float"?1:n==="rgb"?255:100,t==="float"?1:n==="rgb"?255:100]}function xo(n,t){return n===t?t:Os(n,t)}function yo(n,t,e){var s;const c=Mn(t,e);return[t==="rgb"?te(n[0],0,c[0]):xo(n[0],c[0]),te(n[1],0,c[1]),te(n[2],0,c[2]),te((s=n[3])!==null&&s!==void 0?s:1,0,1)]}function Ws(n,t,e,s){const c=Mn(t,e),P=Mn(t,s);return n.map((T,nt)=>T/c[nt]*P[nt])}function Po(n,t,e){const s=Ws(n,t.mode,t.type,"int"),c=wo[t.mode][e.mode](...s);return Ws(c,e.mode,"int",e.type)}function Bn(n,t){return typeof n!="object"||q(n)?!1:t in n&&typeof n[t]=="number"}class Ft{static black(t="int"){return new Ft([0,0,0],"rgb",t)}static fromObject(t,e="int"){const s="a"in t?[t.r,t.g,t.b,t.a]:[t.r,t.g,t.b];return new Ft(s,"rgb",e)}static toRgbaObject(t,e="int"){return t.toRgbaObject(e)}static isRgbColorObject(t){return Bn(t,"r")&&Bn(t,"g")&&Bn(t,"b")}static isRgbaColorObject(t){return this.isRgbColorObject(t)&&Bn(t,"a")}static isColorObject(t){return this.isRgbColorObject(t)}static equals(t,e){if(t.mode!==e.mode)return!1;const s=t.comps_,c=e.comps_;for(let P=0;P<s.length;P++)if(s[P]!==c[P])return!1;return!0}constructor(t,e,s="int"){this.mode=e,this.type=s,this.comps_=yo(t,e,s)}getComponents(t,e="int"){return $s(Po(Ue(this.comps_),{mode:this.mode,type:this.type},{mode:t??this.mode,type:e}),this.comps_[3])}toRgbaObject(t="int"){const e=this.getComponents("rgb",t);return{r:e[0],g:e[1],b:e[2],a:e[3]}}}const Me=U("colp");class So{constructor(t,e){this.alphaViews_=null,this.element=t.createElement("div"),this.element.classList.add(Me()),e.viewProps.bindClassModifiers(this.element);const s=t.createElement("div");s.classList.add(Me("hsv"));const c=t.createElement("div");c.classList.add(Me("sv")),this.svPaletteView_=e.svPaletteView,c.appendChild(this.svPaletteView_.element),s.appendChild(c);const P=t.createElement("div");P.classList.add(Me("h")),this.hPaletteView_=e.hPaletteView,P.appendChild(this.hPaletteView_.element),s.appendChild(P),this.element.appendChild(s);const T=t.createElement("div");if(T.classList.add(Me("rgb")),this.textView_=e.textView,T.appendChild(this.textView_.element),this.element.appendChild(T),e.alphaViews){this.alphaViews_={palette:e.alphaViews.palette,text:e.alphaViews.text};const nt=t.createElement("div");nt.classList.add(Me("a"));const St=t.createElement("div");St.classList.add(Me("ap")),St.appendChild(this.alphaViews_.palette.element),nt.appendChild(St);const Bt=t.createElement("div");Bt.classList.add(Me("at")),Bt.appendChild(this.alphaViews_.text.element),nt.appendChild(Bt),this.element.appendChild(nt)}}get allFocusableElements(){const t=[this.svPaletteView_.element,this.hPaletteView_.element,this.textView_.modeSelectElement,...this.textView_.textViews.map(e=>e.inputElement)];return this.alphaViews_&&t.push(this.alphaViews_.palette.element,this.alphaViews_.text.inputElement),t}}function ko(n){return n==="int"?"int":n==="float"?"float":void 0}function Kn(n){const t=xt;return ht(n,{alpha:t.optional.boolean,color:t.optional.object({alpha:t.optional.boolean,type:t.optional.custom(ko)}),expanded:t.optional.boolean,picker:t.optional.custom(Fs)})}function Ve(n){return n?.1:1}function Ge(n){var t;return(t=n.color)===null||t===void 0?void 0:t.type}function Co(n,t){return n.alpha===t.alpha&&n.mode===t.mode&&n.notation===t.notation&&n.type===t.type}function pe(n,t){const e=n.match(/^(.+)%$/);return Math.min(e?parseFloat(e[1])*.01*t:parseFloat(n),t)}const Eo={deg:n=>n,grad:n=>n*360/400,rad:n=>n*360/(2*Math.PI),turn:n=>n*360};function js(n){const t=n.match(/^([0-9.]+?)(deg|grad|rad|turn)$/);if(!t)return parseFloat(n);const e=parseFloat(t[1]),s=t[2];return Eo[s](e)}function Ks(n){const t=n.match(/^rgb\(\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*\)$/);if(!t)return null;const e=[pe(t[1],255),pe(t[2],255),pe(t[3],255)];return isNaN(e[0])||isNaN(e[1])||isNaN(e[2])?null:e}function Hs(n){return t=>{const e=Ks(t);return e?new Ft(e,"rgb",n):null}}function Ys(n){const t=n.match(/^rgba\(\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*\)$/);if(!t)return null;const e=[pe(t[1],255),pe(t[2],255),pe(t[3],255),pe(t[4],1)];return isNaN(e[0])||isNaN(e[1])||isNaN(e[2])||isNaN(e[3])?null:e}function Zs(n){return t=>{const e=Ys(t);return e?new Ft(e,"rgb",n):null}}function Xs(n){const t=n.match(/^hsl\(\s*([0-9A-Fa-f.]+(?:deg|grad|rad|turn)?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*\)$/);if(!t)return null;const e=[js(t[1]),pe(t[2],100),pe(t[3],100)];return isNaN(e[0])||isNaN(e[1])||isNaN(e[2])?null:e}function Qs(n){return t=>{const e=Xs(t);return e?new Ft(e,"hsl",n):null}}function Js(n){const t=n.match(/^hsla\(\s*([0-9A-Fa-f.]+(?:deg|grad|rad|turn)?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*\)$/);if(!t)return null;const e=[js(t[1]),pe(t[2],100),pe(t[3],100),pe(t[4],1)];return isNaN(e[0])||isNaN(e[1])||isNaN(e[2])||isNaN(e[3])?null:e}function tr(n){return t=>{const e=Js(t);return e?new Ft(e,"hsl",n):null}}function er(n){const t=n.match(/^#([0-9A-Fa-f])([0-9A-Fa-f])([0-9A-Fa-f])$/);if(t)return[parseInt(t[1]+t[1],16),parseInt(t[2]+t[2],16),parseInt(t[3]+t[3],16)];const e=n.match(/^(?:#|0x)([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})$/);return e?[parseInt(e[1],16),parseInt(e[2],16),parseInt(e[3],16)]:null}function Mo(n){const t=er(n);return t?new Ft(t,"rgb","int"):null}function nr(n){const t=n.match(/^#?([0-9A-Fa-f])([0-9A-Fa-f])([0-9A-Fa-f])([0-9A-Fa-f])$/);if(t)return[parseInt(t[1]+t[1],16),parseInt(t[2]+t[2],16),parseInt(t[3]+t[3],16),Zt(parseInt(t[4]+t[4],16),0,255,0,1)];const e=n.match(/^(?:#|0x)?([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})$/);return e?[parseInt(e[1],16),parseInt(e[2],16),parseInt(e[3],16),Zt(parseInt(e[4],16),0,255,0,1)]:null}function Bo(n){const t=nr(n);return t?new Ft(t,"rgb","int"):null}function sr(n){const t=n.match(/^\{\s*r\s*:\s*([0-9A-Fa-f.]+%?)\s*,\s*g\s*:\s*([0-9A-Fa-f.]+%?)\s*,\s*b\s*:\s*([0-9A-Fa-f.]+%?)\s*\}$/);if(!t)return null;const e=[parseFloat(t[1]),parseFloat(t[2]),parseFloat(t[3])];return isNaN(e[0])||isNaN(e[1])||isNaN(e[2])?null:e}function rr(n){return t=>{const e=sr(t);return e?new Ft(e,"rgb",n):null}}function ir(n){const t=n.match(/^\{\s*r\s*:\s*([0-9A-Fa-f.]+%?)\s*,\s*g\s*:\s*([0-9A-Fa-f.]+%?)\s*,\s*b\s*:\s*([0-9A-Fa-f.]+%?)\s*,\s*a\s*:\s*([0-9A-Fa-f.]+%?)\s*\}$/);if(!t)return null;const e=[parseFloat(t[1]),parseFloat(t[2]),parseFloat(t[3]),parseFloat(t[4])];return isNaN(e[0])||isNaN(e[1])||isNaN(e[2])||isNaN(e[3])?null:e}function or(n){return t=>{const e=ir(t);return e?new Ft(e,"rgb",n):null}}const To=[{parser:er,result:{alpha:!1,mode:"rgb",notation:"hex"}},{parser:nr,result:{alpha:!0,mode:"rgb",notation:"hex"}},{parser:Ks,result:{alpha:!1,mode:"rgb",notation:"func"}},{parser:Ys,result:{alpha:!0,mode:"rgb",notation:"func"}},{parser:Xs,result:{alpha:!1,mode:"hsl",notation:"func"}},{parser:Js,result:{alpha:!0,mode:"hsl",notation:"func"}},{parser:sr,result:{alpha:!1,mode:"rgb",notation:"object"}},{parser:ir,result:{alpha:!0,mode:"rgb",notation:"object"}}];function Do(n){return To.reduce((t,{parser:e,result:s})=>t||(e(n)?s:null),null)}function Hn(n,t="int"){const e=Do(n);return e?e.notation==="hex"&&t!=="float"?Object.assign(Object.assign({},e),{type:"int"}):e.notation==="func"?Object.assign(Object.assign({},e),{type:t}):null:null}const ar={int:[Mo,Bo,Hs("int"),Zs("int"),Qs("int"),tr("int"),rr("int"),or("int")],float:[Hs("float"),Zs("float"),Qs("float"),tr("float"),rr("float"),or("float")]};function Ao(n){const t=ar[n];return e=>{if(typeof e!="string")return Ft.black(n);const s=t.reduce((c,P)=>c||P(e),null);return s??Ft.black(n)}}function Yn(n){const t=ar[n];return e=>t.reduce((s,c)=>s||c(e),null)}function lr(n){const t=te(Math.floor(n),0,255).toString(16);return t.length===1?`0${t}`:t}function cr(n,t="#"){const e=Ue(n.getComponents("rgb")).map(lr).join("");return`${t}${e}`}function Zn(n,t="#"){const e=n.getComponents("rgb"),s=[e[0],e[1],e[2],e[3]*255].map(lr).join("");return`${t}${s}`}function ur(n,t){const e=ne(t==="float"?2:0);return`rgb(${Ue(n.getComponents("rgb",t)).map(c=>e(c)).join(", ")})`}function Ro(n){return t=>ur(t,n)}function Tn(n,t){const e=ne(2),s=ne(t==="float"?2:0);return`rgba(${n.getComponents("rgb",t).map((P,T)=>(T===3?e:s)(P)).join(", ")})`}function Io(n){return t=>Tn(t,n)}function Lo(n){const t=[ne(0),Sn,Sn];return`hsl(${Ue(n.getComponents("hsl")).map((s,c)=>t[c](s)).join(", ")})`}function Uo(n){const t=[ne(0),Sn,Sn,ne(2)];return`hsla(${n.getComponents("hsl").map((s,c)=>t[c](s)).join(", ")})`}function dr(n,t){const e=ne(t==="float"?2:0),s=["r","g","b"];return`{${Ue(n.getComponents("rgb",t)).map((P,T)=>`${s[T]}: ${e(P)}`).join(", ")}}`}function Vo(n){return t=>dr(t,n)}function pr(n,t){const e=ne(2),s=ne(t==="float"?2:0),c=["r","g","b","a"];return`{${n.getComponents("rgb",t).map((T,nt)=>{const St=nt===3?e:s;return`${c[nt]}: ${St(T)}`}).join(", ")}}`}function Go(n){return t=>pr(t,n)}const zo=[{format:{alpha:!1,mode:"rgb",notation:"hex",type:"int"},stringifier:cr},{format:{alpha:!0,mode:"rgb",notation:"hex",type:"int"},stringifier:Zn},{format:{alpha:!1,mode:"hsl",notation:"func",type:"int"},stringifier:Lo},{format:{alpha:!0,mode:"hsl",notation:"func",type:"int"},stringifier:Uo},...["int","float"].reduce((n,t)=>[...n,{format:{alpha:!1,mode:"rgb",notation:"func",type:t},stringifier:Ro(t)},{format:{alpha:!0,mode:"rgb",notation:"func",type:t},stringifier:Io(t)},{format:{alpha:!1,mode:"rgb",notation:"object",type:t},stringifier:Vo(t)},{format:{alpha:!0,mode:"rgb",notation:"object",type:t},stringifier:Go(t)}],[])];function Xn(n){return zo.reduce((t,e)=>t||(Co(e.format,n)?e.stringifier:null),null)}const fn=U("apl");class Oo{constructor(t,e){this.onValueChange_=this.onValueChange_.bind(this),this.value=e.value,this.value.emitter.on("change",this.onValueChange_),this.element=t.createElement("div"),this.element.classList.add(fn()),e.viewProps.bindClassModifiers(this.element),e.viewProps.bindTabIndex(this.element);const s=t.createElement("div");s.classList.add(fn("b")),this.element.appendChild(s);const c=t.createElement("div");c.classList.add(fn("c")),s.appendChild(c),this.colorElem_=c;const P=t.createElement("div");P.classList.add(fn("m")),this.element.appendChild(P),this.markerElem_=P;const T=t.createElement("div");T.classList.add(fn("p")),this.markerElem_.appendChild(T),this.previewElem_=T,this.update_()}update_(){const t=this.value.rawValue,e=t.getComponents("rgb"),s=new Ft([e[0],e[1],e[2],0],"rgb"),c=new Ft([e[0],e[1],e[2],255],"rgb"),P=["to right",Tn(s),Tn(c)];this.colorElem_.style.background=`linear-gradient(${P.join(",")})`,this.previewElem_.style.backgroundColor=Tn(t);const T=Zt(e[3],0,1,0,100);this.markerElem_.style.left=`${T}%`}onValueChange_(){this.update_()}}class Fo{constructor(t,e){this.onKeyDown_=this.onKeyDown_.bind(this),this.onKeyUp_=this.onKeyUp_.bind(this),this.onPointerDown_=this.onPointerDown_.bind(this),this.onPointerMove_=this.onPointerMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.value=e.value,this.viewProps=e.viewProps,this.view=new Oo(t,{value:this.value,viewProps:this.viewProps}),this.ptHandler_=new Ie(this.view.element),this.ptHandler_.emitter.on("down",this.onPointerDown_),this.ptHandler_.emitter.on("move",this.onPointerMove_),this.ptHandler_.emitter.on("up",this.onPointerUp_),this.view.element.addEventListener("keydown",this.onKeyDown_),this.view.element.addEventListener("keyup",this.onKeyUp_)}handlePointerEvent_(t,e){if(!t.point)return;const s=t.point.x/t.bounds.width,c=this.value.rawValue,[P,T,nt]=c.getComponents("hsv");this.value.setRawValue(new Ft([P,T,nt,s],"hsv"),e)}onPointerDown_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerMove_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerUp_(t){this.handlePointerEvent_(t.data,{forceEmit:!0,last:!0})}onKeyDown_(t){const e=ae(Ve(!0),Se(t));if(e===0)return;const s=this.value.rawValue,[c,P,T,nt]=s.getComponents("hsv");this.value.setRawValue(new Ft([c,P,T,nt+e],"hsv"),{forceEmit:!1,last:!1})}onKeyUp_(t){ae(Ve(!0),Se(t))!==0&&this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}}const Xe=U("coltxt");function qo(n){const t=n.createElement("select"),e=[{text:"RGB",value:"rgb"},{text:"HSL",value:"hsl"},{text:"HSV",value:"hsv"}];return t.appendChild(e.reduce((s,c)=>{const P=n.createElement("option");return P.textContent=c.text,P.value=c.value,s.appendChild(P),s},n.createDocumentFragment())),t}class No{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(Xe()),e.viewProps.bindClassModifiers(this.element);const s=t.createElement("div");s.classList.add(Xe("m")),this.modeElem_=qo(t),this.modeElem_.classList.add(Xe("ms")),s.appendChild(this.modeSelectElement),e.viewProps.bindDisabled(this.modeElem_);const c=t.createElement("div");c.classList.add(Xe("mm")),c.appendChild(v(t,"dropdown")),s.appendChild(c),this.element.appendChild(s);const P=t.createElement("div");P.classList.add(Xe("w")),this.element.appendChild(P),this.textsElem_=P,this.textViews_=e.textViews,this.applyTextViews_(),X(e.colorMode,T=>{this.modeElem_.value=T})}get modeSelectElement(){return this.modeElem_}get textViews(){return this.textViews_}set textViews(t){this.textViews_=t,this.applyTextViews_()}applyTextViews_(){$(this.textsElem_);const t=this.element.ownerDocument;this.textViews_.forEach(e=>{const s=t.createElement("div");s.classList.add(Xe("c")),s.appendChild(e.element),this.textsElem_.appendChild(s)})}}function $o(n){return ne(n==="float"?2:0)}function Wo(n,t,e){const s=Mn(n,t)[e];return new He({min:0,max:s})}function Qn(n,t,e){return new pn(n,{arrayPosition:e===0?"fst":e===3-1?"lst":"mid",baseStep:Ve(!1),parser:t.parser,props:st.fromObject({draggingScale:t.colorType==="float"?.01:1,formatter:$o(t.colorType)}),value:H(0,{constraint:Wo(t.colorMode,t.colorType,e)}),viewProps:t.viewProps})}class jo{constructor(t,e){this.onModeSelectChange_=this.onModeSelectChange_.bind(this),this.colorType_=e.colorType,this.parser_=e.parser,this.value=e.value,this.viewProps=e.viewProps,this.colorMode=H(this.value.rawValue.mode),this.ccs_=this.createComponentControllers_(t),this.view=new No(t,{colorMode:this.colorMode,textViews:[this.ccs_[0].view,this.ccs_[1].view,this.ccs_[2].view],viewProps:this.viewProps}),this.view.modeSelectElement.addEventListener("change",this.onModeSelectChange_)}createComponentControllers_(t){const e={colorMode:this.colorMode.rawValue,colorType:this.colorType_,parser:this.parser_,viewProps:this.viewProps},s=[Qn(t,e,0),Qn(t,e,1),Qn(t,e,2)];return s.forEach((c,P)=>{un({primary:this.value,secondary:c.value,forward:T=>T.rawValue.getComponents(this.colorMode.rawValue,this.colorType_)[P],backward:(T,nt)=>{const St=this.colorMode.rawValue,Bt=T.rawValue.getComponents(St,this.colorType_);return Bt[P]=nt.rawValue,new Ft($s(Ue(Bt),Bt[3]),St,this.colorType_)}})}),s}onModeSelectChange_(t){const e=t.currentTarget;this.colorMode.rawValue=e.value,this.ccs_=this.createComponentControllers_(this.view.element.ownerDocument),this.view.textViews=[this.ccs_[0].view,this.ccs_[1].view,this.ccs_[2].view]}}const Jn=U("hpl");class Ko{constructor(t,e){this.onValueChange_=this.onValueChange_.bind(this),this.value=e.value,this.value.emitter.on("change",this.onValueChange_),this.element=t.createElement("div"),this.element.classList.add(Jn()),e.viewProps.bindClassModifiers(this.element),e.viewProps.bindTabIndex(this.element);const s=t.createElement("div");s.classList.add(Jn("c")),this.element.appendChild(s);const c=t.createElement("div");c.classList.add(Jn("m")),this.element.appendChild(c),this.markerElem_=c,this.update_()}update_(){const t=this.value.rawValue,[e]=t.getComponents("hsv");this.markerElem_.style.backgroundColor=ur(new Ft([e,100,100],"hsv"));const s=Zt(e,0,360,0,100);this.markerElem_.style.left=`${s}%`}onValueChange_(){this.update_()}}class Ho{constructor(t,e){this.onKeyDown_=this.onKeyDown_.bind(this),this.onKeyUp_=this.onKeyUp_.bind(this),this.onPointerDown_=this.onPointerDown_.bind(this),this.onPointerMove_=this.onPointerMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.value=e.value,this.viewProps=e.viewProps,this.view=new Ko(t,{value:this.value,viewProps:this.viewProps}),this.ptHandler_=new Ie(this.view.element),this.ptHandler_.emitter.on("down",this.onPointerDown_),this.ptHandler_.emitter.on("move",this.onPointerMove_),this.ptHandler_.emitter.on("up",this.onPointerUp_),this.view.element.addEventListener("keydown",this.onKeyDown_),this.view.element.addEventListener("keyup",this.onKeyUp_)}handlePointerEvent_(t,e){if(!t.point)return;const s=Zt(te(t.point.x,0,t.bounds.width),0,t.bounds.width,0,360),c=this.value.rawValue,[,P,T,nt]=c.getComponents("hsv");this.value.setRawValue(new Ft([s,P,T,nt],"hsv"),e)}onPointerDown_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerMove_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerUp_(t){this.handlePointerEvent_(t.data,{forceEmit:!0,last:!0})}onKeyDown_(t){const e=ae(Ve(!1),Se(t));if(e===0)return;const s=this.value.rawValue,[c,P,T,nt]=s.getComponents("hsv");this.value.setRawValue(new Ft([c+e,P,T,nt],"hsv"),{forceEmit:!1,last:!1})}onKeyUp_(t){ae(Ve(!1),Se(t))!==0&&this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}}const ts=U("svp"),hr=64;class Yo{constructor(t,e){this.onValueChange_=this.onValueChange_.bind(this),this.value=e.value,this.value.emitter.on("change",this.onValueChange_),this.element=t.createElement("div"),this.element.classList.add(ts()),e.viewProps.bindClassModifiers(this.element),e.viewProps.bindTabIndex(this.element);const s=t.createElement("canvas");s.height=hr,s.width=hr,s.classList.add(ts("c")),this.element.appendChild(s),this.canvasElement=s;const c=t.createElement("div");c.classList.add(ts("m")),this.element.appendChild(c),this.markerElem_=c,this.update_()}update_(){const t=_(this.canvasElement);if(!t)return;const s=this.value.rawValue.getComponents("hsv"),c=this.canvasElement.width,P=this.canvasElement.height,T=t.getImageData(0,0,c,P),nt=T.data;for(let Nt=0;Nt<P;Nt++)for(let $t=0;$t<c;$t++){const ze=Zt($t,0,c,0,100),mn=Zt(Nt,0,P,100,0),bn=Ns(s[0],ze,mn),Dn=(Nt*c+$t)*4;nt[Dn]=bn[0],nt[Dn+1]=bn[1],nt[Dn+2]=bn[2],nt[Dn+3]=255}t.putImageData(T,0,0);const St=Zt(s[1],0,100,0,100);this.markerElem_.style.left=`${St}%`;const Bt=Zt(s[2],0,100,100,0);this.markerElem_.style.top=`${Bt}%`}onValueChange_(){this.update_()}}class Zo{constructor(t,e){this.onKeyDown_=this.onKeyDown_.bind(this),this.onKeyUp_=this.onKeyUp_.bind(this),this.onPointerDown_=this.onPointerDown_.bind(this),this.onPointerMove_=this.onPointerMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.value=e.value,this.viewProps=e.viewProps,this.view=new Yo(t,{value:this.value,viewProps:this.viewProps}),this.ptHandler_=new Ie(this.view.element),this.ptHandler_.emitter.on("down",this.onPointerDown_),this.ptHandler_.emitter.on("move",this.onPointerMove_),this.ptHandler_.emitter.on("up",this.onPointerUp_),this.view.element.addEventListener("keydown",this.onKeyDown_),this.view.element.addEventListener("keyup",this.onKeyUp_)}handlePointerEvent_(t,e){if(!t.point)return;const s=Zt(t.point.x,0,t.bounds.width,0,100),c=Zt(t.point.y,0,t.bounds.height,100,0),[P,,,T]=this.value.rawValue.getComponents("hsv");this.value.setRawValue(new Ft([P,s,c,T],"hsv"),e)}onPointerDown_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerMove_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerUp_(t){this.handlePointerEvent_(t.data,{forceEmit:!0,last:!0})}onKeyDown_(t){Gs(t.key)&&t.preventDefault();const[e,s,c,P]=this.value.rawValue.getComponents("hsv"),T=Ve(!1),nt=ae(T,Se(t)),St=ae(T,dn(t));nt===0&&St===0||this.value.setRawValue(new Ft([e,s+nt,c+St,P],"hsv"),{forceEmit:!1,last:!1})}onKeyUp_(t){const e=Ve(!1),s=ae(e,Se(t)),c=ae(e,dn(t));s===0&&c===0||this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}}class Xo{constructor(t,e){this.value=e.value,this.viewProps=e.viewProps,this.hPaletteC_=new Ho(t,{value:this.value,viewProps:this.viewProps}),this.svPaletteC_=new Zo(t,{value:this.value,viewProps:this.viewProps}),this.alphaIcs_=e.supportsAlpha?{palette:new Fo(t,{value:this.value,viewProps:this.viewProps}),text:new pn(t,{parser:Pe,baseStep:.1,props:st.fromObject({draggingScale:.01,formatter:ne(2)}),value:H(0,{constraint:new He({min:0,max:1})}),viewProps:this.viewProps})}:null,this.alphaIcs_&&un({primary:this.value,secondary:this.alphaIcs_.text.value,forward:s=>s.rawValue.getComponents()[3],backward:(s,c)=>{const P=s.rawValue.getComponents();return P[3]=c.rawValue,new Ft(P,s.rawValue.mode)}}),this.textC_=new jo(t,{colorType:e.colorType,parser:Pe,value:this.value,viewProps:this.viewProps}),this.view=new So(t,{alphaViews:this.alphaIcs_?{palette:this.alphaIcs_.palette.view,text:this.alphaIcs_.text.view}:null,hPaletteView:this.hPaletteC_.view,supportsAlpha:e.supportsAlpha,svPaletteView:this.svPaletteC_.view,textView:this.textC_.view,viewProps:this.viewProps})}get textController(){return this.textC_}}const es=U("colsw");class Qo{constructor(t,e){this.onValueChange_=this.onValueChange_.bind(this),e.value.emitter.on("change",this.onValueChange_),this.value=e.value,this.element=t.createElement("div"),this.element.classList.add(es()),e.viewProps.bindClassModifiers(this.element);const s=t.createElement("div");s.classList.add(es("sw")),this.element.appendChild(s),this.swatchElem_=s;const c=t.createElement("button");c.classList.add(es("b")),e.viewProps.bindDisabled(c),this.element.appendChild(c),this.buttonElement=c,this.update_()}update_(){const t=this.value.rawValue;this.swatchElem_.style.backgroundColor=Zn(t)}onValueChange_(){this.update_()}}class Jo{constructor(t,e){this.value=e.value,this.viewProps=e.viewProps,this.view=new Qo(t,{value:this.value,viewProps:this.viewProps})}}class ns{constructor(t,e){this.onButtonBlur_=this.onButtonBlur_.bind(this),this.onButtonClick_=this.onButtonClick_.bind(this),this.onPopupChildBlur_=this.onPopupChildBlur_.bind(this),this.onPopupChildKeydown_=this.onPopupChildKeydown_.bind(this),this.value=e.value,this.viewProps=e.viewProps,this.foldable_=Q.create(e.expanded),this.swatchC_=new Jo(t,{value:this.value,viewProps:this.viewProps});const s=this.swatchC_.view.buttonElement;s.addEventListener("blur",this.onButtonBlur_),s.addEventListener("click",this.onButtonClick_),this.textC_=new Pn(t,{parser:e.parser,props:st.fromObject({formatter:e.formatter}),value:this.value,viewProps:this.viewProps}),this.view=new fo(t,{foldable:this.foldable_,pickerLayout:e.pickerLayout}),this.view.swatchElement.appendChild(this.swatchC_.view.element),this.view.textElement.appendChild(this.textC_.view.element),this.popC_=e.pickerLayout==="popup"?new Bs(t,{viewProps:this.viewProps}):null;const c=new Xo(t,{colorType:e.colorType,supportsAlpha:e.supportsAlpha,value:this.value,viewProps:this.viewProps});c.view.allFocusableElements.forEach(P=>{P.addEventListener("blur",this.onPopupChildBlur_),P.addEventListener("keydown",this.onPopupChildKeydown_)}),this.pickerC_=c,this.popC_?(this.view.element.appendChild(this.popC_.view.element),this.popC_.view.element.appendChild(c.view.element),un({primary:this.foldable_.value("expanded"),secondary:this.popC_.shows,forward:P=>P.rawValue,backward:(P,T)=>T.rawValue})):this.view.pickerElement&&(this.view.pickerElement.appendChild(this.pickerC_.view.element),gt(this.foldable_,this.view.pickerElement))}get textController(){return this.textC_}onButtonBlur_(t){if(!this.popC_)return;const e=this.view.element,s=t.relatedTarget;(!s||!e.contains(s))&&(this.popC_.shows.rawValue=!1)}onButtonClick_(){this.foldable_.set("expanded",!this.foldable_.get("expanded")),this.foldable_.get("expanded")&&this.pickerC_.view.allFocusableElements[0].focus()}onPopupChildBlur_(t){if(!this.popC_)return;const e=this.popC_.view.element,s=it(t);s&&e.contains(s)||s&&s===this.swatchC_.view.buttonElement&&!u(e.ownerDocument)||(this.popC_.shows.rawValue=!1)}onPopupChildKeydown_(t){this.popC_?t.key==="Escape"&&(this.popC_.shows.rawValue=!1):this.view.pickerElement&&t.key==="Escape"&&this.swatchC_.view.buttonElement.focus()}}function ta(n,t){return Ft.isColorObject(n)?Ft.fromObject(n,t):Ft.black(t)}function ea(n){return Ue(n.getComponents("rgb")).reduce((t,e)=>t<<8|Math.floor(e)&255,0)}function na(n){return n.getComponents("rgb").reduce((t,e,s)=>{const c=Math.floor(s===3?e*255:e)&255;return t<<8|c},0)>>>0}function sa(n){return new Ft([n>>16&255,n>>8&255,n&255],"rgb")}function ra(n){return new Ft([n>>24&255,n>>16&255,n>>8&255,Zt(n&255,0,255,0,1)],"rgb")}function ia(n){return typeof n!="number"?Ft.black():sa(n)}function oa(n){return typeof n!="number"?Ft.black():ra(n)}function aa(n){const t=Xn(n);return t?(e,s)=>{hn(e,t(s))}:null}function la(n){const t=n?na:ea;return(e,s)=>{hn(e,t(s))}}function ca(n,t,e){const s=t.toRgbaObject(e);n.writeProperty("r",s.r),n.writeProperty("g",s.g),n.writeProperty("b",s.b),n.writeProperty("a",s.a)}function ua(n,t,e){const s=t.toRgbaObject(e);n.writeProperty("r",s.r),n.writeProperty("g",s.g),n.writeProperty("b",s.b)}function da(n,t){return(e,s)=>{n?ca(e,s,t):ua(e,s,t)}}function ss(n){var t;return!!(n!=null&&n.alpha||!((t=n==null?void 0:n.color)===null||t===void 0)&&t.alpha)}function pa(n){return n?t=>Zn(t,"0x"):t=>cr(t,"0x")}function ha(n){return"color"in n||"view"in n&&n.view==="color"}const fa={id:"input-color-number",type:"input",accept:(n,t)=>{if(typeof n!="number"||!ha(t))return null;const e=Kn(t);return e?{initialValue:n,params:e}:null},binding:{reader:n=>ss(n.params)?oa:ia,equals:Ft.equals,writer:n=>la(ss(n.params))},controller:n=>{const t=ss(n.params),e="expanded"in n.params?n.params.expanded:void 0,s="picker"in n.params?n.params.picker:void 0;return new ns(n.document,{colorType:"int",expanded:e??!1,formatter:pa(t),parser:Yn("int"),pickerLayout:s??"popup",supportsAlpha:t,value:n.value,viewProps:n.viewProps})}};function _a(n){return Ft.isRgbaColorObject(n)}function ma(n){return t=>ta(t,n)}function ba(n,t){return e=>n?pr(e,t):dr(e,t)}const va={id:"input-color-object",type:"input",accept:(n,t)=>{if(!Ft.isColorObject(n))return null;const e=Kn(t);return e?{initialValue:n,params:e}:null},binding:{reader:n=>ma(Ge(n.params)),equals:Ft.equals,writer:n=>da(_a(n.initialValue),Ge(n.params))},controller:n=>{var t;const e=Ft.isRgbaColorObject(n.initialValue),s="expanded"in n.params?n.params.expanded:void 0,c="picker"in n.params?n.params.picker:void 0,P=(t=Ge(n.params))!==null&&t!==void 0?t:"int";return new ns(n.document,{colorType:P,expanded:s??!1,formatter:ba(e,P),parser:Yn(P),pickerLayout:c??"popup",supportsAlpha:e,value:n.value,viewProps:n.viewProps})}},ga={id:"input-color-string",type:"input",accept:(n,t)=>{if(typeof n!="string"||"view"in t&&t.view==="text")return null;const e=Hn(n,Ge(t));if(!e||!Xn(e))return null;const c=Kn(t);return c?{initialValue:n,params:c}:null},binding:{reader:n=>{var t;return Ao((t=Ge(n.params))!==null&&t!==void 0?t:"int")},equals:Ft.equals,writer:n=>{const t=Hn(n.initialValue,Ge(n.params));if(!t)throw z.shouldNeverHappen();const e=aa(t);if(!e)throw z.notBindable();return e}},controller:n=>{const t=Hn(n.initialValue,Ge(n.params));if(!t)throw z.shouldNeverHappen();const e=Xn(t);if(!e)throw z.shouldNeverHappen();const s="expanded"in n.params?n.params.expanded:void 0,c="picker"in n.params?n.params.picker:void 0;return new ns(n.document,{colorType:t.type,expanded:s??!1,formatter:e,parser:Yn(t.type),pickerLayout:c??"popup",supportsAlpha:t.alpha,value:n.value,viewProps:n.viewProps})}};class Be{constructor(t){this.components=t.components,this.asm_=t.assembly}constrain(t){const e=this.asm_.toComponents(t).map((s,c)=>{var P,T;return(T=(P=this.components[c])===null||P===void 0?void 0:P.constrain(s))!==null&&T!==void 0?T:s});return this.asm_.fromComponents(e)}}const fr=U("pndtxt");class wa{constructor(t,e){this.textViews=e.textViews,this.element=t.createElement("div"),this.element.classList.add(fr()),this.textViews.forEach(s=>{const c=t.createElement("div");c.classList.add(fr("a")),c.appendChild(s.element),this.element.appendChild(c)})}}function xa(n,t,e){return new pn(n,{arrayPosition:e===0?"fst":e===t.axes.length-1?"lst":"mid",baseStep:t.axes[e].baseStep,parser:t.parser,props:t.axes[e].textProps,value:H(0,{constraint:t.axes[e].constraint}),viewProps:t.viewProps})}class rs{constructor(t,e){this.value=e.value,this.viewProps=e.viewProps,this.acs_=e.axes.map((s,c)=>xa(t,e,c)),this.acs_.forEach((s,c)=>{un({primary:this.value,secondary:s.value,forward:P=>e.assembly.toComponents(P.rawValue)[c],backward:(P,T)=>{const nt=e.assembly.toComponents(P.rawValue);return nt[c]=T.rawValue,e.assembly.fromComponents(nt)}})}),this.view=new wa(t,{textViews:this.acs_.map(s=>s.view)})}}function _r(n,t){return"step"in n&&!q(n.step)?new yn(n.step,t):null}function mr(n){return!q(n.max)&&!q(n.min)?new He({max:n.max,min:n.min}):!q(n.max)||!q(n.min)?new Es({max:n.max,min:n.min}):null}function ya(n){const t=ye(n,He);if(t)return[t.values.get("min"),t.values.get("max")];const e=ye(n,Es);return e?[e.minValue,e.maxValue]:[void 0,void 0]}function Pa(n,t){const e=[],s=_r(n,t);s&&e.push(s);const c=mr(n);c&&e.push(c);const P=jn(n.options);return P&&e.push(P),new rn(e)}const Sa={id:"input-number",type:"input",accept:(n,t)=>{if(typeof n!="number")return null;const e=xt,s=ht(t,{format:e.optional.function,max:e.optional.number,min:e.optional.number,options:e.optional.custom(kn),step:e.optional.number});return s?{initialValue:n,params:s}:null},binding:{reader:n=>Us,constraint:n=>Pa(n.params,n.initialValue),writer:n=>hn},controller:n=>{var t;const e=n.value,s=n.constraint,c=s&&ye(s,on);if(c)return new an(n.document,{props:new st({options:c.values.value("options")}),value:e,viewProps:n.viewProps});const P=(t="format"in n.params?n.params.format:void 0)!==null&&t!==void 0?t:ne(Cn(s,e.rawValue)),T=s&&ye(s,He);return T?new Wn(n.document,{baseStep:Ye(s),parser:Pe,sliderProps:new st({maxValue:T.values.value("max"),minValue:T.values.value("min")}),textProps:st.fromObject({draggingScale:Ze(s,e.rawValue),formatter:P}),value:e,viewProps:n.viewProps}):new pn(n.document,{baseStep:Ye(s),parser:Pe,props:st.fromObject({draggingScale:Ze(s,e.rawValue),formatter:P}),value:e,viewProps:n.viewProps})}};class Te{constructor(t=0,e=0){this.x=t,this.y=e}getComponents(){return[this.x,this.y]}static isObject(t){if(q(t))return!1;const e=t.x,s=t.y;return!(typeof e!="number"||typeof s!="number")}static equals(t,e){return t.x===e.x&&t.y===e.y}toObject(){return{x:this.x,y:this.y}}}const br={toComponents:n=>n.getComponents(),fromComponents:n=>new Te(...n)},Qe=U("p2d");class ka{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(Qe()),e.viewProps.bindClassModifiers(this.element),X(e.expanded,_t(this.element,Qe(void 0,"expanded")));const s=t.createElement("div");s.classList.add(Qe("h")),this.element.appendChild(s);const c=t.createElement("button");c.classList.add(Qe("b")),c.appendChild(v(t,"p2dpad")),e.viewProps.bindDisabled(c),s.appendChild(c),this.buttonElement=c;const P=t.createElement("div");if(P.classList.add(Qe("t")),s.appendChild(P),this.textElement=P,e.pickerLayout==="inline"){const T=t.createElement("div");T.classList.add(Qe("p")),this.element.appendChild(T),this.pickerElement=T}else this.pickerElement=null}}const De=U("p2dp");class Ca{constructor(t,e){this.onFoldableChange_=this.onFoldableChange_.bind(this),this.onValueChange_=this.onValueChange_.bind(this),this.invertsY_=e.invertsY,this.maxValue_=e.maxValue,this.element=t.createElement("div"),this.element.classList.add(De()),e.layout==="popup"&&this.element.classList.add(De(void 0,"p")),e.viewProps.bindClassModifiers(this.element);const s=t.createElement("div");s.classList.add(De("p")),e.viewProps.bindTabIndex(s),this.element.appendChild(s),this.padElement=s;const c=t.createElementNS(k,"svg");c.classList.add(De("g")),this.padElement.appendChild(c),this.svgElem_=c;const P=t.createElementNS(k,"line");P.classList.add(De("ax")),P.setAttributeNS(null,"x1","0"),P.setAttributeNS(null,"y1","50%"),P.setAttributeNS(null,"x2","100%"),P.setAttributeNS(null,"y2","50%"),this.svgElem_.appendChild(P);const T=t.createElementNS(k,"line");T.classList.add(De("ax")),T.setAttributeNS(null,"x1","50%"),T.setAttributeNS(null,"y1","0"),T.setAttributeNS(null,"x2","50%"),T.setAttributeNS(null,"y2","100%"),this.svgElem_.appendChild(T);const nt=t.createElementNS(k,"line");nt.classList.add(De("l")),nt.setAttributeNS(null,"x1","50%"),nt.setAttributeNS(null,"y1","50%"),this.svgElem_.appendChild(nt),this.lineElem_=nt;const St=t.createElement("div");St.classList.add(De("m")),this.padElement.appendChild(St),this.markerElem_=St,e.value.emitter.on("change",this.onValueChange_),this.value=e.value,this.update_()}get allFocusableElements(){return[this.padElement]}update_(){const[t,e]=this.value.rawValue.getComponents(),s=this.maxValue_,c=Zt(t,-s,+s,0,100),P=Zt(e,-s,+s,0,100),T=this.invertsY_?100-P:P;this.lineElem_.setAttributeNS(null,"x2",`${c}%`),this.lineElem_.setAttributeNS(null,"y2",`${T}%`),this.markerElem_.style.left=`${c}%`,this.markerElem_.style.top=`${T}%`}onValueChange_(){this.update_()}onFoldableChange_(){this.update_()}}function vr(n,t,e){return[ae(t[0],Se(n)),ae(t[1],dn(n))*(e?1:-1)]}class Ea{constructor(t,e){this.onPadKeyDown_=this.onPadKeyDown_.bind(this),this.onPadKeyUp_=this.onPadKeyUp_.bind(this),this.onPointerDown_=this.onPointerDown_.bind(this),this.onPointerMove_=this.onPointerMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.value=e.value,this.viewProps=e.viewProps,this.baseSteps_=e.baseSteps,this.maxValue_=e.maxValue,this.invertsY_=e.invertsY,this.view=new Ca(t,{invertsY:this.invertsY_,layout:e.layout,maxValue:this.maxValue_,value:this.value,viewProps:this.viewProps}),this.ptHandler_=new Ie(this.view.padElement),this.ptHandler_.emitter.on("down",this.onPointerDown_),this.ptHandler_.emitter.on("move",this.onPointerMove_),this.ptHandler_.emitter.on("up",this.onPointerUp_),this.view.padElement.addEventListener("keydown",this.onPadKeyDown_),this.view.padElement.addEventListener("keyup",this.onPadKeyUp_)}handlePointerEvent_(t,e){if(!t.point)return;const s=this.maxValue_,c=Zt(t.point.x,0,t.bounds.width,-s,+s),P=Zt(this.invertsY_?t.bounds.height-t.point.y:t.point.y,0,t.bounds.height,-s,+s);this.value.setRawValue(new Te(c,P),e)}onPointerDown_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerMove_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerUp_(t){this.handlePointerEvent_(t.data,{forceEmit:!0,last:!0})}onPadKeyDown_(t){Gs(t.key)&&t.preventDefault();const[e,s]=vr(t,this.baseSteps_,this.invertsY_);e===0&&s===0||this.value.setRawValue(new Te(this.value.rawValue.x+e,this.value.rawValue.y+s),{forceEmit:!1,last:!1})}onPadKeyUp_(t){const[e,s]=vr(t,this.baseSteps_,this.invertsY_);e===0&&s===0||this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}}class Ma{constructor(t,e){var s,c;this.onPopupChildBlur_=this.onPopupChildBlur_.bind(this),this.onPopupChildKeydown_=this.onPopupChildKeydown_.bind(this),this.onPadButtonBlur_=this.onPadButtonBlur_.bind(this),this.onPadButtonClick_=this.onPadButtonClick_.bind(this),this.value=e.value,this.viewProps=e.viewProps,this.foldable_=Q.create(e.expanded),this.popC_=e.pickerLayout==="popup"?new Bs(t,{viewProps:this.viewProps}):null;const P=new Ea(t,{baseSteps:[e.axes[0].baseStep,e.axes[1].baseStep],invertsY:e.invertsY,layout:e.pickerLayout,maxValue:e.maxValue,value:this.value,viewProps:this.viewProps});P.view.allFocusableElements.forEach(T=>{T.addEventListener("blur",this.onPopupChildBlur_),T.addEventListener("keydown",this.onPopupChildKeydown_)}),this.pickerC_=P,this.textC_=new rs(t,{assembly:br,axes:e.axes,parser:e.parser,value:this.value,viewProps:this.viewProps}),this.view=new ka(t,{expanded:this.foldable_.value("expanded"),pickerLayout:e.pickerLayout,viewProps:this.viewProps}),this.view.textElement.appendChild(this.textC_.view.element),(s=this.view.buttonElement)===null||s===void 0||s.addEventListener("blur",this.onPadButtonBlur_),(c=this.view.buttonElement)===null||c===void 0||c.addEventListener("click",this.onPadButtonClick_),this.popC_?(this.view.element.appendChild(this.popC_.view.element),this.popC_.view.element.appendChild(this.pickerC_.view.element),un({primary:this.foldable_.value("expanded"),secondary:this.popC_.shows,forward:T=>T.rawValue,backward:(T,nt)=>nt.rawValue})):this.view.pickerElement&&(this.view.pickerElement.appendChild(this.pickerC_.view.element),gt(this.foldable_,this.view.pickerElement))}onPadButtonBlur_(t){if(!this.popC_)return;const e=this.view.element,s=t.relatedTarget;(!s||!e.contains(s))&&(this.popC_.shows.rawValue=!1)}onPadButtonClick_(){this.foldable_.set("expanded",!this.foldable_.get("expanded")),this.foldable_.get("expanded")&&this.pickerC_.view.allFocusableElements[0].focus()}onPopupChildBlur_(t){if(!this.popC_)return;const e=this.popC_.view.element,s=it(t);s&&e.contains(s)||s&&s===this.view.buttonElement&&!u(e.ownerDocument)||(this.popC_.shows.rawValue=!1)}onPopupChildKeydown_(t){this.popC_?t.key==="Escape"&&(this.popC_.shows.rawValue=!1):this.view.pickerElement&&t.key==="Escape"&&this.view.buttonElement.focus()}}class Je{constructor(t=0,e=0,s=0){this.x=t,this.y=e,this.z=s}getComponents(){return[this.x,this.y,this.z]}static isObject(t){if(q(t))return!1;const e=t.x,s=t.y,c=t.z;return!(typeof e!="number"||typeof s!="number"||typeof c!="number")}static equals(t,e){return t.x===e.x&&t.y===e.y&&t.z===e.z}toObject(){return{x:this.x,y:this.y,z:this.z}}}const gr={toComponents:n=>n.getComponents(),fromComponents:n=>new Je(...n)};function Ba(n){return Je.isObject(n)?new Je(n.x,n.y,n.z):new Je}function Ta(n,t){n.writeProperty("x",t.x),n.writeProperty("y",t.y),n.writeProperty("z",t.z)}function Da(n,t){return new Be({assembly:gr,components:[ke("x"in n?n.x:void 0,t.x),ke("y"in n?n.y:void 0,t.y),ke("z"in n?n.z:void 0,t.z)]})}function is(n,t){return{baseStep:Ye(t),constraint:t,textProps:st.fromObject({draggingScale:Ze(t,n),formatter:ne(Cn(t,n))})}}const Aa={id:"input-point3d",type:"input",accept:(n,t)=>{if(!Je.isObject(n))return null;const e=xt,s=ht(t,{x:e.optional.custom(Ee),y:e.optional.custom(Ee),z:e.optional.custom(Ee)});return s?{initialValue:n,params:s}:null},binding:{reader:n=>Ba,constraint:n=>Da(n.params,n.initialValue),equals:Je.equals,writer:n=>Ta},controller:n=>{const t=n.value,e=n.constraint;if(!(e instanceof Be))throw z.shouldNeverHappen();return new rs(n.document,{assembly:gr,axes:[is(t.rawValue.x,e.components[0]),is(t.rawValue.y,e.components[1]),is(t.rawValue.z,e.components[2])],parser:Pe,value:t,viewProps:n.viewProps})}};class tn{constructor(t=0,e=0,s=0,c=0){this.x=t,this.y=e,this.z=s,this.w=c}getComponents(){return[this.x,this.y,this.z,this.w]}static isObject(t){if(q(t))return!1;const e=t.x,s=t.y,c=t.z,P=t.w;return!(typeof e!="number"||typeof s!="number"||typeof c!="number"||typeof P!="number")}static equals(t,e){return t.x===e.x&&t.y===e.y&&t.z===e.z&&t.w===e.w}toObject(){return{x:this.x,y:this.y,z:this.z,w:this.w}}}const wr={toComponents:n=>n.getComponents(),fromComponents:n=>new tn(...n)};function Ra(n){return tn.isObject(n)?new tn(n.x,n.y,n.z,n.w):new tn}function Ia(n,t){n.writeProperty("x",t.x),n.writeProperty("y",t.y),n.writeProperty("z",t.z),n.writeProperty("w",t.w)}function La(n,t){return new Be({assembly:wr,components:[ke("x"in n?n.x:void 0,t.x),ke("y"in n?n.y:void 0,t.y),ke("z"in n?n.z:void 0,t.z),ke("w"in n?n.w:void 0,t.w)]})}function Ua(n,t){return{baseStep:Ye(t),constraint:t,textProps:st.fromObject({draggingScale:Ze(t,n),formatter:ne(Cn(t,n))})}}const Va={id:"input-point4d",type:"input",accept:(n,t)=>{if(!tn.isObject(n))return null;const e=xt,s=ht(t,{x:e.optional.custom(Ee),y:e.optional.custom(Ee),z:e.optional.custom(Ee),w:e.optional.custom(Ee)});return s?{initialValue:n,params:s}:null},binding:{reader:n=>Ra,constraint:n=>La(n.params,n.initialValue),equals:tn.equals,writer:n=>Ia},controller:n=>{const t=n.value,e=n.constraint;if(!(e instanceof Be))throw z.shouldNeverHappen();return new rs(n.document,{assembly:wr,axes:t.rawValue.getComponents().map((s,c)=>Ua(s,e.components[c])),parser:Pe,value:t,viewProps:n.viewProps})}};function Ga(n){const t=[],e=jn(n.options);return e&&t.push(e),new rn(t)}const za={id:"input-string",type:"input",accept:(n,t)=>{if(typeof n!="string")return null;const s=ht(t,{options:xt.optional.custom(kn)});return s?{initialValue:n,params:s}:null},binding:{reader:n=>Vs,constraint:n=>Ga(n.params),writer:n=>hn},controller:n=>{const t=n.document,e=n.value,s=n.constraint,c=s&&ye(s,on);return c?new an(t,{props:new st({options:c.values.value("options")}),value:e,viewProps:n.viewProps}):new Pn(t,{parser:P=>P,props:st.fromObject({formatter:Fn}),value:e,viewProps:n.viewProps})}},_n={monitor:{defaultInterval:200,defaultLineCount:3}},xr=U("mll");class Oa{constructor(t,e){this.onValueUpdate_=this.onValueUpdate_.bind(this),this.formatter_=e.formatter,this.element=t.createElement("div"),this.element.classList.add(xr()),e.viewProps.bindClassModifiers(this.element);const s=t.createElement("textarea");s.classList.add(xr("i")),s.style.height=`calc(var(--bld-us) * ${e.lineCount})`,s.readOnly=!0,e.viewProps.bindDisabled(s),this.element.appendChild(s),this.textareaElem_=s,e.value.emitter.on("change",this.onValueUpdate_),this.value=e.value,this.update_()}update_(){const t=this.textareaElem_,e=t.scrollTop===t.scrollHeight-t.clientHeight,s=[];this.value.rawValue.forEach(c=>{c!==void 0&&s.push(this.formatter_(c))}),t.textContent=s.join(`
`),e&&(t.scrollTop=t.scrollHeight)}onValueUpdate_(){this.update_()}}class os{constructor(t,e){this.value=e.value,this.viewProps=e.viewProps,this.view=new Oa(t,{formatter:e.formatter,lineCount:e.lineCount,value:this.value,viewProps:this.viewProps})}}const yr=U("sgl");class Fa{constructor(t,e){this.onValueUpdate_=this.onValueUpdate_.bind(this),this.formatter_=e.formatter,this.element=t.createElement("div"),this.element.classList.add(yr()),e.viewProps.bindClassModifiers(this.element);const s=t.createElement("input");s.classList.add(yr("i")),s.readOnly=!0,s.type="text",e.viewProps.bindDisabled(s),this.element.appendChild(s),this.inputElement=s,e.value.emitter.on("change",this.onValueUpdate_),this.value=e.value,this.update_()}update_(){const t=this.value.rawValue,e=t[t.length-1];this.inputElement.value=e!==void 0?this.formatter_(e):""}onValueUpdate_(){this.update_()}}class as{constructor(t,e){this.value=e.value,this.viewProps=e.viewProps,this.view=new Fa(t,{formatter:e.formatter,value:this.value,viewProps:this.viewProps})}}const qa={id:"monitor-bool",type:"monitor",accept:(n,t)=>{if(typeof n!="boolean")return null;const s=ht(t,{lineCount:xt.optional.number});return s?{initialValue:n,params:s}:null},binding:{reader:n=>Ds},controller:n=>{var t;return n.value.rawValue.length===1?new as(n.document,{formatter:As,value:n.value,viewProps:n.viewProps}):new os(n.document,{formatter:As,lineCount:(t=n.params.lineCount)!==null&&t!==void 0?t:_n.monitor.defaultLineCount,value:n.value,viewProps:n.viewProps})}},Ae=U("grl");class Na{constructor(t,e){this.onCursorChange_=this.onCursorChange_.bind(this),this.onValueUpdate_=this.onValueUpdate_.bind(this),this.element=t.createElement("div"),this.element.classList.add(Ae()),e.viewProps.bindClassModifiers(this.element),this.formatter_=e.formatter,this.props_=e.props,this.cursor_=e.cursor,this.cursor_.emitter.on("change",this.onCursorChange_);const s=t.createElementNS(k,"svg");s.classList.add(Ae("g")),s.style.height=`calc(var(--bld-us) * ${e.lineCount})`,this.element.appendChild(s),this.svgElem_=s;const c=t.createElementNS(k,"polyline");this.svgElem_.appendChild(c),this.lineElem_=c;const P=t.createElement("div");P.classList.add(Ae("t"),U("tt")()),this.element.appendChild(P),this.tooltipElem_=P,e.value.emitter.on("change",this.onValueUpdate_),this.value=e.value,this.update_()}get graphElement(){return this.svgElem_}update_(){const t=this.svgElem_.getBoundingClientRect(),e=this.value.rawValue.length-1,s=this.props_.get("minValue"),c=this.props_.get("maxValue"),P=[];this.value.rawValue.forEach((Nt,$t)=>{if(Nt===void 0)return;const ze=Zt($t,0,e,0,t.width),mn=Zt(Nt,s,c,t.height,0);P.push([ze,mn].join(","))}),this.lineElem_.setAttributeNS(null,"points",P.join(" "));const T=this.tooltipElem_,nt=this.value.rawValue[this.cursor_.rawValue];if(nt===void 0){T.classList.remove(Ae("t","a"));return}const St=Zt(this.cursor_.rawValue,0,e,0,t.width),Bt=Zt(nt,s,c,t.height,0);T.style.left=`${St}px`,T.style.top=`${Bt}px`,T.textContent=`${this.formatter_(nt)}`,T.classList.contains(Ae("t","a"))||(T.classList.add(Ae("t","a"),Ae("t","in")),r(T),T.classList.remove(Ae("t","in")))}onValueUpdate_(){this.update_()}onCursorChange_(){this.update_()}}class $a{constructor(t,e){if(this.onGraphMouseMove_=this.onGraphMouseMove_.bind(this),this.onGraphMouseLeave_=this.onGraphMouseLeave_.bind(this),this.onGraphPointerDown_=this.onGraphPointerDown_.bind(this),this.onGraphPointerMove_=this.onGraphPointerMove_.bind(this),this.onGraphPointerUp_=this.onGraphPointerUp_.bind(this),this.props_=e.props,this.value=e.value,this.viewProps=e.viewProps,this.cursor_=H(-1),this.view=new Na(t,{cursor:this.cursor_,formatter:e.formatter,lineCount:e.lineCount,props:this.props_,value:this.value,viewProps:this.viewProps}),!u(t))this.view.element.addEventListener("mousemove",this.onGraphMouseMove_),this.view.element.addEventListener("mouseleave",this.onGraphMouseLeave_);else{const s=new Ie(this.view.element);s.emitter.on("down",this.onGraphPointerDown_),s.emitter.on("move",this.onGraphPointerMove_),s.emitter.on("up",this.onGraphPointerUp_)}}onGraphMouseLeave_(){this.cursor_.rawValue=-1}onGraphMouseMove_(t){const e=this.view.element.getBoundingClientRect();this.cursor_.rawValue=Math.floor(Zt(t.offsetX,0,e.width,0,this.value.rawValue.length))}onGraphPointerDown_(t){this.onGraphPointerMove_(t)}onGraphPointerMove_(t){if(!t.data.point){this.cursor_.rawValue=-1;return}this.cursor_.rawValue=Math.floor(Zt(t.data.point.x,0,t.data.bounds.width,0,this.value.rawValue.length))}onGraphPointerUp_(){this.cursor_.rawValue=-1}}function ls(n){return"format"in n&&!q(n.format)?n.format:ne(2)}function Wa(n){var t;return n.value.rawValue.length===1?new as(n.document,{formatter:ls(n.params),value:n.value,viewProps:n.viewProps}):new os(n.document,{formatter:ls(n.params),lineCount:(t=n.params.lineCount)!==null&&t!==void 0?t:_n.monitor.defaultLineCount,value:n.value,viewProps:n.viewProps})}function ja(n){var t,e,s;return new $a(n.document,{formatter:ls(n.params),lineCount:(t=n.params.lineCount)!==null&&t!==void 0?t:_n.monitor.defaultLineCount,props:st.fromObject({maxValue:(e="max"in n.params?n.params.max:null)!==null&&e!==void 0?e:100,minValue:(s="min"in n.params?n.params.min:null)!==null&&s!==void 0?s:0}),value:n.value,viewProps:n.viewProps})}function Pr(n){return"view"in n&&n.view==="graph"}const Ka={id:"monitor-number",type:"monitor",accept:(n,t)=>{if(typeof n!="number")return null;const e=xt,s=ht(t,{format:e.optional.function,lineCount:e.optional.number,max:e.optional.number,min:e.optional.number,view:e.optional.string});return s?{initialValue:n,params:s}:null},binding:{defaultBufferSize:n=>Pr(n)?64:1,reader:n=>Us},controller:n=>Pr(n.params)?ja(n):Wa(n)},Ha={id:"monitor-string",type:"monitor",accept:(n,t)=>{if(typeof n!="string")return null;const e=xt,s=ht(t,{lineCount:e.optional.number,multiline:e.optional.boolean});return s?{initialValue:n,params:s}:null},binding:{reader:n=>Vs},controller:n=>{var t;const e=n.value;return e.rawValue.length>1||"multiline"in n.params&&n.params.multiline?new os(n.document,{formatter:Fn,lineCount:(t=n.params.lineCount)!==null&&t!==void 0?t:_n.monitor.defaultLineCount,value:e,viewProps:n.viewProps}):new as(n.document,{formatter:Fn,value:e,viewProps:n.viewProps})}};function Ya(n,t){var e;const s=n.accept(t.target.read(),t.params);if(q(s))return null;const c=xt,P={target:t.target,initialValue:s.initialValue,params:s.params},T=n.binding.reader(P),nt=n.binding.constraint?n.binding.constraint(P):void 0,St=H(T(s.initialValue),{constraint:nt,equals:n.binding.equals}),Bt=new wi({reader:T,target:t.target,value:St,writer:n.binding.writer(P)}),Nt=c.optional.boolean(t.params.disabled).value,$t=c.optional.boolean(t.params.hidden).value,ze=n.controller({constraint:nt,document:t.document,initialValue:s.initialValue,params:s.params,value:Bt.value,viewProps:f.create({disabled:Nt,hidden:$t})});return new Kt(t.document,{binding:Bt,blade:At(),props:st.fromObject({label:"label"in t.params?(e=c.optional.string(t.params.label).value)!==null&&e!==void 0?e:null:t.target.key}),valueController:ze})}function Za(n,t){return t===0?new vi:new gi(n,t??_n.monitor.defaultInterval)}function Xa(n,t){var e,s,c;const P=xt,T=n.accept(t.target.read(),t.params);if(q(T))return null;const nt={target:t.target,initialValue:T.initialValue,params:T.params},St=n.binding.reader(nt),Bt=(s=(e=P.optional.number(t.params.bufferSize).value)!==null&&e!==void 0?e:n.binding.defaultBufferSize&&n.binding.defaultBufferSize(T.params))!==null&&s!==void 0?s:1,Nt=P.optional.number(t.params.interval).value,$t=new Si({reader:St,target:t.target,ticker:Za(t.document,Nt),value:xi(Bt)}),ze=P.optional.boolean(t.params.disabled).value,mn=P.optional.boolean(t.params.hidden).value,bn=n.controller({document:t.document,params:T.params,value:$t.value,viewProps:f.create({disabled:ze,hidden:mn})});return new Ht(t.document,{binding:$t,blade:At(),props:st.fromObject({label:"label"in t.params?(c=P.optional.string(t.params.label).value)!==null&&c!==void 0?c:null:t.target.key}),valueController:bn})}class Qa{constructor(){this.pluginsMap_={blades:[],inputs:[],monitors:[]}}getAll(){return[...this.pluginsMap_.blades,...this.pluginsMap_.inputs,...this.pluginsMap_.monitors]}register(t){t.type==="blade"?this.pluginsMap_.blades.unshift(t):t.type==="input"?this.pluginsMap_.inputs.unshift(t):t.type==="monitor"&&this.pluginsMap_.monitors.unshift(t)}createInput(t,e,s){const c=e.read();if(q(c))throw new z({context:{key:e.key},type:"nomatchingcontroller"});const P=this.pluginsMap_.inputs.reduce((T,nt)=>T??Ya(nt,{document:t,target:e,params:s}),null);if(P)return P;throw new z({context:{key:e.key},type:"nomatchingcontroller"})}createMonitor(t,e,s){const c=this.pluginsMap_.monitors.reduce((P,T)=>P??Xa(T,{document:t,params:s,target:e}),null);if(c)return c;throw new z({context:{key:e.key},type:"nomatchingcontroller"})}createBlade(t,e){const s=this.pluginsMap_.blades.reduce((c,P)=>c??bi(P,{document:t,params:e}),null);if(!s)throw new z({type:"nomatchingview",context:{params:e}});return s}createBladeApi(t){if(t instanceof Kt)return new qt(t);if(t instanceof Ht)return new Xt(t);if(t instanceof Yt)return new fe(t,this);const e=this.pluginsMap_.blades.reduce((s,c)=>s??c.api({controller:t,pool:this}),null);if(!e)throw z.shouldNeverHappen();return e}}function Ja(){const n=new Qa;return[il,Aa,Va,za,Sa,ga,va,fa,ho,qa,Ha,Ka,bt,ui,pi,ks].forEach(t=>{n.register(t)}),n}function tl(n){return Te.isObject(n)?new Te(n.x,n.y):new Te}function el(n,t){n.writeProperty("x",t.x),n.writeProperty("y",t.y)}function ke(n,t){if(!n)return;const e=[],s=_r(n,t);s&&e.push(s);const c=mr(n);return c&&e.push(c),new rn(e)}function nl(n,t){return new Be({assembly:br,components:[ke("x"in n?n.x:void 0,t.x),ke("y"in n?n.y:void 0,t.y)]})}function Sr(n,t){const[e,s]=n?ya(n):[];if(!q(e)||!q(s))return Math.max(Math.abs(e??0),Math.abs(s??0));const c=Ye(n);return Math.max(Math.abs(c)*10,Math.abs(t)*10)}function sl(n,t){const e=t instanceof Be?t.components[0]:void 0,s=t instanceof Be?t.components[1]:void 0,c=Sr(e,n.x),P=Sr(s,n.y);return Math.max(c,P)}function kr(n,t){return{baseStep:Ye(t),constraint:t,textProps:st.fromObject({draggingScale:Ze(t,n),formatter:ne(Cn(t,n))})}}function rl(n){if(!("y"in n))return!1;const t=n.y;return t&&"inverted"in t?!!t.inverted:!1}const il={id:"input-point2d",type:"input",accept:(n,t)=>{if(!Te.isObject(n))return null;const e=xt,s=ht(t,{expanded:e.optional.boolean,picker:e.optional.custom(Fs),x:e.optional.custom(Ee),y:e.optional.object({inverted:e.optional.boolean,max:e.optional.number,min:e.optional.number,step:e.optional.number})});return s?{initialValue:n,params:s}:null},binding:{reader:n=>tl,constraint:n=>nl(n.params,n.initialValue),equals:Te.equals,writer:n=>el},controller:n=>{const t=n.document,e=n.value,s=n.constraint;if(!(s instanceof Be))throw z.shouldNeverHappen();const c="expanded"in n.params?n.params.expanded:void 0,P="picker"in n.params?n.params.picker:void 0;return new Ma(t,{axes:[kr(e.rawValue.x,s.components[0]),kr(e.rawValue.y,s.components[1])],expanded:c??!1,invertsY:rl(n.params),maxValue:sl(e.rawValue,s),parser:Pe,pickerLayout:P??"popup",value:e,viewProps:n.viewProps})}};class Cr extends x{constructor(t){super(t),this.emitter_=new O,this.controller_.valueController.value.emitter.on("change",e=>{this.emitter_.emit("change",{event:new M(this,e.rawValue)})})}get label(){return this.controller_.props.get("label")}set label(t){this.controller_.props.set("label",t)}get options(){return this.controller_.valueController.props.get("options")}set options(t){this.controller_.valueController.props.set("options",t)}get value(){return this.controller_.valueController.value.rawValue}set value(t){this.controller_.valueController.value.rawValue=t}on(t,e){const s=e.bind(this);return this.emitter_.on(t,c=>{s(c.event)}),this}}class Er extends x{constructor(t){super(t),this.emitter_=new O,this.controller_.valueController.value.emitter.on("change",e=>{this.emitter_.emit("change",{event:new M(this,e.rawValue)})})}get label(){return this.controller_.props.get("label")}set label(t){this.controller_.props.set("label",t)}get maxValue(){return this.controller_.valueController.sliderController.props.get("maxValue")}set maxValue(t){this.controller_.valueController.sliderController.props.set("maxValue",t)}get minValue(){return this.controller_.valueController.sliderController.props.get("minValue")}set minValue(t){this.controller_.valueController.sliderController.props.set("minValue",t)}get value(){return this.controller_.valueController.value.rawValue}set value(t){this.controller_.valueController.value.rawValue=t}on(t,e){const s=e.bind(this);return this.emitter_.on(t,c=>{s(c.event)}),this}}class Mr extends x{constructor(t){super(t),this.emitter_=new O,this.controller_.valueController.value.emitter.on("change",e=>{this.emitter_.emit("change",{event:new M(this,e.rawValue)})})}get label(){return this.controller_.props.get("label")}set label(t){this.controller_.props.set("label",t)}get formatter(){return this.controller_.valueController.props.get("formatter")}set formatter(t){this.controller_.valueController.props.set("formatter",t)}get value(){return this.controller_.valueController.value.rawValue}set value(t){this.controller_.valueController.value.rawValue=t}on(t,e){const s=e.bind(this);return this.emitter_.on(t,c=>{s(c.event)}),this}}const ol=function(){return{id:"list",type:"blade",accept(n){const t=xt,e=ht(n,{options:t.required.custom(kn),value:t.required.raw,view:t.required.constant("list"),label:t.optional.string});return e?{params:e}:null},controller(n){const t=new on(qs(n.params.options)),e=H(n.params.value,{constraint:t}),s=new an(n.document,{props:new st({options:t.values.value("options")}),value:e,viewProps:n.viewProps});return new Ke(n.document,{blade:n.blade,props:st.fromObject({label:n.params.label}),valueController:s})},api(n){return!(n.controller instanceof Ke)||!(n.controller.valueController instanceof an)?null:new Cr(n.controller)}}}();function al(n){return n.reduce((t,e)=>Object.assign(t,{[e.presetKey]:e.read()}),{})}function ll(n,t){n.forEach(e=>{const s=t[e.target.presetKey];s!==void 0&&e.writer(e.target,e.reader(s))})}class cl extends _e{constructor(t,e){super(t,e)}get element(){return this.controller_.view.element}importPreset(t){const e=this.controller_.rackController.rack.find(Kt).map(s=>s.binding);ll(e,t),this.refresh()}exportPreset(){const t=this.controller_.rackController.rack.find(Kt).map(e=>e.binding.target);return al(t)}refresh(){this.controller_.rackController.rack.find(Kt).forEach(t=>{t.binding.read()}),this.controller_.rackController.rack.find(Ht).forEach(t=>{t.binding.read()})}}class ul extends Vn{constructor(t,e){super(t,{expanded:e.expanded,blade:e.blade,props:e.props,root:!0,viewProps:e.viewProps})}}const dl={id:"slider",type:"blade",accept(n){const t=xt,e=ht(n,{max:t.required.number,min:t.required.number,view:t.required.constant("slider"),format:t.optional.function,label:t.optional.string,value:t.optional.number});return e?{params:e}:null},controller(n){var t,e;const s=(t=n.params.value)!==null&&t!==void 0?t:0,c=new He({max:n.params.max,min:n.params.min}),P=new Wn(n.document,{baseStep:1,parser:Pe,sliderProps:new st({maxValue:c.values.value("max"),minValue:c.values.value("min")}),textProps:st.fromObject({draggingScale:Ze(void 0,s),formatter:(e=n.params.format)!==null&&e!==void 0?e:eo}),value:H(s,{constraint:c}),viewProps:n.viewProps});return new Ke(n.document,{blade:n.blade,props:st.fromObject({label:n.params.label}),valueController:P})},api(n){return!(n.controller instanceof Ke)||!(n.controller.valueController instanceof Wn)?null:new Er(n.controller)}},pl=function(){return{id:"text",type:"blade",accept(n){const t=xt,e=ht(n,{parse:t.required.function,value:t.required.raw,view:t.required.constant("text"),format:t.optional.function,label:t.optional.string});return e?{params:e}:null},controller(n){var t;const e=new Pn(n.document,{parser:n.params.parse,props:st.fromObject({formatter:(t=n.params.format)!==null&&t!==void 0?t:s=>String(s)}),value:H(n.params.value),viewProps:n.viewProps});return new Ke(n.document,{blade:n.blade,props:st.fromObject({label:n.params.label}),valueController:e})},api(n){return!(n.controller instanceof Ke)||!(n.controller.valueController instanceof Pn)?null:new Mr(n.controller)}}}();function hl(n){const t=n.createElement("div");return t.classList.add(U("dfw")()),n.body&&n.body.appendChild(t),t}function Br(n,t,e){if(n.querySelector(`style[data-tp-style=${t}]`))return;const s=n.createElement("style");s.dataset.tpStyle=t,s.textContent=e,n.head.appendChild(s)}class fl extends cl{constructor(t){var e,s;const c=t??{},P=(e=c.document)!==null&&e!==void 0?e:a(),T=Ja(),nt=new ul(P,{expanded:c.expanded,blade:At(),props:st.fromObject({title:c.title}),viewProps:f.create()});super(nt,T),this.pool_=T,this.containerElem_=(s=c.container)!==null&&s!==void 0?s:hl(P),this.containerElem_.appendChild(this.element),this.doc_=P,this.usesDefaultWrapper_=!c.container,this.setUpDefaultPlugins_()}get document(){if(!this.doc_)throw z.alreadyDisposed();return this.doc_}dispose(){const t=this.containerElem_;if(!t)throw z.alreadyDisposed();if(this.usesDefaultWrapper_){const e=t.parentElement;e&&e.removeChild(t)}this.containerElem_=null,this.doc_=null,super.dispose()}registerPlugin(t){("plugin"in t?[t.plugin]:"plugins"in t?t.plugins:[]).forEach(s=>{this.pool_.register(s),this.embedPluginStyle_(s)})}embedPluginStyle_(t){t.css&&Br(this.document,`plugin-${t.id}`,t.css)}setUpDefaultPlugins_(){Br(this.document,"default",'.tp-tbiv_b,.tp-coltxtv_ms,.tp-ckbv_i,.tp-rotv_b,.tp-fldv_b,.tp-mllv_i,.tp-sglv_i,.tp-grlv_g,.tp-txtv_i,.tp-p2dpv_p,.tp-colswv_sw,.tp-p2dv_b,.tp-btnv_b,.tp-lstv_s{-webkit-appearance:none;-moz-appearance:none;appearance:none;background-color:rgba(0,0,0,0);border-width:0;font-family:inherit;font-size:inherit;font-weight:inherit;margin:0;outline:none;padding:0}.tp-p2dv_b,.tp-btnv_b,.tp-lstv_s{background-color:var(--btn-bg);border-radius:var(--elm-br);color:var(--btn-fg);cursor:pointer;display:block;font-weight:bold;height:var(--bld-us);line-height:var(--bld-us);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.tp-p2dv_b:hover,.tp-btnv_b:hover,.tp-lstv_s:hover{background-color:var(--btn-bg-h)}.tp-p2dv_b:focus,.tp-btnv_b:focus,.tp-lstv_s:focus{background-color:var(--btn-bg-f)}.tp-p2dv_b:active,.tp-btnv_b:active,.tp-lstv_s:active{background-color:var(--btn-bg-a)}.tp-p2dv_b:disabled,.tp-btnv_b:disabled,.tp-lstv_s:disabled{opacity:.5}.tp-txtv_i,.tp-p2dpv_p,.tp-colswv_sw{background-color:var(--in-bg);border-radius:var(--elm-br);box-sizing:border-box;color:var(--in-fg);font-family:inherit;height:var(--bld-us);line-height:var(--bld-us);min-width:0;width:100%}.tp-txtv_i:hover,.tp-p2dpv_p:hover,.tp-colswv_sw:hover{background-color:var(--in-bg-h)}.tp-txtv_i:focus,.tp-p2dpv_p:focus,.tp-colswv_sw:focus{background-color:var(--in-bg-f)}.tp-txtv_i:active,.tp-p2dpv_p:active,.tp-colswv_sw:active{background-color:var(--in-bg-a)}.tp-txtv_i:disabled,.tp-p2dpv_p:disabled,.tp-colswv_sw:disabled{opacity:.5}.tp-mllv_i,.tp-sglv_i,.tp-grlv_g{background-color:var(--mo-bg);border-radius:var(--elm-br);box-sizing:border-box;color:var(--mo-fg);height:var(--bld-us);scrollbar-color:currentColor rgba(0,0,0,0);scrollbar-width:thin;width:100%}.tp-mllv_i::-webkit-scrollbar,.tp-sglv_i::-webkit-scrollbar,.tp-grlv_g::-webkit-scrollbar{height:8px;width:8px}.tp-mllv_i::-webkit-scrollbar-corner,.tp-sglv_i::-webkit-scrollbar-corner,.tp-grlv_g::-webkit-scrollbar-corner{background-color:rgba(0,0,0,0)}.tp-mllv_i::-webkit-scrollbar-thumb,.tp-sglv_i::-webkit-scrollbar-thumb,.tp-grlv_g::-webkit-scrollbar-thumb{background-clip:padding-box;background-color:currentColor;border:rgba(0,0,0,0) solid 2px;border-radius:4px}.tp-rotv{--font-family: var(--tp-font-family, Roboto Mono, Source Code Pro, Menlo, Courier, monospace);--bs-br: var(--tp-base-border-radius, 6px);--cnt-h-p: var(--tp-container-horizontal-padding, 4px);--cnt-v-p: var(--tp-container-vertical-padding, 4px);--elm-br: var(--tp-element-border-radius, 2px);--bld-s: var(--tp-blade-spacing, 4px);--bld-us: var(--tp-blade-unit-size, 20px);--bs-bg: var(--tp-base-background-color, hsl(230, 7%, 17%));--bs-sh: var(--tp-base-shadow-color, rgba(0, 0, 0, 0.2));--btn-bg: var(--tp-button-background-color, hsl(230, 7%, 70%));--btn-bg-a: var(--tp-button-background-color-active, #d6d7db);--btn-bg-f: var(--tp-button-background-color-focus, #c8cad0);--btn-bg-h: var(--tp-button-background-color-hover, #bbbcc4);--btn-fg: var(--tp-button-foreground-color, hsl(230, 7%, 17%));--cnt-bg: var(--tp-container-background-color, rgba(187, 188, 196, 0.1));--cnt-bg-a: var(--tp-container-background-color-active, rgba(187, 188, 196, 0.25));--cnt-bg-f: var(--tp-container-background-color-focus, rgba(187, 188, 196, 0.2));--cnt-bg-h: var(--tp-container-background-color-hover, rgba(187, 188, 196, 0.15));--cnt-fg: var(--tp-container-foreground-color, hsl(230, 7%, 75%));--in-bg: var(--tp-input-background-color, rgba(187, 188, 196, 0.1));--in-bg-a: var(--tp-input-background-color-active, rgba(187, 188, 196, 0.25));--in-bg-f: var(--tp-input-background-color-focus, rgba(187, 188, 196, 0.2));--in-bg-h: var(--tp-input-background-color-hover, rgba(187, 188, 196, 0.15));--in-fg: var(--tp-input-foreground-color, hsl(230, 7%, 75%));--lbl-fg: var(--tp-label-foreground-color, rgba(187, 188, 196, 0.7));--mo-bg: var(--tp-monitor-background-color, rgba(0, 0, 0, 0.2));--mo-fg: var(--tp-monitor-foreground-color, rgba(187, 188, 196, 0.7));--grv-fg: var(--tp-groove-foreground-color, rgba(187, 188, 196, 0.1))}.tp-rotv_c>.tp-cntv.tp-v-lst,.tp-tabv_c .tp-brkv>.tp-cntv.tp-v-lst,.tp-fldv_c>.tp-cntv.tp-v-lst{margin-bottom:calc(-1*var(--cnt-v-p))}.tp-rotv_c>.tp-fldv.tp-v-lst .tp-fldv_c,.tp-tabv_c .tp-brkv>.tp-fldv.tp-v-lst .tp-fldv_c,.tp-fldv_c>.tp-fldv.tp-v-lst .tp-fldv_c{border-bottom-left-radius:0}.tp-rotv_c>.tp-fldv.tp-v-lst .tp-fldv_b,.tp-tabv_c .tp-brkv>.tp-fldv.tp-v-lst .tp-fldv_b,.tp-fldv_c>.tp-fldv.tp-v-lst .tp-fldv_b{border-bottom-left-radius:0}.tp-rotv_c>*:not(.tp-v-fst),.tp-tabv_c .tp-brkv>*:not(.tp-v-fst),.tp-fldv_c>*:not(.tp-v-fst){margin-top:var(--bld-s)}.tp-rotv_c>.tp-sprv:not(.tp-v-fst),.tp-tabv_c .tp-brkv>.tp-sprv:not(.tp-v-fst),.tp-fldv_c>.tp-sprv:not(.tp-v-fst),.tp-rotv_c>.tp-cntv:not(.tp-v-fst),.tp-tabv_c .tp-brkv>.tp-cntv:not(.tp-v-fst),.tp-fldv_c>.tp-cntv:not(.tp-v-fst){margin-top:var(--cnt-v-p)}.tp-rotv_c>.tp-sprv+*:not(.tp-v-hidden),.tp-tabv_c .tp-brkv>.tp-sprv+*:not(.tp-v-hidden),.tp-fldv_c>.tp-sprv+*:not(.tp-v-hidden),.tp-rotv_c>.tp-cntv+*:not(.tp-v-hidden),.tp-tabv_c .tp-brkv>.tp-cntv+*:not(.tp-v-hidden),.tp-fldv_c>.tp-cntv+*:not(.tp-v-hidden){margin-top:var(--cnt-v-p)}.tp-rotv_c>.tp-sprv:not(.tp-v-hidden)+.tp-sprv,.tp-tabv_c .tp-brkv>.tp-sprv:not(.tp-v-hidden)+.tp-sprv,.tp-fldv_c>.tp-sprv:not(.tp-v-hidden)+.tp-sprv,.tp-rotv_c>.tp-cntv:not(.tp-v-hidden)+.tp-cntv,.tp-tabv_c .tp-brkv>.tp-cntv:not(.tp-v-hidden)+.tp-cntv,.tp-fldv_c>.tp-cntv:not(.tp-v-hidden)+.tp-cntv{margin-top:0}.tp-tabv_c .tp-brkv>.tp-cntv,.tp-fldv_c>.tp-cntv{margin-left:4px}.tp-tabv_c .tp-brkv>.tp-fldv>.tp-fldv_b,.tp-fldv_c>.tp-fldv>.tp-fldv_b{border-top-left-radius:var(--elm-br);border-bottom-left-radius:var(--elm-br)}.tp-tabv_c .tp-brkv>.tp-fldv.tp-fldv-expanded>.tp-fldv_b,.tp-fldv_c>.tp-fldv.tp-fldv-expanded>.tp-fldv_b{border-bottom-left-radius:0}.tp-tabv_c .tp-brkv .tp-fldv>.tp-fldv_c,.tp-fldv_c .tp-fldv>.tp-fldv_c{border-bottom-left-radius:var(--elm-br)}.tp-tabv_c .tp-brkv>.tp-cntv+.tp-fldv>.tp-fldv_b,.tp-fldv_c>.tp-cntv+.tp-fldv>.tp-fldv_b{border-top-left-radius:0}.tp-tabv_c .tp-brkv>.tp-cntv+.tp-tabv>.tp-tabv_t,.tp-fldv_c>.tp-cntv+.tp-tabv>.tp-tabv_t{border-top-left-radius:0}.tp-tabv_c .tp-brkv>.tp-tabv>.tp-tabv_t,.tp-fldv_c>.tp-tabv>.tp-tabv_t{border-top-left-radius:var(--elm-br)}.tp-tabv_c .tp-brkv .tp-tabv>.tp-tabv_c,.tp-fldv_c .tp-tabv>.tp-tabv_c{border-bottom-left-radius:var(--elm-br)}.tp-rotv_b,.tp-fldv_b{background-color:var(--cnt-bg);color:var(--cnt-fg);cursor:pointer;display:block;height:calc(var(--bld-us) + 4px);line-height:calc(var(--bld-us) + 4px);overflow:hidden;padding-left:var(--cnt-h-p);padding-right:calc(4px + var(--bld-us) + var(--cnt-h-p));position:relative;text-align:left;text-overflow:ellipsis;white-space:nowrap;width:100%;transition:border-radius .2s ease-in-out .2s}.tp-rotv_b:hover,.tp-fldv_b:hover{background-color:var(--cnt-bg-h)}.tp-rotv_b:focus,.tp-fldv_b:focus{background-color:var(--cnt-bg-f)}.tp-rotv_b:active,.tp-fldv_b:active{background-color:var(--cnt-bg-a)}.tp-rotv_b:disabled,.tp-fldv_b:disabled{opacity:.5}.tp-rotv_m,.tp-fldv_m{background:linear-gradient(to left, var(--cnt-fg), var(--cnt-fg) 2px, transparent 2px, transparent 4px, var(--cnt-fg) 4px);border-radius:2px;bottom:0;content:"";display:block;height:6px;right:calc(var(--cnt-h-p) + (var(--bld-us) + 4px - 6px)/2 - 2px);margin:auto;opacity:.5;position:absolute;top:0;transform:rotate(90deg);transition:transform .2s ease-in-out;width:6px}.tp-rotv.tp-rotv-expanded .tp-rotv_m,.tp-fldv.tp-fldv-expanded>.tp-fldv_b>.tp-fldv_m{transform:none}.tp-rotv_c,.tp-fldv_c{box-sizing:border-box;height:0;opacity:0;overflow:hidden;padding-bottom:0;padding-top:0;position:relative;transition:height .2s ease-in-out,opacity .2s linear,padding .2s ease-in-out}.tp-rotv.tp-rotv-cpl:not(.tp-rotv-expanded) .tp-rotv_c,.tp-fldv.tp-fldv-cpl:not(.tp-fldv-expanded)>.tp-fldv_c{display:none}.tp-rotv.tp-rotv-expanded .tp-rotv_c,.tp-fldv.tp-fldv-expanded>.tp-fldv_c{opacity:1;padding-bottom:var(--cnt-v-p);padding-top:var(--cnt-v-p);transform:none;overflow:visible;transition:height .2s ease-in-out,opacity .2s linear .2s,padding .2s ease-in-out}.tp-lstv,.tp-coltxtv_m{position:relative}.tp-lstv_s{padding:0 20px 0 4px;width:100%}.tp-lstv_m,.tp-coltxtv_mm{bottom:0;margin:auto;pointer-events:none;position:absolute;right:2px;top:0}.tp-lstv_m svg,.tp-coltxtv_mm svg{bottom:0;height:16px;margin:auto;position:absolute;right:0;top:0;width:16px}.tp-lstv_m svg path,.tp-coltxtv_mm svg path{fill:currentColor}.tp-pndtxtv,.tp-coltxtv_w{display:flex}.tp-pndtxtv_a,.tp-coltxtv_c{width:100%}.tp-pndtxtv_a+.tp-pndtxtv_a,.tp-coltxtv_c+.tp-pndtxtv_a,.tp-pndtxtv_a+.tp-coltxtv_c,.tp-coltxtv_c+.tp-coltxtv_c{margin-left:2px}.tp-btnv_b{width:100%}.tp-btnv_t{text-align:center}.tp-ckbv_l{display:block;position:relative}.tp-ckbv_i{left:0;opacity:0;position:absolute;top:0}.tp-ckbv_w{background-color:var(--in-bg);border-radius:var(--elm-br);cursor:pointer;display:block;height:var(--bld-us);position:relative;width:var(--bld-us)}.tp-ckbv_w svg{bottom:0;display:block;height:16px;left:0;margin:auto;opacity:0;position:absolute;right:0;top:0;width:16px}.tp-ckbv_w svg path{fill:none;stroke:var(--in-fg);stroke-width:2}.tp-ckbv_i:hover+.tp-ckbv_w{background-color:var(--in-bg-h)}.tp-ckbv_i:focus+.tp-ckbv_w{background-color:var(--in-bg-f)}.tp-ckbv_i:active+.tp-ckbv_w{background-color:var(--in-bg-a)}.tp-ckbv_i:checked+.tp-ckbv_w svg{opacity:1}.tp-ckbv.tp-v-disabled .tp-ckbv_w{opacity:.5}.tp-colv{position:relative}.tp-colv_h{display:flex}.tp-colv_s{flex-grow:0;flex-shrink:0;width:var(--bld-us)}.tp-colv_t{flex:1;margin-left:4px}.tp-colv_p{height:0;margin-top:0;opacity:0;overflow:hidden;transition:height .2s ease-in-out,opacity .2s linear,margin .2s ease-in-out}.tp-colv.tp-colv-expanded.tp-colv-cpl .tp-colv_p{overflow:visible}.tp-colv.tp-colv-expanded .tp-colv_p{margin-top:var(--bld-s);opacity:1}.tp-colv .tp-popv{left:calc(-1*var(--cnt-h-p));right:calc(-1*var(--cnt-h-p));top:var(--bld-us)}.tp-colpv_h,.tp-colpv_ap{margin-left:6px;margin-right:6px}.tp-colpv_h{margin-top:var(--bld-s)}.tp-colpv_rgb{display:flex;margin-top:var(--bld-s);width:100%}.tp-colpv_a{display:flex;margin-top:var(--cnt-v-p);padding-top:calc(var(--cnt-v-p) + 2px);position:relative}.tp-colpv_a::before{background-color:var(--grv-fg);content:"";height:2px;left:calc(-1*var(--cnt-h-p));position:absolute;right:calc(-1*var(--cnt-h-p));top:0}.tp-colpv.tp-v-disabled .tp-colpv_a::before{opacity:.5}.tp-colpv_ap{align-items:center;display:flex;flex:3}.tp-colpv_at{flex:1;margin-left:4px}.tp-svpv{border-radius:var(--elm-br);outline:none;overflow:hidden;position:relative}.tp-svpv.tp-v-disabled{opacity:.5}.tp-svpv_c{cursor:crosshair;display:block;height:calc(var(--bld-us)*4);width:100%}.tp-svpv_m{border-radius:100%;border:rgba(255,255,255,.75) solid 2px;box-sizing:border-box;filter:drop-shadow(0 0 1px rgba(0, 0, 0, 0.3));height:12px;margin-left:-6px;margin-top:-6px;pointer-events:none;position:absolute;width:12px}.tp-svpv:focus .tp-svpv_m{border-color:#fff}.tp-hplv{cursor:pointer;height:var(--bld-us);outline:none;position:relative}.tp-hplv.tp-v-disabled{opacity:.5}.tp-hplv_c{background-image:url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAEAAAAABCAYAAABubagXAAAAQ0lEQVQoU2P8z8Dwn0GCgQEDi2OK/RBgYHjBgIpfovFh8j8YBIgzFGQxuqEgPhaDOT5gOhPkdCxOZeBg+IDFZZiGAgCaSSMYtcRHLgAAAABJRU5ErkJggg==);background-position:left top;background-repeat:no-repeat;background-size:100% 100%;border-radius:2px;display:block;height:4px;left:0;margin-top:-2px;position:absolute;top:50%;width:100%}.tp-hplv_m{border-radius:var(--elm-br);border:rgba(255,255,255,.75) solid 2px;box-shadow:0 0 2px rgba(0,0,0,.1);box-sizing:border-box;height:12px;left:50%;margin-left:-6px;margin-top:-6px;pointer-events:none;position:absolute;top:50%;width:12px}.tp-hplv:focus .tp-hplv_m{border-color:#fff}.tp-aplv{cursor:pointer;height:var(--bld-us);outline:none;position:relative;width:100%}.tp-aplv.tp-v-disabled{opacity:.5}.tp-aplv_b{background-color:#fff;background-image:linear-gradient(to top right, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%),linear-gradient(to top right, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%);background-size:4px 4px;background-position:0 0,2px 2px;border-radius:2px;display:block;height:4px;left:0;margin-top:-2px;overflow:hidden;position:absolute;top:50%;width:100%}.tp-aplv_c{bottom:0;left:0;position:absolute;right:0;top:0}.tp-aplv_m{background-color:#fff;background-image:linear-gradient(to top right, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%),linear-gradient(to top right, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%);background-size:12px 12px;background-position:0 0,6px 6px;border-radius:var(--elm-br);box-shadow:0 0 2px rgba(0,0,0,.1);height:12px;left:50%;margin-left:-6px;margin-top:-6px;overflow:hidden;pointer-events:none;position:absolute;top:50%;width:12px}.tp-aplv_p{border-radius:var(--elm-br);border:rgba(255,255,255,.75) solid 2px;box-sizing:border-box;bottom:0;left:0;position:absolute;right:0;top:0}.tp-aplv:focus .tp-aplv_p{border-color:#fff}.tp-colswv{background-color:#fff;background-image:linear-gradient(to top right, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%),linear-gradient(to top right, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%);background-size:10px 10px;background-position:0 0,5px 5px;border-radius:var(--elm-br);overflow:hidden}.tp-colswv.tp-v-disabled{opacity:.5}.tp-colswv_sw{border-radius:0}.tp-colswv_b{-webkit-appearance:none;-moz-appearance:none;appearance:none;background-color:rgba(0,0,0,0);border-width:0;cursor:pointer;display:block;height:var(--bld-us);left:0;margin:0;outline:none;padding:0;position:absolute;top:0;width:var(--bld-us)}.tp-colswv_b:focus::after{border:rgba(255,255,255,.75) solid 2px;border-radius:var(--elm-br);bottom:0;content:"";display:block;left:0;position:absolute;right:0;top:0}.tp-coltxtv{display:flex;width:100%}.tp-coltxtv_m{margin-right:4px}.tp-coltxtv_ms{border-radius:var(--elm-br);color:var(--lbl-fg);cursor:pointer;height:var(--bld-us);line-height:var(--bld-us);padding:0 18px 0 4px}.tp-coltxtv_ms:hover{background-color:var(--in-bg-h)}.tp-coltxtv_ms:focus{background-color:var(--in-bg-f)}.tp-coltxtv_ms:active{background-color:var(--in-bg-a)}.tp-coltxtv_mm{color:var(--lbl-fg)}.tp-coltxtv.tp-v-disabled .tp-coltxtv_mm{opacity:.5}.tp-coltxtv_w{flex:1}.tp-dfwv{position:absolute;top:8px;right:8px;width:256px}.tp-fldv{position:relative}.tp-fldv.tp-fldv-not .tp-fldv_b{display:none}.tp-fldv_t{padding-left:4px}.tp-fldv_b:disabled .tp-fldv_m{display:none}.tp-fldv_c{padding-left:4px}.tp-fldv_i{bottom:0;color:var(--cnt-bg);left:0;overflow:hidden;position:absolute;top:calc(var(--bld-us) + 4px);width:var(--bs-br)}.tp-fldv_i::before{background-color:currentColor;bottom:0;content:"";left:0;position:absolute;top:0;width:4px}.tp-fldv_b:hover+.tp-fldv_i{color:var(--cnt-bg-h)}.tp-fldv_b:focus+.tp-fldv_i{color:var(--cnt-bg-f)}.tp-fldv_b:active+.tp-fldv_i{color:var(--cnt-bg-a)}.tp-fldv.tp-v-disabled>.tp-fldv_i{opacity:.5}.tp-grlv{position:relative}.tp-grlv_g{display:block;height:calc(var(--bld-us)*3)}.tp-grlv_g polyline{fill:none;stroke:var(--mo-fg);stroke-linejoin:round}.tp-grlv_t{margin-top:-4px;transition:left .05s,top .05s;visibility:hidden}.tp-grlv_t.tp-grlv_t-a{visibility:visible}.tp-grlv_t.tp-grlv_t-in{transition:none}.tp-grlv.tp-v-disabled .tp-grlv_g{opacity:.5}.tp-grlv .tp-ttv{background-color:var(--mo-fg)}.tp-grlv .tp-ttv::before{border-top-color:var(--mo-fg)}.tp-lblv{align-items:center;display:flex;line-height:1.3;padding-left:var(--cnt-h-p);padding-right:var(--cnt-h-p)}.tp-lblv.tp-lblv-nol{display:block}.tp-lblv_l{color:var(--lbl-fg);flex:1;-webkit-hyphens:auto;hyphens:auto;overflow:hidden;padding-left:4px;padding-right:16px}.tp-lblv.tp-v-disabled .tp-lblv_l{opacity:.5}.tp-lblv.tp-lblv-nol .tp-lblv_l{display:none}.tp-lblv_v{align-self:flex-start;flex-grow:0;flex-shrink:0;width:160px}.tp-lblv.tp-lblv-nol .tp-lblv_v{width:100%}.tp-lstv_s{padding:0 20px 0 4px;width:100%}.tp-lstv_m{color:var(--btn-fg)}.tp-sglv_i{padding:0 4px}.tp-sglv.tp-v-disabled .tp-sglv_i{opacity:.5}.tp-mllv_i{display:block;height:calc(var(--bld-us)*3);line-height:var(--bld-us);padding:0 4px;resize:none;white-space:pre}.tp-mllv.tp-v-disabled .tp-mllv_i{opacity:.5}.tp-p2dv{position:relative}.tp-p2dv_h{display:flex}.tp-p2dv_b{height:var(--bld-us);margin-right:4px;position:relative;width:var(--bld-us)}.tp-p2dv_b svg{display:block;height:16px;left:50%;margin-left:-8px;margin-top:-8px;position:absolute;top:50%;width:16px}.tp-p2dv_b svg path{stroke:currentColor;stroke-width:2}.tp-p2dv_b svg circle{fill:currentColor}.tp-p2dv_t{flex:1}.tp-p2dv_p{height:0;margin-top:0;opacity:0;overflow:hidden;transition:height .2s ease-in-out,opacity .2s linear,margin .2s ease-in-out}.tp-p2dv.tp-p2dv-expanded .tp-p2dv_p{margin-top:var(--bld-s);opacity:1}.tp-p2dv .tp-popv{left:calc(-1*var(--cnt-h-p));right:calc(-1*var(--cnt-h-p));top:var(--bld-us)}.tp-p2dpv{padding-left:calc(var(--bld-us) + 4px)}.tp-p2dpv_p{cursor:crosshair;height:0;overflow:hidden;padding-bottom:100%;position:relative}.tp-p2dpv.tp-v-disabled .tp-p2dpv_p{opacity:.5}.tp-p2dpv_g{display:block;height:100%;left:0;pointer-events:none;position:absolute;top:0;width:100%}.tp-p2dpv_ax{opacity:.1;stroke:var(--in-fg);stroke-dasharray:1}.tp-p2dpv_l{opacity:.5;stroke:var(--in-fg);stroke-dasharray:1}.tp-p2dpv_m{border:var(--in-fg) solid 1px;border-radius:50%;box-sizing:border-box;height:4px;margin-left:-2px;margin-top:-2px;position:absolute;width:4px}.tp-p2dpv_p:focus .tp-p2dpv_m{background-color:var(--in-fg);border-width:0}.tp-popv{background-color:var(--bs-bg);border-radius:6px;box-shadow:0 2px 4px var(--bs-sh);display:none;max-width:168px;padding:var(--cnt-v-p) var(--cnt-h-p);position:absolute;visibility:hidden;z-index:1000}.tp-popv.tp-popv-v{display:block;visibility:visible}.tp-sprv_r{background-color:var(--grv-fg);border-width:0;display:block;height:2px;margin:0;width:100%}.tp-sprv.tp-v-disabled .tp-sprv_r{opacity:.5}.tp-sldv.tp-v-disabled{opacity:.5}.tp-sldv_t{box-sizing:border-box;cursor:pointer;height:var(--bld-us);margin:0 6px;outline:none;position:relative}.tp-sldv_t::before{background-color:var(--in-bg);border-radius:1px;bottom:0;content:"";display:block;height:2px;left:0;margin:auto;position:absolute;right:0;top:0}.tp-sldv_k{height:100%;left:0;position:absolute;top:0}.tp-sldv_k::before{background-color:var(--in-fg);border-radius:1px;bottom:0;content:"";display:block;height:2px;left:0;margin-bottom:auto;margin-top:auto;position:absolute;right:0;top:0}.tp-sldv_k::after{background-color:var(--btn-bg);border-radius:var(--elm-br);bottom:0;content:"";display:block;height:12px;margin-bottom:auto;margin-top:auto;position:absolute;right:-6px;top:0;width:12px}.tp-sldv_t:hover .tp-sldv_k::after{background-color:var(--btn-bg-h)}.tp-sldv_t:focus .tp-sldv_k::after{background-color:var(--btn-bg-f)}.tp-sldv_t:active .tp-sldv_k::after{background-color:var(--btn-bg-a)}.tp-sldtxtv{display:flex}.tp-sldtxtv_s{flex:2}.tp-sldtxtv_t{flex:1;margin-left:4px}.tp-tabv{position:relative}.tp-tabv_t{align-items:flex-end;color:var(--cnt-bg);display:flex;overflow:hidden;position:relative}.tp-tabv_t:hover{color:var(--cnt-bg-h)}.tp-tabv_t:has(*:focus){color:var(--cnt-bg-f)}.tp-tabv_t:has(*:active){color:var(--cnt-bg-a)}.tp-tabv_t::before{background-color:currentColor;bottom:0;content:"";height:2px;left:0;pointer-events:none;position:absolute;right:0}.tp-tabv.tp-v-disabled .tp-tabv_t::before{opacity:.5}.tp-tabv.tp-tabv-nop .tp-tabv_t{height:calc(var(--bld-us) + 4px);position:relative}.tp-tabv.tp-tabv-nop .tp-tabv_t::before{background-color:var(--cnt-bg);bottom:0;content:"";height:2px;left:0;position:absolute;right:0}.tp-tabv_c{padding-bottom:var(--cnt-v-p);padding-left:4px;padding-top:var(--cnt-v-p)}.tp-tabv_i{bottom:0;color:var(--cnt-bg);left:0;overflow:hidden;position:absolute;top:calc(var(--bld-us) + 4px);width:var(--bs-br)}.tp-tabv_i::before{background-color:currentColor;bottom:0;content:"";left:0;position:absolute;top:0;width:4px}.tp-tabv_t:hover+.tp-tabv_i{color:var(--cnt-bg-h)}.tp-tabv_t:has(*:focus)+.tp-tabv_i{color:var(--cnt-bg-f)}.tp-tabv_t:has(*:active)+.tp-tabv_i{color:var(--cnt-bg-a)}.tp-tabv.tp-v-disabled>.tp-tabv_i{opacity:.5}.tp-tbiv{flex:1;min-width:0;position:relative}.tp-tbiv+.tp-tbiv{margin-left:2px}.tp-tbiv+.tp-tbiv.tp-v-disabled::before{opacity:.5}.tp-tbiv_b{display:block;padding-left:calc(var(--cnt-h-p) + 4px);padding-right:calc(var(--cnt-h-p) + 4px);position:relative;width:100%}.tp-tbiv_b:disabled{opacity:.5}.tp-tbiv_b::before{background-color:var(--cnt-bg);bottom:2px;content:"";left:0;pointer-events:none;position:absolute;right:0;top:0}.tp-tbiv_b:hover::before{background-color:var(--cnt-bg-h)}.tp-tbiv_b:focus::before{background-color:var(--cnt-bg-f)}.tp-tbiv_b:active::before{background-color:var(--cnt-bg-a)}.tp-tbiv_t{color:var(--cnt-fg);height:calc(var(--bld-us) + 4px);line-height:calc(var(--bld-us) + 4px);opacity:.5;overflow:hidden;text-overflow:ellipsis}.tp-tbiv.tp-tbiv-sel .tp-tbiv_t{opacity:1}.tp-txtv{position:relative}.tp-txtv_i{padding:0 4px}.tp-txtv.tp-txtv-fst .tp-txtv_i{border-bottom-right-radius:0;border-top-right-radius:0}.tp-txtv.tp-txtv-mid .tp-txtv_i{border-radius:0}.tp-txtv.tp-txtv-lst .tp-txtv_i{border-bottom-left-radius:0;border-top-left-radius:0}.tp-txtv.tp-txtv-num .tp-txtv_i{text-align:right}.tp-txtv.tp-txtv-drg .tp-txtv_i{opacity:.3}.tp-txtv_k{cursor:pointer;height:100%;left:-3px;position:absolute;top:0;width:12px}.tp-txtv_k::before{background-color:var(--in-fg);border-radius:1px;bottom:0;content:"";height:calc(var(--bld-us) - 4px);left:50%;margin-bottom:auto;margin-left:-1px;margin-top:auto;opacity:.1;position:absolute;top:0;transition:border-radius .1s,height .1s,transform .1s,width .1s;width:2px}.tp-txtv_k:hover::before,.tp-txtv.tp-txtv-drg .tp-txtv_k::before{opacity:1}.tp-txtv.tp-txtv-drg .tp-txtv_k::before{border-radius:50%;height:4px;transform:translateX(-1px);width:4px}.tp-txtv_g{bottom:0;display:block;height:8px;left:50%;margin:auto;overflow:visible;pointer-events:none;position:absolute;top:0;visibility:hidden;width:100%}.tp-txtv.tp-txtv-drg .tp-txtv_g{visibility:visible}.tp-txtv_gb{fill:none;stroke:var(--in-fg);stroke-dasharray:1}.tp-txtv_gh{fill:none;stroke:var(--in-fg)}.tp-txtv .tp-ttv{margin-left:6px;visibility:hidden}.tp-txtv.tp-txtv-drg .tp-ttv{visibility:visible}.tp-ttv{background-color:var(--in-fg);border-radius:var(--elm-br);color:var(--bs-bg);padding:2px 4px;pointer-events:none;position:absolute;transform:translate(-50%, -100%)}.tp-ttv::before{border-color:var(--in-fg) rgba(0,0,0,0) rgba(0,0,0,0) rgba(0,0,0,0);border-style:solid;border-width:2px;box-sizing:border-box;content:"";font-size:.9em;height:4px;left:50%;margin-left:-2px;position:absolute;top:100%;width:4px}.tp-rotv{background-color:var(--bs-bg);border-radius:var(--bs-br);box-shadow:0 2px 4px var(--bs-sh);font-family:var(--font-family);font-size:11px;font-weight:500;line-height:1;text-align:left}.tp-rotv_b{border-bottom-left-radius:var(--bs-br);border-bottom-right-radius:var(--bs-br);border-top-left-radius:var(--bs-br);border-top-right-radius:var(--bs-br);padding-left:calc(4px + var(--bld-us) + var(--cnt-h-p));text-align:center}.tp-rotv.tp-rotv-expanded .tp-rotv_b{border-bottom-left-radius:0;border-bottom-right-radius:0}.tp-rotv.tp-rotv-not .tp-rotv_b{display:none}.tp-rotv_b:disabled .tp-rotv_m{display:none}.tp-rotv_c>.tp-fldv.tp-v-lst>.tp-fldv_c{border-bottom-left-radius:var(--bs-br);border-bottom-right-radius:var(--bs-br)}.tp-rotv_c>.tp-fldv.tp-v-lst>.tp-fldv_i{border-bottom-left-radius:var(--bs-br)}.tp-rotv_c>.tp-fldv.tp-v-lst:not(.tp-fldv-expanded)>.tp-fldv_b{border-bottom-left-radius:var(--bs-br);border-bottom-right-radius:var(--bs-br)}.tp-rotv_c .tp-fldv.tp-v-vlst:not(.tp-fldv-expanded)>.tp-fldv_b{border-bottom-right-radius:var(--bs-br)}.tp-rotv.tp-rotv-not .tp-rotv_c>.tp-fldv.tp-v-fst{margin-top:calc(-1*var(--cnt-v-p))}.tp-rotv.tp-rotv-not .tp-rotv_c>.tp-fldv.tp-v-fst>.tp-fldv_b{border-top-left-radius:var(--bs-br);border-top-right-radius:var(--bs-br)}.tp-rotv_c>.tp-tabv.tp-v-lst>.tp-tabv_c{border-bottom-left-radius:var(--bs-br);border-bottom-right-radius:var(--bs-br)}.tp-rotv_c>.tp-tabv.tp-v-lst>.tp-tabv_i{border-bottom-left-radius:var(--bs-br)}.tp-rotv.tp-rotv-not .tp-rotv_c>.tp-tabv.tp-v-fst{margin-top:calc(-1*var(--cnt-v-p))}.tp-rotv.tp-rotv-not .tp-rotv_c>.tp-tabv.tp-v-fst>.tp-tabv_t{border-top-left-radius:var(--bs-br);border-top-right-radius:var(--bs-br)}.tp-rotv.tp-v-disabled,.tp-rotv .tp-v-disabled{pointer-events:none}.tp-rotv.tp-v-hidden,.tp-rotv .tp-v-hidden{display:none}'),this.pool_.getAll().forEach(t=>{this.embedPluginStyle_(t)}),this.registerPlugin({plugins:[dl,ol,ks,pl]})}}const _l=new C("3.1.10");h.BladeApi=x,h.ButtonApi=ut,h.FolderApi=_e,h.InputBindingApi=qt,h.ListApi=Cr,h.MonitorBindingApi=Xt,h.Pane=fl,h.SeparatorApi=bs,h.SliderApi=Er,h.TabApi=ys,h.TabPageApi=xs,h.TextApi=Mr,h.TpChangeEvent=M,h.VERSION=_l,Object.defineProperty(h,"__esModule",{value:!0})})})(us,us.exports);var Fl=us.exports;const ql=`// 2DGS preprocess — per-alive-Gauss view-dependent color eval.
//
...
${this.lastFrame} frames rendered since start`;if(h||(console.log(W),console.log("All Frame Times (Total, ms):",JSON.stringify(this.allFrameTimes))),this.downloadOnceNextRead){this.downloadOnceNextRead=!1;const ut=`Stage,ms
`,O=V.map(([lt,K])=>`${lt},${K.toFixed(3)}`).join(`
`),R="data:text/csv;charset=utf-8,"+encodeURIComponent(ut+O),U=document.createElement("a");U.href=R,U.download=`${this.downloadOnceFileName}.csv`,document.body.appendChild(U),U.click(),U.remove()}if(this.showPerfDialogNext){this.showPerfDialogNext=!1;try{alert(W)}catch{console.warn("Unable to show dialog; metrics printed to console.")}}this.resultBuffer.unmap()}_setupTimestampQueries(){this.querySet=this.device.createQuerySet({type:"timestamp",count:this.totalQueryCount});const l=this.totalQueryCount*8;this.resolveBuffer=this.device.createBuffer({size:l,usage:GPUBufferUsage.QUERY_RESOLVE|GPUBufferUsage.COPY_SRC}),this.resultBuffer=this.device.createBuffer({size:l,usage:GPUBufferUsage.COPY_DST|GPUBufferUsage.MAP_READ})}_setupBuffers(){this.render_settings_buffer=this.device.createBuffer({label:"render settings",size:Ql,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST});const l=document.querySelector("canvas"),h=l?l.width:1,C=l?l.height:1;Zl({width:h,height:C,sh_bias:this.pc.sh_bias,color_K:this.pc.K,feature_mode:this.pc.feature_mode}),ei(this.device,this.render_settings_buffer),this.splat_2d_buffer=this.device.createBuffer({label:"splats_2d (Splat2DGS)",size:en(this.pc.num_points*tc),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST}),this.draw_indirect_buffer=this.device.createBuffer({label:"draw indirect",size:4*4,usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_DST|GPUBufferUsage.COPY_SRC|GPUBufferUsage.INDIRECT}),this.device.queue.writeBuffer(this.draw_indirect_buffer,0,new Uint32Array([4,0,0,0])),this.sh_solvers_buffer=this.device.createBuffer({label:"sh_solvers",size:en(this.pc.num_points*ec),usage:GPUBufferUsage.STORAGE|GPUBufferUsage.COPY_SRC|GPUBufferUsage.COPY_DST})}requestPerfDialog(){this.showPerfDialogNext=!0}requestDownloadMetrics(l){if(l&&l.trim().length>0){const h=l.trim().replace(/[^a-zA-Z0-9_\-]/g,"_");this.downloadOnceFileName=h.length>0?h:this.downloadOnceFileName}else{const h=new Date,C=`${h.getFullYear()}${String(h.getMonth()+1).padStart(2,"0")}${String(h.getDate()).padStart(2,"0")}_${String(h.getHours()).padStart(2,"0")}${String(h.getMinutes()).padStart(2,"0")}${String(h.getSeconds()).padStart(2,"0")}`;this.downloadOnceFileName=`fps_metrics_${C}`}this.downloadOnceNextRead=!0}requestReorder(){}async maybeReorderAfterSubmit(){}}function ac(o,l){return 2*Math.atan(l/(2*o))}function lc(o,l,h,C){const x=Math.tan(C/2),E=Math.tan(h/2),M=x*o,G=-M,A=E*o,L=-A,V=jt.create();return V[0]=2*o/(A-L),V[5]=-2*o/(M-G),V[2]=(A+L)/(A-L),V[6]=(M+G)/(M-G),V[14]=1,V[10]=l/(l-o),V[11]=-(l*o)/(l-o),jt.transpose(V,V),V}async function cc(o){ie(`loading scene camera file... : ${o}`);const h=await(await fetch(o)).json();return ie(`loaded cameras count: ${h.length}`),h.map(C=>{const x=I.clone(C.position),E=he.create(...C.rotation.flat()),M=E[0],G=E[4],A=E[8],L=E[1],V=E[5],q=E[9],Z=E[2],J=E[6],F=E[10];M*(V*F-q*J)-G*(L*F-q*Z)+A*(L*J-V*Z)<0&&(E[1]=-E[1],E[5]=-E[5],E[9]=-E[9]);const W=jt.fromMat3(E);return{position:x,rotation:W,img_name:C.img_name,id:C.id}})}const uc=4*2,dc=4*16,ni=4*dc+2*uc;function pc(o){return o.createBuffer({label:"camera uniform",size:ni,usage:GPUBufferUsage.UNIFORM|GPUBufferUsage.COPY_DST})}const re=new Float32Array(ni/Float32Array.BYTES_PER_ELEMENT);function hc(o,l,h,C,x,E){const M=new Float32Array(16),G=new Float32Array(16);jt.inverse(h,M),jt.inverse(C,G);const A=.5*x*C[0],L=.5*E*C[5];let V=0;re.set(h,V),V+=16,re.set(M,V),V+=16,re.set(C,V),V+=16,re.set(G,V),V+=16,re[V++]=x,re[V++]=E,re[V++]=A,re[V++]=L,o.queue.writeBuffer(l,0,re)}const In=class In{constructor(l,h){tt(this,"uniform_buffer");tt(this,"position",I.create());tt(this,"rotation",jt.create());tt(this,"fovY",45/180*Math.PI);tt(this,"fovX");tt(this,"focal",Ur.create());tt(this,"viewport",Ur.create());tt(this,"view_matrix",jt.identity());tt(this,"view_inv_matrix",jt.identity());tt(this,"proj_matrix",jt.identity());tt(this,"proj_inv_matrix",jt.identity());tt(this,"_negPos",I.create());tt(this,"look",I.create(0,0,1));tt(this,"up",I.create(0,1,0));tt(this,"right",I.create(1,0,0));this.canvas=l,this.device=h,this.uniform_buffer=pc(h),this.on_update_canvas()}on_update_canvas(){const l=.5*this.canvas.height/Math.tan(this.fovY*.5);this.focal[0]=l,this.focal[1]=l,this.fovX=ac(l,this.canvas.width),this.viewport[0]=this.canvas.width,this.viewport[1]=this.canvas.height,this.proj_matrix=lc(.01,100,this.fovX,this.fovY),jt.inverse(this.proj_matrix,this.proj_inv_matrix),this.update_buffer()}update_buffer(){this._negPos[0]=-this.position[0],this._negPos[1]=-this.position[1],this._negPos[2]=-this.position[2],jt.copy(this.rotation,this.view_matrix),jt.translate(this.view_matrix,this._negPos,this.view_matrix),jt.inverse(this.view_matrix,this.view_inv_matrix),I.transformMat4Upper3x3(In.Z_AXIS,this.view_inv_matrix,this.look),I.normalize(this.look,this.look),I.cross(this.up,this.look,this.right),I.normalize(this.right,this.right);let l=0;re.set(this.view_matrix,l),l+=16,re.set(this.view_inv_matrix,l),l+=16,re.set(this.proj_matrix,l),l+=16,re.set(this.proj_inv_matrix,l),l+=16,re.set(this.viewport,l),l+=2,re.set(this.focal,l),l+=2,this.device.queue.writeBuffer(this.uniform_buffer,0,re)}set_preset(l){I.copy(l.position,this.position),jt.copy(l.rotation,this.rotation),this.update_buffer()}setFov(l){this.fovY=l,this.on_update_canvas()}getFov(){return this.fovY}};tt(In,"Z_AXIS",I.create(0,0,1));let hs=In;const fc=I.create(1,0,0),_c=I.create(0,1,0);function mc(o,l){const h=o[0],C=o[4],x=o[8],E=o[1],M=o[5],G=o[9],A=o[2],L=o[6],V=o[10],q=h+M+V;let Z,J,F,z;if(q>0){const W=.5/Math.sqrt(q+1);Z=.25/W,J=(L-G)*W,F=(x-A)*W,z=(E-C)*W}else if(h>M&&h>V){const W=2*Math.sqrt(1+h-M-V);Z=(L-G)/W,J=.25*W,F=(C+E)/W,z=(x+A)/W}else if(M>V){const W=2*Math.sqrt(1+M-h-V);Z=(x-A)/W,J=(C+E)/W,F=.25*W,z=(G+L)/W}else{const W=2*Math.sqrt(1+V-h-M);Z=(E-C)/W,J=(x+A)/W,F=(G+L)/W,z=.25*W}return l[0]=J,l[1]=F,l[2]=z,l[3]=Z,l}class bc{constructor(l){tt(this,"element");tt(this,"enabled",!0);tt(this,"center",I.create(0,0,0));tt(this,"up",I.create(0,1,0));tt(this,"rotation",[0,0]);tt(this,"shift",[0,0]);tt(this,"scroll",0);tt(this,"speed",.1);tt(this,"sensitivity",.08);tt(this,"leftPressed",!1);tt(this,"rightPressed",!1);tt(this,"leftDragPans",!1);tt(this,"lastX",0);tt(this,"lastY",0);tt(this,"touches",new Map);tt(this,"lastTouchCenter",null);tt(this,"lastPinchDistance",null);tt(this,"lastTwoFingerAngle",null);tt(this,"lastTouchCount",0);tt(this,"roll",0);tt(this,"_dir",I.create());tt(this,"_right",I.create());tt(this,"_upCam",I.create());tt(this,"_scratch",I.create());tt(this,"_qY",se.create());tt(this,"_qX",se.create());tt(this,"_qRot",se.create());tt(this,"_qLocal",se.create());tt(this,"_qWorldToCam",se.create());tt(this,"_scratchMat3",he.create());tt(this,"bboxMin",null);tt(this,"bboxMax",null);tt(this,"anchor",I.create(0,0,0));tt(this,"downCallback",l=>{var h,C,x,E;if(this.enabled){if(l.pointerType==="touch"){this.touches.set(l.pointerId,{x:l.pageX,y:l.pageY}),this.handleTouchGestures(),(C=(h=l.target)==null?void 0:h.setPointerCapture)==null||C.call(h,l.pointerId),l.preventDefault();return}l.isPrimary&&(l.button===0?(this.leftPressed=!0,this.leftDragPans=l.shiftKey):l.button===2?this.rightPressed=!0:this.rightPressed=!0,this.lastX=l.pageX,this.lastY=l.pageY,(E=(x=l.target)==null?void 0:x.setPointerCapture)==null||E.call(x,l.pointerId),l.preventDefault())}});tt(this,"moveCallback",l=>{if(!this.enabled)return;if(l.pointerType==="touch"){if(!this.touches.has(l.pointerId))return;this.touches.set(l.pointerId,{x:l.pageX,y:l.pageY}),this.handleTouchGestures(),l.preventDefault();return}if(!l.isPrimary||!this.leftPressed&&!this.rightPressed)return;l.preventDefault();const h=l.pageX-this.lastX,C=l.pageY-this.lastY;this.lastX=l.pageX,this.lastY=l.pageY,this.leftPressed&&!this.leftDragPans?(this.rotation[0]+=h,this.rotation[1]-=C):(this.rightPressed||this.leftPressed&&this.leftDragPans)&&(this.shift[1]-=h,this.shift[0]+=C)});tt(this,"upCallback",l=>{var h,C,x,E;if(l.pointerType==="touch"){this.touches.delete(l.pointerId),this.handleTouchGestures(),(C=(h=l.target)==null?void 0:h.releasePointerCapture)==null||C.call(h,l.pointerId),l.preventDefault();return}l.button===0?this.leftPressed=!1:l.button===2?this.rightPressed=!1:this.rightPressed=!1,(E=(x=l.target)==null?void 0:x.releasePointerCapture)==null||E.call(x,l.pointerId),l.preventDefault()});tt(this,"wheelCallback",l=>{if(!this.enabled||(l.preventDefault(),this.rightPressed))return;let h=l.deltaY;l.deltaMode===1?h*=16:l.deltaMode===2&&(h*=100),this.scroll+=h*.01});this.camera=l,this.registerElement(l.canvas)}registerElement(l){this.element&&this.element!==l&&(this.element.removeEventListener("pointerdown",this.downCallback),this.element.removeEventListener("pointermove",this.moveCallback),this.element.removeEventListener("pointerup",this.upCallback),this.element.removeEventListener("wheel",this.wheelCallback)),this.element=l,this.element.addEventListener("pointerdown",this.downCallback),this.element.addEventListener("pointermove",this.moveCallback),this.element.addEventListener("pointerup",this.upCallback),this.element.addEventListener("wheel",this.wheelCallback,{passive:!1}),this.element.addEventListener("contextmenu",h=>h.preventDefault())}setCenter(l){I.copy(l,this.center),I.copy(l,this.anchor)}setOrbitPivot(l){I.set(l[0],l[1],l[2],this.center),this._reorientCameraToCenter()}setOrbitDepth(l){if(!isFinite(l)||l<.001)return;const h=this.camera.rotation;I.set(h[2],h[6],h[10],this._dir),I.normalize(this._dir,this._dir),I.scale(this._dir,l,this._dir),I.add(this.camera.position,this._dir,this.center)}_reorientCameraToCenter(){const l=this.camera;if(I.subtract(this.center,l.position,this._scratch),I.length(this._scratch)<1e-6)return;I.normalize(this._scratch,this._scratch),I.cross(this.up,this._scratch,this._right),I.length(this._right)<1e-6&&I.set(1,0,0,this._right),I.normalize(this._right,this._right),I.cross(this._scratch,this._right,this._upCam),I.normalize(this._upCam,this._upCam);const h=l.rotation;h[0]=this._right[0],h[1]=this._upCam[0],h[2]=this._scratch[0],h[3]=0,h[4]=this._right[1],h[5]=this._upCam[1],h[6]=this._scratch[1],h[7]=0,h[8]=this._right[2],h[9]=this._upCam[2],h[10]=this._scratch[2],h[11]=0,h[12]=0,h[13]=0,h[14]=0,h[15]=1,l.update_buffer()}setBbox(l,h){this.bboxMin=I.create(l[0],l[1],l[2]),this.bboxMax=I.create(h[0],h[1],h[2]);const C=(l[0]+h[0])*.5,x=(l[1]+h[1])*.5,E=(l[2]+h[2])*.5;I.set(C,x,E,this.center),I.set(C,x,E,this.anchor)}resetToCamera(){const l=this.camera.rotation;I.set(l[2],l[6],l[10],this._dir),I.normalize(this._dir,this._dir);let h=null;if(this.bboxMin&&this.bboxMax){let C=-1/0,x=1/0,E=!1;for(let M=0;M<3;M++){const G=this._dir[M],A=this.bboxMin[M]-this.camera.position[M],L=this.bboxMax[M]-this.camera.position[M];if(Math.abs(G)>1e-8){const V=A/G,q=L/G;C=Math.max(C,Math.min(V,q)),x=Math.min(x,Math.max(V,q))}else if(A>0||L<0){E=!0;break}}!E&&C<=x&&x>0&&(h=(Math.max(C,0)+x)*.5)}if(h===null||!isFinite(h)||h<.001){I.subtract(this.anchor,this.camera.position,this._scratch);const C=I.dot(this._scratch,this._dir);h=C>.001?C:I.length(this._scratch)}h=Math.max(.1,h),I.scale(this._dir,h,this._dir),I.add(this.camera.position,this._dir,this.center)}handleTouchGestures(){const l=this.touches.size;if(l!==this.lastTouchCount&&(this.lastTouchCenter=null,this.lastPinchDistance=null,this.lastTwoFingerAngle=null),this.lastTouchCount=l,l===1){const h=this.touches.values().next().value;if(this.lastTouchCenter){const C=h.x-this.lastTouchCenter[0],x=h.y-this.lastTouchCenter[1];this.rotation[0]+=C*.3,this.rotation[1]-=x*.3}this.lastTouchCenter=[h.x,h.y]}else if(l===2){const h=Array.from(this.touches.values()),C=(h[0].x+h[1].x)*.5,x=(h[0].y+h[1].y)*.5,E=h[1].x-h[0].x,M=h[1].y-h[0].y,G=Math.hypot(E,M),A=Math.atan2(M,E);if(this.lastTouchCenter!==null&&this.lastPinchDistance!==null&&this.lastTwoFingerAngle!==null){const L=C-this.lastTouchCenter[0],V=x-this.lastTouchCenter[1],q=Math.hypot(L,V),Z=Math.abs(G-this.lastPinchDistance);let J=A-this.lastTwoFingerAngle;J>Math.PI&&(J-=2*Math.PI),J<-Math.PI&&(J+=2*Math.PI),q>.5&&(this.shift[1]-=L,this.shift[0]+=V),Z>1&&this.lastPinchDistance>.001&&(this.scroll+=-Math.log(G/this.lastPinchDistance)*10),Math.abs(J)>.0087&&(this.roll+=-J)}this.lastTouchCenter=[C,x],this.lastPinchDistance=G,this.lastTwoFingerAngle=A}}update(l){if(!this.enabled||Math.abs(this.rotation[0])<1e-4&&Math.abs(this.rotation[1])<1e-4&&Math.abs(this.shift[0])<1e-4&&Math.abs(this.shift[1])<1e-4&&Math.abs(this.scroll)<1e-4&&Math.abs(this.roll)<1e-4)return;const h=this.camera;{const z=h.rotation;this.up[0]=z[1],this.up[1]=z[5],this.up[2]=z[9],I.length(this.up)>1e-6?I.normalize(this.up,this.up):I.set(0,1,0,this.up)}let C=!1;if(Math.abs(this.roll)>1e-4){const z=h.rotation;I.set(z[2],z[6],z[10],this._scratch),I.normalize(this._scratch,this._scratch),se.fromAxisAngle(this._scratch,this.roll,this._qRot),I.transformQuat(this.up,this._qRot,this.up),I.normalize(this.up,this.up),this.roll=0,C=!0}I.subtract(h.position,this.center,this._dir);let x=I.length(this._dir);x<1e-6&&(x=1e-6);const E=Math.exp(Math.log(x)+this.scroll*l*10*this.speed);I.scale(this._dir,E/x,this._dir),x=E;const M=h.rotation;this._right[0]=M[0],this._right[1]=M[4],this._right[2]=M[8],I.normalize(this._right,this._right),I.length(this._right)<1e-6&&I.set(1,0,0,this._right);const G=I.create(M[1],M[5],M[9]);I.normalize(G,G),I.length(G)<1e-6&&I.set(0,1,0,G);const A=l*this.speed*.1*x,L=this.shift[1]*A,V=-this.shift[0]*A;I.scale(this._right,L,this._scratch),I.add(this.center,this._scratch,this.center),I.add(h.position,this._scratch,h.position),I.scale(G,V,this._scratch),I.add(this.center,this._scratch,this.center),I.add(h.position,this._scratch,h.position);const q=this.rotation[0]*l*this.sensitivity,Z=this.rotation[1]*l*this.sensitivity;if(Math.abs(q)>1e-5||Math.abs(Z)>1e-5||C){const z=h.rotation;mc(z,this._qWorldToCam),se.fromAxisAngle(fc,-Z,this._qX),se.fromAxisAngle(_c,-q,this._qY),se.multiply(this._qX,this._qY,this._qLocal),se.normalize(this._qLocal,this._qLocal),se.multiply(this._qLocal,this._qWorldToCam,this._qWorldToCam),se.normalize(this._qWorldToCam,this._qWorldToCam),he.fromQuat(this._qWorldToCam,this._scratchMat3),jt.fromMat3(this._scratchMat3,h.rotation);const W=h.rotation,ut=W[2],O=W[6],R=W[10];h.position[0]=this.center[0]-ut*x,h.position[1]=this.center[1]-O*x,h.position[2]=this.center[2]-R*x,this.up[0]=W[1],this.up[1]=W[5],this.up[2]=W[9],I.normalize(this.up,this.up)}else I.add(this.center,this._dir,h.position);h.update_buffer();const F=Math.pow(.8,l*60);this.rotation[0]*=F,Math.abs(this.rotation[0])<1e-4&&(this.rotation[0]=0),this.rotation[1]*=F,Math.abs(this.rotation[1])<1e-4&&(this.rotation[1]=0),this.shift[0]*=F,Math.abs(this.shift[0])<1e-4&&(this.shift[0]=0),this.shift[1]*=F,Math.abs(this.shift[1])<1e-4&&(this.shift[1]=0),this.scroll*=F,Math.abs(this.scroll)<1e-4&&(this.scroll=0)}}function si(o){const l=I.create();for(const h of o)I.add(l,h,l);return I.scale(l,1/Math.max(o.length,1),l)}function ri(o,l){const h=he.create();he.inverse(o,h);const C=I.create();return C[0]=h[0]*l[0]+h[4]*l[1]+h[8]*l[2],C[1]=h[1]*l[0]+h[5]*l[1]+h[9]*l[2],C[2]=h[2]*l[0]+h[6]*l[1]+h[10]*l[2],C}function vc(o){const l=o.slice(),h=[1,0,0,0,1,0,0,0,1],C=(A,L)=>l[A*3+L],x=(A,L,V)=>{l[A*3+L]=V},E=(A,L)=>h[A*3+L],M=(A,L,V)=>{h[A*3+L]=V};for(let A=0;A<30;A++){let L=0,V=1,q=Math.abs(C(0,1));if(Math.abs(C(0,2))>q&&(L=0,V=2,q=Math.abs(C(0,2))),Math.abs(C(1,2))>q&&(L=1,V=2,q=Math.abs(C(1,2))),q<1e-12)break;const Z=C(L,L),J=C(V,V),F=C(L,V);let z;Math.abs(Z-J)<1e-30?z=Math.PI/4*Math.sign(F):z=.5*Math.atan2(2*F,Z-J);const W=Math.cos(z),ut=Math.sin(z);for(let O=0;O<3;O++){const R=C(O,L),U=C(O,V);x(O,L,W*R+ut*U),x(O,V,-ut*R+W*U)}for(let O=0;O<3;O++){const R=C(L,O),U=C(V,O);x(L,O,W*R+ut*U),x(V,O,-ut*R+W*U)}for(let O=0;O<3;O++){const R=E(O,L),U=E(O,V);M(O,L,W*R+ut*U),M(O,V,-ut*R+W*U)}}const G=[];for(let A=0;A<3;A++)G.push({val:C(A,A),vec:I.create(E(0,A),E(1,A),E(2,A))});return G.sort((A,L)=>L.val-A.val),{vals:[G[0].val,G[1].val,G[2].val],vecs:[G[0].vec,G[1].vec,G[2].vec]}}function gc(o,l){const h=si(o);let C=0,x=0,E=0,M=0,G=0,A=0;for(const F of o){const z=F[0]-h[0],W=F[1]-h[1],ut=F[2]-h[2];C+=z*z,x+=z*W,E+=z*ut,M+=W*W,G+=W*ut,A+=ut*ut}const L=[C,x,E,x,M,G,E,G,A],{vecs:V}=vc(L);let q=V[0],Z=V[1],J=V[2];return I.dot(J,l)<0&&(I.scale(J,-1,J),I.scale(Z,-1,Z)),{centroid:h,normal:J,u:q,v:Z}}function wc(o){let l=0,h=0,C=0,x=0,E=0,M=0,G=0,A=0,L=0;for(const[W,ut]of o){const O=-2*W,R=-2*ut,U=1,lt=-(W*W+ut*ut);l+=O*O,h+=O*R,C+=O*U,x+=R*R,E+=R*U,M+=U*U,G+=O*lt,A+=R*lt,L+=U*lt}const V=he.create(l,h,C,h,x,E,C,E,M),q=ri(V,I.create(G,A,L)),Z=q[0],J=q[1],F=q[2],z=Z*Z+J*J-F;return{center:[Z,J],radius:Math.sqrt(Math.max(z,1e-12))}}function xc(o,l){let h=0,C=0,x=0,E=0,M=0,G=0,A=0,L=0,V=0;for(let Z=0;Z<o.length;Z++){const J=o[Z],F=I.normalize(l[Z],I.create()),z=1-F[0]*F[0],W=-F[0]*F[1],ut=-F[0]*F[2],O=1-F[1]*F[1],R=-F[1]*F[2],U=1-F[2]*F[2];h+=z,C+=W,x+=ut,E+=O,M+=R,G+=U,A+=z*J[0]+W*J[1]+ut*J[2],L+=W*J[0]+O*J[1]+R*J[2],V+=ut*J[0]+R*J[1]+U*J[2]}const q=he.create(h,C,x,C,E,M,x,M,G);return ri(q,I.create(A,L,V))}function ii(o,l={}){if(o.length===0)return null;const h=l.tiltDownDeg??8,C=l.radiusScale??1,x=l.alignFirst??!0,E=(l.direction??"ccw")==="ccw"?1:-1,M=o.map(Y=>I.clone(Y.position)),G=o.map(Y=>{const et=Y.rotation;return I.create(et[8],et[9],et[10])}),A=o.map(Y=>{const et=Y.rotation;return I.create(et[4],et[5],et[6])}),L=si(A),V=I.normalize(I.scale(L,-1,I.create())),{centroid:q,normal:Z,u:J,v:F}=gc(M,V),z=M.map(Y=>{const et=I.sub(Y,q,I.create());return[I.dot(et,J),I.dot(et,F)]}),{center:W,radius:ut}=wc(z),O=ut*C,R=I.add(q,I.add(I.scale(J,W[0],I.create()),I.scale(F,W[1],I.create()),I.create()),I.create()),U=xc(M,G),lt=O*Math.tan(h*Math.PI/180),K=I.sub(U,I.scale(Z,lt,I.create()),I.create());let X=0;if(x){const Y=I.sub(M[0],R,I.create());X=Math.atan2(I.dot(Y,F),I.dot(Y,J))/(2*Math.PI)%1,X<0&&(X+=1)}return console.log(`[orbit] fit ${o.length} train cams: radius=${O.toFixed(2)}, tilt=${h}°, normal=[${Z[0].toFixed(2)}, ${Z[1].toFixed(2)}, ${Z[2].toFixed(2)}], startPhase=${X.toFixed(3)}`),{center:R,radius:O,normal:Z,u:J,v:F,lookAt:K,startPhase:X,direction:E}}function oi(o,l){const h=(o.startPhase+l*o.direction)*2*Math.PI,C=Math.cos(h),x=Math.sin(h),E=I.add(o.center,I.add(I.scale(o.u,o.radius*C,I.create()),I.scale(o.v,o.radius*x,I.create()),I.create()),I.create()),M=I.normalize(I.sub(o.lookAt,E,I.create())),G=I.cross(M,o.normal,I.create());I.length(G)<1e-6&&I.copy(o.u,G),I.normalize(G,G);const A=I.cross(M,G,I.create());I.normalize(A,A);const L=jt.create();return L[0]=G[0],L[1]=A[0],L[2]=M[0],L[3]=0,L[4]=G[1],L[5]=A[1],L[6]=M[1],L[7]=0,L[8]=G[2],L[9]=A[2],L[10]=M[2],L[11]=0,L[12]=0,L[13]=0,L[14]=0,L[15]=1,{position:E,rotation:L,img_name:`orbit_${(l*1e3).toFixed(0)}`,id:0}}function yc(o,l={}){const h=ii(o,l);if(!h)return[];const C=l.numViews??120;return Array.from({length:C},(x,E)=>({...oi(h,E/C),img_name:`circle_${E.toString().padStart(4,"0")}`,id:E}))}async function Pc(){if(!("xr"in navigator)||!navigator.xr)return!1;try{return await navigator.xr.isSessionSupported("immersive-vr")}catch{return!1}}async function Sc(o){const l=window.XRGPUBinding??window.XRWebGPUBinding;if(!l)throw new Error("XRGPUBinding is not available in this browser. On Quest Browser you may need to enable it under chrome://flags/#webxr-webgpu-binding (inspect via ADB). Falling back to a WebGL2 XR layer is a future TODO.");const h=await navigator.xr.requestSession("immersive-vr",{requiredFeatures:["local"],optionalFeatures:["local-floor","bounded-floor","hand-tracking"]}),C=new l(h,o.device),x=C.createProjectionLayer({colorFormat:"rgba8unorm-srgb",depthStencilFormat:"depth24plus",scaleFactor:1});h.updateRenderState({layers:[x]});const E=await h.requestReferenceSpace("local"),M=I.create(0,0,-1.5),G=jt.identity(),A=jt.create(),L=jt.create(),V=new Promise(Z=>{h.addEventListener("end",()=>{o.onExit(),Z()})}),q=performance.now();h.requestAnimationFrame(function Z(J,F){h.requestAnimationFrame(Z);const z=F.getViewerPose(E);if(!z)return;kc(h,F,E,M,G),jt.copy(G,A);const W=I.create(-M[0],-M[1],-M[2]);jt.translate(A,W,A);const ut=o.device.createCommandEncoder({label:"xr-frame"});for(const O of z.views){const R=C.getViewSubImage(x,O),U=R.colorTexture.createView(),lt=R.viewport,K=O.transform.inverse.matrix;jt.multiply(K,A,L),hc(o.device,o.camera.uniform_buffer,L,O.projectionMatrix,lt.width,lt.height),o.renderer.frame(ut,U,!1)}o.device.queue.submit([ut.finish()])}),console.log(`[XR] session started in ${(performance.now()-q).toFixed(1)} ms; ${h.inputSources.length} controllers`),await V}function kc(o,l,h,C,x){const M=.013888888888888888,G=1.5/72,A=.8/72;for(const L of o.inputSources){const V=L.gamepad;if(!V||V.axes.length<2)continue;const q=V.axes[2]??V.axes[0],Z=V.axes[3]??V.axes[1];if(!(Math.abs(q)<.15&&Math.abs(Z)<.15)){if(L.handedness==="left"){const J=Math.abs(q)>.15?q*M:0,F=Math.abs(Z)>.15?-Z*M:0;C[0]+=J,C[1]+=F}else if(L.handedness==="right"&&(Math.abs(Z)>.15&&(C[2]+=Z*G),Math.abs(q)>.15)){const J=-q*A,F=jt.rotateY(jt.identity(),J);jt.multiply(F,x,x)}}}}const ai="BITYMI01",Cc=0,Ec=1,Mc=2,Bc=3,Tc=4,Dc=5;function An(o){const l=(o&32768)>>15,h=(o&31744)>>10,C=o&1023;return h===0?(l?-1:1)*Math.pow(2,-14)*(C/1024):h===31?C?NaN:l?-1/0:1/0:(l?-1:1)*Math.pow(2,h-15)*(1+C/1024)}function Wr(o,l,h,C,x,E){const M=(o-h.width*.5)/C.focal[0],G=-((l-h.height*.5)/C.focal[1]),A=C.rotation,L=A[0],V=A[4],q=A[8],Z=A[1],J=A[5],F=A[9],z=A[2],W=A[6],ut=A[10];let O=M*L+G*Z+z,R=M*V+G*J+W,U=M*q+G*F+ut;const lt=Math.hypot(O,R,U)||1;O/=lt,R/=lt,U/=lt;const K=C.position[0],X=C.position[1],Y=C.position[2],et=E*.005,_t=et*et,Vt=new Uint32Array(x.buffer,x.byteOffset,x.length),Rt=x.length/8;let Dt=1/0,pt=0,kt=0,wt=0,H=-1;for(let st=0;st<Rt;st++){const It=st*8,Mt=x[It+0]-K,zt=x[It+1]-X,Tt=x[It+2]-Y,Ot=Mt*O+zt*R+Tt*U;if(Ot<=0)continue;const xt=Mt-Ot*O,ht=zt-Ot*R,Wt=Tt-Ot*U;if(xt*xt+ht*ht+Wt*Wt>=_t||!(Vt[It+7]>>>16&1))continue;const g=Vt[It+5],i=Vt[It+6],f=An(g&65535),d=An(g>>>16&65535),b=An(i&65535),y=An(i>>>16&65535),S=Math.hypot(f,d,b,y)||1,k=f/S,r=d/S,m=b/S,u=y/S,p=2*(r*u+k*m),a=2*(m*u-k*r),_=1-2*(r*r+m*m),w=O*p+R*a+U*_;let v;Math.abs(w)>1e-6?(v=(Mt*p+zt*a+Tt*_)/w,(!isFinite(v)||v<=0)&&(v=Ot)):v=Ot,v<Dt&&(Dt=v,pt=K+v*O,kt=X+v*R,wt=Y+v*U,H=st)}return H<0?null:[pt,kt,wt]}function li(o){const l=new Uint8Array(o),h=new TextDecoder().decode(l.subarray(0,8));if(h!==ai)throw new Error(`Not a BITYMI bundle (bad magic '${h}')`);const C=new DataView(o),x=C.getUint32(8,!0),E=12,M=20;let G=null,A=null,L=null;for(let V=0;V<x;V++){const q=E+V*M,Z=C.getUint32(q+0,!0),J=Number(C.getBigUint64(q+4,!0)),F=Number(C.getBigUint64(q+12,!0)),z=l.slice(J,J+F).buffer;Z===Cc||Z===Ec||Z===Dc?G=z:Z===Mc?A=z:(Z===Bc||Z===Tc)&&(L=z)}if(G===null)throw new Error("BITYMI bundle has no point cloud chunk");return{pcBuffer:G,camerasBuffer:A,atlasBuffer:L}}async function Ac(o,l){var M;const h=await fetch(o);if(!h.ok)throw new Error(`fetch failed: ${h.status} ${h.statusText}`);const C=(()=>{const G=h.headers.get("content-length");return G&&parseInt(G,10)||void 0})(),x=(M=h.body)==null?void 0:M.getReader();let E;if(!x)E=await h.arrayBuffer(),l&&l(E.byteLength,C,0);else{const G=[];let A=0,L=performance.now(),V=0;for(;;){const{done:J,value:F}=await x.read();if(J)break;G.push(F),A+=F.byteLength;const z=performance.now();if(z-L>=150&&l){const W=(A-V)/((z-L)/1e3);l(A,C,W),L=z,V=A}}const q=new Uint8Array(A);let Z=0;for(const J of G)q.set(J,Z),Z+=J.byteLength;E=q.buffer,l&&l(A,C,0)}return E.byteLength>=8&&new TextDecoder().decode(new Uint8Array(E,0,8))===ai?{bundle:li(E),rawPly:null}:{bundle:null,rawPly:E}}function Rc(o){return new Promise(l=>{const h=document.createElement("input");h.type="file",h.accept=o,h.style.display="none",h.onchange=()=>{var C;return l(((C=h.files)==null?void 0:C[0])??null)},document.body.appendChild(h),h.click(),setTimeout(()=>document.body.removeChild(h),1e3)})}function Ic(o,l,h){const C=document.getElementById("ui-panel-container"),x=document.getElementById("load-button"),E=document.getElementById("quick-links");x&&(x.onclick=async()=>{const L=await Rc(".ply,.bitymi");if(L)if(C&&(C.style.display="none"),L.name.toLowerCase().endsWith(".bitymi")){const V=await L.arrayBuffer(),{pcBuffer:q}=li(V),Z=new File([q],L.name.replace(/\.bitymi$/i,".ply"),{type:"application/octet-stream"}),J=await cs(Z,o);l(J)}else{const V=await cs(L,o);l(V)}}),E&&(E.innerHTML="");const M=new URLSearchParams(window.location.search),G=M.get("bundle")??M.get("model_url"),A=M.get("camera_url");G&&(C&&(C.style.display="none"),h(G,A))}async function Lc(o,l,h,C){const x=new hs(o,h),E=new bc(x);let M=!1;o.addEventListener("pointerdown",()=>{M=!0}),window.addEventListener("pointerup",()=>{M=!1});const G="rgba8unorm";l.configure({device:h,format:G,alphaMode:"opaque",usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.STORAGE_BINDING});let A=null;const L=()=>{x.on_update_canvas(),A!==null&&vn(o.width,o.height,h,A.render_settings_buffer)};new ResizeObserver(()=>{const X=Math.max(.25,R.render_scale),Y=Math.max(1,Math.ceil(X*o.clientWidth)),et=Math.max(1,Math.ceil(X*o.clientHeight));o.width===Y&&o.height===et||(o.width=Y,o.height=et,L())}).observe(o);let q=0,Z=0;const J=()=>{(o.width!==q||o.height!==Z)&&(q=o.width,Z=o.height,L())},F=new URLSearchParams(window.location.search);let W=F.get("animation")==="1";E.enabled=!W;const ut=F.get("camera_url"),O=Math.max(1,window.devicePixelRatio||1),R={gaussian_scaling:1,sh_bias:.5,animate:W,animateMode:"presets",bg:{r:0,g:0,b:0,a:0},atlas_enabled:!1,bfc:!1,render_scale:1},U=new Fl.Pane({title:"Config",expanded:!0});U.addInput(R,"animate",{label:"Animate"}).on("change",X=>{const Y=W;W=X.value,E.enabled=!X.value,!Y&&W&&lt.value&&lt.value.onAnimateStart(),Y&&!W&&lt.value&&lt.value.onAnimateStop()}),U.addInput(R,"animateMode",{label:"Anim path",options:{"Training views":"presets","Circle orbit":"circle"}});const lt={value:null};Ic(h,X=>K(X,[],null),async(X,Y)=>{let et=Y??ut,_t,Vt=null;const Rt=X.toLowerCase();if(Rt.endsWith(".bitymi")||Rt.includes(".bitymi?")){_s("downloading bundle ...");try{const{bundle:pt}=await Ac(X,(wt,H,st)=>{const It=wt/1048576,Mt=H?H/(1024*1024):void 0,zt=st/(1024*1024),Tt=H?Math.min(99,Math.floor(wt/H*100)):void 0,Ot=Mt?`total ${Mt.toFixed(1)} MB`:"total -- MB",xt=Mt&&Tt!==void 0?`${It.toFixed(1)} MB downloaded (${Tt}%)`:`${It.toFixed(1)} MB downloaded`,ht=`${zt.toFixed(2)} MB/s`;Ne(`downloading bundle ...
${Ot}, ${xt}
...
${wt.toFixed(1)} MB BC7`);try{const H=Il(pt.atlasBuffer);Vt=Gl(h,H,!0)}catch(H){console.warn("[atlas] failed to parse/upload atlas:",H)}}}catch(pt){throw gn(),pt}}else _t=await zl(X,h);const Dt=et?await cc(et):[];Dt.length>0&&x.set_preset(Dt[0]),K(_t,Dt,Vt)});function K(X,Y=[],et=null){const _t=[(X.bbox.min[0]+X.bbox.max[0])/2,(X.bbox.min[1]+X.bbox.max[1])/2,(X.bbox.min[2]+X.bbox.max[2])/2];E.setBbox(X.bbox.min,X.bbox.max);const Vt=.5*Math.sqrt((X.bbox.max[0]-X.bbox.min[0])**2+(X.bbox.max[1]-X.bbox.min[1])**2+(X.bbox.max[2]-X.bbox.min[2])**2);function Rt(Q,at){const ot=Wr(Q,at,o,x,X.surfel_data,Vt);ot&&(E.setOrbitPivot(ot),console.log(`[pick] orbit pivot → (${ot[0].toFixed(3)}, ${ot[1].toFixed(3)}, ${ot[2].toFixed(3)})`))}function Dt(){const Q=o.width*.5,at=o.height*.5,ot=Wr(Q,at,o,x,X.surfel_data,Vt);if(!ot)return;const gt=x.rotation,Pt=gt[2],Et=gt[6],mt=gt[10],vt=ot[0]-x.position[0],Gt=ot[1]-x.position[1],Ut=ot[2]-x.position[2],qt=vt*Pt+Gt*Et+Ut*mt;qt>0&&E.setOrbitDepth(qt)}if(Y.length===0){const Q=X.bbox.max[0]-X.bbox.min[0],at=X.bbox.max[1]-X.bbox.min[1],ot=X.bbox.max[2]-X.bbox.min[2],Pt=.5*Math.sqrt(Q*Q+at*at+ot*ot)*.5;I.set(_t[0]-Pt,_t[1]-Pt,_t[2]-Pt,x.position);const Et=I.create(Pt,Pt,Pt);I.normalize(Et,Et);const mt=I.create(0,1,0),vt=I.create();I.cross(mt,Et,vt),I.normalize(vt,vt);const Gt=I.create();I.cross(Et,vt,Gt);const Ut=he.create(vt[0],Gt[0],Et[0],vt[1],Gt[1],Et[1],vt[2],Gt[2],Et[2]);jt.fromMat3(Ut,x.rotation),x.update_buffer()}E.setCenter(I.create(X.centroid[0],X.centroid[1],X.centroid[2]));const pt=new oc(X,h,G,x.uniform_buffer,C,et);A=pt;let kt=!1;(async()=>{if(!await Pc())return;const Q=document.getElementById("enter-vr-button");Q&&(Q.style.display="",Q.addEventListener("click",async()=>{if(!kt){kt=!0,Q.disabled=!0,Q.textContent="🥽 In VR…";try{await Sc({device:h,renderer:pt,camera:x,onExit:()=>{kt=!1,Q.disabled=!1,Q.textContent="🥽 Enter VR",vn(o.width,o.height,h,pt.render_settings_buffer),x.on_update_canvas()}})}catch(at){console.error("[XR] session failed:",at),alert(`XR session failed: ${at.message}`),kt=!1,Q.disabled=!1,Q.textContent="🥽 Enter VR"}}}))})(),window.__xrActive=()=>kt,vn(o.width,o.height,h,pt.render_settings_buffer),R.atlas_enabled=et!==null;let wt=!1;const H=(()=>{if(et!==null)return`${et.meta.format===2?"BC7":et.meta.format===3?"ASTC 4×4":et.meta.format===5?"RVQ-paired (typeA)":et.meta.format===6?"RVQ-paired + BC7 codebook (typeB)":et.meta.format===7?"BC7 codebook gather (typeD)":`format=${et.meta.format}`} ${et.meta.width}×${et.meta.height}, ${et.meta.n_layers} layers`;const Q=h.features.has("texture-compression-bc"),at=h.features.has("texture-compression-astc");return`no atlas in bundle (GPU supports: ${(Q?["BC7"]:[]).concat(at?["ASTC"]:[]).join("+")||"none"})`})();console.log("[atlas]",H),qr(X.sh_bias,h,pt.render_settings_buffer),Fr(R.gaussian_scaling,h,pt.render_settings_buffer),R.sh_bias=X.sh_bias;const st=X.num_points.toLocaleString(),It={stats:`${st} surfels · -- fps`};U.addMonitor(It,"stats",{label:"Stats",interval:200}),U.addMonitor({atlas:H},"atlas",{label:"Atlas"});const Mt={stages:"— ms · awaiting timestamp data"};U.addMonitor(Mt,"stages",{label:"Stages",interval:500});let zt=null;if(pt.timeQueryEnabled){zt=document.createElement("canvas"),zt.width=280,zt.height=24,zt.style.cssText="position:fixed;right:8px;bottom:8px;width:280px;height:24px;background:#0008;border:1px solid #2a2a2a;border-radius:4px;font-family:ui-monospace,Menlo,monospace;pointer-events:none;z-index:1000;",document.body.appendChild(zt);const Q=ot=>{const gt=zt.getContext("2d");if(!gt)return;const Pt=zt.width,Et=zt.height;if(gt.clearRect(0,0,Pt,Et),!ot||ot.total<=0){gt.fillStyle="#888",gt.font="11px ui-monospace,Menlo,monospace",gt.fillText("awaiting GPU timestamps…",8,16);return}const mt=[{label:"cull",ms:ot.cull,color:"#3aa3ff"},{label:"pre",ms:ot.preprocess,color:"#3ad27a"},{label:"sort",ms:ot.sort,color:"#ffa53a"},{label:"render",ms:ot.render,color:"#ff5566"}],vt=Math.max(.001,mt.reduce((Ut,qt)=>Ut+qt.ms,0));let Gt=0;gt.font="10px ui-monospace,Menlo,monospace",gt.textBaseline="middle";for(const Ut of mt){const qt=Ut.ms/vt*Pt;gt.fillStyle=Ut.color,gt.fillRect(Gt,0,qt,Et),qt>=38&&(gt.fillStyle="#000c",gt.fillText(`${Ut.label} ${Ut.ms.toFixed(1)}`,Gt+4,Et/2)),Gt+=qt}};setInterval(()=>{wt||pt.readPerfMetrics({silent:!0}).then(()=>{const ot=pt.lastStageBreakdownMs;Q(ot),ot&&(Mt.stages=`${ot.total.toFixed(1)} ms · cull ${ot.cull.toFixed(1)} / pre ${ot.preprocess.toFixed(1)} / sort ${ot.sort.toFixed(1)} / render ${ot.render.toFixed(1)}`)}).catch(ot=>console.warn("[perf] readPerfMetrics failed:",ot))},500)}const Tt=.4,Ot=3,xt=.3;let ht=null,Wt=0,B=0;const j=se.create(),g=he.create();let i=Y.length>0?0:-1;const f={view:Y.length>0?`${i+1} / ${Y.length}: ${Y[i].img_name??i}`:"— no presets —"};U.addMonitor(f,"view",{label:"View",interval:100});function d(Q){const at=he.create(Q[0],Q[1],Q[2],Q[4],Q[5],Q[6],Q[8],Q[9],Q[10]);return se.fromMat(at)}function b(Q,at){ht={fromPos:I.clone(x.position),toPos:I.clone(Q.position),fromQuat:se.normalize(d(x.rotation)),toQuat:se.normalize(d(Q.rotation)),target:Q,t:0,duration:Math.max(.01,at)}}const y=(Q,at=!0)=>{if(Y.length===0)return;i=(Q%Y.length+Y.length)%Y.length;const ot=Y[i];at?b(ot,Tt):(x.set_preset(ot),E.resetToCamera(),Dt()),f.view=`${i+1} / ${Y.length}: ${Y[i].img_name??i}`};Y.length>0&&(U.addButton({title:"◀ Prev view"}).on("click",()=>y(i-1)),U.addButton({title:"Next view ▶"}).on("click",()=>y(i+1)));const S=Y.length>0?ii(Y,{tiltDownDeg:15,alignFirst:!0}):null,k=S?yc(Y,{numViews:120,tiltDownDeg:15,alignFirst:!0}):[];let r=0;const m=12;lt.value={onAnimateStart:()=>{r=0},onAnimateStop:()=>{E.resetToCamera(),Dt()}},U.addInput(R,"render_scale",{label:"Render scale",min:.25,max:O,step:.25}).on("change",Q=>{const at=Math.max(.25,Q.value),ot=Math.max(1,Math.ceil(at*o.clientWidth)),gt=Math.max(1,Math.ceil(at*o.clientHeight));(o.width!==ot||o.height!==gt)&&(o.width=ot,o.height=gt,L())}),U.addInput(R,"gaussian_scaling",{label:"Surfel scale",min:0,max:1}).on("change",Q=>Fr(Q.value,h,pt.render_settings_buffer)),U.addInput(R,"sh_bias",{label:"SH bias",min:0,max:2,step:.01}).on("change",Q=>qr(Q.value,h,pt.render_settings_buffer)),U.addInput(R,"bg",{label:"Background",color:{type:"float",alpha:!0}}).on("change",Q=>{pt.bgColor=[Q.value.r,Q.value.g,Q.value.b,Q.value.a]});const u=et?et.meta.format===3?"Atlas (ASTC)":et.meta.format===5?"Atlas (RVQ)":"Atlas (BC7)":"Atlas";U.addInput(R,"atlas_enabled",{label:u}).on("change",Q=>pt.setAtlasEnabled(Q.value)),U.addInput(R,"bfc",{label:"Backface"}).on("change",Q=>Xl({bfc:Q.value},h,pt.render_settings_buffer)),U.addButton({title:"🎯 Reset camera"}).on("click",()=>{if(Y.length>0)x.set_preset(Y[0]);else{const Q=X.bbox.max[0]-X.bbox.min[0],at=X.bbox.max[1]-X.bbox.min[1],ot=X.bbox.max[2]-X.bbox.min[2],Pt=.5*Math.sqrt(Q*Q+at*at+ot*ot)*.5;I.set(_t[0]-Pt,_t[1]-Pt,_t[2]-Pt,x.position);const Et=I.create(Pt,Pt,Pt);I.normalize(Et,Et);const mt=I.create();I.cross(I.create(0,1,0),Et,mt),I.normalize(mt,mt);const vt=I.create();I.cross(Et,mt,vt);const Gt=he.create(mt[0],vt[0],Et[0],mt[1],vt[1],Et[1],mt[2],vt[2],Et[2]);jt.fromMat3(Gt,x.rotation),x.update_buffer()}E.resetToCamera(),Dt()});const p={result:"— click Benchmark —"};U.addMonitor(p,"result",{label:"Bench",interval:500,multiline:!0,lineCount:4});const a={bicycle:{w:1237,h:822,fovY:2*Math.atan(3286/(2*4627.3))},flowers:{w:1256,h:828,fovY:2*Math.atan(3312/(2*4285.5))},garden:{w:1297,h:840,fovY:2*Math.atan(3361/(2*3852.4))},stump:{w:1245,h:825,fovY:2*Math.atan(3300/(2*4528.1))},treehill:{w:1267,h:832,fovY:2*Math.atan(3326/(2*4205.6))},bonsai:{w:1559,h:1039,fovY:2*Math.atan(2078/(2*3222.7))},counter:{w:1558,h:1038,fovY:2*Math.atan(2076/(2*3192.7))},kitchen:{w:1558,h:1039,fovY:2*Math.atan(2078/(2*3240.8))},room:{w:1557,h:1038,fovY:2*Math.atan(2075/(2*3174))}};function _(){const at=((new URLSearchParams(window.location.search).get("bundle")??"").split("/").pop()??"").toLowerCase();for(const ot of Object.keys(a))if(at.startsWith(ot))return ot;return null}const w=document.createElement("div");w.id="bench-overlay",w.style.cssText=["position:fixed","top:50%","left:50%","transform:translate(-50%,-50%)","background:rgba(0,0,0,0.9)","color:#fff","padding:24px 32px","border-radius:8px","font-family:monospace","font-size:14px","min-width:340px","text-align:left","box-shadow:0 4px 24px rgba(0,0,0,0.6)","display:none","z-index:9999","pointer-events:none"].join(";"),document.body.appendChild(w);function v(Q,at,ot){const gt=Math.floor(at/Math.max(1,ot)*100),Pt=32,Et=Math.floor(at/Math.max(1,ot)*Pt),mt="█".repeat(Et)+"░".repeat(Pt-Et);w.innerHTML=`<div style="margin-bottom:10px;font-weight:bold">📊 ${Q}</div><div>[${mt}] ${gt}%</div><div style="margin-top:6px;font-size:11px;opacity:0.7">${at} / ${ot} frames · offscreen · pipelined · no vsync</div>`,w.style.display="block"}function D(){w.style.display="none"}async function N(Q=10,at=200){if(wt)return;if(Y.length===0){p.result="no cameras to benchmark";return}wt=!0;const ot=W,gt=R.animate,Pt=new Float32Array(x.position),Et=new Float32Array(x.rotation);W=!1,R.animate=!1,U.refresh(),ht=null,E.enabled=!1;const mt=_(),vt=mt?a[mt]:null,Gt=(vt==null?void 0:vt.w)??o.width,Ut=(vt==null?void 0:vt.h)??o.height,qt=(vt==null?void 0:vt.fovY)??x.getFov(),Kt=mt?`${mt} · ${Gt>=4e3/4+500?"images_4":"images_2"}`:"custom",Xt=o.width,Ht=o.height,ee=x.getFov();o.width=Gt,o.height=Ut,x.setFov(qt),vn(Gt,Ut,h,pt.render_settings_buffer);const Qt=h.createTexture({size:[Gt,Ut,1],format:G,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.STORAGE_BINDING}),be=Qt.createView(),fe=()=>{const Jt=h.createCommandEncoder();pt.frame(Jt,be,!1),h.queue.submit([Jt.finish()])},_e=()=>new Promise(Jt=>setTimeout(Jt,0)),me=20,ve=async(Jt,ue)=>{let ge=0,oe=0;for(v(ue,0,Jt),await _e();oe<Jt;){const we=Math.min(me,Jt-oe),xe=performance.now();for(let je=0;je<we;je++)x.set_preset(Y[(oe+je)%Y.length]),fe();await h.queue.onSubmittedWorkDone();const Yt=performance.now();ge+=Yt-xe,oe+=we,v(ue,oe,Jt),await _e()}return ge};try{await ve(Q,"Warming up");const ue=await ve(at,"Benchmarking")/at,ge=1e3/ue,oe=X.num_points??X.surfel_data.length/8,we=(qt*180/Math.PI).toFixed(1),xe=`${ge.toFixed(1)} FPS  (${ue.toFixed(2)} ms/frame)
${Gt}×${Ut} · fovY ${we}° · ${Kt}
${oe.toLocaleString()} surfels · ${Q}w+${at}b · pipelined`;p.result=xe,console.log("[bench]",xe.replace(/\n/g,"  |  "))}catch(Jt){console.error("[bench] failed:",Jt),p.result=`bench failed: ${Jt}`}finally{D(),Qt.destroy(),o.width=Xt,o.height=Ht,x.setFov(ee),vn(Xt,Ht,h,pt.render_settings_buffer),x.position.set(Pt),x.rotation.set(Et),x.update_buffer(),E.enabled=!ot,W=ot,R.animate=gt,U.refresh(),wt=!1}}U.addButton({title:"📊 Benchmark"}).on("click",()=>N()),document.addEventListener("keydown",Q=>{const at=Q.key;if(at>="0"&&at<="9"&&Y.length>0){const ot=parseInt(at);ot<Y.length&&y(ot)}else at==="ArrowLeft"||at==="PageUp"?(y(i-1),Q.preventDefault()):at==="ArrowRight"||at==="PageDown"?(y(i+1),Q.preventDefault()):(at==="d"||at==="D")&&pt.debugReadSortedIndices(30).catch(ot=>console.error("[DEBUG] readback failed:",ot))});function $(Q,at){const ot=o.getBoundingClientRect(),gt=window.devicePixelRatio||1;return[(Q-ot.left)*gt,(at-ot.top)*gt]}o.addEventListener("dblclick",Q=>{const[at,ot]=$(Q.clientX,Q.clientY);Rt(at,ot)});let ct=0,it=0,rt=0;o.addEventListener("pointerdown",Q=>{if(Q.pointerType!=="touch")return;const at=performance.now(),ot=at-ct,gt=Q.clientX-it,Pt=Q.clientY-rt;if(ot>0&&ot<300&&gt*gt+Pt*Pt<40*40){const[Et,mt]=$(Q.clientX,Q.clientY);Rt(Et,mt),ct=0}else ct=at,it=Q.clientX,rt=Q.clientY});function ft(){return M}let yt=performance.now(),dt=60,bt=Promise.resolve(),Ct=0;async function At(){var Et;const Q=performance.now(),at=Math.min((Q-yt)/1e3,.1);if(yt=Q,at>0){const mt=((Et=pt.lastStageBreakdownMs)==null?void 0:Et.total)??0,vt=mt>.5?1e3/mt:1/at;dt=dt*.9+vt*.1,It.stats=`${st} surfels · ${Math.round(dt)} fps`}if(wt||kt){requestAnimationFrame(At);return}if(ft()&&(ht||W)&&(ht=null,E.resetToCamera(),Dt(),W&&(W=!1,R.animate=!1,U.refresh())),W&&R.animateMode==="circle"&&S){r+=at/m,r>=1&&(r-=1);const mt=oi(S,r);x.set_preset(mt),E.update(at);const vt=h.createCommandEncoder();pt.frame(vt,l.getCurrentTexture().createView()),h.queue.submit([vt.finish()]),Ct++,Ct===2&&gn(),requestAnimationFrame(At);return}if(ht){ht.t+=at/ht.duration;const mt=Math.min(1,ht.t),vt=mt*mt*(3-2*mt);I.lerp(ht.fromPos,ht.toPos,vt,x.position),se.slerp(ht.fromQuat,ht.toQuat,vt,j),he.fromQuat(j,g),jt.fromMat3(g,x.rotation),x.update_buffer(),ht.t>=1&&(x.set_preset(ht.target),ht=null,W?Y.length>0&&(Wt=xt):(E.resetToCamera(),Dt()))}else if(W&&!ft()){const mt=R.animateMode==="circle"&&k.length>0,vt=mt?k:Y;if(vt.length!==0){if(Wt-=at,Wt<=0){const Ut=((mt?B:i)+1)%vt.length;mt?B=Ut:i=Ut;const qt=mt?Ot/8:Ot;b(vt[Ut],qt),mt||(f.view=`${i+1} / ${Y.length}: ${Y[i].img_name??i}`)}}}E.update(at),J(),await bt;const ot=h.createCommandEncoder(),gt=l.getCurrentTexture().createView(),Pt=window.__halloumiProgress??(mt=>{});Ct<3&&Pt("flat-frame#"+Ct+" encoding…"),pt.frame(ot,gt),Ct<3&&Pt("flat-frame#"+Ct+" submitting…"),h.queue.submit([ot.finish()]),Ct<3&&Pt("flat-frame#"+Ct+" submit OK"),bt=h.queue.onSubmittedWorkDone().then(()=>{Ct<=3&&Pt("flat-frame#"+(Ct-1)+" GPU work done")}),Ct++,Ct===2&&gn(),requestAnimationFrame(At)}requestAnimationFrame(At)}}(function(){let l="dev";for(const C of Array.from(document.querySelectorAll('script[type="module"]'))){const E=C.src.match(/\/assets\/index-([0-9a-z]+)\.js$/i);if(E){l=E[1];break}}const h=document.createElement("div");h.textContent="v "+l,h.title="viewer build hash (Vite content hash of index-*.js)",Object.assign(h.style,{position:"fixed",right:"6px",bottom:"6px",font:"10px ui-monospace, SFMono-Regular, Menlo, monospace",color:"rgba(255,255,255,0.55)",background:"rgba(0,0,0,0.35)",padding:"2px 6px",borderRadius:"4px",pointerEvents:"none",zIndex:"9999",userSelect:"all"}),document.body.appendChild(h)})();function Oe(o){let l=document.getElementById("halloumi-xr-error");l||(l=document.createElement("div"),l.id="halloumi-xr-error",l.style.cssText="position:fixed;top:0;left:0;right:0;padding:1em;background:#3a0000;color:#ffb0b0;font-family:system-ui,monospace;font-size:0.85rem;z-index:9999;white-space:pre-wrap;overflow-x:auto;max-height:60vh;border-bottom:2px solid #7a0000",document.body.appendChild(l)),l.textContent+=(l.textContent?`
`:"")+o,console.error(o)}const jr=[];function qe(o){const l=performance.now().toFixed(0);jr.push(`[${l}ms] ${o}`);let h=document.getElementById("halloumi-xr-progress");h||(h=document.createElement("div"),h.id="halloumi-xr-progress",h.style.cssText="position:fixed;bottom:20px;left:0;right:0;padding:0.6em;background:rgba(0,20,40,0.85);color:#a0c8ff;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:0.75rem;z-index:9998;white-space:pre-wrap;max-height:35vh;overflow-y:auto;border-top:1px solid #204080",document.body.appendChild(h)),h.textContent=jr.slice(-40).join(`
`),console.log(o)}window.__halloumiProgress=qe;(async()=>{var o;try{if(qe("boot: main.ts entered"),navigator.gpu===void 0){Oe("WebGPU is not supported in this browser. (navigator.gpu is undefined)");return}qe("requesting adapter…");const l=await navigator.gpu.requestAdapter({powerPreference:"high-performance"});if(l===null){Oe("WebGPU adapter unavailable. requestAdapter returned null.");return}qe("adapter OK; vendor="+(((o=l.info)==null?void 0:o.vendor)??"?"));const h=[];l.features.has("timestamp-query")&&h.push("timestamp-query"),l.features.has("texture-compression-bc")&&h.push("texture-compression-bc"),l.features.has("texture-compression-astc")&&h.push("texture-compression-astc"),console.log("[adapter]",l.info??"(unknown)"),console.log("[adapter] features:",Array.from(l.features)),console.log("[adapter] BC7:",l.features.has("texture-compression-bc")),console.log("[adapter] ASTC:",l.features.has("texture-compression-astc")),console.log("[adapter] limits:",{maxStorageBuffersPerShaderStage:l.limits.maxStorageBuffersPerShaderStage,maxComputeWorkgroupStorageSize:l.limits.maxComputeWorkgroupStorageSize,maxBufferSize:l.limits.maxBufferSize,maxStorageBufferBindingSize:l.limits.maxStorageBufferBindingSize,maxTextureDimension2D:l.limits.maxTextureDimension2D});const C=10,x=Math.min(C,l.limits.maxStorageBuffersPerShaderStage);x<C&&console.warn(`[adapter] adapter exposes only ${x} storage buffers per stage; viewer wants ${C}. Cull stage may fail to compile.`),qe("requesting device (features="+h.join(",")+")…");let E;try{E=await l.requestDevice({requiredFeatures:h,requiredLimits:{maxStorageBuffersPerShaderStage:x,maxComputeWorkgroupStorageSize:l.limits.maxComputeWorkgroupStorageSize,maxBufferSize:l.limits.maxBufferSize,maxStorageBufferBindingSize:l.limits.maxStorageBufferBindingSize}}),qe("device OK")}catch(A){Oe(`WebGPU device creation FAILED.
error: ${A.message}

Adapter info: `+JSON.stringify(l.info??{})+`
Requested features: `+h.join(", ")+`
Requested maxStorageBuffersPerShaderStage: `+x);return}E.addEventListener("uncapturederror",A=>{const L=A.error;Oe(`WebGPU uncaptured error (${L.constructor.name}):
${L.message}`)}),E.lost.then(A=>{Oe(`WebGPU device LOST: ${A.reason} — ${A.message}`)});const M=document.querySelector("#webgpu-canvas");Dl(M!==null);const G=M.getContext("webgpu");if(G===null){Oe('canvas.getContext("webgpu") returned null.');return}qe("canvas ctx OK; entering splat-app init…"),Lc(M,G,E,h)}catch(l){Oe(`Bootstrap failed: ${l.message}
${l.stack??""}`)}})();
